...
public class HrisUpdateEmployeeEmploymentOperation implements RequestOperation<HrisUpdateEmployeeEmploymentRequest, HrisUpdateEmployeeEmploymentResponse> {
    ...
    public HrisUpdateEmployeeEmploymentOperation(
    ...
    public HttpRequest buildRequest(HrisUpdateEmployeeEmploymentRequest request) throws Exception {
