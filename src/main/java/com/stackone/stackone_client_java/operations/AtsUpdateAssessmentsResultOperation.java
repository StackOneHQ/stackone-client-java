...
public class AtsUpdateAssessmentsResultOperation implements RequestOperation<AtsUpdateAssessmentsResultRequest, AtsUpdateAssessmentsResultResponse> {
    ...
    public AtsUpdateAssessmentsResultOperation(
    ...
    public HttpRequest buildRequest(AtsUpdateAssessmentsResultRequest request) throws Exception {
