...
public class AtsGetCandidateCustomFieldDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetCandidateCustomFieldDefinitionRequest, AtsGetCandidateCustomFieldDefinitionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetCandidateCustomFieldDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetCandidateCustomFieldDefinitionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetCandidateCustomFieldDefinitionRequest request) {
        ...
        @Override
        public AtsGetCandidateCustomFieldDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetCandidateCustomFieldDefinitionResponse.Builder resBuilder =
            ...
            AtsGetCandidateCustomFieldDefinitionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetCandidateCustomFieldDefinitionRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateCustomFieldDefinitionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetCandidateCustomFieldDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetCandidateCustomFieldDefinitionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetCandidateCustomFieldDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateCustomFieldDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateCustomFieldDefinitionResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateCustomFieldDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateCustomFieldDefinitionResponse res = resBuilder.build();
