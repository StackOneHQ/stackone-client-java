...
public class HrisListTimeOffPolicies {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListTimeOffPoliciesRequest, HrisListTimeOffPoliciesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListTimeOffPoliciesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListTimeOffPoliciesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListTimeOffPoliciesRequest request) {
        ...
        @Override
        public HrisListTimeOffPoliciesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListTimeOffPoliciesResponse.Builder resBuilder =
            ...
            HrisListTimeOffPoliciesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListTimeOffPoliciesRequest, com.stackone.stackone_client_java.models.operations.async.HrisListTimeOffPoliciesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListTimeOffPoliciesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListTimeOffPoliciesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListTimeOffPoliciesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListTimeOffPoliciesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListTimeOffPoliciesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListTimeOffPoliciesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListTimeOffPoliciesResponse res = resBuilder.build();
