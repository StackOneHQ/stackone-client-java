...
public class HrisListCompaniesGroupsOperation implements RequestOperation<HrisListCompaniesGroupsRequest, HrisListCompaniesGroupsResponse> {
    ...
    public HrisListCompaniesGroupsOperation(
    ...
    public HttpRequest buildRequest(HrisListCompaniesGroupsRequest request) throws Exception {
