...
public class LmsGetCategory {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsGetCategoryRequest, LmsGetCategoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsGetCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetCategoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetCategoryRequest request) {
        ...
        @Override
        public LmsGetCategoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsGetCategoryResponse.Builder resBuilder =
            ...
            LmsGetCategoryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCategoryResult(Utils.unmarshal(response, new TypeReference<CategoryResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsGetCategoryRequest, com.stackone.stackone_client_java.models.operations.async.LmsGetCategoryResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsGetCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetCategoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsGetCategoryRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsGetCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsGetCategoryResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsGetCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsGetCategoryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CategoryResult>() {})
                            .thenApply(res::withCategoryResult);
                } else {
