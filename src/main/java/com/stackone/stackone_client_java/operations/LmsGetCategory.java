...
public class LmsGetCategory {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetCategoryRequest request) throws Exception {
        ...
        @Override
        public LmsGetCategoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CategoryResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCategoryResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
