...
public class LmsCreateUserAssignmentOperation implements RequestOperation<LmsCreateUserAssignmentRequest, LmsCreateUserAssignmentResponse> {
    ...
    public LmsCreateUserAssignmentOperation(
    ...
    public HttpRequest buildRequest(LmsCreateUserAssignmentRequest request) throws Exception {
