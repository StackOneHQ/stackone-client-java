...
public class AtsListLocationsOperation implements RequestOperation<AtsListLocationsRequest, AtsListLocationsResponse> {
    ...
    public AtsListLocationsOperation(
    ...
    public HttpRequest buildRequest(AtsListLocationsRequest request) throws Exception {
