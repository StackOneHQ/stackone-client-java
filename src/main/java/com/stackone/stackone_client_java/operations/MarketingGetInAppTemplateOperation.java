...
public class MarketingGetInAppTemplateOperation implements RequestOperation<MarketingGetInAppTemplateRequest, MarketingGetInAppTemplateResponse> {
    ...
    public MarketingGetInAppTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingGetInAppTemplateRequest request) throws Exception {
