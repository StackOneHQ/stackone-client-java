...
public class HrisListEmployeeCategoriesOperation implements RequestOperation<HrisListEmployeeCategoriesRequest, HrisListEmployeeCategoriesResponse> {
    ...
    public HrisListEmployeeCategoriesOperation(
    ...
    public HttpRequest buildRequest(HrisListEmployeeCategoriesRequest request) throws Exception {
