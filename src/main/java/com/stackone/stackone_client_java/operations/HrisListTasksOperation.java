...
public class HrisListTasksOperation implements RequestOperation<HrisListTasksRequest, HrisListTasksResponse> {
    ...
    public HttpRequest buildRequest(HrisListTasksRequest request) throws Exception {
