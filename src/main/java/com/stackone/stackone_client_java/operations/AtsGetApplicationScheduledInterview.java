...
public class AtsGetApplicationScheduledInterview {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationScheduledInterviewRequest request) throws Exception {
        ...
        @Override
        public AtsGetApplicationScheduledInterviewResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ScheduledInterviewsResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withScheduledInterviewsResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
