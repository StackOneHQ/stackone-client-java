...
public class AtsGetApplicationScheduledInterview {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetApplicationScheduledInterviewRequest, AtsGetApplicationScheduledInterviewResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetApplicationScheduledInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetApplicationScheduledInterviewRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationScheduledInterviewRequest request) {
        ...
        @Override
        public AtsGetApplicationScheduledInterviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetApplicationScheduledInterviewResponse.Builder resBuilder =
            ...
            AtsGetApplicationScheduledInterviewResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScheduledInterviewsResult(Utils.unmarshal(response, new TypeReference<ScheduledInterviewsResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetApplicationScheduledInterviewRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationScheduledInterviewResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetApplicationScheduledInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetApplicationScheduledInterviewRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetApplicationScheduledInterviewRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationScheduledInterviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationScheduledInterviewResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationScheduledInterviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationScheduledInterviewResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ScheduledInterviewsResult>() {})
                            .thenApply(res::withScheduledInterviewsResult);
                } else {
