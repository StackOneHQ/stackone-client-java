...
public class HrisUpdateEmployee {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisUpdateEmployeeRequest request) {
        ...
        @Override
        public HrisUpdateEmployeeResponse handleResponse(HttpResponse<InputStream> response) {
