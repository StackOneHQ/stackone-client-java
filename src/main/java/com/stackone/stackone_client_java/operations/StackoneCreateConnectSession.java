...
public class StackoneCreateConnectSession {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectSessionCreate request) throws Exception {
        ...
        @Override
        public StackoneCreateConnectSessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ConnectSessionTokenAuthLink out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withConnectSessionTokenAuthLink(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
