...
public class StackoneCreateConnectSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<ConnectSessionCreate, StackoneCreateConnectSessionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ConnectSessionCreate request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ConnectSessionCreate>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectSessionCreate request) {
        ...
        @Override
        public StackoneCreateConnectSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneCreateConnectSessionResponse.Builder resBuilder =
            ...
            StackoneCreateConnectSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConnectSessionTokenAuthLink(Utils.unmarshal(response, new TypeReference<ConnectSessionTokenAuthLink>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ConnectSessionCreate, com.stackone.stackone_client_java.models.operations.async.StackoneCreateConnectSessionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ConnectSessionCreate request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ConnectSessionCreate>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ConnectSessionCreate request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneCreateConnectSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneCreateConnectSessionResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneCreateConnectSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneCreateConnectSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ConnectSessionTokenAuthLink>() {})
                            .thenApply(res::withConnectSessionTokenAuthLink);
                } else {
