...
public class AtsGetJobCustomFieldDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetJobCustomFieldDefinitionRequest, AtsGetJobCustomFieldDefinitionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetJobCustomFieldDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetJobCustomFieldDefinitionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetJobCustomFieldDefinitionRequest request) {
        ...
        @Override
        public AtsGetJobCustomFieldDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetJobCustomFieldDefinitionResponse.Builder resBuilder =
            ...
            AtsGetJobCustomFieldDefinitionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetJobCustomFieldDefinitionRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetJobCustomFieldDefinitionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetJobCustomFieldDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetJobCustomFieldDefinitionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetJobCustomFieldDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetJobCustomFieldDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetJobCustomFieldDefinitionResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetJobCustomFieldDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetJobCustomFieldDefinitionResponse res = resBuilder.build();
