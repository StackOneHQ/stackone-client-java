...
public class HrisGetPosition {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetPositionRequest, HrisGetPositionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetPositionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetPositionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetPositionRequest request) {
        ...
        @Override
        public HrisGetPositionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetPositionResponse.Builder resBuilder =
            ...
            HrisGetPositionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPositionResult(Utils.unmarshal(response, new TypeReference<PositionResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetPositionRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetPositionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetPositionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetPositionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetPositionRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetPositionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetPositionResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetPositionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetPositionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PositionResult>() {})
                            .thenApply(res::withPositionResult);
                } else {
