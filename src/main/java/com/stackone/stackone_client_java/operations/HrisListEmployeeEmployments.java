...
public class HrisListEmployeeEmployments {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListEmployeeEmploymentsRequest, HrisListEmployeeEmploymentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListEmployeeEmploymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmployeeEmploymentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeEmploymentsRequest request) {
        ...
        @Override
        public HrisListEmployeeEmploymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListEmployeeEmploymentsResponse.Builder resBuilder =
            ...
            HrisListEmployeeEmploymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEmploymentsPaginated(Utils.unmarshal(response, new TypeReference<EmploymentsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListEmployeeEmploymentsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeEmploymentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListEmployeeEmploymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmployeeEmploymentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListEmployeeEmploymentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeEmploymentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeEmploymentsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeEmploymentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeEmploymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EmploymentsPaginated>() {})
                            .thenApply(res::withEmploymentsPaginated);
                } else {
