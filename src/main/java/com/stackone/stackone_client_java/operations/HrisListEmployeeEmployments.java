...
public class HrisListEmployeeEmployments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeEmploymentsRequest request) throws Exception {
        ...
        @Override
        public HrisListEmployeeEmploymentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EmploymentsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmploymentsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
