...
public class LmsListCompletions {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsListCompletionsRequest, LmsListCompletionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsListCompletionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListCompletionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListCompletionsRequest request) {
        ...
        @Override
        public LmsListCompletionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsListCompletionsResponse.Builder resBuilder =
            ...
            LmsListCompletionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsListCompletionsRequest, com.stackone.stackone_client_java.models.operations.async.LmsListCompletionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsListCompletionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListCompletionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsListCompletionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsListCompletionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsListCompletionsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsListCompletionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsListCompletionsResponse res = resBuilder.build();
