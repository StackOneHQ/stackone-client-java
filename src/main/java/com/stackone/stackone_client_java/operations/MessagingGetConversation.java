...
public class MessagingGetConversation {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingGetConversationRequest request) throws Exception {
        ...
        @Override
        public MessagingGetConversationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MessagingConversationResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMessagingConversationResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
