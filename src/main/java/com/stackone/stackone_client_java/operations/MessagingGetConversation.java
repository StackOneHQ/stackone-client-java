...
public class MessagingGetConversation {
    ...
    public static class Sync extends Base
            implements RequestOperation<MessagingGetConversationRequest, MessagingGetConversationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MessagingGetConversationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingGetConversationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingGetConversationRequest request) {
        ...
        @Override
        public MessagingGetConversationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MessagingGetConversationResponse.Builder resBuilder =
            ...
            MessagingGetConversationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingConversationResult(Utils.unmarshal(response, new TypeReference<MessagingConversationResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MessagingGetConversationRequest, com.stackone.stackone_client_java.models.operations.async.MessagingGetConversationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MessagingGetConversationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingGetConversationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MessagingGetConversationRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MessagingGetConversationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MessagingGetConversationResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MessagingGetConversationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MessagingGetConversationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MessagingConversationResult>() {})
                            .thenApply(res::withMessagingConversationResult);
                } else {
