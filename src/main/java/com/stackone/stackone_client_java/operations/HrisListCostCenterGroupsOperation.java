...
public class HrisListCostCenterGroupsOperation implements RequestOperation<HrisListCostCenterGroupsRequest, HrisListCostCenterGroupsResponse> {
    ...
    public HrisListCostCenterGroupsOperation(
    ...
    public HttpRequest buildRequest(HrisListCostCenterGroupsRequest request) throws Exception {
