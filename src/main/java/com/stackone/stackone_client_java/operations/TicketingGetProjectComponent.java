...
public class TicketingGetProjectComponent {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingGetProjectComponentRequest request) throws Exception {
        ...
        @Override
        public TicketingGetProjectComponentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TicketingComponentResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingComponentResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
