...
public class TicketingGetProjectComponent {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingGetProjectComponentRequest, TicketingGetProjectComponentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingGetProjectComponentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetProjectComponentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingGetProjectComponentRequest request) {
        ...
        @Override
        public TicketingGetProjectComponentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingGetProjectComponentResponse.Builder resBuilder =
            ...
            TicketingGetProjectComponentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingComponentResult(Utils.unmarshal(response, new TypeReference<TicketingComponentResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingGetProjectComponentRequest, com.stackone.stackone_client_java.models.operations.async.TicketingGetProjectComponentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingGetProjectComponentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetProjectComponentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingGetProjectComponentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingGetProjectComponentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingGetProjectComponentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingGetProjectComponentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingGetProjectComponentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingComponentResult>() {})
                            .thenApply(res::withTicketingComponentResult);
                } else {
