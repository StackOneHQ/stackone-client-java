...
public class DocumentsListDrives {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsListDrivesRequest request) throws Exception {
        ...
        @Override
        public DocumentsListDrivesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DrivesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDrivesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
