...
public class DocumentsListDrives {
    ...
    public static class Sync extends Base
            implements RequestOperation<DocumentsListDrivesRequest, DocumentsListDrivesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DocumentsListDrivesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsListDrivesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsListDrivesRequest request) {
        ...
        @Override
        public DocumentsListDrivesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DocumentsListDrivesResponse.Builder resBuilder =
            ...
            DocumentsListDrivesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDrivesPaginated(Utils.unmarshal(response, new TypeReference<DrivesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DocumentsListDrivesRequest, com.stackone.stackone_client_java.models.operations.async.DocumentsListDrivesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DocumentsListDrivesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsListDrivesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DocumentsListDrivesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.DocumentsListDrivesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.DocumentsListDrivesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.DocumentsListDrivesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.DocumentsListDrivesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DrivesPaginated>() {})
                            .thenApply(res::withDrivesPaginated);
                } else {
