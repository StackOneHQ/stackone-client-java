...
public class TicketingGetTicket {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingGetTicketRequest, TicketingGetTicketResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingGetTicketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetTicketRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingGetTicketRequest request) {
        ...
        @Override
        public TicketingGetTicketResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingGetTicketResponse.Builder resBuilder =
            ...
            TicketingGetTicketResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingTicketResult(Utils.unmarshal(response, new TypeReference<TicketingTicketResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingGetTicketRequest, com.stackone.stackone_client_java.models.operations.async.TicketingGetTicketResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingGetTicketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetTicketRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingGetTicketRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingGetTicketResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingGetTicketResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingGetTicketResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingGetTicketResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingTicketResult>() {})
                            .thenApply(res::withTicketingTicketResult);
                } else {
