...
public class MarketingUpdateSmsTemplateOperation implements RequestOperation<MarketingUpdateSmsTemplateRequest, MarketingUpdateSmsTemplateResponse> {
    ...
    public MarketingUpdateSmsTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingUpdateSmsTemplateRequest request) throws Exception {
