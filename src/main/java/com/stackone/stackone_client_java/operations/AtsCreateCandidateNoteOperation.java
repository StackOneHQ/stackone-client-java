...
public class AtsCreateCandidateNoteOperation implements RequestOperation<AtsCreateCandidateNoteRequest, AtsCreateCandidateNoteResponse> {
    ...
    public AtsCreateCandidateNoteOperation(
    ...
    public HttpRequest buildRequest(AtsCreateCandidateNoteRequest request) throws Exception {
