...
public class HrisListEmployeeWorkEligibility {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeWorkEligibilityRequest request) throws Exception {
        ...
        @Override
        public HrisListEmployeeWorkEligibilityResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    WorkEligibilityPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withWorkEligibilityPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
