...
public class HrisListEmployeeWorkEligibility {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListEmployeeWorkEligibilityRequest, HrisListEmployeeWorkEligibilityResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListEmployeeWorkEligibilityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmployeeWorkEligibilityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeWorkEligibilityRequest request) {
        ...
        @Override
        public HrisListEmployeeWorkEligibilityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListEmployeeWorkEligibilityResponse.Builder resBuilder =
            ...
            HrisListEmployeeWorkEligibilityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWorkEligibilityPaginated(Utils.unmarshal(response, new TypeReference<WorkEligibilityPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListEmployeeWorkEligibilityRequest, com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeWorkEligibilityResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListEmployeeWorkEligibilityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmployeeWorkEligibilityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListEmployeeWorkEligibilityRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeWorkEligibilityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeWorkEligibilityResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeWorkEligibilityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeWorkEligibilityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<WorkEligibilityPaginated>() {})
                            .thenApply(res::withWorkEligibilityPaginated);
                } else {
