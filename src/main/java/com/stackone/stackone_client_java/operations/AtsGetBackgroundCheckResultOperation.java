...
public class AtsGetBackgroundCheckResultOperation implements RequestOperation<AtsGetBackgroundCheckResultRequest, AtsGetBackgroundCheckResultResponse> {
    ...
    public AtsGetBackgroundCheckResultOperation(
    ...
    public HttpRequest buildRequest(AtsGetBackgroundCheckResultRequest request) throws Exception {
