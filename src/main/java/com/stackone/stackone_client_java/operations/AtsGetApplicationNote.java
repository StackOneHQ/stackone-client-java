...
public class AtsGetApplicationNote {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationNoteRequest request) throws Exception {
        ...
        @Override
        public AtsGetApplicationNoteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    NoteResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withNoteResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
