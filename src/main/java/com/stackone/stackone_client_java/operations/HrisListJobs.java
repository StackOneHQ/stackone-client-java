...
public class HrisListJobs {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListJobsRequest, HrisListJobsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListJobsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListJobsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListJobsRequest request) {
        ...
        @Override
        public HrisListJobsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListJobsResponse.Builder resBuilder =
            ...
            HrisListJobsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisJobsPaginated(Utils.unmarshal(response, new TypeReference<HrisJobsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListJobsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListJobsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListJobsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListJobsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListJobsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListJobsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListJobsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListJobsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListJobsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisJobsPaginated>() {})
                            .thenApply(res::withHrisJobsPaginated);
                } else {
