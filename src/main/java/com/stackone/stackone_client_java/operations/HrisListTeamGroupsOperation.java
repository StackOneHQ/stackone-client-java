...
public class HrisListTeamGroupsOperation implements RequestOperation<HrisListTeamGroupsRequest, HrisListTeamGroupsResponse> {
    ...
    public HrisListTeamGroupsOperation(
    ...
    public HttpRequest buildRequest(HrisListTeamGroupsRequest request) throws Exception {
