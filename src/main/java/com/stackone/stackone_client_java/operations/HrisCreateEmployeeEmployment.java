...
public class HrisCreateEmployeeEmployment {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisCreateEmployeeEmploymentRequest, HrisCreateEmployeeEmploymentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisCreateEmployeeEmploymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCreateEmployeeEmploymentRequest.class, new TypeReference<HrisCreateEmployeeEmploymentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisCreateEmployeeEmploymentRequest request) {
        ...
        @Override
        public HrisCreateEmployeeEmploymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisCreateEmployeeEmploymentResponse.Builder resBuilder =
            ...
            HrisCreateEmployeeEmploymentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisCreateEmployeeEmploymentRequest, com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeEmploymentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisCreateEmployeeEmploymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCreateEmployeeEmploymentRequest.class, new TypeReference<HrisCreateEmployeeEmploymentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisCreateEmployeeEmploymentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeEmploymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeEmploymentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeEmploymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeEmploymentResponse res = resBuilder.build();
