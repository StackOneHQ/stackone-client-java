...
public class AtsGetApplicationNoteOperation implements RequestOperation<AtsGetApplicationNoteRequest, AtsGetApplicationNoteResponse> {
    ...
    public AtsGetApplicationNoteOperation(
    ...
    public HttpRequest buildRequest(AtsGetApplicationNoteRequest request) throws Exception {
