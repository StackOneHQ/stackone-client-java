...
public class HrisUploadEmployeeDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisUploadEmployeeDocumentRequest, HrisUploadEmployeeDocumentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisUploadEmployeeDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisUploadEmployeeDocumentRequest.class, new TypeReference<HrisUploadEmployeeDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisUploadEmployeeDocumentRequest request) {
        ...
        @Override
        public HrisUploadEmployeeDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisUploadEmployeeDocumentResponse.Builder resBuilder =
            ...
            HrisUploadEmployeeDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisUploadEmployeeDocumentRequest, com.stackone.stackone_client_java.models.operations.async.HrisUploadEmployeeDocumentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisUploadEmployeeDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisUploadEmployeeDocumentRequest.class, new TypeReference<HrisUploadEmployeeDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisUploadEmployeeDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisUploadEmployeeDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisUploadEmployeeDocumentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisUploadEmployeeDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisUploadEmployeeDocumentResponse res = resBuilder.build();
