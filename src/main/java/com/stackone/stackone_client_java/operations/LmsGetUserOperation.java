...
public class LmsGetUserOperation implements RequestOperation<LmsGetUserRequest, LmsGetUserResponse> {
    ...
    public HttpRequest buildRequest(LmsGetUserRequest request) throws Exception {
