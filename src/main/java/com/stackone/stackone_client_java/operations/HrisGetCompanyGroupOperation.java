...
public class HrisGetCompanyGroupOperation implements RequestOperation<HrisGetCompanyGroupRequest, HrisGetCompanyGroupResponse> {
    ...
    public HrisGetCompanyGroupOperation(
    ...
    public HttpRequest buildRequest(HrisGetCompanyGroupRequest request) throws Exception {
