...
public class HrisListLocations {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListLocationsRequest, HrisListLocationsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListLocationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListLocationsRequest request) {
        ...
        @Override
        public HrisListLocationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListLocationsResponse.Builder resBuilder =
            ...
            HrisListLocationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISLocationsPaginated(Utils.unmarshal(response, new TypeReference<HRISLocationsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListLocationsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListLocationsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListLocationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListLocationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListLocationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListLocationsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListLocationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListLocationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISLocationsPaginated>() {})
                            .thenApply(res::withHRISLocationsPaginated);
                } else {
