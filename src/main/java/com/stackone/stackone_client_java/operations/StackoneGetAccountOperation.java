...
public class StackoneGetAccountOperation implements RequestOperation<StackoneGetAccountRequest, StackoneGetAccountResponse> {
    ...
    public StackoneGetAccountOperation(
    ...
    public HttpRequest buildRequest(StackoneGetAccountRequest request) throws Exception {
