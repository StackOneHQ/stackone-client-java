...
public class AtsListApplicationChangesOperation implements RequestOperation<AtsListApplicationChangesRequest, AtsListApplicationChangesResponse> {
    ...
    public AtsListApplicationChangesOperation(
    ...
    public HttpRequest buildRequest(AtsListApplicationChangesRequest request) throws Exception {
