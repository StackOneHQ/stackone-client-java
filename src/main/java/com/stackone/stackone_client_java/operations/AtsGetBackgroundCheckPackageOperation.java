...
public class AtsGetBackgroundCheckPackageOperation implements RequestOperation<AtsGetBackgroundCheckPackageRequest, AtsGetBackgroundCheckPackageResponse> {
    ...
    public AtsGetBackgroundCheckPackageOperation(
    ...
    public HttpRequest buildRequest(AtsGetBackgroundCheckPackageRequest request) throws Exception {
