...
public class AtsListOffers {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListOffersRequest, AtsListOffersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListOffersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListOffersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListOffersRequest request) {
        ...
        @Override
        public AtsListOffersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListOffersResponse.Builder resBuilder =
            ...
            AtsListOffersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListOffersRequest, com.stackone.stackone_client_java.models.operations.async.AtsListOffersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListOffersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListOffersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListOffersRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListOffersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListOffersResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListOffersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListOffersResponse res = resBuilder.build();
