...
public class LmsUpsertContentOperation implements RequestOperation<LmsUpsertContentRequest, LmsUpsertContentResponse> {
    ...
    public LmsUpsertContentOperation(
    ...
    public HttpRequest buildRequest(LmsUpsertContentRequest request) throws Exception {
