...
public class AtsCreateJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsCreateJobRequest, AtsCreateJobResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsCreateJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsCreateJobRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsCreateJobRequest request) {
        ...
        @Override
        public AtsCreateJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsCreateJobResponse.Builder resBuilder =
            ...
            AtsCreateJobResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsCreateJobRequest, com.stackone.stackone_client_java.models.operations.async.AtsCreateJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsCreateJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsCreateJobRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsCreateJobRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsCreateJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsCreateJobResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsCreateJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsCreateJobResponse res = resBuilder.build();
