...
public class StackoneListLinkedAccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneListLinkedAccountsRequest, StackoneListLinkedAccountsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneListLinkedAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneListLinkedAccountsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneListLinkedAccountsRequest request) {
        ...
        @Override
        public StackoneListLinkedAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneListLinkedAccountsResponse.Builder resBuilder =
            ...
            StackoneListLinkedAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLinkedAccounts(Utils.unmarshal(response, new TypeReference<List<LinkedAccount>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneListLinkedAccountsRequest, com.stackone.stackone_client_java.models.operations.async.StackoneListLinkedAccountsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StackoneListLinkedAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneListLinkedAccountsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StackoneListLinkedAccountsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneListLinkedAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneListLinkedAccountsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneListLinkedAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneListLinkedAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<LinkedAccount>>() {})
                            .thenApply(res::withLinkedAccounts);
                } else {
