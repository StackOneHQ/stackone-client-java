...
public class StackoneListLinkedAccounts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneListLinkedAccountsRequest request) throws Exception {
        ...
        @Override
        public StackoneListLinkedAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<LinkedAccount> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withLinkedAccounts(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
