...
public class AtsListApplicationChanges {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationChangesRequest request) throws Exception {
        ...
        @Override
        public AtsListApplicationChangesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ApplicationChangesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withApplicationChangesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
