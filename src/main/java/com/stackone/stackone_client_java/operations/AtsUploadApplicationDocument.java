...
public class AtsUploadApplicationDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsUploadApplicationDocumentRequest, AtsUploadApplicationDocumentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsUploadApplicationDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsUploadApplicationDocumentRequest.class, new TypeReference<AtsUploadApplicationDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsUploadApplicationDocumentRequest request) {
        ...
        @Override
        public AtsUploadApplicationDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsUploadApplicationDocumentResponse.Builder resBuilder =
            ...
            AtsUploadApplicationDocumentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWriteResultApiModel(Utils.unmarshal(response, new TypeReference<WriteResultApiModel>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsUploadApplicationDocumentRequest, com.stackone.stackone_client_java.models.operations.async.AtsUploadApplicationDocumentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsUploadApplicationDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsUploadApplicationDocumentRequest.class, new TypeReference<AtsUploadApplicationDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsUploadApplicationDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsUploadApplicationDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsUploadApplicationDocumentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsUploadApplicationDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsUploadApplicationDocumentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<WriteResultApiModel>() {})
                            .thenApply(res::withWriteResultApiModel);
                } else {
