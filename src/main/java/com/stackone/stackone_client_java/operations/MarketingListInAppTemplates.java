...
public class MarketingListInAppTemplates {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListInAppTemplatesRequest request) throws Exception {
        ...
        @Override
        public MarketingListInAppTemplatesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    InAppTemplatesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withInAppTemplatesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
