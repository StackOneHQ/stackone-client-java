...
public class MarketingListInAppTemplates {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingListInAppTemplatesRequest, MarketingListInAppTemplatesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingListInAppTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListInAppTemplatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListInAppTemplatesRequest request) {
        ...
        @Override
        public MarketingListInAppTemplatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingListInAppTemplatesResponse.Builder resBuilder =
            ...
            MarketingListInAppTemplatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInAppTemplatesPaginated(Utils.unmarshal(response, new TypeReference<InAppTemplatesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingListInAppTemplatesRequest, com.stackone.stackone_client_java.models.operations.async.MarketingListInAppTemplatesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingListInAppTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListInAppTemplatesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingListInAppTemplatesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingListInAppTemplatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingListInAppTemplatesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingListInAppTemplatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingListInAppTemplatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InAppTemplatesPaginated>() {})
                            .thenApply(res::withInAppTemplatesPaginated);
                } else {
