...
public class HrisListDivisionGroupsOperation implements RequestOperation<HrisListDivisionGroupsRequest, HrisListDivisionGroupsResponse> {
    ...
    public HrisListDivisionGroupsOperation(
    ...
    public HttpRequest buildRequest(HrisListDivisionGroupsRequest request) throws Exception {
