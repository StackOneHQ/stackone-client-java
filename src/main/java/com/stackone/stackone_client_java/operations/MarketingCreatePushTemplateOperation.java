...
public class MarketingCreatePushTemplateOperation implements RequestOperation<MarketingCreatePushTemplateRequest, MarketingCreatePushTemplateResponse> {
    ...
    public MarketingCreatePushTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingCreatePushTemplateRequest request) throws Exception {
