...
public class AtsListRejectedReasons {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListRejectedReasonsRequest, AtsListRejectedReasonsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListRejectedReasonsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListRejectedReasonsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListRejectedReasonsRequest request) {
        ...
        @Override
        public AtsListRejectedReasonsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListRejectedReasonsResponse.Builder resBuilder =
            ...
            AtsListRejectedReasonsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRejectedReasonsPaginated(Utils.unmarshal(response, new TypeReference<RejectedReasonsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListRejectedReasonsRequest, com.stackone.stackone_client_java.models.operations.async.AtsListRejectedReasonsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListRejectedReasonsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListRejectedReasonsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListRejectedReasonsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListRejectedReasonsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListRejectedReasonsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListRejectedReasonsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListRejectedReasonsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RejectedReasonsPaginated>() {})
                            .thenApply(res::withRejectedReasonsPaginated);
                } else {
