...
public class AtsListRejectedReasons {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListRejectedReasonsRequest request) throws Exception {
        ...
        @Override
        public AtsListRejectedReasonsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    RejectedReasonsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRejectedReasonsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
