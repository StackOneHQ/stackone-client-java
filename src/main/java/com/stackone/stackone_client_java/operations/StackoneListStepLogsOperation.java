...
public class StackoneListStepLogsOperation implements RequestOperation<StackoneListStepLogsRequest, StackoneListStepLogsResponse> {
    ...
    public StackoneListStepLogsOperation(
    ...
    public HttpRequest buildRequest(StackoneListStepLogsRequest request) throws Exception {
