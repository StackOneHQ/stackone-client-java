...
public class HrisGetGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetGroupRequest, HrisGetGroupResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetGroupRequest request) {
        ...
        @Override
        public HrisGetGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetGroupResponse.Builder resBuilder =
            ...
            HrisGetGroupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISGroupsResult(Utils.unmarshal(response, new TypeReference<HRISGroupsResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetGroupRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetGroupResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetGroupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISGroupsResult>() {})
                            .thenApply(res::withHRISGroupsResult);
                } else {
