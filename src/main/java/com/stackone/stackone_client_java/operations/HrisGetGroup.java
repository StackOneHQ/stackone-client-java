...
public class HrisGetGroup {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetGroupRequest request) throws Exception {
        ...
        @Override
        public HrisGetGroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HRISGroupsResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHRISGroupsResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
