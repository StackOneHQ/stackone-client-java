...
public class HrisCreateEmployeeWorkEligibilityRequestOperation implements RequestOperation<HrisCreateEmployeeWorkEligibilityRequestRequest, HrisCreateEmployeeWorkEligibilityRequestResponse> {
    ...
    public HrisCreateEmployeeWorkEligibilityRequestOperation(
    ...
    public HttpRequest buildRequest(HrisCreateEmployeeWorkEligibilityRequestRequest request) throws Exception {
