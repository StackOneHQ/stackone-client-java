...
public class HrisGetDivisionGroupOperation implements RequestOperation<HrisGetDivisionGroupRequest, HrisGetDivisionGroupResponse> {
    ...
    public HrisGetDivisionGroupOperation(
    ...
    public HttpRequest buildRequest(HrisGetDivisionGroupRequest request) throws Exception {
