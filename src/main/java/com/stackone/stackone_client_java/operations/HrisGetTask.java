...
public class HrisGetTask {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetTaskRequest, HrisGetTaskResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetTaskRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetTaskRequest request) {
        ...
        @Override
        public HrisGetTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetTaskResponse.Builder resBuilder =
                    HrisGetTaskResponse
                            .builder()
            ...
            HrisGetTaskResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetTaskRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetTaskResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetTaskRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetTaskRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetTaskResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetTaskResponse res = resBuilder.build();
