...
public class DocumentsGetFile {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsGetFileRequest request) throws Exception {
        ...
        @Override
        public DocumentsGetFileResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    FileResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withFileResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
