...
public class DocumentsGetFile {
    ...
    public static class Sync extends Base
            implements RequestOperation<DocumentsGetFileRequest, DocumentsGetFileResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DocumentsGetFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsGetFileRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsGetFileRequest request) {
        ...
        @Override
        public DocumentsGetFileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DocumentsGetFileResponse.Builder resBuilder =
            ...
            DocumentsGetFileResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFileResult(Utils.unmarshal(response, new TypeReference<FileResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DocumentsGetFileRequest, com.stackone.stackone_client_java.models.operations.async.DocumentsGetFileResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DocumentsGetFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsGetFileRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DocumentsGetFileRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.DocumentsGetFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.DocumentsGetFileResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.DocumentsGetFileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.DocumentsGetFileResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FileResult>() {})
                            .thenApply(res::withFileResult);
                } else {
