...
public class StackoneGetAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneGetAccountRequest, StackoneGetAccountResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneGetAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneGetAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneGetAccountRequest request) {
        ...
        @Override
        public StackoneGetAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneGetAccountResponse.Builder resBuilder =
            ...
            StackoneGetAccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneGetAccountRequest, com.stackone.stackone_client_java.models.operations.async.StackoneGetAccountResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StackoneGetAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneGetAccountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StackoneGetAccountRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneGetAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneGetAccountResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneGetAccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneGetAccountResponse res = resBuilder.build();
