...
public class HrisListEmployeeCategories {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListEmployeeCategoriesRequest, HrisListEmployeeCategoriesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListEmployeeCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmployeeCategoriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeCategoriesRequest request) {
        ...
        @Override
        public HrisListEmployeeCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListEmployeeCategoriesResponse.Builder resBuilder =
            ...
            HrisListEmployeeCategoriesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListEmployeeCategoriesRequest, com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeCategoriesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListEmployeeCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmployeeCategoriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListEmployeeCategoriesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeCategoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeCategoriesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeCategoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeCategoriesResponse res = resBuilder.build();
