...
public class HrisListCompaniesGroups {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListCompaniesGroupsRequest request) throws Exception {
        ...
        @Override
        public HrisListCompaniesGroupsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompaniesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompaniesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
