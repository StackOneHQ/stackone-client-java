...
public class HrisListCompaniesGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListCompaniesGroupsRequest, HrisListCompaniesGroupsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListCompaniesGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListCompaniesGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListCompaniesGroupsRequest request) {
        ...
        @Override
        public HrisListCompaniesGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListCompaniesGroupsResponse.Builder resBuilder =
            ...
            HrisListCompaniesGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCompaniesPaginated(Utils.unmarshal(response, new TypeReference<CompaniesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListCompaniesGroupsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListCompaniesGroupsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListCompaniesGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListCompaniesGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListCompaniesGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListCompaniesGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListCompaniesGroupsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListCompaniesGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListCompaniesGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CompaniesPaginated>() {})
                            .thenApply(res::withCompaniesPaginated);
                } else {
