...
public class LmsListUserCompletionsOperation implements RequestOperation<LmsListUserCompletionsRequest, LmsListUserCompletionsResponse> {
    ...
    public LmsListUserCompletionsOperation(
    ...
    public HttpRequest buildRequest(LmsListUserCompletionsRequest request) throws Exception {
