...
public class DocumentsListFiles {
    ...
    public static class Sync extends Base
            implements RequestOperation<DocumentsListFilesRequest, DocumentsListFilesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DocumentsListFilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsListFilesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsListFilesRequest request) {
        ...
        @Override
        public DocumentsListFilesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DocumentsListFilesResponse.Builder resBuilder =
            ...
            DocumentsListFilesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFilesPaginated(Utils.unmarshal(response, new TypeReference<FilesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DocumentsListFilesRequest, com.stackone.stackone_client_java.models.operations.async.DocumentsListFilesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DocumentsListFilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsListFilesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DocumentsListFilesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.DocumentsListFilesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.DocumentsListFilesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.DocumentsListFilesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.DocumentsListFilesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FilesPaginated>() {})
                            .thenApply(res::withFilesPaginated);
                } else {
