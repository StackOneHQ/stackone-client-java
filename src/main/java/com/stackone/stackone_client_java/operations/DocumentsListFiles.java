...
public class DocumentsListFiles {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsListFilesRequest request) throws Exception {
        ...
        @Override
        public DocumentsListFilesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    FilesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withFilesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
