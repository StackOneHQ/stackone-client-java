...
public class LmsListContent {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsListContentRequest, LmsListContentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsListContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListContentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListContentRequest request) {
        ...
        @Override
        public LmsListContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsListContentResponse.Builder resBuilder =
            ...
            LmsListContentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContentPaginated(Utils.unmarshal(response, new TypeReference<ContentPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsListContentRequest, com.stackone.stackone_client_java.models.operations.async.LmsListContentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsListContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListContentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsListContentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsListContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsListContentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsListContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsListContentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContentPaginated>() {})
                            .thenApply(res::withContentPaginated);
                } else {
