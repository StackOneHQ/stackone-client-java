...
public class AtsListCandidateCustomFieldDefinitions {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListCandidateCustomFieldDefinitionsRequest, AtsListCandidateCustomFieldDefinitionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListCandidateCustomFieldDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListCandidateCustomFieldDefinitionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListCandidateCustomFieldDefinitionsRequest request) {
        ...
        @Override
        public AtsListCandidateCustomFieldDefinitionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListCandidateCustomFieldDefinitionsResponse.Builder resBuilder =
            ...
            AtsListCandidateCustomFieldDefinitionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListCandidateCustomFieldDefinitionsRequest, com.stackone.stackone_client_java.models.operations.async.AtsListCandidateCustomFieldDefinitionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListCandidateCustomFieldDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListCandidateCustomFieldDefinitionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListCandidateCustomFieldDefinitionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListCandidateCustomFieldDefinitionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListCandidateCustomFieldDefinitionsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListCandidateCustomFieldDefinitionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListCandidateCustomFieldDefinitionsResponse res = resBuilder.build();
