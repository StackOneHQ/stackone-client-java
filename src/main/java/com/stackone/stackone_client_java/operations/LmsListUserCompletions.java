...
public class LmsListUserCompletions {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListUserCompletionsRequest request) throws Exception {
        ...
        @Override
        public LmsListUserCompletionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompletionsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompletionsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
