...
public class LmsListUserCompletions {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsListUserCompletionsRequest, LmsListUserCompletionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsListUserCompletionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListUserCompletionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListUserCompletionsRequest request) {
        ...
        @Override
        public LmsListUserCompletionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsListUserCompletionsResponse.Builder resBuilder =
            ...
            LmsListUserCompletionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCompletionsPaginated(Utils.unmarshal(response, new TypeReference<CompletionsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsListUserCompletionsRequest, com.stackone.stackone_client_java.models.operations.async.LmsListUserCompletionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsListUserCompletionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListUserCompletionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsListUserCompletionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsListUserCompletionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsListUserCompletionsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsListUserCompletionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsListUserCompletionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CompletionsPaginated>() {})
                            .thenApply(res::withCompletionsPaginated);
                } else {
