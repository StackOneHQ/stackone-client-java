...
public class HrisListEmployeeSkills {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListEmployeeSkillsRequest, HrisListEmployeeSkillsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListEmployeeSkillsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmployeeSkillsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeSkillsRequest request) {
        ...
        @Override
        public HrisListEmployeeSkillsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListEmployeeSkillsResponse.Builder resBuilder =
            ...
            HrisListEmployeeSkillsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEntitySkillsPaginated(Utils.unmarshal(response, new TypeReference<EntitySkillsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListEmployeeSkillsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeSkillsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListEmployeeSkillsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmployeeSkillsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListEmployeeSkillsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeSkillsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeSkillsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeSkillsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeSkillsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EntitySkillsPaginated>() {})
                            .thenApply(res::withEntitySkillsPaginated);
                } else {
