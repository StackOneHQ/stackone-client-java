...
public class HrisListEmployeeSkills {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeSkillsRequest request) throws Exception {
        ...
        @Override
        public HrisListEmployeeSkillsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EntitySkillsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEntitySkillsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
