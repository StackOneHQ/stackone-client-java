...
public class HrisGetDivisionGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetDivisionGroupRequest, HrisGetDivisionGroupResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetDivisionGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetDivisionGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetDivisionGroupRequest request) {
        ...
        @Override
        public HrisGetDivisionGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetDivisionGroupResponse.Builder resBuilder =
            ...
            HrisGetDivisionGroupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISDivisionsResult(Utils.unmarshal(response, new TypeReference<HRISDivisionsResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetDivisionGroupRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetDivisionGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetDivisionGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetDivisionGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetDivisionGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetDivisionGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetDivisionGroupResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetDivisionGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetDivisionGroupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISDivisionsResult>() {})
                            .thenApply(res::withHRISDivisionsResult);
                } else {
