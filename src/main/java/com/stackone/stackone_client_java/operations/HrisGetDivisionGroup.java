...
public class HrisGetDivisionGroup {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetDivisionGroupRequest request) throws Exception {
        ...
        @Override
        public HrisGetDivisionGroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HRISDivisionsResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHRISDivisionsResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
