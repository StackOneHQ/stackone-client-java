...
public class TicketingListTicketTypes {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingListTicketTypesRequest, TicketingListTicketTypesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingListTicketTypesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListTicketTypesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListTicketTypesRequest request) {
        ...
        @Override
        public TicketingListTicketTypesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingListTicketTypesResponse.Builder resBuilder =
            ...
            TicketingListTicketTypesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingListTicketTypesRequest, com.stackone.stackone_client_java.models.operations.async.TicketingListTicketTypesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingListTicketTypesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListTicketTypesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingListTicketTypesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingListTicketTypesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingListTicketTypesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingListTicketTypesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingListTicketTypesResponse res = resBuilder.build();
