...
public class LmsGetUserCompletionOperation implements RequestOperation<LmsGetUserCompletionRequest, LmsGetUserCompletionResponse> {
    ...
    public LmsGetUserCompletionOperation(
    ...
    public HttpRequest buildRequest(LmsGetUserCompletionRequest request) throws Exception {
