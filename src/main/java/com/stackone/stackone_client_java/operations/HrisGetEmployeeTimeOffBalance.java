...
public class HrisGetEmployeeTimeOffBalance {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeeTimeOffBalanceRequest request) throws Exception {
        ...
        @Override
        public HrisGetEmployeeTimeOffBalanceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TimeOffBalanceResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTimeOffBalanceResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
