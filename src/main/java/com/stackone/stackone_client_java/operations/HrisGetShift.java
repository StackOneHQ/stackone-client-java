...
public class HrisGetShift {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetShiftRequest, HrisGetShiftResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetShiftRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetShiftRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetShiftRequest request) {
        ...
        @Override
        public HrisGetShiftResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetShiftResponse.Builder resBuilder =
            ...
            HrisGetShiftResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetShiftRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetShiftResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetShiftRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetShiftRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetShiftRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetShiftResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetShiftResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetShiftResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetShiftResponse res = resBuilder.build();
