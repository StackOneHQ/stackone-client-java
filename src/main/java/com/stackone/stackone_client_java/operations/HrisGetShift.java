...
public class HrisGetShift {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetShiftRequest request) throws Exception {
        ...
        @Override
        public HrisGetShiftResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
