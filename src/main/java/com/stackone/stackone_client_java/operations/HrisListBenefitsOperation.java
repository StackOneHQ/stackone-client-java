...
public class HrisListBenefitsOperation implements RequestOperation<HrisListBenefitsRequest, HrisListBenefitsResponse> {
    ...
    public HrisListBenefitsOperation(
    ...
    public HttpRequest buildRequest(HrisListBenefitsRequest request) throws Exception {
