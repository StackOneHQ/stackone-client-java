...
public class HrisListEmployeeTasks {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeTasksRequest request) throws Exception {
        ...
        @Override
        public HrisListEmployeeTasksResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TasksPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTasksPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
