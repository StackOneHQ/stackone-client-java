...
public class AtsListJobCustomFieldDefinitionsOperation implements RequestOperation<AtsListJobCustomFieldDefinitionsRequest, AtsListJobCustomFieldDefinitionsResponse> {
    ...
    public AtsListJobCustomFieldDefinitionsOperation(
    ...
    public HttpRequest buildRequest(AtsListJobCustomFieldDefinitionsRequest request) throws Exception {
