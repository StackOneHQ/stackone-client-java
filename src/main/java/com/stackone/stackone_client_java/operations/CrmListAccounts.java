...
public class CrmListAccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmListAccountsRequest, CrmListAccountsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmListAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListAccountsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmListAccountsRequest request) {
        ...
        @Override
        public CrmListAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmListAccountsResponse.Builder resBuilder =
            ...
            CrmListAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountsPaginated(Utils.unmarshal(response, new TypeReference<AccountsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmListAccountsRequest, com.stackone.stackone_client_java.models.operations.async.CrmListAccountsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmListAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListAccountsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmListAccountsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.CrmListAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.CrmListAccountsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.CrmListAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.CrmListAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountsPaginated>() {})
                            .thenApply(res::withAccountsPaginated);
                } else {
