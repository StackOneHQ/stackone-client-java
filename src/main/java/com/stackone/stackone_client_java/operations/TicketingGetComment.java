...
public class TicketingGetComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingGetCommentRequest, TicketingGetCommentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingGetCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetCommentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingGetCommentRequest request) {
        ...
        @Override
        public TicketingGetCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingGetCommentResponse.Builder resBuilder =
            ...
            TicketingGetCommentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingCommentResult(Utils.unmarshal(response, new TypeReference<TicketingCommentResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingGetCommentRequest, com.stackone.stackone_client_java.models.operations.async.TicketingGetCommentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingGetCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetCommentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingGetCommentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingGetCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingGetCommentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingGetCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingGetCommentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingCommentResult>() {})
                            .thenApply(res::withTicketingCommentResult);
                } else {
