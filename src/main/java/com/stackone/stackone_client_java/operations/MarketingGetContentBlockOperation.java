...
public class MarketingGetContentBlockOperation implements RequestOperation<MarketingGetContentBlockRequest, MarketingGetContentBlockResponse> {
    ...
    public MarketingGetContentBlockOperation(
    ...
    public HttpRequest buildRequest(MarketingGetContentBlockRequest request) throws Exception {
