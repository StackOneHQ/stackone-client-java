...
public class AtsListApplicationDocumentCategories {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationDocumentCategoriesRequest request) throws Exception {
        ...
        @Override
        public AtsListApplicationDocumentCategoriesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ReferencePaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withReferencePaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
