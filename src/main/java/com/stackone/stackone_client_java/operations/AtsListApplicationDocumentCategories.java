...
public class AtsListApplicationDocumentCategories {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListApplicationDocumentCategoriesRequest, AtsListApplicationDocumentCategoriesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListApplicationDocumentCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListApplicationDocumentCategoriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationDocumentCategoriesRequest request) {
        ...
        @Override
        public AtsListApplicationDocumentCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListApplicationDocumentCategoriesResponse.Builder resBuilder =
            ...
            AtsListApplicationDocumentCategoriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withReferencePaginated(Utils.unmarshal(response, new TypeReference<ReferencePaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListApplicationDocumentCategoriesRequest, com.stackone.stackone_client_java.models.operations.async.AtsListApplicationDocumentCategoriesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListApplicationDocumentCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListApplicationDocumentCategoriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListApplicationDocumentCategoriesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListApplicationDocumentCategoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListApplicationDocumentCategoriesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListApplicationDocumentCategoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListApplicationDocumentCategoriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ReferencePaginated>() {})
                            .thenApply(res::withReferencePaginated);
                } else {
