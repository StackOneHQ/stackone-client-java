...
public class MarketingListContentBlocks {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingListContentBlocksRequest, MarketingListContentBlocksResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingListContentBlocksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListContentBlocksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListContentBlocksRequest request) {
        ...
        @Override
        public MarketingListContentBlocksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingListContentBlocksResponse.Builder resBuilder =
            ...
            MarketingListContentBlocksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContentBlocksPaginated(Utils.unmarshal(response, new TypeReference<ContentBlocksPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingListContentBlocksRequest, com.stackone.stackone_client_java.models.operations.async.MarketingListContentBlocksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingListContentBlocksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListContentBlocksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingListContentBlocksRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingListContentBlocksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingListContentBlocksResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingListContentBlocksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingListContentBlocksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContentBlocksPaginated>() {})
                            .thenApply(res::withContentBlocksPaginated);
                } else {
