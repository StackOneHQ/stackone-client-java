...
public class MarketingListContentBlocks {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListContentBlocksRequest request) throws Exception {
        ...
        @Override
        public MarketingListContentBlocksResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ContentBlocksPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withContentBlocksPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
