...
public class HrisListEmployeeCustomFieldDefinitionsOperation implements RequestOperation<HrisListEmployeeCustomFieldDefinitionsRequest, HrisListEmployeeCustomFieldDefinitionsResponse> {
    ...
    public HrisListEmployeeCustomFieldDefinitionsOperation(
    ...
    public HttpRequest buildRequest(HrisListEmployeeCustomFieldDefinitionsRequest request) throws Exception {
