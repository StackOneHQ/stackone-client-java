...
public class HrisListEmployeeTimeOffRequests {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeTimeOffRequestsRequest request) throws Exception {
        ...
        @Override
        public HrisListEmployeeTimeOffRequestsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TimeOffPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTimeOffPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
