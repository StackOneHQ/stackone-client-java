...
public class HrisGetLocationOperation implements RequestOperation<HrisGetLocationRequest, HrisGetLocationResponse> {
    ...
    public HrisGetLocationOperation(
    ...
    public HttpRequest buildRequest(HrisGetLocationRequest request) throws Exception {
