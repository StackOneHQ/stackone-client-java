...
public class IamListRolesOperation implements RequestOperation<IamListRolesRequest, IamListRolesResponse> {
    ...
    public HttpRequest buildRequest(IamListRolesRequest request) throws Exception {
