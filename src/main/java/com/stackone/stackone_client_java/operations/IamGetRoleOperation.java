...
public class IamGetRoleOperation implements RequestOperation<IamGetRoleRequest, IamGetRoleResponse> {
    ...
    public HttpRequest buildRequest(IamGetRoleRequest request) throws Exception {
