...
public class DocumentsGetDrive {
    ...
    public static class Sync extends Base
            implements RequestOperation<DocumentsGetDriveRequest, DocumentsGetDriveResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DocumentsGetDriveRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsGetDriveRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsGetDriveRequest request) {
        ...
        @Override
        public DocumentsGetDriveResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DocumentsGetDriveResponse.Builder resBuilder =
            ...
            DocumentsGetDriveResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDriveResult(Utils.unmarshal(response, new TypeReference<DriveResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DocumentsGetDriveRequest, com.stackone.stackone_client_java.models.operations.async.DocumentsGetDriveResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DocumentsGetDriveRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsGetDriveRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DocumentsGetDriveRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.DocumentsGetDriveResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.DocumentsGetDriveResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.DocumentsGetDriveResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.DocumentsGetDriveResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DriveResult>() {})
                            .thenApply(res::withDriveResult);
                } else {
