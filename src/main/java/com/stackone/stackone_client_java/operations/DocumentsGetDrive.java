...
public class DocumentsGetDrive {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsGetDriveRequest request) throws Exception {
        ...
        @Override
        public DocumentsGetDriveResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DriveResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDriveResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
