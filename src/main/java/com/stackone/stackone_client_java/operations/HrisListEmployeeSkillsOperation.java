...
public class HrisListEmployeeSkillsOperation implements RequestOperation<HrisListEmployeeSkillsRequest, HrisListEmployeeSkillsResponse> {
    ...
    public HrisListEmployeeSkillsOperation(
    ...
    public HttpRequest buildRequest(HrisListEmployeeSkillsRequest request) throws Exception {
