...
public class IamGetGroupOperation implements RequestOperation<IamGetGroupRequest, IamGetGroupResponse> {
    ...
    public HttpRequest buildRequest(IamGetGroupRequest request) throws Exception {
