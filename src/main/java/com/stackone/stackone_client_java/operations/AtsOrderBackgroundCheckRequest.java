...
public class AtsOrderBackgroundCheckRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsOrderBackgroundCheckRequestRequest request) throws Exception {
        ...
        @Override
        public AtsOrderBackgroundCheckRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateBackgroundCheckOrderResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateBackgroundCheckOrderResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
