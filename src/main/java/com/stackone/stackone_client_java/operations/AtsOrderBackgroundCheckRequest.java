...
public class AtsOrderBackgroundCheckRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsOrderBackgroundCheckRequestRequest, AtsOrderBackgroundCheckRequestResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsOrderBackgroundCheckRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsOrderBackgroundCheckRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsOrderBackgroundCheckRequestRequest request) {
        ...
        @Override
        public AtsOrderBackgroundCheckRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsOrderBackgroundCheckRequestResponse.Builder resBuilder =
            ...
            AtsOrderBackgroundCheckRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateBackgroundCheckOrderResult(Utils.unmarshal(response, new TypeReference<CreateBackgroundCheckOrderResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsOrderBackgroundCheckRequestRequest, com.stackone.stackone_client_java.models.operations.async.AtsOrderBackgroundCheckRequestResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsOrderBackgroundCheckRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsOrderBackgroundCheckRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsOrderBackgroundCheckRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsOrderBackgroundCheckRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsOrderBackgroundCheckRequestResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsOrderBackgroundCheckRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsOrderBackgroundCheckRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateBackgroundCheckOrderResult>() {})
                            .thenApply(res::withCreateBackgroundCheckOrderResult);
                } else {
