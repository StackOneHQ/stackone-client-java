...
public class AtsListDepartments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListDepartmentsRequest request) throws Exception {
        ...
        @Override
        public AtsListDepartmentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DepartmentsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDepartmentsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
