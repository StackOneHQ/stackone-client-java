...
public class AtsListDepartments {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListDepartmentsRequest, AtsListDepartmentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListDepartmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListDepartmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListDepartmentsRequest request) {
        ...
        @Override
        public AtsListDepartmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListDepartmentsResponse.Builder resBuilder =
            ...
            AtsListDepartmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDepartmentsPaginated(Utils.unmarshal(response, new TypeReference<DepartmentsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListDepartmentsRequest, com.stackone.stackone_client_java.models.operations.async.AtsListDepartmentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListDepartmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListDepartmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListDepartmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListDepartmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListDepartmentsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListDepartmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListDepartmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DepartmentsPaginated>() {})
                            .thenApply(res::withDepartmentsPaginated);
                } else {
