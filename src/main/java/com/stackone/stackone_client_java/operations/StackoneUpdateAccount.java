...
public class StackoneUpdateAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneUpdateAccountRequest, StackoneUpdateAccountResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneUpdateAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneUpdateAccountRequest.class, new TypeReference<StackoneUpdateAccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneUpdateAccountRequest request) {
        ...
        @Override
        public StackoneUpdateAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneUpdateAccountResponse.Builder resBuilder =
            ...
            StackoneUpdateAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLinkedAccount(Utils.unmarshal(response, new TypeReference<LinkedAccount>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneUpdateAccountRequest, com.stackone.stackone_client_java.models.operations.async.StackoneUpdateAccountResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StackoneUpdateAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneUpdateAccountRequest.class, new TypeReference<StackoneUpdateAccountRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StackoneUpdateAccountRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneUpdateAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneUpdateAccountResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneUpdateAccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneUpdateAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LinkedAccount>() {})
                            .thenApply(res::withLinkedAccount);
                } else {
