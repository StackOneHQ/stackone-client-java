...
public class StackoneUpdateAccount {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneUpdateAccountRequest request) throws Exception {
        ...
        @Override
        public StackoneUpdateAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    LinkedAccount out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withLinkedAccount(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
