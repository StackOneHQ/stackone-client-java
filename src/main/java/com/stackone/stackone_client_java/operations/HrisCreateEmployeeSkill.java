...
public class HrisCreateEmployeeSkill {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisCreateEmployeeSkillRequest, HrisCreateEmployeeSkillResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisCreateEmployeeSkillRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCreateEmployeeSkillRequest.class, new TypeReference<HrisCreateEmployeeSkillRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisCreateEmployeeSkillRequest request) {
        ...
        @Override
        public HrisCreateEmployeeSkillResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisCreateEmployeeSkillResponse.Builder resBuilder =
            ...
            HrisCreateEmployeeSkillResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisCreateEmployeeSkillRequest, com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeSkillResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisCreateEmployeeSkillRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCreateEmployeeSkillRequest.class, new TypeReference<HrisCreateEmployeeSkillRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisCreateEmployeeSkillRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeSkillResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeSkillResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeSkillResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeSkillResponse res = resBuilder.build();
