...
public class HrisGetEmployeeOperation implements RequestOperation<HrisGetEmployeeRequest, HrisGetEmployeeResponse> {
    ...
    public HrisGetEmployeeOperation(
    ...
    public HttpRequest buildRequest(HrisGetEmployeeRequest request) throws Exception {
