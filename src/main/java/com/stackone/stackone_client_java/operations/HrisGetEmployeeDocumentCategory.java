...
public class HrisGetEmployeeDocumentCategory {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetEmployeeDocumentCategoryRequest, HrisGetEmployeeDocumentCategoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetEmployeeDocumentCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetEmployeeDocumentCategoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeeDocumentCategoryRequest request) {
        ...
        @Override
        public HrisGetEmployeeDocumentCategoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetEmployeeDocumentCategoryResponse.Builder resBuilder =
            ...
            HrisGetEmployeeDocumentCategoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetEmployeeDocumentCategoryRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeDocumentCategoryResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetEmployeeDocumentCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetEmployeeDocumentCategoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetEmployeeDocumentCategoryRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeDocumentCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeDocumentCategoryResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeDocumentCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeDocumentCategoryResponse res = resBuilder.build();
