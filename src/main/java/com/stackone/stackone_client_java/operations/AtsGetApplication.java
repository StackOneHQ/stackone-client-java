...
public class AtsGetApplication {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetApplicationRequest, AtsGetApplicationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetApplicationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationRequest request) {
        ...
        @Override
        public AtsGetApplicationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetApplicationResponse.Builder resBuilder =
            ...
            AtsGetApplicationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withApplicationResult(Utils.unmarshal(response, new TypeReference<ApplicationResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetApplicationRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetApplicationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetApplicationRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ApplicationResult>() {})
                            .thenApply(res::withApplicationResult);
                } else {
