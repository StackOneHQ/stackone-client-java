...
public class MarketingListEmailTemplates {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListEmailTemplatesRequest request) throws Exception {
        ...
        @Override
        public MarketingListEmailTemplatesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EmailTemplatesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmailTemplatesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
