...
public class MarketingListEmailTemplates {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingListEmailTemplatesRequest, MarketingListEmailTemplatesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingListEmailTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListEmailTemplatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListEmailTemplatesRequest request) {
        ...
        @Override
        public MarketingListEmailTemplatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingListEmailTemplatesResponse.Builder resBuilder =
            ...
            MarketingListEmailTemplatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEmailTemplatesPaginated(Utils.unmarshal(response, new TypeReference<EmailTemplatesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingListEmailTemplatesRequest, com.stackone.stackone_client_java.models.operations.async.MarketingListEmailTemplatesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingListEmailTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListEmailTemplatesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingListEmailTemplatesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingListEmailTemplatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingListEmailTemplatesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingListEmailTemplatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingListEmailTemplatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EmailTemplatesPaginated>() {})
                            .thenApply(res::withEmailTemplatesPaginated);
                } else {
