...
public class AtsGetList {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetListRequest, AtsGetListResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetListRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetListRequest request) {
        ...
        @Override
        public AtsGetListResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetListResponse.Builder resBuilder =
                    AtsGetListResponse
                            .builder()
            ...
            AtsGetListResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetListRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetListResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetListRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetListRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetListResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetListResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetListResponse res = resBuilder.build();
