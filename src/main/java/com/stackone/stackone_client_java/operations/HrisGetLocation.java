...
public class HrisGetLocation {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetLocationRequest, HrisGetLocationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetLocationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetLocationRequest request) {
        ...
        @Override
        public HrisGetLocationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetLocationResponse.Builder resBuilder =
            ...
            HrisGetLocationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISLocationResult(Utils.unmarshal(response, new TypeReference<HRISLocationResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetLocationRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetLocationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetLocationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetLocationRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetLocationResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetLocationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetLocationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISLocationResult>() {})
                            .thenApply(res::withHRISLocationResult);
                } else {
