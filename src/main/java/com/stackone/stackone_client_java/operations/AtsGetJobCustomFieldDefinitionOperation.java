...
public class AtsGetJobCustomFieldDefinitionOperation implements RequestOperation<AtsGetJobCustomFieldDefinitionRequest, AtsGetJobCustomFieldDefinitionResponse> {
    ...
    public AtsGetJobCustomFieldDefinitionOperation(
    ...
    public HttpRequest buildRequest(AtsGetJobCustomFieldDefinitionRequest request) throws Exception {
