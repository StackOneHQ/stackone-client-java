...
public class HrisListEmployeeDocuments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeDocumentsRequest request) throws Exception {
        ...
        @Override
        public HrisListEmployeeDocumentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HrisDocumentsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisDocumentsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
