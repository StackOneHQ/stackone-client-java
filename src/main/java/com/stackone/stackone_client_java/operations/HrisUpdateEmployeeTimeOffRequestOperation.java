...
public class HrisUpdateEmployeeTimeOffRequestOperation implements RequestOperation<HrisUpdateEmployeeTimeOffRequestRequest, HrisUpdateEmployeeTimeOffRequestResponse> {
    ...
    public HrisUpdateEmployeeTimeOffRequestOperation(
    ...
    public HttpRequest buildRequest(HrisUpdateEmployeeTimeOffRequestRequest request) throws Exception {
