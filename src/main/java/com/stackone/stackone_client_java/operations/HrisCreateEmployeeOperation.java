...
public class HrisCreateEmployeeOperation implements RequestOperation<HrisCreateEmployeeRequest, HrisCreateEmployeeResponse> {
    ...
    public HrisCreateEmployeeOperation(
    ...
    public HttpRequest buildRequest(HrisCreateEmployeeRequest request) throws Exception {
