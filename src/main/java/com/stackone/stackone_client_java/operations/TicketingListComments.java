...
public class TicketingListComments {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingListCommentsRequest, TicketingListCommentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingListCommentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListCommentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListCommentsRequest request) {
        ...
        @Override
        public TicketingListCommentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingListCommentsResponse.Builder resBuilder =
            ...
            TicketingListCommentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingCommentsPaginated(Utils.unmarshal(response, new TypeReference<TicketingCommentsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingListCommentsRequest, com.stackone.stackone_client_java.models.operations.async.TicketingListCommentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingListCommentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListCommentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingListCommentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingListCommentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingListCommentsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingListCommentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingListCommentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingCommentsPaginated>() {})
                            .thenApply(res::withTicketingCommentsPaginated);
                } else {
