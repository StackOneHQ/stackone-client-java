...
public class MarketingListOmniChannelTemplatesOperation implements RequestOperation<MarketingListOmniChannelTemplatesRequest, MarketingListOmniChannelTemplatesResponse> {
    ...
    public MarketingListOmniChannelTemplatesOperation(
    ...
    public HttpRequest buildRequest(MarketingListOmniChannelTemplatesRequest request) throws Exception {
