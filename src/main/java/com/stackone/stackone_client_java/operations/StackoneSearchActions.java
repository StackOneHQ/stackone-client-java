...
public class StackoneSearchActions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ActionSearchDto, StackoneSearchActionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ActionSearchDto request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ActionSearchDto>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ActionSearchDto request) {
        ...
        @Override
        public StackoneSearchActionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneSearchActionsResponse.Builder resBuilder =
            ...
            StackoneSearchActionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withActionSearchResponseDto(Utils.unmarshal(response, new TypeReference<ActionSearchResponseDto>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ActionSearchDto, com.stackone.stackone_client_java.models.operations.async.StackoneSearchActionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ActionSearchDto request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ActionSearchDto>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ActionSearchDto request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneSearchActionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneSearchActionsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneSearchActionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneSearchActionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ActionSearchResponseDto>() {})
                            .thenApply(res::withActionSearchResponseDto);
                } else {
