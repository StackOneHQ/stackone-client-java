...
public class AtsGetUser {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetUserRequest, AtsGetUserResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetUserRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetUserRequest request) {
        ...
        @Override
        public AtsGetUserResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetUserResponse.Builder resBuilder =
                    AtsGetUserResponse
                            .builder()
            ...
            AtsGetUserResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetUserRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetUserResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetUserRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetUserRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetUserResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetUserResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetUserResponse res = resBuilder.build();
