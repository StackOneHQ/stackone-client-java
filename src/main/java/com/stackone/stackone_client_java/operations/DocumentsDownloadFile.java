...
public class DocumentsDownloadFile {
    ...
    public static class Sync extends Base
            implements RequestOperation<DocumentsDownloadFileRequest, DocumentsDownloadFileResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DocumentsDownloadFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsDownloadFileRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsDownloadFileRequest request) throws Exception {
        ...
        @Override
        public DocumentsDownloadFileResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DocumentsDownloadFileResponse.Builder resBuilder =
            ...
            DocumentsDownloadFileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DocumentsDownloadFileRequest, com.stackone.stackone_client_java.models.operations.async.DocumentsDownloadFileResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DocumentsDownloadFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsDownloadFileRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DocumentsDownloadFileRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.DocumentsDownloadFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.DocumentsDownloadFileResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.DocumentsDownloadFileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.DocumentsDownloadFileResponse res = resBuilder.build();
