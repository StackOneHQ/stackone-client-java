...
public class StackoneGetLog {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneGetLogRequest request) throws Exception {
        ...
        @Override
        public StackoneGetLogResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UnifiedLogResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUnifiedLogResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
