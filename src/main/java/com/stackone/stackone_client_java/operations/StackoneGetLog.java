...
public class StackoneGetLog {
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneGetLogRequest, StackoneGetLogResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneGetLogRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneGetLogRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneGetLogRequest request) {
        ...
        @Override
        public StackoneGetLogResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneGetLogResponse.Builder resBuilder =
            ...
            StackoneGetLogResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUnifiedLogResult(Utils.unmarshal(response, new TypeReference<UnifiedLogResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneGetLogRequest, com.stackone.stackone_client_java.models.operations.async.StackoneGetLogResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StackoneGetLogRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneGetLogRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StackoneGetLogRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneGetLogResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneGetLogResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneGetLogResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneGetLogResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UnifiedLogResult>() {})
                            .thenApply(res::withUnifiedLogResult);
                } else {
