...
public class AtsCreateOfferOperation implements RequestOperation<AtsCreateOfferRequest, AtsCreateOfferResponse> {
    ...
    public AtsCreateOfferOperation(
    ...
    public HttpRequest buildRequest(AtsCreateOfferRequest request) throws Exception {
