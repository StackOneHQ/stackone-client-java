...
public class HrisGetEmployeeEmploymentOperation implements RequestOperation<HrisGetEmployeeEmploymentRequest, HrisGetEmployeeEmploymentResponse> {
    ...
    public HrisGetEmployeeEmploymentOperation(
    ...
    public HttpRequest buildRequest(HrisGetEmployeeEmploymentRequest request) throws Exception {
