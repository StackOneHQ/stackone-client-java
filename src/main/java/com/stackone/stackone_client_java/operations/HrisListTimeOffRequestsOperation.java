...
public class HrisListTimeOffRequestsOperation implements RequestOperation<HrisListTimeOffRequestsRequest, HrisListTimeOffRequestsResponse> {
    ...
    public HrisListTimeOffRequestsOperation(
    ...
    public HttpRequest buildRequest(HrisListTimeOffRequestsRequest request) throws Exception {
