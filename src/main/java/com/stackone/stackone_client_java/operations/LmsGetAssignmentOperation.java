...
public class LmsGetAssignmentOperation implements RequestOperation<LmsGetAssignmentRequest, LmsGetAssignmentResponse> {
    ...
    public LmsGetAssignmentOperation(
    ...
    public HttpRequest buildRequest(LmsGetAssignmentRequest request) throws Exception {
