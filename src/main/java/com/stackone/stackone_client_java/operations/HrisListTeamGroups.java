...
public class HrisListTeamGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListTeamGroupsRequest, HrisListTeamGroupsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListTeamGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListTeamGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListTeamGroupsRequest request) {
        ...
        @Override
        public HrisListTeamGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListTeamGroupsResponse.Builder resBuilder =
            ...
            HrisListTeamGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISTeamsPaginated(Utils.unmarshal(response, new TypeReference<HRISTeamsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListTeamGroupsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListTeamGroupsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListTeamGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListTeamGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListTeamGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListTeamGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListTeamGroupsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListTeamGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListTeamGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISTeamsPaginated>() {})
                            .thenApply(res::withHRISTeamsPaginated);
                } else {
