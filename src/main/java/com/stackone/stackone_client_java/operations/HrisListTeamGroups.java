...
public class HrisListTeamGroups {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListTeamGroupsRequest request) throws Exception {
        ...
        @Override
        public HrisListTeamGroupsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HRISTeamsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHRISTeamsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
