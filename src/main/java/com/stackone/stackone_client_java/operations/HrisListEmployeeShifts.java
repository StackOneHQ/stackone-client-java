...
public class HrisListEmployeeShifts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeShiftsRequest request) throws Exception {
        ...
        @Override
        public HrisListEmployeeShiftsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HrisShiftsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisShiftsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
