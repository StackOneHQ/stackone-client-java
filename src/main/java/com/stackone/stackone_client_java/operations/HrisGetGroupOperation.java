...
public class HrisGetGroupOperation implements RequestOperation<HrisGetGroupRequest, HrisGetGroupResponse> {
    ...
    public HttpRequest buildRequest(HrisGetGroupRequest request) throws Exception {
