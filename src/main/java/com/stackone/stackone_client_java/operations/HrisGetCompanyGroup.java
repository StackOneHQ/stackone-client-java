...
public class HrisGetCompanyGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetCompanyGroupRequest, HrisGetCompanyGroupResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetCompanyGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetCompanyGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetCompanyGroupRequest request) {
        ...
        @Override
        public HrisGetCompanyGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetCompanyGroupResponse.Builder resBuilder =
            ...
            HrisGetCompanyGroupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCompanyResult(Utils.unmarshal(response, new TypeReference<CompanyResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetCompanyGroupRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetCompanyGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetCompanyGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetCompanyGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetCompanyGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetCompanyGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetCompanyGroupResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetCompanyGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetCompanyGroupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CompanyResult>() {})
                            .thenApply(res::withCompanyResult);
                } else {
