...
public class HrisGetCompanyGroup {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetCompanyGroupRequest request) throws Exception {
        ...
        @Override
        public HrisGetCompanyGroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompanyResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompanyResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
