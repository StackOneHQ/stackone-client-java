...
public class AtsGetApplicationDocumentCategory {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationDocumentCategoryRequest request) throws Exception {
        ...
        @Override
        public AtsGetApplicationDocumentCategoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ReferenceResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withReferenceResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
