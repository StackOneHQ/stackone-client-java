...
public class LmsGetContentOperation implements RequestOperation<LmsGetContentRequest, LmsGetContentResponse> {
    ...
    public HttpRequest buildRequest(LmsGetContentRequest request) throws Exception {
