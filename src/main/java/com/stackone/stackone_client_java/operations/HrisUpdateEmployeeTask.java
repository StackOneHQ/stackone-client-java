...
public class HrisUpdateEmployeeTask {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisUpdateEmployeeTaskRequest request) {
        ...
        @Override
        public HrisUpdateEmployeeTaskResponse handleResponse(HttpResponse<InputStream> response) {
