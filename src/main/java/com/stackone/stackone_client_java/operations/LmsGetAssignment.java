...
public class LmsGetAssignment {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsGetAssignmentRequest, LmsGetAssignmentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsGetAssignmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetAssignmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetAssignmentRequest request) {
        ...
        @Override
        public LmsGetAssignmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsGetAssignmentResponse.Builder resBuilder =
            ...
            LmsGetAssignmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsGetAssignmentRequest, com.stackone.stackone_client_java.models.operations.async.LmsGetAssignmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsGetAssignmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetAssignmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsGetAssignmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsGetAssignmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsGetAssignmentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsGetAssignmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsGetAssignmentResponse res = resBuilder.build();
