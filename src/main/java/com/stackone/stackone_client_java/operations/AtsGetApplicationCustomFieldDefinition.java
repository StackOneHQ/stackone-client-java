...
public class AtsGetApplicationCustomFieldDefinition {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationCustomFieldDefinitionRequest request) throws Exception {
        ...
        @Override
        public AtsGetApplicationCustomFieldDefinitionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CustomFieldDefinitionResultApiModel out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCustomFieldDefinitionResultApiModel(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
