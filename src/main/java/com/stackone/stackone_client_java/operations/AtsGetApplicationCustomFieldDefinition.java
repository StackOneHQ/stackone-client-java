...
public class AtsGetApplicationCustomFieldDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetApplicationCustomFieldDefinitionRequest, AtsGetApplicationCustomFieldDefinitionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetApplicationCustomFieldDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetApplicationCustomFieldDefinitionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationCustomFieldDefinitionRequest request) {
        ...
        @Override
        public AtsGetApplicationCustomFieldDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetApplicationCustomFieldDefinitionResponse.Builder resBuilder =
            ...
            AtsGetApplicationCustomFieldDefinitionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCustomFieldDefinitionResultApiModel(Utils.unmarshal(response, new TypeReference<CustomFieldDefinitionResultApiModel>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetApplicationCustomFieldDefinitionRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationCustomFieldDefinitionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetApplicationCustomFieldDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetApplicationCustomFieldDefinitionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetApplicationCustomFieldDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationCustomFieldDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationCustomFieldDefinitionResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationCustomFieldDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationCustomFieldDefinitionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CustomFieldDefinitionResultApiModel>() {})
                            .thenApply(res::withCustomFieldDefinitionResultApiModel);
                } else {
