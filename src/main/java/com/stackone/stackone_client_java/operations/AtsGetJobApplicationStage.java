...
public class AtsGetJobApplicationStage {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetJobApplicationStageRequest request) throws Exception {
        ...
        @Override
        public AtsGetJobApplicationStageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ApplicationStageResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withApplicationStageResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
