...
public class AtsGetJobApplicationStage {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetJobApplicationStageRequest, AtsGetJobApplicationStageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetJobApplicationStageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetJobApplicationStageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetJobApplicationStageRequest request) {
        ...
        @Override
        public AtsGetJobApplicationStageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetJobApplicationStageResponse.Builder resBuilder =
            ...
            AtsGetJobApplicationStageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withApplicationStageResult(Utils.unmarshal(response, new TypeReference<ApplicationStageResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetJobApplicationStageRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetJobApplicationStageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetJobApplicationStageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetJobApplicationStageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetJobApplicationStageRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetJobApplicationStageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetJobApplicationStageResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetJobApplicationStageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetJobApplicationStageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ApplicationStageResult>() {})
                            .thenApply(res::withApplicationStageResult);
                } else {
