...
public class HrisGetEmployeeTimeOffBalanceOperation implements RequestOperation<HrisGetEmployeeTimeOffBalanceRequest, HrisGetEmployeeTimeOffBalanceResponse> {
    ...
    public HrisGetEmployeeTimeOffBalanceOperation(
    ...
    public HttpRequest buildRequest(HrisGetEmployeeTimeOffBalanceRequest request) throws Exception {
