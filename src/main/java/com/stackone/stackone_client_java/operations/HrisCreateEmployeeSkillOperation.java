...
public class HrisCreateEmployeeSkillOperation implements RequestOperation<HrisCreateEmployeeSkillRequest, HrisCreateEmployeeSkillResponse> {
    ...
    public HrisCreateEmployeeSkillOperation(
    ...
    public HttpRequest buildRequest(HrisCreateEmployeeSkillRequest request) throws Exception {
