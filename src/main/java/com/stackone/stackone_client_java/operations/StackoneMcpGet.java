...
public class StackoneMcpGet {

    static abstract class Base {
        final SDKConfiguration sdkConfiguration;
        final String baseUrl;
        final StackoneMcpGetSecurity security;
        ...
        public Base(
                SDKConfiguration sdkConfiguration, StackoneMcpGetSecurity security,
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneMcpGetRequest, StackoneMcpGetResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, StackoneMcpGetSecurity security,
                Optional<Options> options, Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneMcpGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneMcpGetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneMcpGetRequest request) {
        ...
        @Override
        public StackoneMcpGetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneMcpGetResponse.Builder resBuilder =
            ...
            StackoneMcpGetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneMcpGetRequest, com.stackone.stackone_client_java.models.operations.async.StackoneMcpGetResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StackoneMcpGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneMcpGetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StackoneMcpGetRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneMcpGetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneMcpGetResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneMcpGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneMcpGetResponse res = resBuilder.build();
