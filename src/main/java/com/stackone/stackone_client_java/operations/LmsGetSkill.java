...
public class LmsGetSkill {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetSkillRequest request) throws Exception {
        ...
        @Override
        public LmsGetSkillResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    SkillResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSkillResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
