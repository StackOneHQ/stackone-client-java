...
public class LmsGetSkill {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsGetSkillRequest, LmsGetSkillResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsGetSkillRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetSkillRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetSkillRequest request) {
        ...
        @Override
        public LmsGetSkillResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsGetSkillResponse.Builder resBuilder =
                    LmsGetSkillResponse
                            .builder()
            ...
            LmsGetSkillResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSkillResult(Utils.unmarshal(response, new TypeReference<SkillResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsGetSkillRequest, com.stackone.stackone_client_java.models.operations.async.LmsGetSkillResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsGetSkillRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetSkillRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsGetSkillRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsGetSkillResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsGetSkillResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsGetSkillResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsGetSkillResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SkillResult>() {})
                            .thenApply(res::withSkillResult);
                } else {
