...
public class AccountingListCompanyJournals {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingListCompanyJournalsRequest, AccountingListCompanyJournalsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingListCompanyJournalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingListCompanyJournalsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingListCompanyJournalsRequest request) {
        ...
        @Override
        public AccountingListCompanyJournalsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingListCompanyJournalsResponse.Builder resBuilder =
            ...
            AccountingListCompanyJournalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingJournalsPaginated(Utils.unmarshal(response, new TypeReference<AccountingJournalsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingListCompanyJournalsRequest, com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyJournalsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingListCompanyJournalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingListCompanyJournalsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingListCompanyJournalsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyJournalsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyJournalsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyJournalsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyJournalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingJournalsPaginated>() {})
                            .thenApply(res::withAccountingJournalsPaginated);
                } else {
