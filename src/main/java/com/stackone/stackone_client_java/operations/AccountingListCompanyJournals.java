...
public class AccountingListCompanyJournals {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingListCompanyJournalsRequest request) throws Exception {
        ...
        @Override
        public AccountingListCompanyJournalsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingJournalsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingJournalsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
