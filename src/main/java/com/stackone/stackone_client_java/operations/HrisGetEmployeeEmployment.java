...
public class HrisGetEmployeeEmployment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeeEmploymentRequest request) throws Exception {
        ...
        @Override
        public HrisGetEmployeeEmploymentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EmploymentResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmploymentResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
