...
public class AtsListApplicationScorecards {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationScorecardsRequest request) throws Exception {
        ...
        @Override
        public AtsListApplicationScorecardsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ScorecardsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withScorecardsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
