...
public class AtsListApplicationScorecards {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListApplicationScorecardsRequest, AtsListApplicationScorecardsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListApplicationScorecardsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListApplicationScorecardsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationScorecardsRequest request) {
        ...
        @Override
        public AtsListApplicationScorecardsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListApplicationScorecardsResponse.Builder resBuilder =
            ...
            AtsListApplicationScorecardsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScorecardsPaginated(Utils.unmarshal(response, new TypeReference<ScorecardsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListApplicationScorecardsRequest, com.stackone.stackone_client_java.models.operations.async.AtsListApplicationScorecardsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListApplicationScorecardsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListApplicationScorecardsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListApplicationScorecardsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListApplicationScorecardsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListApplicationScorecardsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListApplicationScorecardsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListApplicationScorecardsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ScorecardsPaginated>() {})
                            .thenApply(res::withScorecardsPaginated);
                } else {
