...
public class AccountingBatchCreateCompanyJournals {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBatchCreateCompanyJournalsRequest request) throws Exception {
        ...
        @Override
        public AccountingBatchCreateCompanyJournalsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BatchResultApiModel out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBatchResultApiModel(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
