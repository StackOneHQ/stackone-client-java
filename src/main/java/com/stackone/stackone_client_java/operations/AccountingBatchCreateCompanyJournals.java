...
public class AccountingBatchCreateCompanyJournals {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBatchCreateCompanyJournalsRequest, AccountingBatchCreateCompanyJournalsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBatchCreateCompanyJournalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBatchCreateCompanyJournalsRequest.class, new TypeReference<AccountingBatchCreateCompanyJournalsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBatchCreateCompanyJournalsRequest request) {
        ...
        @Override
        public AccountingBatchCreateCompanyJournalsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBatchCreateCompanyJournalsResponse.Builder resBuilder =
            ...
            AccountingBatchCreateCompanyJournalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBatchResultApiModel(Utils.unmarshal(response, new TypeReference<BatchResultApiModel>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBatchCreateCompanyJournalsRequest, com.stackone.stackone_client_java.models.operations.async.AccountingBatchCreateCompanyJournalsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBatchCreateCompanyJournalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBatchCreateCompanyJournalsRequest.class, new TypeReference<AccountingBatchCreateCompanyJournalsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBatchCreateCompanyJournalsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AccountingBatchCreateCompanyJournalsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AccountingBatchCreateCompanyJournalsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AccountingBatchCreateCompanyJournalsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AccountingBatchCreateCompanyJournalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BatchResultApiModel>() {})
                            .thenApply(res::withBatchResultApiModel);
                } else {
