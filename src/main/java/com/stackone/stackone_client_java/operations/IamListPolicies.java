...
public class IamListPolicies {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamListPoliciesRequest request) throws Exception {
        ...
        @Override
        public IamListPoliciesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    IamPoliciesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withIamPoliciesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
