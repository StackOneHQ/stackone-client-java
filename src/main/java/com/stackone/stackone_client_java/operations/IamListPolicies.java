...
public class IamListPolicies {
    ...
    public static class Sync extends Base
            implements RequestOperation<IamListPoliciesRequest, IamListPoliciesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IamListPoliciesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamListPoliciesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamListPoliciesRequest request) {
        ...
        @Override
        public IamListPoliciesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IamListPoliciesResponse.Builder resBuilder =
            ...
            IamListPoliciesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIamPoliciesPaginated(Utils.unmarshal(response, new TypeReference<IamPoliciesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IamListPoliciesRequest, com.stackone.stackone_client_java.models.operations.async.IamListPoliciesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IamListPoliciesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamListPoliciesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IamListPoliciesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.IamListPoliciesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.IamListPoliciesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.IamListPoliciesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.IamListPoliciesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<IamPoliciesPaginated>() {})
                            .thenApply(res::withIamPoliciesPaginated);
                } else {
