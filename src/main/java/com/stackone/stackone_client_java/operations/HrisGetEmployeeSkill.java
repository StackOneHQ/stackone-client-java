...
public class HrisGetEmployeeSkill {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetEmployeeSkillRequest, HrisGetEmployeeSkillResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetEmployeeSkillRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetEmployeeSkillRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeeSkillRequest request) {
        ...
        @Override
        public HrisGetEmployeeSkillResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetEmployeeSkillResponse.Builder resBuilder =
            ...
            HrisGetEmployeeSkillResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEntitySkillResult(Utils.unmarshal(response, new TypeReference<EntitySkillResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetEmployeeSkillRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeSkillResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetEmployeeSkillRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetEmployeeSkillRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetEmployeeSkillRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeSkillResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeSkillResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeSkillResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeSkillResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EntitySkillResult>() {})
                            .thenApply(res::withEntitySkillResult);
                } else {
