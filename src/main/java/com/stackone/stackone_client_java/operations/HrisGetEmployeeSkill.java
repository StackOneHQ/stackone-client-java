...
public class HrisGetEmployeeSkill {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeeSkillRequest request) throws Exception {
        ...
        @Override
        public HrisGetEmployeeSkillResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EntitySkillResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEntitySkillResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
