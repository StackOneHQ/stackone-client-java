...
public class HrisListPositions {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListPositionsRequest, HrisListPositionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListPositionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListPositionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListPositionsRequest request) {
        ...
        @Override
        public HrisListPositionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListPositionsResponse.Builder resBuilder =
            ...
            HrisListPositionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPositionsPaginated(Utils.unmarshal(response, new TypeReference<PositionsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListPositionsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListPositionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListPositionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListPositionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListPositionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListPositionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListPositionsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListPositionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListPositionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PositionsPaginated>() {})
                            .thenApply(res::withPositionsPaginated);
                } else {
