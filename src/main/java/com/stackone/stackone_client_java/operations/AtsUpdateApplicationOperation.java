...
public class AtsUpdateApplicationOperation implements RequestOperation<AtsUpdateApplicationRequest, AtsUpdateApplicationResponse> {
    ...
    public AtsUpdateApplicationOperation(
    ...
    public HttpRequest buildRequest(AtsUpdateApplicationRequest request) throws Exception {
