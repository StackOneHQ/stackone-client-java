...
public class AtsGetCandidateNoteOperation implements RequestOperation<AtsGetCandidateNoteRequest, AtsGetCandidateNoteResponse> {
    ...
    public AtsGetCandidateNoteOperation(
    ...
    public HttpRequest buildRequest(AtsGetCandidateNoteRequest request) throws Exception {
