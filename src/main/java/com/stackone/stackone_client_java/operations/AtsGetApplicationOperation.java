...
public class AtsGetApplicationOperation implements RequestOperation<AtsGetApplicationRequest, AtsGetApplicationResponse> {
    ...
    public AtsGetApplicationOperation(
    ...
    public HttpRequest buildRequest(AtsGetApplicationRequest request) throws Exception {
