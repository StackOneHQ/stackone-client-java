...
public class StackoneListPlatformLogsOperation implements RequestOperation<StackoneListPlatformLogsRequest, StackoneListPlatformLogsResponse> {
    ...
    public StackoneListPlatformLogsOperation(
    ...
    public HttpRequest buildRequest(StackoneListPlatformLogsRequest request) throws Exception {
