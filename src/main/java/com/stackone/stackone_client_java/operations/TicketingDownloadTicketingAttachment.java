...
public class TicketingDownloadTicketingAttachment {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(TicketingDownloadTicketingAttachmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingDownloadTicketingAttachmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingDownloadTicketingAttachmentRequest request) throws Exception {
        ...
        @Override
        public TicketingDownloadTicketingAttachmentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingDownloadTicketingAttachmentResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingDownloadTicketingAttachmentRequest, com.stackone.stackone_client_java.models.operations.async.TicketingDownloadTicketingAttachmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingDownloadTicketingAttachmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingDownloadTicketingAttachmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingDownloadTicketingAttachmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingDownloadTicketingAttachmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingDownloadTicketingAttachmentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingDownloadTicketingAttachmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingDownloadTicketingAttachmentResponse res = resBuilder.build();
