...
public class ScreeningGetScreeningPackage {
    ...
    public static class Sync extends Base
            implements RequestOperation<ScreeningGetScreeningPackageRequest, ScreeningGetScreeningPackageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ScreeningGetScreeningPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ScreeningGetScreeningPackageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ScreeningGetScreeningPackageRequest request) {
        ...
        @Override
        public ScreeningGetScreeningPackageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ScreeningGetScreeningPackageResponse.Builder resBuilder =
            ...
            ScreeningGetScreeningPackageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScreeningPackageResult(Utils.unmarshal(response, new TypeReference<ScreeningPackageResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ScreeningGetScreeningPackageRequest, com.stackone.stackone_client_java.models.operations.async.ScreeningGetScreeningPackageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ScreeningGetScreeningPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ScreeningGetScreeningPackageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ScreeningGetScreeningPackageRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.ScreeningGetScreeningPackageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.ScreeningGetScreeningPackageResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.ScreeningGetScreeningPackageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.ScreeningGetScreeningPackageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ScreeningPackageResult>() {})
                            .thenApply(res::withScreeningPackageResult);
                } else {
