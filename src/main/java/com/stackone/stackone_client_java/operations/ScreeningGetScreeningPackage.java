...
public class ScreeningGetScreeningPackage {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ScreeningGetScreeningPackageRequest request) throws Exception {
        ...
        @Override
        public ScreeningGetScreeningPackageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ScreeningPackageResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withScreeningPackageResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
