...
public class AtsGetLocationOperation implements RequestOperation<AtsGetLocationRequest, AtsGetLocationResponse> {
    ...
    public AtsGetLocationOperation(
    ...
    public HttpRequest buildRequest(AtsGetLocationRequest request) throws Exception {
