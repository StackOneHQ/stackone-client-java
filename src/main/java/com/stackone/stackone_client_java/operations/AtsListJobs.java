...
public class AtsListJobs {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListJobsRequest, AtsListJobsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListJobsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListJobsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListJobsRequest request) {
        ...
        @Override
        public AtsListJobsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListJobsResponse.Builder resBuilder =
                    AtsListJobsResponse
                            .builder()
            ...
            AtsListJobsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsJobsPaginated(Utils.unmarshal(response, new TypeReference<AtsJobsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListJobsRequest, com.stackone.stackone_client_java.models.operations.async.AtsListJobsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListJobsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListJobsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListJobsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListJobsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListJobsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListJobsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListJobsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AtsJobsPaginated>() {})
                            .thenApply(res::withAtsJobsPaginated);
                } else {
