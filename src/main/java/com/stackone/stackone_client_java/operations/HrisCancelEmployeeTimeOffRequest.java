...
public class HrisCancelEmployeeTimeOffRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisCancelEmployeeTimeOffRequestRequest, HrisCancelEmployeeTimeOffRequestResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisCancelEmployeeTimeOffRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCancelEmployeeTimeOffRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisCancelEmployeeTimeOffRequestRequest request) {
        ...
        @Override
        public HrisCancelEmployeeTimeOffRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisCancelEmployeeTimeOffRequestResponse.Builder resBuilder =
            ...
            HrisCancelEmployeeTimeOffRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteResult(Utils.unmarshal(response, new TypeReference<DeleteResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisCancelEmployeeTimeOffRequestRequest, com.stackone.stackone_client_java.models.operations.async.HrisCancelEmployeeTimeOffRequestResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisCancelEmployeeTimeOffRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCancelEmployeeTimeOffRequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisCancelEmployeeTimeOffRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisCancelEmployeeTimeOffRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisCancelEmployeeTimeOffRequestResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisCancelEmployeeTimeOffRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisCancelEmployeeTimeOffRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteResult>() {})
                            .thenApply(res::withDeleteResult);
                } else {
