...
public class HrisCancelEmployeeTimeOffRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisCancelEmployeeTimeOffRequestRequest request) throws Exception {
        ...
        @Override
        public HrisCancelEmployeeTimeOffRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
