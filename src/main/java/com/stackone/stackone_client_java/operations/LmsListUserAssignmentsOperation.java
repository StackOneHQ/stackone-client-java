...
public class LmsListUserAssignmentsOperation implements RequestOperation<LmsListUserAssignmentsRequest, LmsListUserAssignmentsResponse> {
    ...
    public LmsListUserAssignmentsOperation(
    ...
    public HttpRequest buildRequest(LmsListUserAssignmentsRequest request) throws Exception {
