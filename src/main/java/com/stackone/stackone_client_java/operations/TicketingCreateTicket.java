...
public class TicketingCreateTicket {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingCreateTicketRequest, TicketingCreateTicketResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingCreateTicketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<TicketingCreateTicketRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingCreateTicketRequest request) {
        ...
        @Override
        public TicketingCreateTicketResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingCreateTicketResponse.Builder resBuilder =
            ...
            TicketingCreateTicketResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingCreateTicketRequest, com.stackone.stackone_client_java.models.operations.async.TicketingCreateTicketResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingCreateTicketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<TicketingCreateTicketRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingCreateTicketRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingCreateTicketResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingCreateTicketResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingCreateTicketResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingCreateTicketResponse res = resBuilder.build();
