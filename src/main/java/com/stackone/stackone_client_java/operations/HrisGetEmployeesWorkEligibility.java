...
public class HrisGetEmployeesWorkEligibility {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetEmployeesWorkEligibilityRequest, HrisGetEmployeesWorkEligibilityResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetEmployeesWorkEligibilityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetEmployeesWorkEligibilityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeesWorkEligibilityRequest request) {
        ...
        @Override
        public HrisGetEmployeesWorkEligibilityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetEmployeesWorkEligibilityResponse.Builder resBuilder =
            ...
            HrisGetEmployeesWorkEligibilityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWorkEligibilityResult(Utils.unmarshal(response, new TypeReference<WorkEligibilityResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetEmployeesWorkEligibilityRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeesWorkEligibilityResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetEmployeesWorkEligibilityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetEmployeesWorkEligibilityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetEmployeesWorkEligibilityRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeesWorkEligibilityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeesWorkEligibilityResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeesWorkEligibilityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeesWorkEligibilityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<WorkEligibilityResult>() {})
                            .thenApply(res::withWorkEligibilityResult);
                } else {
