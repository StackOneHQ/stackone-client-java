...
public class HrisGetEmployeesWorkEligibility {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeesWorkEligibilityRequest request) throws Exception {
        ...
        @Override
        public HrisGetEmployeesWorkEligibilityResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    WorkEligibilityResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withWorkEligibilityResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
