...
public class AtsGetJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetJobRequest, AtsGetJobResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetJobRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetJobRequest request) {
        ...
        @Override
        public AtsGetJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetJobResponse.Builder resBuilder =
                    AtsGetJobResponse
                            .builder()
            ...
            AtsGetJobResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsJobResult(Utils.unmarshal(response, new TypeReference<AtsJobResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetJobRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetJobRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetJobRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetJobResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetJobResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AtsJobResult>() {})
                            .thenApply(res::withAtsJobResult);
                } else {
