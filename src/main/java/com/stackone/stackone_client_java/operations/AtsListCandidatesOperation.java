...
public class AtsListCandidatesOperation implements RequestOperation<AtsListCandidatesRequest, AtsListCandidatesResponse> {
    ...
    public AtsListCandidatesOperation(
    ...
    public HttpRequest buildRequest(AtsListCandidatesRequest request) throws Exception {
