...
public class IamUpdateUserOperation implements RequestOperation<IamUpdateUserRequest, IamUpdateUserResponse> {
    ...
    public HttpRequest buildRequest(IamUpdateUserRequest request) throws Exception {
