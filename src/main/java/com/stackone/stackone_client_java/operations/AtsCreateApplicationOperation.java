...
public class AtsCreateApplicationOperation implements RequestOperation<AtsCreateApplicationRequest, AtsCreateApplicationResponse> {
    ...
    public AtsCreateApplicationOperation(
    ...
    public HttpRequest buildRequest(AtsCreateApplicationRequest request) throws Exception {
