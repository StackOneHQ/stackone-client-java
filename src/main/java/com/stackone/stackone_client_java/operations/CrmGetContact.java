...
public class CrmGetContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmGetContactRequest, CrmGetContactResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmGetContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmGetContactRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmGetContactRequest request) {
        ...
        @Override
        public CrmGetContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmGetContactResponse.Builder resBuilder =
            ...
            CrmGetContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmGetContactRequest, com.stackone.stackone_client_java.models.operations.async.CrmGetContactResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmGetContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmGetContactRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmGetContactRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.CrmGetContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.CrmGetContactResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.CrmGetContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.CrmGetContactResponse res = resBuilder.build();
