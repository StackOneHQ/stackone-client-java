...
public class CrmListContactCustomFieldDefinitionsOperation implements RequestOperation<CrmListContactCustomFieldDefinitionsRequest, CrmListContactCustomFieldDefinitionsResponse> {
    ...
    public CrmListContactCustomFieldDefinitionsOperation(
    ...
    public HttpRequest buildRequest(CrmListContactCustomFieldDefinitionsRequest request) throws Exception {
