...
public class MarketingUpdateSmsTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingUpdateSmsTemplateRequest, MarketingUpdateSmsTemplateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingUpdateSmsTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingUpdateSmsTemplateRequest.class, new TypeReference<MarketingUpdateSmsTemplateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingUpdateSmsTemplateRequest request) {
        ...
        @Override
        public MarketingUpdateSmsTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingUpdateSmsTemplateResponse.Builder resBuilder =
            ...
            MarketingUpdateSmsTemplateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingUpdateSmsTemplateRequest, com.stackone.stackone_client_java.models.operations.async.MarketingUpdateSmsTemplateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingUpdateSmsTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingUpdateSmsTemplateRequest.class, new TypeReference<MarketingUpdateSmsTemplateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingUpdateSmsTemplateRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingUpdateSmsTemplateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingUpdateSmsTemplateResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingUpdateSmsTemplateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingUpdateSmsTemplateResponse res = resBuilder.build();
