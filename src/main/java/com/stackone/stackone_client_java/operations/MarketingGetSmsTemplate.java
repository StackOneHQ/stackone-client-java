...
public class MarketingGetSmsTemplate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingGetSmsTemplateRequest request) throws Exception {
        ...
        @Override
        public MarketingGetSmsTemplateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    SmsTemplateResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSmsTemplateResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
