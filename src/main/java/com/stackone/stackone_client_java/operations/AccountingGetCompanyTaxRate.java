...
public class AccountingGetCompanyTaxRate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingGetCompanyTaxRateRequest, AccountingGetCompanyTaxRateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingGetCompanyTaxRateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGetCompanyTaxRateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingGetCompanyTaxRateRequest request) {
        ...
        @Override
        public AccountingGetCompanyTaxRateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingGetCompanyTaxRateResponse.Builder resBuilder =
            ...
            AccountingGetCompanyTaxRateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingTaxRateResult(Utils.unmarshal(response, new TypeReference<AccountingTaxRateResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingGetCompanyTaxRateRequest, com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyTaxRateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingGetCompanyTaxRateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGetCompanyTaxRateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingGetCompanyTaxRateRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyTaxRateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyTaxRateResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyTaxRateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyTaxRateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingTaxRateResult>() {})
                            .thenApply(res::withAccountingTaxRateResult);
                } else {
