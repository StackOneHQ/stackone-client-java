...
public class AccountingGetCompanyTaxRate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingGetCompanyTaxRateRequest request) throws Exception {
        ...
        @Override
        public AccountingGetCompanyTaxRateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingTaxRateResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingTaxRateResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
