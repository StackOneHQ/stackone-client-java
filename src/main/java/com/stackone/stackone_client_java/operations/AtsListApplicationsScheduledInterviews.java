...
public class AtsListApplicationsScheduledInterviews {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListApplicationsScheduledInterviewsRequest, AtsListApplicationsScheduledInterviewsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListApplicationsScheduledInterviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListApplicationsScheduledInterviewsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationsScheduledInterviewsRequest request) {
        ...
        @Override
        public AtsListApplicationsScheduledInterviewsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListApplicationsScheduledInterviewsResponse.Builder resBuilder =
            ...
            AtsListApplicationsScheduledInterviewsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScheduledInterviewsPaginated(Utils.unmarshal(response, new TypeReference<ScheduledInterviewsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListApplicationsScheduledInterviewsRequest, com.stackone.stackone_client_java.models.operations.async.AtsListApplicationsScheduledInterviewsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListApplicationsScheduledInterviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListApplicationsScheduledInterviewsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListApplicationsScheduledInterviewsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListApplicationsScheduledInterviewsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListApplicationsScheduledInterviewsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListApplicationsScheduledInterviewsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListApplicationsScheduledInterviewsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ScheduledInterviewsPaginated>() {})
                            .thenApply(res::withScheduledInterviewsPaginated);
                } else {
