...
public class AtsListApplicationsScheduledInterviews {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationsScheduledInterviewsRequest request) throws Exception {
        ...
        @Override
        public AtsListApplicationsScheduledInterviewsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ScheduledInterviewsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withScheduledInterviewsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
