...
public class ScreeningWebhookScreeningResult {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ScreeningWebhookScreeningResultRequest request) throws Exception {
        ...
        @Override
        public ScreeningWebhookScreeningResultResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ScreeningResultWebhook out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withScreeningResultWebhook(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
