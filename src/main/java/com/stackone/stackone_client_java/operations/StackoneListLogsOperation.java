...
public class StackoneListLogsOperation implements RequestOperation<StackoneListLogsRequest, StackoneListLogsResponse> {
    ...
    public StackoneListLogsOperation(
    ...
    public HttpRequest buildRequest(StackoneListLogsRequest request) throws Exception {
