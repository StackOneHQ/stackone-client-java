...
public class AtsGetOffer {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetOfferRequest, AtsGetOfferResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetOfferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetOfferRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetOfferRequest request) {
        ...
        @Override
        public AtsGetOfferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetOfferResponse.Builder resBuilder =
                    AtsGetOfferResponse
                            .builder()
            ...
            AtsGetOfferResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetOfferRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetOfferResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetOfferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetOfferRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetOfferRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetOfferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetOfferResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetOfferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetOfferResponse res = resBuilder.build();
