...
public class AtsGetOffer {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetOfferRequest request) throws Exception {
        ...
        @Override
        public AtsGetOfferResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
