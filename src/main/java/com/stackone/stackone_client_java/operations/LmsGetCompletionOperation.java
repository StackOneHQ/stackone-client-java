...
public class LmsGetCompletionOperation implements RequestOperation<LmsGetCompletionRequest, LmsGetCompletionResponse> {
    ...
    public LmsGetCompletionOperation(
    ...
    public HttpRequest buildRequest(LmsGetCompletionRequest request) throws Exception {
