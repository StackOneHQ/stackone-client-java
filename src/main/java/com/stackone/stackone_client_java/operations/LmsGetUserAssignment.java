...
public class LmsGetUserAssignment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetUserAssignmentRequest request) throws Exception {
        ...
        @Override
        public LmsGetUserAssignmentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AssignmentResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAssignmentResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
