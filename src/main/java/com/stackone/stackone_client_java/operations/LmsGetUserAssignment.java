...
public class LmsGetUserAssignment {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsGetUserAssignmentRequest, LmsGetUserAssignmentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsGetUserAssignmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetUserAssignmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetUserAssignmentRequest request) {
        ...
        @Override
        public LmsGetUserAssignmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsGetUserAssignmentResponse.Builder resBuilder =
            ...
            LmsGetUserAssignmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAssignmentResult(Utils.unmarshal(response, new TypeReference<AssignmentResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsGetUserAssignmentRequest, com.stackone.stackone_client_java.models.operations.async.LmsGetUserAssignmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsGetUserAssignmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetUserAssignmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsGetUserAssignmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsGetUserAssignmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsGetUserAssignmentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsGetUserAssignmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsGetUserAssignmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AssignmentResult>() {})
                            .thenApply(res::withAssignmentResult);
                } else {
