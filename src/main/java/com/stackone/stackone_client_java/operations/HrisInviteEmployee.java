...
public class HrisInviteEmployee {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisInviteEmployeeRequest, HrisInviteEmployeeResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisInviteEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisInviteEmployeeRequest.class, new TypeReference<HrisInviteEmployeeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisInviteEmployeeRequest request) {
        ...
        @Override
        public HrisInviteEmployeeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisInviteEmployeeResponse.Builder resBuilder =
            ...
            HrisInviteEmployeeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInviteEmployeeResult(Utils.unmarshal(response, new TypeReference<InviteEmployeeResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisInviteEmployeeRequest, com.stackone.stackone_client_java.models.operations.async.HrisInviteEmployeeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisInviteEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisInviteEmployeeRequest.class, new TypeReference<HrisInviteEmployeeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisInviteEmployeeRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisInviteEmployeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisInviteEmployeeResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisInviteEmployeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisInviteEmployeeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InviteEmployeeResult>() {})
                            .thenApply(res::withInviteEmployeeResult);
                } else {
