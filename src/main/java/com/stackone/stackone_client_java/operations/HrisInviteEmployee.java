...
public class HrisInviteEmployee {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisInviteEmployeeRequest request) throws Exception {
        ...
        @Override
        public HrisInviteEmployeeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    InviteEmployeeResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withInviteEmployeeResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
