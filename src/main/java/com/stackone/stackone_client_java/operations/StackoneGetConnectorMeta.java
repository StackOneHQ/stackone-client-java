...
public class StackoneGetConnectorMeta {
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneGetConnectorMetaRequest, StackoneGetConnectorMetaResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneGetConnectorMetaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneGetConnectorMetaRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneGetConnectorMetaRequest request) throws Exception {
        ...
        @Override
        public StackoneGetConnectorMetaResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneGetConnectorMetaResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ConnectorsMeta out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withConnectorsMeta(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneGetConnectorMetaRequest, com.stackone.stackone_client_java.models.operations.async.StackoneGetConnectorMetaResponse> {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneGetConnectorMetaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneGetConnectorMetaResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneGetConnectorMetaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneGetConnectorMetaResponse res = resBuilder.build();
