...
public class StackoneGetConnectorMeta {
    ...
    public static class Sync extends Base
        ...
        @Override
        public StackoneGetConnectorMetaResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneGetConnectorMetaResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ConnectorsMeta>() {})
                            .thenApply(res::withConnectorsMeta);
                } else {
