...
public class HrisGetBenefit {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetBenefitRequest request) throws Exception {
        ...
        @Override
        public HrisGetBenefitResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HRISBenefitResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHRISBenefitResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
