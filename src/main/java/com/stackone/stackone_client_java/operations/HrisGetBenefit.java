...
public class HrisGetBenefit {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetBenefitRequest, HrisGetBenefitResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetBenefitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetBenefitRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetBenefitRequest request) {
        ...
        @Override
        public HrisGetBenefitResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetBenefitResponse.Builder resBuilder =
            ...
            HrisGetBenefitResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISBenefitResult(Utils.unmarshal(response, new TypeReference<HRISBenefitResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetBenefitRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetBenefitResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetBenefitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetBenefitRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetBenefitRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetBenefitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetBenefitResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetBenefitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetBenefitResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISBenefitResult>() {})
                            .thenApply(res::withHRISBenefitResult);
                } else {
