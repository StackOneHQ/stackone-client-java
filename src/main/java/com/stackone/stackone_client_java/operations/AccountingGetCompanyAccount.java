...
public class AccountingGetCompanyAccount {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingGetCompanyAccountRequest request) throws Exception {
        ...
        @Override
        public AccountingGetCompanyAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingAccountResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingAccountResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
