...
public class AccountingGetCompanyAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingGetCompanyAccountRequest, AccountingGetCompanyAccountResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingGetCompanyAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGetCompanyAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingGetCompanyAccountRequest request) {
        ...
        @Override
        public AccountingGetCompanyAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingGetCompanyAccountResponse.Builder resBuilder =
            ...
            AccountingGetCompanyAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingAccountResult(Utils.unmarshal(response, new TypeReference<AccountingAccountResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingGetCompanyAccountRequest, com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyAccountResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingGetCompanyAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGetCompanyAccountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingGetCompanyAccountRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyAccountResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyAccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingAccountResult>() {})
                            .thenApply(res::withAccountingAccountResult);
                } else {
