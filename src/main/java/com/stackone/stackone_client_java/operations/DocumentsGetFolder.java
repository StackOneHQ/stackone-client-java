...
public class DocumentsGetFolder {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsGetFolderRequest request) throws Exception {
        ...
        @Override
        public DocumentsGetFolderResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    FolderResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withFolderResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
