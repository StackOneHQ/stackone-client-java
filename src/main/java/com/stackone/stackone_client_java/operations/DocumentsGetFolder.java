...
public class DocumentsGetFolder {
    ...
    public static class Sync extends Base
            implements RequestOperation<DocumentsGetFolderRequest, DocumentsGetFolderResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DocumentsGetFolderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsGetFolderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsGetFolderRequest request) {
        ...
        @Override
        public DocumentsGetFolderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DocumentsGetFolderResponse.Builder resBuilder =
            ...
            DocumentsGetFolderResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFolderResult(Utils.unmarshal(response, new TypeReference<FolderResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DocumentsGetFolderRequest, com.stackone.stackone_client_java.models.operations.async.DocumentsGetFolderResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DocumentsGetFolderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsGetFolderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DocumentsGetFolderRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.DocumentsGetFolderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.DocumentsGetFolderResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.DocumentsGetFolderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.DocumentsGetFolderResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FolderResult>() {})
                            .thenApply(res::withFolderResult);
                } else {
