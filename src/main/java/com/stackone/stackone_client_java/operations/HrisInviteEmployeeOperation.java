...
public class HrisInviteEmployeeOperation implements RequestOperation<HrisInviteEmployeeRequest, HrisInviteEmployeeResponse> {
    ...
    public HrisInviteEmployeeOperation(
    ...
    public HttpRequest buildRequest(HrisInviteEmployeeRequest request) throws Exception {
