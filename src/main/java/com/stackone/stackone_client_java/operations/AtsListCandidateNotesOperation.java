...
public class AtsListCandidateNotesOperation implements RequestOperation<AtsListCandidateNotesRequest, AtsListCandidateNotesResponse> {
    ...
    public AtsListCandidateNotesOperation(
    ...
    public HttpRequest buildRequest(AtsListCandidateNotesRequest request) throws Exception {
