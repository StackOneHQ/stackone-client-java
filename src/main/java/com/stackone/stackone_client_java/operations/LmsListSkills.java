...
public class LmsListSkills {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsListSkillsRequest, LmsListSkillsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsListSkillsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListSkillsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListSkillsRequest request) {
        ...
        @Override
        public LmsListSkillsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsListSkillsResponse.Builder resBuilder =
            ...
            LmsListSkillsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSkillsPaginated(Utils.unmarshal(response, new TypeReference<SkillsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsListSkillsRequest, com.stackone.stackone_client_java.models.operations.async.LmsListSkillsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsListSkillsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListSkillsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsListSkillsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsListSkillsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsListSkillsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsListSkillsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsListSkillsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SkillsPaginated>() {})
                            .thenApply(res::withSkillsPaginated);
                } else {
