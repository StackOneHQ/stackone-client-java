...
public class LmsListSkills {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListSkillsRequest request) throws Exception {
        ...
        @Override
        public LmsListSkillsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    SkillsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSkillsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
