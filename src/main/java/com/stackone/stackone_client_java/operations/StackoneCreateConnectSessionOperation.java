...
public class StackoneCreateConnectSessionOperation implements RequestOperation<ConnectSessionCreate, StackoneCreateConnectSessionResponse> {
    ...
    public StackoneCreateConnectSessionOperation(
    ...
    public HttpRequest buildRequest(ConnectSessionCreate request) throws Exception {
