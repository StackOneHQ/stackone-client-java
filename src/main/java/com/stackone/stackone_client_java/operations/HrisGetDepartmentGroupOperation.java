...
public class HrisGetDepartmentGroupOperation implements RequestOperation<HrisGetDepartmentGroupRequest, HrisGetDepartmentGroupResponse> {
    ...
    public HrisGetDepartmentGroupOperation(
    ...
    public HttpRequest buildRequest(HrisGetDepartmentGroupRequest request) throws Exception {
