...
public class TicketingListAttachments {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingListAttachmentsRequest, TicketingListAttachmentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingListAttachmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListAttachmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListAttachmentsRequest request) {
        ...
        @Override
        public TicketingListAttachmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingListAttachmentsResponse.Builder resBuilder =
            ...
            TicketingListAttachmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingAttachmentsPaginated(Utils.unmarshal(response, new TypeReference<TicketingAttachmentsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingListAttachmentsRequest, com.stackone.stackone_client_java.models.operations.async.TicketingListAttachmentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingListAttachmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListAttachmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingListAttachmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingListAttachmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingListAttachmentsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingListAttachmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingListAttachmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingAttachmentsPaginated>() {})
                            .thenApply(res::withTicketingAttachmentsPaginated);
                } else {
