...
public class TicketingListAttachments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListAttachmentsRequest request) throws Exception {
        ...
        @Override
        public TicketingListAttachmentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TicketingAttachmentsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingAttachmentsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
