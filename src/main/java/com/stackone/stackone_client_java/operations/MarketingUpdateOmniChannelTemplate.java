...
public class MarketingUpdateOmniChannelTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingUpdateOmniChannelTemplateRequest, MarketingUpdateOmniChannelTemplateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingUpdateOmniChannelTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingUpdateOmniChannelTemplateRequest.class, new TypeReference<MarketingUpdateOmniChannelTemplateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingUpdateOmniChannelTemplateRequest request) {
        ...
        @Override
        public MarketingUpdateOmniChannelTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingUpdateOmniChannelTemplateResponse.Builder resBuilder =
            ...
            MarketingUpdateOmniChannelTemplateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingUpdateOmniChannelTemplateRequest, com.stackone.stackone_client_java.models.operations.async.MarketingUpdateOmniChannelTemplateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingUpdateOmniChannelTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingUpdateOmniChannelTemplateRequest.class, new TypeReference<MarketingUpdateOmniChannelTemplateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingUpdateOmniChannelTemplateRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingUpdateOmniChannelTemplateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingUpdateOmniChannelTemplateResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingUpdateOmniChannelTemplateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingUpdateOmniChannelTemplateResponse res = resBuilder.build();
