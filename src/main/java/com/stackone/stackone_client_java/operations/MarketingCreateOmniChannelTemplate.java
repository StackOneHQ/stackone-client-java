...
public class MarketingCreateOmniChannelTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingCreateOmniChannelTemplateRequest, MarketingCreateOmniChannelTemplateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingCreateOmniChannelTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MarketingCreateOmniChannelTemplateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingCreateOmniChannelTemplateRequest request) {
        ...
        @Override
        public MarketingCreateOmniChannelTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingCreateOmniChannelTemplateResponse.Builder resBuilder =
            ...
            MarketingCreateOmniChannelTemplateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingCreateOmniChannelTemplateRequest, com.stackone.stackone_client_java.models.operations.async.MarketingCreateOmniChannelTemplateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingCreateOmniChannelTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MarketingCreateOmniChannelTemplateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingCreateOmniChannelTemplateRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingCreateOmniChannelTemplateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingCreateOmniChannelTemplateResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingCreateOmniChannelTemplateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingCreateOmniChannelTemplateResponse res = resBuilder.build();
