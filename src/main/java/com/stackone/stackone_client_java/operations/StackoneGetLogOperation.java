...
public class StackoneGetLogOperation implements RequestOperation<StackoneGetLogRequest, StackoneGetLogResponse> {
    ...
    public StackoneGetLogOperation(
    ...
    public HttpRequest buildRequest(StackoneGetLogRequest request) throws Exception {
