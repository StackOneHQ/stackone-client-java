...
public class AtsOrderBackgroundCheckRequestOperation implements RequestOperation<AtsOrderBackgroundCheckRequestRequest, AtsOrderBackgroundCheckRequestResponse> {
    ...
    public AtsOrderBackgroundCheckRequestOperation(
    ...
    public HttpRequest buildRequest(AtsOrderBackgroundCheckRequestRequest request) throws Exception {
