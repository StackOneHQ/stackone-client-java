...
public class StackoneListPlatformLogs {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneListPlatformLogsRequest request) throws Exception {
        ...
        @Override
        public StackoneListPlatformLogsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PlatformLogsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPlatformLogsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
