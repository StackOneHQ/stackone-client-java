...
public class StackoneListPlatformLogs {
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneListPlatformLogsRequest, StackoneListPlatformLogsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneListPlatformLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneListPlatformLogsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneListPlatformLogsRequest request) {
        ...
        @Override
        public StackoneListPlatformLogsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneListPlatformLogsResponse.Builder resBuilder =
            ...
            StackoneListPlatformLogsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlatformLogsPaginated(Utils.unmarshal(response, new TypeReference<PlatformLogsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneListPlatformLogsRequest, com.stackone.stackone_client_java.models.operations.async.StackoneListPlatformLogsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StackoneListPlatformLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneListPlatformLogsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StackoneListPlatformLogsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneListPlatformLogsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneListPlatformLogsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneListPlatformLogsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneListPlatformLogsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlatformLogsPaginated>() {})
                            .thenApply(res::withPlatformLogsPaginated);
                } else {
