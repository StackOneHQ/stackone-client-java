...
public class AtsGetRejectedReason {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetRejectedReasonRequest request) throws Exception {
        ...
        @Override
        public AtsGetRejectedReasonResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    RejectedReasonResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRejectedReasonResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
