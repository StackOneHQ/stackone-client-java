...
public class AtsGetRejectedReason {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetRejectedReasonRequest, AtsGetRejectedReasonResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetRejectedReasonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetRejectedReasonRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetRejectedReasonRequest request) {
        ...
        @Override
        public AtsGetRejectedReasonResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetRejectedReasonResponse.Builder resBuilder =
            ...
            AtsGetRejectedReasonResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRejectedReasonResult(Utils.unmarshal(response, new TypeReference<RejectedReasonResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetRejectedReasonRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetRejectedReasonResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetRejectedReasonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetRejectedReasonRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetRejectedReasonRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetRejectedReasonResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetRejectedReasonResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetRejectedReasonResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetRejectedReasonResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RejectedReasonResult>() {})
                            .thenApply(res::withRejectedReasonResult);
                } else {
