...
public class AtsDeleteBackgroundCheckPackage {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsDeleteBackgroundCheckPackageRequest, AtsDeleteBackgroundCheckPackageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsDeleteBackgroundCheckPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsDeleteBackgroundCheckPackageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsDeleteBackgroundCheckPackageRequest request) {
        ...
        @Override
        public AtsDeleteBackgroundCheckPackageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsDeleteBackgroundCheckPackageResponse.Builder resBuilder =
            ...
            AtsDeleteBackgroundCheckPackageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsDeleteBackgroundCheckPackageRequest, com.stackone.stackone_client_java.models.operations.async.AtsDeleteBackgroundCheckPackageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsDeleteBackgroundCheckPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsDeleteBackgroundCheckPackageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsDeleteBackgroundCheckPackageRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsDeleteBackgroundCheckPackageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsDeleteBackgroundCheckPackageResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsDeleteBackgroundCheckPackageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsDeleteBackgroundCheckPackageResponse res = resBuilder.build();
