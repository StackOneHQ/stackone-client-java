...
public class HrisListEmployeesOperation implements RequestOperation<HrisListEmployeesRequest, HrisListEmployeesResponse> {
    ...
    public HrisListEmployeesOperation(
    ...
    public HttpRequest buildRequest(HrisListEmployeesRequest request) throws Exception {
