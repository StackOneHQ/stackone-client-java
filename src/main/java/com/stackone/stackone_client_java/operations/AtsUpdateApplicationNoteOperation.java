...
public class AtsUpdateApplicationNoteOperation implements RequestOperation<AtsUpdateApplicationNoteRequest, AtsUpdateApplicationNoteResponse> {
    ...
    public AtsUpdateApplicationNoteOperation(
    ...
    public HttpRequest buildRequest(AtsUpdateApplicationNoteRequest request) throws Exception {
