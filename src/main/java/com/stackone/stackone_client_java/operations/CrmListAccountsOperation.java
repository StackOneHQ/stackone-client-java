...
public class CrmListAccountsOperation implements RequestOperation<CrmListAccountsRequest, CrmListAccountsResponse> {
    ...
    public CrmListAccountsOperation(
    ...
    public HttpRequest buildRequest(CrmListAccountsRequest request) throws Exception {
