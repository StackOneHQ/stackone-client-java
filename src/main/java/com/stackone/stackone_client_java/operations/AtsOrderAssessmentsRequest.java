...
public class AtsOrderAssessmentsRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsOrderAssessmentsRequestRequest request) throws Exception {
        ...
        @Override
        public AtsOrderAssessmentsRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateAssessmentOrderResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateAssessmentOrderResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
