...
public class AtsOrderAssessmentsRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsOrderAssessmentsRequestRequest, AtsOrderAssessmentsRequestResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsOrderAssessmentsRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsOrderAssessmentsRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsOrderAssessmentsRequestRequest request) {
        ...
        @Override
        public AtsOrderAssessmentsRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsOrderAssessmentsRequestResponse.Builder resBuilder =
            ...
            AtsOrderAssessmentsRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateAssessmentOrderResult(Utils.unmarshal(response, new TypeReference<CreateAssessmentOrderResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsOrderAssessmentsRequestRequest, com.stackone.stackone_client_java.models.operations.async.AtsOrderAssessmentsRequestResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsOrderAssessmentsRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsOrderAssessmentsRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsOrderAssessmentsRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsOrderAssessmentsRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsOrderAssessmentsRequestResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsOrderAssessmentsRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsOrderAssessmentsRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateAssessmentOrderResult>() {})
                            .thenApply(res::withCreateAssessmentOrderResult);
                } else {
