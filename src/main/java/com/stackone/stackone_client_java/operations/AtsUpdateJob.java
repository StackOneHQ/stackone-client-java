...
public class AtsUpdateJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsUpdateJobRequest, AtsUpdateJobResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsUpdateJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsUpdateJobRequest.class, new TypeReference<AtsUpdateJobRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsUpdateJobRequest request) {
        ...
        @Override
        public AtsUpdateJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsUpdateJobResponse.Builder resBuilder =
            ...
            AtsUpdateJobResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsUpdateJobRequest, com.stackone.stackone_client_java.models.operations.async.AtsUpdateJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsUpdateJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsUpdateJobRequest.class, new TypeReference<AtsUpdateJobRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsUpdateJobRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsUpdateJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsUpdateJobResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsUpdateJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsUpdateJobResponse res = resBuilder.build();
