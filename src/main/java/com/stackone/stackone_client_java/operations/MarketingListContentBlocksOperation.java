...
public class MarketingListContentBlocksOperation implements RequestOperation<MarketingListContentBlocksRequest, MarketingListContentBlocksResponse> {
    ...
    public MarketingListContentBlocksOperation(
    ...
    public HttpRequest buildRequest(MarketingListContentBlocksRequest request) throws Exception {
