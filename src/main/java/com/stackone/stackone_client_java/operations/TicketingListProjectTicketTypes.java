...
public class TicketingListProjectTicketTypes {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingListProjectTicketTypesRequest, TicketingListProjectTicketTypesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingListProjectTicketTypesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListProjectTicketTypesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListProjectTicketTypesRequest request) {
        ...
        @Override
        public TicketingListProjectTicketTypesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingListProjectTicketTypesResponse.Builder resBuilder =
            ...
            TicketingListProjectTicketTypesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingTicketTypePaginated(Utils.unmarshal(response, new TypeReference<TicketingTicketTypePaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingListProjectTicketTypesRequest, com.stackone.stackone_client_java.models.operations.async.TicketingListProjectTicketTypesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingListProjectTicketTypesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListProjectTicketTypesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingListProjectTicketTypesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingListProjectTicketTypesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingListProjectTicketTypesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingListProjectTicketTypesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingListProjectTicketTypesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingTicketTypePaginated>() {})
                            .thenApply(res::withTicketingTicketTypePaginated);
                } else {
