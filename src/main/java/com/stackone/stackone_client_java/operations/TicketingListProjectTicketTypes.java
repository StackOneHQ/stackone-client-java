...
public class TicketingListProjectTicketTypes {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListProjectTicketTypesRequest request) throws Exception {
        ...
        @Override
        public TicketingListProjectTicketTypesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TicketingTicketTypePaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingTicketTypePaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
