...
public class HrisListShiftsOperation implements RequestOperation<HrisListShiftsRequest, HrisListShiftsResponse> {
    ...
    public HrisListShiftsOperation(
    ...
    public HttpRequest buildRequest(HrisListShiftsRequest request) throws Exception {
