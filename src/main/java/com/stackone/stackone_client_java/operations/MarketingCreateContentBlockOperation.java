...
public class MarketingCreateContentBlockOperation implements RequestOperation<MarketingCreateContentBlockRequest, MarketingCreateContentBlockResponse> {
    ...
    public MarketingCreateContentBlockOperation(
    ...
    public HttpRequest buildRequest(MarketingCreateContentBlockRequest request) throws Exception {
