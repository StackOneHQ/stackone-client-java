...
public class AtsGetCandidateNote {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetCandidateNoteRequest, AtsGetCandidateNoteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetCandidateNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetCandidateNoteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetCandidateNoteRequest request) {
        ...
        @Override
        public AtsGetCandidateNoteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetCandidateNoteResponse.Builder resBuilder =
            ...
            AtsGetCandidateNoteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetCandidateNoteRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateNoteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetCandidateNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetCandidateNoteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetCandidateNoteRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateNoteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateNoteResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateNoteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateNoteResponse res = resBuilder.build();
