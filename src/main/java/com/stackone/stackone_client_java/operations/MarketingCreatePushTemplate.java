...
public class MarketingCreatePushTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingCreatePushTemplateRequest, MarketingCreatePushTemplateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingCreatePushTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MarketingCreatePushTemplateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingCreatePushTemplateRequest request) {
        ...
        @Override
        public MarketingCreatePushTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingCreatePushTemplateResponse.Builder resBuilder =
            ...
            MarketingCreatePushTemplateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingCreatePushTemplateRequest, com.stackone.stackone_client_java.models.operations.async.MarketingCreatePushTemplateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingCreatePushTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MarketingCreatePushTemplateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingCreatePushTemplateRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingCreatePushTemplateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingCreatePushTemplateResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingCreatePushTemplateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingCreatePushTemplateResponse res = resBuilder.build();
