...
public class LmsListCategoriesOperation implements RequestOperation<LmsListCategoriesRequest, LmsListCategoriesResponse> {
    ...
    public LmsListCategoriesOperation(
    ...
    public HttpRequest buildRequest(LmsListCategoriesRequest request) throws Exception {
