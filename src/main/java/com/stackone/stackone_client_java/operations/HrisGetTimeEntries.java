...
public class HrisGetTimeEntries {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetTimeEntriesRequest, HrisGetTimeEntriesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetTimeEntriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetTimeEntriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetTimeEntriesRequest request) {
        ...
        @Override
        public HrisGetTimeEntriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetTimeEntriesResponse.Builder resBuilder =
            ...
            HrisGetTimeEntriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTimeEntriesResult(Utils.unmarshal(response, new TypeReference<TimeEntriesResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetTimeEntriesRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetTimeEntriesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetTimeEntriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetTimeEntriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetTimeEntriesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetTimeEntriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetTimeEntriesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetTimeEntriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetTimeEntriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TimeEntriesResult>() {})
                            .thenApply(res::withTimeEntriesResult);
                } else {
