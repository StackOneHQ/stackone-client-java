...
public class HrisGetTimeEntries {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetTimeEntriesRequest request) throws Exception {
        ...
        @Override
        public HrisGetTimeEntriesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TimeEntriesResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTimeEntriesResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
