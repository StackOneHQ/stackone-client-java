...
public class TicketingListTickets {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListTicketsRequest request) throws Exception {
        ...
        @Override
        public TicketingListTicketsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TicketingTicketsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingTicketsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
