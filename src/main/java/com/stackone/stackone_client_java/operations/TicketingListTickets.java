...
public class TicketingListTickets {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingListTicketsRequest, TicketingListTicketsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingListTicketsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListTicketsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListTicketsRequest request) {
        ...
        @Override
        public TicketingListTicketsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingListTicketsResponse.Builder resBuilder =
            ...
            TicketingListTicketsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingTicketsPaginated(Utils.unmarshal(response, new TypeReference<TicketingTicketsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingListTicketsRequest, com.stackone.stackone_client_java.models.operations.async.TicketingListTicketsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingListTicketsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListTicketsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingListTicketsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingListTicketsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingListTicketsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingListTicketsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingListTicketsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingTicketsPaginated>() {})
                            .thenApply(res::withTicketingTicketsPaginated);
                } else {
