...
public class AtsGetApplicationOfferOperation implements RequestOperation<AtsGetApplicationOfferRequest, AtsGetApplicationOfferResponse> {
    ...
    public AtsGetApplicationOfferOperation(
    ...
    public HttpRequest buildRequest(AtsGetApplicationOfferRequest request) throws Exception {
