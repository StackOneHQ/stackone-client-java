...
public class TicketingListTicketStatuses {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingListTicketStatusesRequest, TicketingListTicketStatusesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingListTicketStatusesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListTicketStatusesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListTicketStatusesRequest request) {
        ...
        @Override
        public TicketingListTicketStatusesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingListTicketStatusesResponse.Builder resBuilder =
            ...
            TicketingListTicketStatusesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingTicketStatusesPaginated(Utils.unmarshal(response, new TypeReference<TicketingTicketStatusesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingListTicketStatusesRequest, com.stackone.stackone_client_java.models.operations.async.TicketingListTicketStatusesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingListTicketStatusesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListTicketStatusesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingListTicketStatusesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingListTicketStatusesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingListTicketStatusesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingListTicketStatusesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingListTicketStatusesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingTicketStatusesPaginated>() {})
                            .thenApply(res::withTicketingTicketStatusesPaginated);
                } else {
