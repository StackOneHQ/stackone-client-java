...
public class TicketingListTicketStatuses {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListTicketStatusesRequest request) throws Exception {
        ...
        @Override
        public TicketingListTicketStatusesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TicketingTicketStatusesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingTicketStatusesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
