...
public class AtsGetRejectedReasonOperation implements RequestOperation<AtsGetRejectedReasonRequest, AtsGetRejectedReasonResponse> {
    ...
    public AtsGetRejectedReasonOperation(
    ...
    public HttpRequest buildRequest(AtsGetRejectedReasonRequest request) throws Exception {
