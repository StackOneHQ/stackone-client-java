...
public class AtsListAssessmentsPackagesOperation implements RequestOperation<AtsListAssessmentsPackagesRequest, AtsListAssessmentsPackagesResponse> {
    ...
    public AtsListAssessmentsPackagesOperation(
    ...
    public HttpRequest buildRequest(AtsListAssessmentsPackagesRequest request) throws Exception {
