...
public class HrisGetEmployeeTask {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeeTaskRequest request) throws Exception {
        ...
        @Override
        public HrisGetEmployeeTaskResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TaskResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTaskResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
