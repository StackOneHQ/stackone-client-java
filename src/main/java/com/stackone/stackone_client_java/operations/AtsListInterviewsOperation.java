...
public class AtsListInterviewsOperation implements RequestOperation<AtsListInterviewsRequest, AtsListInterviewsResponse> {
    ...
    public AtsListInterviewsOperation(
    ...
    public HttpRequest buildRequest(AtsListInterviewsRequest request) throws Exception {
