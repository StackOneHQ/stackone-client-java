...
public class MessagingCreateConversation {
    ...
    public static class Sync extends Base
            implements RequestOperation<MessagingCreateConversationRequest, MessagingCreateConversationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MessagingCreateConversationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MessagingCreateConversationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingCreateConversationRequest request) {
        ...
        @Override
        public MessagingCreateConversationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MessagingCreateConversationResponse.Builder resBuilder =
            ...
            MessagingCreateConversationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MessagingCreateConversationRequest, com.stackone.stackone_client_java.models.operations.async.MessagingCreateConversationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MessagingCreateConversationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MessagingCreateConversationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MessagingCreateConversationRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MessagingCreateConversationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MessagingCreateConversationResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MessagingCreateConversationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MessagingCreateConversationResponse res = resBuilder.build();
