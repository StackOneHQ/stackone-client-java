...
public class HrisGetEmployeeDocumentCategoryOperation implements RequestOperation<HrisGetEmployeeDocumentCategoryRequest, HrisGetEmployeeDocumentCategoryResponse> {
    ...
    public HrisGetEmployeeDocumentCategoryOperation(
    ...
    public HttpRequest buildRequest(HrisGetEmployeeDocumentCategoryRequest request) throws Exception {
