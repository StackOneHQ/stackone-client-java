...
public class HrisUpdateEmployeeWorkEligibilityRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisUpdateEmployeeWorkEligibilityRequestRequest, HrisUpdateEmployeeWorkEligibilityRequestResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisUpdateEmployeeWorkEligibilityRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisUpdateEmployeeWorkEligibilityRequestRequest.class, new TypeReference<HrisUpdateEmployeeWorkEligibilityRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisUpdateEmployeeWorkEligibilityRequestRequest request) throws Exception {
        ...
        @Override
        public HrisUpdateEmployeeWorkEligibilityRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisUpdateEmployeeWorkEligibilityRequestResponse.Builder resBuilder =
            ...
            HrisUpdateEmployeeWorkEligibilityRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisUpdateEmployeeWorkEligibilityRequestRequest, com.stackone.stackone_client_java.models.operations.async.HrisUpdateEmployeeWorkEligibilityRequestResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisUpdateEmployeeWorkEligibilityRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisUpdateEmployeeWorkEligibilityRequestRequest.class, new TypeReference<HrisUpdateEmployeeWorkEligibilityRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisUpdateEmployeeWorkEligibilityRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisUpdateEmployeeWorkEligibilityRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisUpdateEmployeeWorkEligibilityRequestResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisUpdateEmployeeWorkEligibilityRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisUpdateEmployeeWorkEligibilityRequestResponse res = resBuilder.build();
