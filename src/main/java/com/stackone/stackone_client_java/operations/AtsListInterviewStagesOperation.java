...
public class AtsListInterviewStagesOperation implements RequestOperation<AtsListInterviewStagesRequest, AtsListInterviewStagesResponse> {
    ...
    public AtsListInterviewStagesOperation(
    ...
    public HttpRequest buildRequest(AtsListInterviewStagesRequest request) throws Exception {
