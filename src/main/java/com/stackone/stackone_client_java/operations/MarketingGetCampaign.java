...
public class MarketingGetCampaign {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingGetCampaignRequest, MarketingGetCampaignResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingGetCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingGetCampaignRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingGetCampaignRequest request) {
        ...
        @Override
        public MarketingGetCampaignResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingGetCampaignResponse.Builder resBuilder =
            ...
            MarketingGetCampaignResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCampaignResult(Utils.unmarshal(response, new TypeReference<CampaignResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingGetCampaignRequest, com.stackone.stackone_client_java.models.operations.async.MarketingGetCampaignResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingGetCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingGetCampaignRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingGetCampaignRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingGetCampaignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingGetCampaignResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingGetCampaignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingGetCampaignResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CampaignResult>() {})
                            .thenApply(res::withCampaignResult);
                } else {
