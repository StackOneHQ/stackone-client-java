...
public class MarketingGetCampaign {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingGetCampaignRequest request) throws Exception {
        ...
        @Override
        public MarketingGetCampaignResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CampaignResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCampaignResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
