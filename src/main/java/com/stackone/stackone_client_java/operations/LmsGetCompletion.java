...
public class LmsGetCompletion {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsGetCompletionRequest, LmsGetCompletionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsGetCompletionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetCompletionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetCompletionRequest request) {
        ...
        @Override
        public LmsGetCompletionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsGetCompletionResponse.Builder resBuilder =
            ...
            LmsGetCompletionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsGetCompletionRequest, com.stackone.stackone_client_java.models.operations.async.LmsGetCompletionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsGetCompletionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetCompletionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsGetCompletionRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsGetCompletionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsGetCompletionResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsGetCompletionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsGetCompletionResponse res = resBuilder.build();
