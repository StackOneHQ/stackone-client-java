...
public class MessagingGetAttachment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingGetAttachmentRequest request) throws Exception {
        ...
        @Override
        public MessagingGetAttachmentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MessagingAttachmentResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMessagingAttachmentResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
