...
public class MessagingGetAttachment {
    ...
    public static class Sync extends Base
            implements RequestOperation<MessagingGetAttachmentRequest, MessagingGetAttachmentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MessagingGetAttachmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingGetAttachmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingGetAttachmentRequest request) {
        ...
        @Override
        public MessagingGetAttachmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MessagingGetAttachmentResponse.Builder resBuilder =
            ...
            MessagingGetAttachmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingAttachmentResult(Utils.unmarshal(response, new TypeReference<MessagingAttachmentResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MessagingGetAttachmentRequest, com.stackone.stackone_client_java.models.operations.async.MessagingGetAttachmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MessagingGetAttachmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingGetAttachmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MessagingGetAttachmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MessagingGetAttachmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MessagingGetAttachmentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MessagingGetAttachmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MessagingGetAttachmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MessagingAttachmentResult>() {})
                            .thenApply(res::withMessagingAttachmentResult);
                } else {
