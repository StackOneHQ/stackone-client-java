...
public class HrisGetTimeOffRequestOperation implements RequestOperation<HrisGetTimeOffRequestRequest, HrisGetTimeOffRequestResponse> {
    ...
    public HrisGetTimeOffRequestOperation(
    ...
    public HttpRequest buildRequest(HrisGetTimeOffRequestRequest request) throws Exception {
