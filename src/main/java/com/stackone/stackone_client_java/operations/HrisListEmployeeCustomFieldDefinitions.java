...
public class HrisListEmployeeCustomFieldDefinitions {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListEmployeeCustomFieldDefinitionsRequest, HrisListEmployeeCustomFieldDefinitionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListEmployeeCustomFieldDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmployeeCustomFieldDefinitionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeCustomFieldDefinitionsRequest request) {
        ...
        @Override
        public HrisListEmployeeCustomFieldDefinitionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListEmployeeCustomFieldDefinitionsResponse.Builder resBuilder =
            ...
            HrisListEmployeeCustomFieldDefinitionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListEmployeeCustomFieldDefinitionsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeCustomFieldDefinitionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListEmployeeCustomFieldDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmployeeCustomFieldDefinitionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListEmployeeCustomFieldDefinitionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeCustomFieldDefinitionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeCustomFieldDefinitionsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeCustomFieldDefinitionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeCustomFieldDefinitionsResponse res = resBuilder.build();
