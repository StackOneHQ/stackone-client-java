...
public class MarketingCreateOmniChannelTemplateOperation implements RequestOperation<MarketingCreateOmniChannelTemplateRequest, MarketingCreateOmniChannelTemplateResponse> {
    ...
    public MarketingCreateOmniChannelTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingCreateOmniChannelTemplateRequest request) throws Exception {
