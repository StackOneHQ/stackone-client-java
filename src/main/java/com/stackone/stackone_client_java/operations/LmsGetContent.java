...
public class LmsGetContent {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsGetContentRequest, LmsGetContentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsGetContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetContentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetContentRequest request) {
        ...
        @Override
        public LmsGetContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsGetContentResponse.Builder resBuilder =
            ...
            LmsGetContentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContentResult(Utils.unmarshal(response, new TypeReference<ContentResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsGetContentRequest, com.stackone.stackone_client_java.models.operations.async.LmsGetContentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsGetContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetContentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsGetContentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsGetContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsGetContentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsGetContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsGetContentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContentResult>() {})
                            .thenApply(res::withContentResult);
                } else {
