...
public class LmsGetContent {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetContentRequest request) throws Exception {
        ...
        @Override
        public LmsGetContentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ContentResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withContentResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
