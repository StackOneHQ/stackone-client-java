...
public class StackoneAuthenticateConnectSessionOperation implements RequestOperation<ConnectSessionAuthenticate, StackoneAuthenticateConnectSessionResponse> {
    ...
    public StackoneAuthenticateConnectSessionOperation(
    ...
    public HttpRequest buildRequest(ConnectSessionAuthenticate request) throws Exception {
