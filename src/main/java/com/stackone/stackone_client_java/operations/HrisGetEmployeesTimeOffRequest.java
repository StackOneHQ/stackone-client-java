...
public class HrisGetEmployeesTimeOffRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetEmployeesTimeOffRequestRequest, HrisGetEmployeesTimeOffRequestResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetEmployeesTimeOffRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetEmployeesTimeOffRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeesTimeOffRequestRequest request) {
        ...
        @Override
        public HrisGetEmployeesTimeOffRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetEmployeesTimeOffRequestResponse.Builder resBuilder =
            ...
            HrisGetEmployeesTimeOffRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTimeOffResult(Utils.unmarshal(response, new TypeReference<TimeOffResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetEmployeesTimeOffRequestRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeesTimeOffRequestResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetEmployeesTimeOffRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetEmployeesTimeOffRequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetEmployeesTimeOffRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeesTimeOffRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeesTimeOffRequestResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeesTimeOffRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeesTimeOffRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TimeOffResult>() {})
                            .thenApply(res::withTimeOffResult);
                } else {
