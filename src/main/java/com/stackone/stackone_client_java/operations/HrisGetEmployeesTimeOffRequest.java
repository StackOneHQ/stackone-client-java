...
public class HrisGetEmployeesTimeOffRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeesTimeOffRequestRequest request) throws Exception {
        ...
        @Override
        public HrisGetEmployeesTimeOffRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TimeOffResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTimeOffResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
