...
public class AtsMoveApplication {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsMoveApplicationRequest request) throws Exception {
        ...
        @Override
        public AtsMoveApplicationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MoveApplicationResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMoveApplicationResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
