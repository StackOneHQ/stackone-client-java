...
public class AtsMoveApplication {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsMoveApplicationRequest, AtsMoveApplicationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsMoveApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsMoveApplicationRequest.class, new TypeReference<AtsMoveApplicationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsMoveApplicationRequest request) {
        ...
        @Override
        public AtsMoveApplicationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsMoveApplicationResponse.Builder resBuilder =
            ...
            AtsMoveApplicationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMoveApplicationResult(Utils.unmarshal(response, new TypeReference<MoveApplicationResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsMoveApplicationRequest, com.stackone.stackone_client_java.models.operations.async.AtsMoveApplicationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsMoveApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsMoveApplicationRequest.class, new TypeReference<AtsMoveApplicationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsMoveApplicationRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsMoveApplicationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsMoveApplicationResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsMoveApplicationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsMoveApplicationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MoveApplicationResult>() {})
                            .thenApply(res::withMoveApplicationResult);
                } else {
