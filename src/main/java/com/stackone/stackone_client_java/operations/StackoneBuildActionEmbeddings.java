...
public class StackoneBuildActionEmbeddings {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "stackone_build_action_embeddings",
    ...
    public static class Sync extends Base
            implements RequestOperation<ActionBuildDto, StackoneBuildActionEmbeddingsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ActionBuildDto request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ActionBuildDto>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ActionBuildDto request) {
        ...
        @Override
        public StackoneBuildActionEmbeddingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneBuildActionEmbeddingsResponse.Builder resBuilder =
            ...
            StackoneBuildActionEmbeddingsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withActionBuildResponseDto(Utils.unmarshal(response, new TypeReference<ActionBuildResponseDto>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ActionBuildDto, com.stackone.stackone_client_java.models.operations.async.StackoneBuildActionEmbeddingsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ActionBuildDto request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ActionBuildDto>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ActionBuildDto request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneBuildActionEmbeddingsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneBuildActionEmbeddingsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneBuildActionEmbeddingsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneBuildActionEmbeddingsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ActionBuildResponseDto>() {})
                            .thenApply(res::withActionBuildResponseDto);
                } else {
