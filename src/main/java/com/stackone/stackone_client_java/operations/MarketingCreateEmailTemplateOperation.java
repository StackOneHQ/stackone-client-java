...
public class MarketingCreateEmailTemplateOperation implements RequestOperation<MarketingCreateEmailTemplateRequest, MarketingCreateEmailTemplateResponse> {
    ...
    public MarketingCreateEmailTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingCreateEmailTemplateRequest request) throws Exception {
