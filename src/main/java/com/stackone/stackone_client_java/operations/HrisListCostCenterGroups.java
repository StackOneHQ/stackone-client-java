...
public class HrisListCostCenterGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListCostCenterGroupsRequest, HrisListCostCenterGroupsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListCostCenterGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListCostCenterGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListCostCenterGroupsRequest request) {
        ...
        @Override
        public HrisListCostCenterGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListCostCenterGroupsResponse.Builder resBuilder =
            ...
            HrisListCostCenterGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISCostCenterPaginated(Utils.unmarshal(response, new TypeReference<HRISCostCenterPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListCostCenterGroupsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListCostCenterGroupsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListCostCenterGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListCostCenterGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListCostCenterGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListCostCenterGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListCostCenterGroupsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListCostCenterGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListCostCenterGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISCostCenterPaginated>() {})
                            .thenApply(res::withHRISCostCenterPaginated);
                } else {
