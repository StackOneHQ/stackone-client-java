...
public class HrisListCostCenterGroups {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListCostCenterGroupsRequest request) throws Exception {
        ...
        @Override
        public HrisListCostCenterGroupsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HRISCostCenterPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHRISCostCenterPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
