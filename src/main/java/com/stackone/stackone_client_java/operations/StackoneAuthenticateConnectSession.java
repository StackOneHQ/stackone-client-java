...
public class StackoneAuthenticateConnectSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<ConnectSessionAuthenticate, StackoneAuthenticateConnectSessionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ConnectSessionAuthenticate request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ConnectSessionAuthenticate>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectSessionAuthenticate request) {
        ...
        @Override
        public StackoneAuthenticateConnectSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneAuthenticateConnectSessionResponse.Builder resBuilder =
            ...
            StackoneAuthenticateConnectSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConnectSession(Utils.unmarshal(response, new TypeReference<ConnectSession>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ConnectSessionAuthenticate, com.stackone.stackone_client_java.models.operations.async.StackoneAuthenticateConnectSessionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ConnectSessionAuthenticate request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ConnectSessionAuthenticate>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ConnectSessionAuthenticate request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneAuthenticateConnectSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneAuthenticateConnectSessionResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneAuthenticateConnectSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneAuthenticateConnectSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ConnectSession>() {})
                            .thenApply(res::withConnectSession);
                } else {
