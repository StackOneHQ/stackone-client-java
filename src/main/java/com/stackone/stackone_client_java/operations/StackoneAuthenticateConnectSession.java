...
public class StackoneAuthenticateConnectSession {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectSessionAuthenticate request) throws Exception {
        ...
        @Override
        public StackoneAuthenticateConnectSessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ConnectSession out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withConnectSession(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
