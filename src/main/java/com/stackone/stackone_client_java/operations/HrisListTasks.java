...
public class HrisListTasks {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListTasksRequest, HrisListTasksResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListTasksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListTasksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListTasksRequest request) {
        ...
        @Override
        public HrisListTasksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListTasksResponse.Builder resBuilder =
            ...
            HrisListTasksResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListTasksRequest, com.stackone.stackone_client_java.models.operations.async.HrisListTasksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListTasksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListTasksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListTasksRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListTasksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListTasksResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListTasksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListTasksResponse res = resBuilder.build();
