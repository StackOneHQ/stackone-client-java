...
public class AtsOrderAssessmentsRequestOperation implements RequestOperation<AtsOrderAssessmentsRequestRequest, AtsOrderAssessmentsRequestResponse> {
    ...
    public AtsOrderAssessmentsRequestOperation(
    ...
    public HttpRequest buildRequest(AtsOrderAssessmentsRequestRequest request) throws Exception {
