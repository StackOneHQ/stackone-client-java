...
public class TicketingGetAttachment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingGetAttachmentRequest request) throws Exception {
        ...
        @Override
        public TicketingGetAttachmentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TicketingAttachmentResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingAttachmentResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
