...
public class TicketingGetAttachment {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingGetAttachmentRequest, TicketingGetAttachmentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingGetAttachmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetAttachmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingGetAttachmentRequest request) {
        ...
        @Override
        public TicketingGetAttachmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingGetAttachmentResponse.Builder resBuilder =
            ...
            TicketingGetAttachmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingAttachmentResult(Utils.unmarshal(response, new TypeReference<TicketingAttachmentResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingGetAttachmentRequest, com.stackone.stackone_client_java.models.operations.async.TicketingGetAttachmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingGetAttachmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetAttachmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingGetAttachmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingGetAttachmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingGetAttachmentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingGetAttachmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingGetAttachmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingAttachmentResult>() {})
                            .thenApply(res::withTicketingAttachmentResult);
                } else {
