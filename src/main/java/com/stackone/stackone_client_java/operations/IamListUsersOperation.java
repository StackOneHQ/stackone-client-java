...
public class IamListUsersOperation implements RequestOperation<IamListUsersRequest, IamListUsersResponse> {
    ...
    public HttpRequest buildRequest(IamListUsersRequest request) throws Exception {
