...
public class LmsListCoursesOperation implements RequestOperation<LmsListCoursesRequest, LmsListCoursesResponse> {
    ...
    public LmsListCoursesOperation(
    ...
    public HttpRequest buildRequest(LmsListCoursesRequest request) throws Exception {
