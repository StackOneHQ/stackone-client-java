...
public class MarketingCreateContentBlock {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingCreateContentBlockRequest, MarketingCreateContentBlockResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingCreateContentBlockRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MarketingCreateContentBlockRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingCreateContentBlockRequest request) {
        ...
        @Override
        public MarketingCreateContentBlockResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingCreateContentBlockResponse.Builder resBuilder =
            ...
            MarketingCreateContentBlockResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingCreateContentBlockRequest, com.stackone.stackone_client_java.models.operations.async.MarketingCreateContentBlockResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingCreateContentBlockRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MarketingCreateContentBlockRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingCreateContentBlockRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingCreateContentBlockResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingCreateContentBlockResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingCreateContentBlockResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingCreateContentBlockResponse res = resBuilder.build();
