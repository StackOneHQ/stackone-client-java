...
public class HrisGetCostCenterGroupOperation implements RequestOperation<HrisGetCostCenterGroupRequest, HrisGetCostCenterGroupResponse> {
    ...
    public HrisGetCostCenterGroupOperation(
    ...
    public HttpRequest buildRequest(HrisGetCostCenterGroupRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(HrisGetCostCenterGroupRequest request) throws Exception {
    ...
    @Override
    public HrisGetCostCenterGroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                HRISCostCenterResult out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withHRISCostCenterResult(out);
                return res;
            } else {
                throw new SDKError(
                    response, 
