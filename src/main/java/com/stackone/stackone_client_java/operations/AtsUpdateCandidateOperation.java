...
public class AtsUpdateCandidateOperation implements RequestOperation<AtsUpdateCandidateRequest, AtsUpdateCandidateResponse> {
    ...
    public AtsUpdateCandidateOperation(
    ...
    public HttpRequest buildRequest(AtsUpdateCandidateRequest request) throws Exception {
