...
public class IamGetGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<IamGetGroupRequest, IamGetGroupResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IamGetGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamGetGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamGetGroupRequest request) {
        ...
        @Override
        public IamGetGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IamGetGroupResponse.Builder resBuilder =
                    IamGetGroupResponse
                            .builder()
            ...
            IamGetGroupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIamGroupResult(Utils.unmarshal(response, new TypeReference<IamGroupResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IamGetGroupRequest, com.stackone.stackone_client_java.models.operations.async.IamGetGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IamGetGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamGetGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IamGetGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.IamGetGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.IamGetGroupResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.IamGetGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.IamGetGroupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<IamGroupResult>() {})
                            .thenApply(res::withIamGroupResult);
                } else {
