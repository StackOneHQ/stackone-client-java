...
public class AtsGetApplicationCustomFieldDefinitionOperation implements RequestOperation<AtsGetApplicationCustomFieldDefinitionRequest, AtsGetApplicationCustomFieldDefinitionResponse> {
    ...
    public AtsGetApplicationCustomFieldDefinitionOperation(
    ...
    public HttpRequest buildRequest(AtsGetApplicationCustomFieldDefinitionRequest request) throws Exception {
