...
public class MarketingGetContentBlock {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingGetContentBlockRequest request) throws Exception {
        ...
        @Override
        public MarketingGetContentBlockResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ContentBlockResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withContentBlockResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
