...
public class MarketingGetContentBlock {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingGetContentBlockRequest, MarketingGetContentBlockResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingGetContentBlockRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingGetContentBlockRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingGetContentBlockRequest request) {
        ...
        @Override
        public MarketingGetContentBlockResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingGetContentBlockResponse.Builder resBuilder =
            ...
            MarketingGetContentBlockResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContentBlockResult(Utils.unmarshal(response, new TypeReference<ContentBlockResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingGetContentBlockRequest, com.stackone.stackone_client_java.models.operations.async.MarketingGetContentBlockResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingGetContentBlockRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingGetContentBlockRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingGetContentBlockRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingGetContentBlockResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingGetContentBlockResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingGetContentBlockResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingGetContentBlockResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContentBlockResult>() {})
                            .thenApply(res::withContentBlockResult);
                } else {
