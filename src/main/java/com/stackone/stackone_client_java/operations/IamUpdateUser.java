...
public class IamUpdateUser {
    ...
    public static class Sync extends Base
            implements RequestOperation<IamUpdateUserRequest, IamUpdateUserResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(IamUpdateUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamUpdateUserRequest.class, new TypeReference<IamUpdateUserRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamUpdateUserRequest request) throws Exception {
        ...
        @Override
        public IamUpdateUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IamUpdateUserResponse.Builder resBuilder =
            ...
            IamUpdateUserResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IamUpdateUserRequest, com.stackone.stackone_client_java.models.operations.async.IamUpdateUserResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IamUpdateUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamUpdateUserRequest.class, new TypeReference<IamUpdateUserRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IamUpdateUserRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.IamUpdateUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.IamUpdateUserResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.IamUpdateUserResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.IamUpdateUserResponse res = resBuilder.build();
