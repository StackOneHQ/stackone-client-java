...
public class LmsCreateUserCompletionOperation implements RequestOperation<LmsCreateUserCompletionRequest, LmsCreateUserCompletionResponse> {
    ...
    public LmsCreateUserCompletionOperation(
    ...
    public HttpRequest buildRequest(LmsCreateUserCompletionRequest request) throws Exception {
