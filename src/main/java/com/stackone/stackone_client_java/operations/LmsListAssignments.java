...
public class LmsListAssignments {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsListAssignmentsRequest, LmsListAssignmentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsListAssignmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListAssignmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListAssignmentsRequest request) {
        ...
        @Override
        public LmsListAssignmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsListAssignmentsResponse.Builder resBuilder =
            ...
            LmsListAssignmentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsListAssignmentsRequest, com.stackone.stackone_client_java.models.operations.async.LmsListAssignmentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsListAssignmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListAssignmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsListAssignmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsListAssignmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsListAssignmentsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsListAssignmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsListAssignmentsResponse res = resBuilder.build();
