...
public class MarketingListCampaignsOperation implements RequestOperation<MarketingListCampaignsRequest, MarketingListCampaignsResponse> {
    ...
    public MarketingListCampaignsOperation(
    ...
    public HttpRequest buildRequest(MarketingListCampaignsRequest request) throws Exception {
