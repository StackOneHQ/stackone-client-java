...
public class AccountingGetCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingGetCompanyRequest, AccountingGetCompanyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingGetCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGetCompanyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingGetCompanyRequest request) {
        ...
        @Override
        public AccountingGetCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingGetCompanyResponse.Builder resBuilder =
            ...
            AccountingGetCompanyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingCompanyResult(Utils.unmarshal(response, new TypeReference<AccountingCompanyResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingGetCompanyRequest, com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingGetCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGetCompanyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingGetCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingCompanyResult>() {})
                            .thenApply(res::withAccountingCompanyResult);
                } else {
