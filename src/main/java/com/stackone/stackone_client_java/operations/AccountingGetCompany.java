...
public class AccountingGetCompany {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingGetCompanyRequest request) throws Exception {
        ...
        @Override
        public AccountingGetCompanyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingCompanyResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingCompanyResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
