...
public class AtsListJobApplicationStages {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListJobApplicationStagesRequest, AtsListJobApplicationStagesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListJobApplicationStagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListJobApplicationStagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListJobApplicationStagesRequest request) {
        ...
        @Override
        public AtsListJobApplicationStagesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListJobApplicationStagesResponse.Builder resBuilder =
            ...
            AtsListJobApplicationStagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withApplicationStagesPaginated(Utils.unmarshal(response, new TypeReference<ApplicationStagesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListJobApplicationStagesRequest, com.stackone.stackone_client_java.models.operations.async.AtsListJobApplicationStagesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListJobApplicationStagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListJobApplicationStagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListJobApplicationStagesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListJobApplicationStagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListJobApplicationStagesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListJobApplicationStagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListJobApplicationStagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ApplicationStagesPaginated>() {})
                            .thenApply(res::withApplicationStagesPaginated);
                } else {
