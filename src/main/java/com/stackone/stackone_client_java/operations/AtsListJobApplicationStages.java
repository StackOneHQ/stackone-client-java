...
public class AtsListJobApplicationStages {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListJobApplicationStagesRequest request) throws Exception {
        ...
        @Override
        public AtsListJobApplicationStagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ApplicationStagesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withApplicationStagesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
