...
public class AtsListJobPostings {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListJobPostingsRequest request) throws Exception {
        ...
        @Override
        public AtsListJobPostingsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    JobPostingsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withJobPostingsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
