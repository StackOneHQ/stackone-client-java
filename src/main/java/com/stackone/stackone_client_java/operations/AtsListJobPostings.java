...
public class AtsListJobPostings {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListJobPostingsRequest, AtsListJobPostingsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListJobPostingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListJobPostingsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListJobPostingsRequest request) {
        ...
        @Override
        public AtsListJobPostingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListJobPostingsResponse.Builder resBuilder =
            ...
            AtsListJobPostingsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withJobPostingsPaginated(Utils.unmarshal(response, new TypeReference<JobPostingsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListJobPostingsRequest, com.stackone.stackone_client_java.models.operations.async.AtsListJobPostingsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListJobPostingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListJobPostingsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListJobPostingsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListJobPostingsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListJobPostingsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListJobPostingsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListJobPostingsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<JobPostingsPaginated>() {})
                            .thenApply(res::withJobPostingsPaginated);
                } else {
