...
public class StackoneUpdateAccountOperation implements RequestOperation<StackoneUpdateAccountRequest, StackoneUpdateAccountResponse> {
    ...
    public StackoneUpdateAccountOperation(
    ...
    public HttpRequest buildRequest(StackoneUpdateAccountRequest request) throws Exception {
