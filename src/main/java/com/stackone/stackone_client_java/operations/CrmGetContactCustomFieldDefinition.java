...
public class CrmGetContactCustomFieldDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmGetContactCustomFieldDefinitionRequest, CrmGetContactCustomFieldDefinitionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmGetContactCustomFieldDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmGetContactCustomFieldDefinitionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmGetContactCustomFieldDefinitionRequest request) {
        ...
        @Override
        public CrmGetContactCustomFieldDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmGetContactCustomFieldDefinitionResponse.Builder resBuilder =
            ...
            CrmGetContactCustomFieldDefinitionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmGetContactCustomFieldDefinitionRequest, com.stackone.stackone_client_java.models.operations.async.CrmGetContactCustomFieldDefinitionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmGetContactCustomFieldDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmGetContactCustomFieldDefinitionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmGetContactCustomFieldDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.CrmGetContactCustomFieldDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.CrmGetContactCustomFieldDefinitionResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.CrmGetContactCustomFieldDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.CrmGetContactCustomFieldDefinitionResponse res = resBuilder.build();
