...
public class MarketingCreateInAppTemplateOperation implements RequestOperation<MarketingCreateInAppTemplateRequest, MarketingCreateInAppTemplateResponse> {
    ...
    public MarketingCreateInAppTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingCreateInAppTemplateRequest request) throws Exception {
