...
public class StackoneListStepLogs {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneListStepLogsRequest request) throws Exception {
        ...
        @Override
        public StackoneListStepLogsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    StepLogsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withStepLogsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
