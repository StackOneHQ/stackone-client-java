...
public class StackoneListStepLogs {
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneListStepLogsRequest, StackoneListStepLogsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneListStepLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneListStepLogsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneListStepLogsRequest request) {
        ...
        @Override
        public StackoneListStepLogsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneListStepLogsResponse.Builder resBuilder =
            ...
            StackoneListStepLogsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStepLogsPaginated(Utils.unmarshal(response, new TypeReference<StepLogsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneListStepLogsRequest, com.stackone.stackone_client_java.models.operations.async.StackoneListStepLogsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StackoneListStepLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneListStepLogsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StackoneListStepLogsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneListStepLogsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneListStepLogsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneListStepLogsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneListStepLogsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<StepLogsPaginated>() {})
                            .thenApply(res::withStepLogsPaginated);
                } else {
