...
public class AccountingListCompanies {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingListCompaniesRequest request) throws Exception {
        ...
        @Override
        public AccountingListCompaniesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingCompaniesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingCompaniesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
