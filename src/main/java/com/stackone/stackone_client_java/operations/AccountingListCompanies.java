...
public class AccountingListCompanies {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingListCompaniesRequest, AccountingListCompaniesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingListCompaniesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingListCompaniesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingListCompaniesRequest request) {
        ...
        @Override
        public AccountingListCompaniesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingListCompaniesResponse.Builder resBuilder =
            ...
            AccountingListCompaniesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingCompaniesPaginated(Utils.unmarshal(response, new TypeReference<AccountingCompaniesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingListCompaniesRequest, com.stackone.stackone_client_java.models.operations.async.AccountingListCompaniesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingListCompaniesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingListCompaniesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingListCompaniesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AccountingListCompaniesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AccountingListCompaniesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AccountingListCompaniesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AccountingListCompaniesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingCompaniesPaginated>() {})
                            .thenApply(res::withAccountingCompaniesPaginated);
                } else {
