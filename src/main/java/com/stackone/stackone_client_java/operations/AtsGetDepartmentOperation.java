...
public class AtsGetDepartmentOperation implements RequestOperation<AtsGetDepartmentRequest, AtsGetDepartmentResponse> {
    ...
    public AtsGetDepartmentOperation(
    ...
    public HttpRequest buildRequest(AtsGetDepartmentRequest request) throws Exception {
