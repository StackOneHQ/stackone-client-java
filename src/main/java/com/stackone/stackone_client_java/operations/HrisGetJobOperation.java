...
public class HrisGetJobOperation implements RequestOperation<HrisGetJobRequest, HrisGetJobResponse> {
    ...
    public HttpRequest buildRequest(HrisGetJobRequest request) throws Exception {
