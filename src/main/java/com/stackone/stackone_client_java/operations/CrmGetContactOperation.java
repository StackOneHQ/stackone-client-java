...
public class CrmGetContactOperation implements RequestOperation<CrmGetContactRequest, CrmGetContactResponse> {
    ...
    public HttpRequest buildRequest(CrmGetContactRequest request) throws Exception {
