...
public class HrisGetEmployeeSkillOperation implements RequestOperation<HrisGetEmployeeSkillRequest, HrisGetEmployeeSkillResponse> {
    ...
    public HrisGetEmployeeSkillOperation(
    ...
    public HttpRequest buildRequest(HrisGetEmployeeSkillRequest request) throws Exception {
