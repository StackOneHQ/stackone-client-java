...
public class AtsGetJobOperation implements RequestOperation<AtsGetJobRequest, AtsGetJobResponse> {
    ...
    public HttpRequest buildRequest(AtsGetJobRequest request) throws Exception {
