...
public class AtsListApplicationNotes {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListApplicationNotesRequest, AtsListApplicationNotesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListApplicationNotesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListApplicationNotesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationNotesRequest request) {
        ...
        @Override
        public AtsListApplicationNotesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListApplicationNotesResponse.Builder resBuilder =
            ...
            AtsListApplicationNotesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withNotesPaginated(Utils.unmarshal(response, new TypeReference<NotesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListApplicationNotesRequest, com.stackone.stackone_client_java.models.operations.async.AtsListApplicationNotesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListApplicationNotesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListApplicationNotesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListApplicationNotesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListApplicationNotesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListApplicationNotesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListApplicationNotesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListApplicationNotesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<NotesPaginated>() {})
                            .thenApply(res::withNotesPaginated);
                } else {
