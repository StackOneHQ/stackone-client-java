...
public class AtsListApplicationNotes {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationNotesRequest request) throws Exception {
        ...
        @Override
        public AtsListApplicationNotesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    NotesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withNotesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
