...
public class HrisGetEmploymentOperation implements RequestOperation<HrisGetEmploymentRequest, HrisGetEmploymentResponse> {
    ...
    public HrisGetEmploymentOperation(
    ...
    public HttpRequest buildRequest(HrisGetEmploymentRequest request) throws Exception {
