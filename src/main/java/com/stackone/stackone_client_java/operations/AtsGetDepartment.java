...
public class AtsGetDepartment {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetDepartmentRequest, AtsGetDepartmentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetDepartmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetDepartmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetDepartmentRequest request) {
        ...
        @Override
        public AtsGetDepartmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetDepartmentResponse.Builder resBuilder =
            ...
            AtsGetDepartmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDepartmentResult(Utils.unmarshal(response, new TypeReference<DepartmentResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetDepartmentRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetDepartmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetDepartmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetDepartmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetDepartmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetDepartmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetDepartmentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetDepartmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetDepartmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DepartmentResult>() {})
                            .thenApply(res::withDepartmentResult);
                } else {
