...
public class AtsGetDepartment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetDepartmentRequest request) throws Exception {
        ...
        @Override
        public AtsGetDepartmentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DepartmentResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDepartmentResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
