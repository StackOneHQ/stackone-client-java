...
public class CrmCreateContactOperation implements RequestOperation<CrmCreateContactRequest, CrmCreateContactResponse> {
    ...
    public CrmCreateContactOperation(
    ...
    public HttpRequest buildRequest(CrmCreateContactRequest request) throws Exception {
