...
public class AtsCreateOffer {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsCreateOfferRequest, AtsCreateOfferResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsCreateOfferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsCreateOfferRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsCreateOfferRequest request) {
        ...
        @Override
        public AtsCreateOfferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsCreateOfferResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsCreateOfferRequest, com.stackone.stackone_client_java.models.operations.async.AtsCreateOfferResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsCreateOfferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsCreateOfferRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsCreateOfferRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsCreateOfferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsCreateOfferResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsCreateOfferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsCreateOfferResponse res = resBuilder.build();
