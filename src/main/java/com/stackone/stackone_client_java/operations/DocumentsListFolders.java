...
public class DocumentsListFolders {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsListFoldersRequest request) throws Exception {
        ...
        @Override
        public DocumentsListFoldersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    FoldersPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withFoldersPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
