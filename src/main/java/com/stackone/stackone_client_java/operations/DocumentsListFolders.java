...
public class DocumentsListFolders {
    ...
    public static class Sync extends Base
            implements RequestOperation<DocumentsListFoldersRequest, DocumentsListFoldersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DocumentsListFoldersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsListFoldersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsListFoldersRequest request) {
        ...
        @Override
        public DocumentsListFoldersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DocumentsListFoldersResponse.Builder resBuilder =
            ...
            DocumentsListFoldersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFoldersPaginated(Utils.unmarshal(response, new TypeReference<FoldersPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DocumentsListFoldersRequest, com.stackone.stackone_client_java.models.operations.async.DocumentsListFoldersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DocumentsListFoldersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DocumentsListFoldersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DocumentsListFoldersRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.DocumentsListFoldersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.DocumentsListFoldersResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.DocumentsListFoldersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.DocumentsListFoldersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FoldersPaginated>() {})
                            .thenApply(res::withFoldersPaginated);
                } else {
