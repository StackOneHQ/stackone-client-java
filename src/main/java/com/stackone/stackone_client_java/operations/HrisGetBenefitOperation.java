...
public class HrisGetBenefitOperation implements RequestOperation<HrisGetBenefitRequest, HrisGetBenefitResponse> {
    ...
    public HrisGetBenefitOperation(
    ...
    public HttpRequest buildRequest(HrisGetBenefitRequest request) throws Exception {
