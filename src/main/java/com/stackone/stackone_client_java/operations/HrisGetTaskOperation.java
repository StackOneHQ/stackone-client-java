...
public class HrisGetTaskOperation implements RequestOperation<HrisGetTaskRequest, HrisGetTaskResponse> {
    ...
    public HttpRequest buildRequest(HrisGetTaskRequest request) throws Exception {
