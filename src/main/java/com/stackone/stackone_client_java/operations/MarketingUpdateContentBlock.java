...
public class MarketingUpdateContentBlock {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingUpdateContentBlockRequest, MarketingUpdateContentBlockResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingUpdateContentBlockRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingUpdateContentBlockRequest.class, new TypeReference<MarketingUpdateContentBlockRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingUpdateContentBlockRequest request) {
        ...
        @Override
        public MarketingUpdateContentBlockResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingUpdateContentBlockResponse.Builder resBuilder =
            ...
            MarketingUpdateContentBlockResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingUpdateContentBlockRequest, com.stackone.stackone_client_java.models.operations.async.MarketingUpdateContentBlockResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingUpdateContentBlockRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingUpdateContentBlockRequest.class, new TypeReference<MarketingUpdateContentBlockRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingUpdateContentBlockRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingUpdateContentBlockResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingUpdateContentBlockResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingUpdateContentBlockResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingUpdateContentBlockResponse res = resBuilder.build();
