...
public class AtsListApplicationCustomFieldDefinitions {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListApplicationCustomFieldDefinitionsRequest, AtsListApplicationCustomFieldDefinitionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListApplicationCustomFieldDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListApplicationCustomFieldDefinitionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationCustomFieldDefinitionsRequest request) {
        ...
        @Override
        public AtsListApplicationCustomFieldDefinitionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListApplicationCustomFieldDefinitionsResponse.Builder resBuilder =
            ...
            AtsListApplicationCustomFieldDefinitionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCustomFieldDefinitionsPaginated(Utils.unmarshal(response, new TypeReference<CustomFieldDefinitionsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListApplicationCustomFieldDefinitionsRequest, com.stackone.stackone_client_java.models.operations.async.AtsListApplicationCustomFieldDefinitionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListApplicationCustomFieldDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListApplicationCustomFieldDefinitionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListApplicationCustomFieldDefinitionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListApplicationCustomFieldDefinitionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListApplicationCustomFieldDefinitionsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListApplicationCustomFieldDefinitionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListApplicationCustomFieldDefinitionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CustomFieldDefinitionsPaginated>() {})
                            .thenApply(res::withCustomFieldDefinitionsPaginated);
                } else {
