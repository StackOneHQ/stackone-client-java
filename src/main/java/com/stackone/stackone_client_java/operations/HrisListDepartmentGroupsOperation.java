...
public class HrisListDepartmentGroupsOperation implements RequestOperation<HrisListDepartmentGroupsRequest, HrisListDepartmentGroupsResponse> {
    ...
    public HrisListDepartmentGroupsOperation(
    ...
    public HttpRequest buildRequest(HrisListDepartmentGroupsRequest request) throws Exception {
