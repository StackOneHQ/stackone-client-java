...
public class HrisUpdateEmployeeOperation implements RequestOperation<HrisUpdateEmployeeRequest, HrisUpdateEmployeeResponse> {
    ...
    public HrisUpdateEmployeeOperation(
    ...
    public HttpRequest buildRequest(HrisUpdateEmployeeRequest request) throws Exception {
