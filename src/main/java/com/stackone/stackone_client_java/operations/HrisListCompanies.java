...
public class HrisListCompanies {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListCompaniesRequest, HrisListCompaniesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListCompaniesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListCompaniesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListCompaniesRequest request) {
        ...
        @Override
        public HrisListCompaniesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListCompaniesResponse.Builder resBuilder =
            ...
            HrisListCompaniesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListCompaniesRequest, com.stackone.stackone_client_java.models.operations.async.HrisListCompaniesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListCompaniesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListCompaniesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListCompaniesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListCompaniesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListCompaniesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListCompaniesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListCompaniesResponse res = resBuilder.build();
