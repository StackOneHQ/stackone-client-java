...
public class AtsGetInterview {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetInterviewRequest, AtsGetInterviewResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetInterviewRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetInterviewRequest request) {
        ...
        @Override
        public AtsGetInterviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetInterviewResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInterviewsResult(Utils.unmarshal(response, new TypeReference<InterviewsResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetInterviewRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetInterviewResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetInterviewRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetInterviewRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetInterviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetInterviewResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetInterviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetInterviewResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InterviewsResult>() {})
                            .thenApply(res::withInterviewsResult);
                } else {
