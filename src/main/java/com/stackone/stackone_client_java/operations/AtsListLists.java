...
public class AtsListLists {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListListsRequest, AtsListListsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListListsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListListsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListListsRequest request) {
        ...
        @Override
        public AtsListListsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListListsResponse.Builder resBuilder =
            ...
            AtsListListsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListListsRequest, com.stackone.stackone_client_java.models.operations.async.AtsListListsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListListsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListListsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListListsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListListsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListListsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListListsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListListsResponse res = resBuilder.build();
