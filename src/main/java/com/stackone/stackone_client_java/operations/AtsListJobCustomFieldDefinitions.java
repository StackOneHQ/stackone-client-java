...
public class AtsListJobCustomFieldDefinitions {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListJobCustomFieldDefinitionsRequest, AtsListJobCustomFieldDefinitionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListJobCustomFieldDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListJobCustomFieldDefinitionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListJobCustomFieldDefinitionsRequest request) {
        ...
        @Override
        public AtsListJobCustomFieldDefinitionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListJobCustomFieldDefinitionsResponse.Builder resBuilder =
            ...
            AtsListJobCustomFieldDefinitionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListJobCustomFieldDefinitionsRequest, com.stackone.stackone_client_java.models.operations.async.AtsListJobCustomFieldDefinitionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListJobCustomFieldDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListJobCustomFieldDefinitionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListJobCustomFieldDefinitionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListJobCustomFieldDefinitionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListJobCustomFieldDefinitionsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListJobCustomFieldDefinitionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListJobCustomFieldDefinitionsResponse res = resBuilder.build();
