...
public class HrisGetTeamGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetTeamGroupRequest, HrisGetTeamGroupResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetTeamGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetTeamGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetTeamGroupRequest request) {
        ...
        @Override
        public HrisGetTeamGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetTeamGroupResponse.Builder resBuilder =
            ...
            HrisGetTeamGroupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISTeamsResult(Utils.unmarshal(response, new TypeReference<HRISTeamsResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetTeamGroupRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetTeamGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetTeamGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetTeamGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetTeamGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetTeamGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetTeamGroupResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetTeamGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetTeamGroupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISTeamsResult>() {})
                            .thenApply(res::withHRISTeamsResult);
                } else {
