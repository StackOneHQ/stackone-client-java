...
public class HrisGetTeamGroup {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetTeamGroupRequest request) throws Exception {
        ...
        @Override
        public HrisGetTeamGroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HRISTeamsResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHRISTeamsResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
