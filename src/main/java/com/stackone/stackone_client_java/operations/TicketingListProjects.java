...
public class TicketingListProjects {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListProjectsRequest request) throws Exception {
        ...
        @Override
        public TicketingListProjectsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TicketingProjectsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingProjectsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
