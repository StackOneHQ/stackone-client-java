...
public class TicketingListProjects {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingListProjectsRequest, TicketingListProjectsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingListProjectsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListProjectsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListProjectsRequest request) {
        ...
        @Override
        public TicketingListProjectsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingListProjectsResponse.Builder resBuilder =
            ...
            TicketingListProjectsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingProjectsPaginated(Utils.unmarshal(response, new TypeReference<TicketingProjectsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingListProjectsRequest, com.stackone.stackone_client_java.models.operations.async.TicketingListProjectsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingListProjectsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListProjectsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingListProjectsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingListProjectsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingListProjectsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingListProjectsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingListProjectsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingProjectsPaginated>() {})
                            .thenApply(res::withTicketingProjectsPaginated);
                } else {
