...
public class MarketingListSmsTemplates {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingListSmsTemplatesRequest, MarketingListSmsTemplatesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingListSmsTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListSmsTemplatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListSmsTemplatesRequest request) {
        ...
        @Override
        public MarketingListSmsTemplatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingListSmsTemplatesResponse.Builder resBuilder =
            ...
            MarketingListSmsTemplatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSmsTemplatesPaginated(Utils.unmarshal(response, new TypeReference<SmsTemplatesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingListSmsTemplatesRequest, com.stackone.stackone_client_java.models.operations.async.MarketingListSmsTemplatesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingListSmsTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListSmsTemplatesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingListSmsTemplatesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingListSmsTemplatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingListSmsTemplatesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingListSmsTemplatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingListSmsTemplatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SmsTemplatesPaginated>() {})
                            .thenApply(res::withSmsTemplatesPaginated);
                } else {
