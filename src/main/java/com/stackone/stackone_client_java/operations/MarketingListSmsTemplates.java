...
public class MarketingListSmsTemplates {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListSmsTemplatesRequest request) throws Exception {
        ...
        @Override
        public MarketingListSmsTemplatesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    SmsTemplatesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSmsTemplatesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
