...
public class AtsGetBackgroundCheckPackage {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetBackgroundCheckPackageRequest, AtsGetBackgroundCheckPackageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetBackgroundCheckPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetBackgroundCheckPackageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetBackgroundCheckPackageRequest request) {
        ...
        @Override
        public AtsGetBackgroundCheckPackageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetBackgroundCheckPackageResponse.Builder resBuilder =
            ...
            AtsGetBackgroundCheckPackageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBackgroundCheckPackageResult(Utils.unmarshal(response, new TypeReference<BackgroundCheckPackageResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetBackgroundCheckPackageRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetBackgroundCheckPackageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetBackgroundCheckPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetBackgroundCheckPackageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetBackgroundCheckPackageRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetBackgroundCheckPackageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetBackgroundCheckPackageResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetBackgroundCheckPackageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetBackgroundCheckPackageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BackgroundCheckPackageResult>() {})
                            .thenApply(res::withBackgroundCheckPackageResult);
                } else {
