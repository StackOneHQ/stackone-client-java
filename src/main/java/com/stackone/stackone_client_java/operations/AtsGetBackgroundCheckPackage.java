...
public class AtsGetBackgroundCheckPackage {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetBackgroundCheckPackageRequest request) throws Exception {
        ...
        @Override
        public AtsGetBackgroundCheckPackageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BackgroundCheckPackageResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBackgroundCheckPackageResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
