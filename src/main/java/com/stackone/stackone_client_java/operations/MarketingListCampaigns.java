...
public class MarketingListCampaigns {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListCampaignsRequest request) throws Exception {
        ...
        @Override
        public MarketingListCampaignsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CampaignsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCampaignsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
