...
public class MarketingListCampaigns {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingListCampaignsRequest, MarketingListCampaignsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingListCampaignsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListCampaignsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListCampaignsRequest request) {
        ...
        @Override
        public MarketingListCampaignsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingListCampaignsResponse.Builder resBuilder =
            ...
            MarketingListCampaignsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCampaignsPaginated(Utils.unmarshal(response, new TypeReference<CampaignsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingListCampaignsRequest, com.stackone.stackone_client_java.models.operations.async.MarketingListCampaignsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingListCampaignsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListCampaignsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingListCampaignsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingListCampaignsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingListCampaignsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingListCampaignsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingListCampaignsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CampaignsPaginated>() {})
                            .thenApply(res::withCampaignsPaginated);
                } else {
