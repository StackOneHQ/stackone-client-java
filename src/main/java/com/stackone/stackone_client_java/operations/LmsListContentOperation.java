...
public class LmsListContentOperation implements RequestOperation<LmsListContentRequest, LmsListContentResponse> {
    ...
    public LmsListContentOperation(
    ...
    public HttpRequest buildRequest(LmsListContentRequest request) throws Exception {
