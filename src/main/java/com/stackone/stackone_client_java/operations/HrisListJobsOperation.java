...
public class HrisListJobsOperation implements RequestOperation<HrisListJobsRequest, HrisListJobsResponse> {
    ...
    public HttpRequest buildRequest(HrisListJobsRequest request) throws Exception {
