...
public class AtsListApplicationDocuments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationDocumentsRequest request) throws Exception {
        ...
        @Override
        public AtsListApplicationDocumentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AtsDocumentsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsDocumentsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
