...
public class MarketingGetOmniChannelTemplateOperation implements RequestOperation<MarketingGetOmniChannelTemplateRequest, MarketingGetOmniChannelTemplateResponse> {
    ...
    public MarketingGetOmniChannelTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingGetOmniChannelTemplateRequest request) throws Exception {
