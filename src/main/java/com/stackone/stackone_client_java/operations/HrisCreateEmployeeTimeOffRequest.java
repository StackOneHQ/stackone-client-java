...
public class HrisCreateEmployeeTimeOffRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisCreateEmployeeTimeOffRequestRequest, HrisCreateEmployeeTimeOffRequestResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisCreateEmployeeTimeOffRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCreateEmployeeTimeOffRequestRequest.class, new TypeReference<HrisCreateEmployeeTimeOffRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisCreateEmployeeTimeOffRequestRequest request) {
        ...
        @Override
        public HrisCreateEmployeeTimeOffRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisCreateEmployeeTimeOffRequestResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisCreateEmployeeTimeOffRequestRequest, com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeTimeOffRequestResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisCreateEmployeeTimeOffRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCreateEmployeeTimeOffRequestRequest.class, new TypeReference<HrisCreateEmployeeTimeOffRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisCreateEmployeeTimeOffRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeTimeOffRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeTimeOffRequestResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeTimeOffRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeTimeOffRequestResponse res = resBuilder.build();
