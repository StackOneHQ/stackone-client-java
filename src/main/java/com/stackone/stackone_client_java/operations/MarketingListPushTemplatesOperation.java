...
public class MarketingListPushTemplatesOperation implements RequestOperation<MarketingListPushTemplatesRequest, MarketingListPushTemplatesResponse> {
    ...
    public MarketingListPushTemplatesOperation(
    ...
    public HttpRequest buildRequest(MarketingListPushTemplatesRequest request) throws Exception {
