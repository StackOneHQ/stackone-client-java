...
public class HrisUploadEmployeeDocumentOperation implements RequestOperation<HrisUploadEmployeeDocumentRequest, HrisUploadEmployeeDocumentResponse> {
    ...
    public HrisUploadEmployeeDocumentOperation(
    ...
    public HttpRequest buildRequest(HrisUploadEmployeeDocumentRequest request) throws Exception {
