...
public class HrisGetJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetJobRequest, HrisGetJobResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetJobRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetJobRequest request) {
        ...
        @Override
        public HrisGetJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetJobResponse.Builder resBuilder =
                    HrisGetJobResponse
                            .builder()
            ...
            HrisGetJobResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisJobResult(Utils.unmarshal(response, new TypeReference<HrisJobResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetJobRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetJobRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetJobRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetJobResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetJobResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisJobResult>() {})
                            .thenApply(res::withHrisJobResult);
                } else {
