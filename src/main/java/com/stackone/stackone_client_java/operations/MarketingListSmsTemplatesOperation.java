...
public class MarketingListSmsTemplatesOperation implements RequestOperation<MarketingListSmsTemplatesRequest, MarketingListSmsTemplatesResponse> {
    ...
    public MarketingListSmsTemplatesOperation(
    ...
    public HttpRequest buildRequest(MarketingListSmsTemplatesRequest request) throws Exception {
