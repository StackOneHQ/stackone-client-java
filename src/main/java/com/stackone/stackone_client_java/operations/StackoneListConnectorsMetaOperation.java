...
public class StackoneListConnectorsMetaOperation implements RequestOperation<StackoneListConnectorsMetaRequest, StackoneListConnectorsMetaResponse> {
    ...
    public StackoneListConnectorsMetaOperation(
    ...
    public HttpRequest buildRequest(StackoneListConnectorsMetaRequest request) throws Exception {
