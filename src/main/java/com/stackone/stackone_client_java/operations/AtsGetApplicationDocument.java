...
public class AtsGetApplicationDocument {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationDocumentRequest request) throws Exception {
        ...
        @Override
        public AtsGetApplicationDocumentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AtsDocumentResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsDocumentResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
