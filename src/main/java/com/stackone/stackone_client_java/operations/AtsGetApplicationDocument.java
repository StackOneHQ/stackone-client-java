...
public class AtsGetApplicationDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetApplicationDocumentRequest, AtsGetApplicationDocumentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetApplicationDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetApplicationDocumentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationDocumentRequest request) {
        ...
        @Override
        public AtsGetApplicationDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetApplicationDocumentResponse.Builder resBuilder =
            ...
            AtsGetApplicationDocumentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsDocumentResult(Utils.unmarshal(response, new TypeReference<AtsDocumentResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetApplicationDocumentRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationDocumentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetApplicationDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetApplicationDocumentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetApplicationDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationDocumentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationDocumentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AtsDocumentResult>() {})
                            .thenApply(res::withAtsDocumentResult);
                } else {
