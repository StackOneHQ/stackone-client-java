...
public class AtsCreateBackgroundCheckPackage {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsCreateBackgroundCheckPackageRequest, AtsCreateBackgroundCheckPackageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsCreateBackgroundCheckPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsCreateBackgroundCheckPackageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsCreateBackgroundCheckPackageRequest request) {
        ...
        @Override
        public AtsCreateBackgroundCheckPackageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsCreateBackgroundCheckPackageResponse.Builder resBuilder =
            ...
            AtsCreateBackgroundCheckPackageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsCreateBackgroundCheckPackageRequest, com.stackone.stackone_client_java.models.operations.async.AtsCreateBackgroundCheckPackageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsCreateBackgroundCheckPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsCreateBackgroundCheckPackageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsCreateBackgroundCheckPackageRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsCreateBackgroundCheckPackageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsCreateBackgroundCheckPackageResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsCreateBackgroundCheckPackageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsCreateBackgroundCheckPackageResponse res = resBuilder.build();
