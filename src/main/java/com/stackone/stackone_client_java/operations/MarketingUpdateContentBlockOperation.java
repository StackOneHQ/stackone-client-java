...
public class MarketingUpdateContentBlockOperation implements RequestOperation<MarketingUpdateContentBlockRequest, MarketingUpdateContentBlockResponse> {
    ...
    public MarketingUpdateContentBlockOperation(
    ...
    public HttpRequest buildRequest(MarketingUpdateContentBlockRequest request) throws Exception {
