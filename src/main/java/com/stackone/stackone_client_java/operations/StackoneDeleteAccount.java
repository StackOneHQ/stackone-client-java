...
public class StackoneDeleteAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneDeleteAccountRequest, StackoneDeleteAccountResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneDeleteAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneDeleteAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneDeleteAccountRequest request) {
        ...
        @Override
        public StackoneDeleteAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneDeleteAccountResponse.Builder resBuilder =
            ...
            StackoneDeleteAccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneDeleteAccountRequest, com.stackone.stackone_client_java.models.operations.async.StackoneDeleteAccountResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StackoneDeleteAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneDeleteAccountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StackoneDeleteAccountRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneDeleteAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneDeleteAccountResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneDeleteAccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneDeleteAccountResponse res = resBuilder.build();
