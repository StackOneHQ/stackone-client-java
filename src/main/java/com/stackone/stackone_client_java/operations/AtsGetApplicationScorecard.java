...
public class AtsGetApplicationScorecard {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationScorecardRequest request) throws Exception {
        ...
        @Override
        public AtsGetApplicationScorecardResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ScorecardsResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withScorecardsResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
