...
public class AtsGetApplicationScorecard {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetApplicationScorecardRequest, AtsGetApplicationScorecardResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetApplicationScorecardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetApplicationScorecardRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationScorecardRequest request) {
        ...
        @Override
        public AtsGetApplicationScorecardResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetApplicationScorecardResponse.Builder resBuilder =
            ...
            AtsGetApplicationScorecardResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScorecardsResult(Utils.unmarshal(response, new TypeReference<ScorecardsResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetApplicationScorecardRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationScorecardResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetApplicationScorecardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetApplicationScorecardRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetApplicationScorecardRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationScorecardResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationScorecardResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationScorecardResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationScorecardResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ScorecardsResult>() {})
                            .thenApply(res::withScorecardsResult);
                } else {
