...
public class LmsDeleteUserCompletion {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(LmsDeleteUserCompletionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsDeleteUserCompletionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsDeleteUserCompletionRequest request) {
        ...
        @Override
        public LmsDeleteUserCompletionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsDeleteUserCompletionResponse.Builder resBuilder =
            ...
            LmsDeleteUserCompletionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsDeleteUserCompletionRequest, com.stackone.stackone_client_java.models.operations.async.LmsDeleteUserCompletionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsDeleteUserCompletionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsDeleteUserCompletionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsDeleteUserCompletionRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsDeleteUserCompletionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsDeleteUserCompletionResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsDeleteUserCompletionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsDeleteUserCompletionResponse res = resBuilder.build();
