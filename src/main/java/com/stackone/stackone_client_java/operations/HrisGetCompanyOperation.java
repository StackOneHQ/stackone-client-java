...
public class HrisGetCompanyOperation implements RequestOperation<HrisGetCompanyRequest, HrisGetCompanyResponse> {
    ...
    public HrisGetCompanyOperation(
    ...
    public HttpRequest buildRequest(HrisGetCompanyRequest request) throws Exception {
