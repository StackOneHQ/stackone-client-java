...
public class AtsListCandidateCustomFieldDefinitionsOperation implements RequestOperation<AtsListCandidateCustomFieldDefinitionsRequest, AtsListCandidateCustomFieldDefinitionsResponse> {
    ...
    public AtsListCandidateCustomFieldDefinitionsOperation(
    ...
    public HttpRequest buildRequest(AtsListCandidateCustomFieldDefinitionsRequest request) throws Exception {
