...
public class LmsListAssignmentsOperation implements RequestOperation<LmsListAssignmentsRequest, LmsListAssignmentsResponse> {
    ...
    public LmsListAssignmentsOperation(
    ...
    public HttpRequest buildRequest(LmsListAssignmentsRequest request) throws Exception {
