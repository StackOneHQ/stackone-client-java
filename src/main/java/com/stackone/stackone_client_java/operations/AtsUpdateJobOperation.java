...
public class AtsUpdateJobOperation implements RequestOperation<AtsUpdateJobRequest, AtsUpdateJobResponse> {
    ...
    public HttpRequest buildRequest(AtsUpdateJobRequest request) throws Exception {
