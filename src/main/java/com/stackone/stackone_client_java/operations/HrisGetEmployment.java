...
public class HrisGetEmployment {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetEmploymentRequest, HrisGetEmploymentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetEmploymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetEmploymentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmploymentRequest request) {
        ...
        @Override
        public HrisGetEmploymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetEmploymentResponse.Builder resBuilder =
            ...
            HrisGetEmploymentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetEmploymentRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetEmploymentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetEmploymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetEmploymentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetEmploymentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetEmploymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetEmploymentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetEmploymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetEmploymentResponse res = resBuilder.build();
