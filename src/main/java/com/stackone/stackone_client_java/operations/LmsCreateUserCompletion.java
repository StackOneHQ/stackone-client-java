...
public class LmsCreateUserCompletion {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsCreateUserCompletionRequest, LmsCreateUserCompletionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsCreateUserCompletionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsCreateUserCompletionRequest.class, new TypeReference<LmsCreateUserCompletionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsCreateUserCompletionRequest request) {
        ...
        @Override
        public LmsCreateUserCompletionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsCreateUserCompletionResponse.Builder resBuilder =
            ...
            LmsCreateUserCompletionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsCreateUserCompletionRequest, com.stackone.stackone_client_java.models.operations.async.LmsCreateUserCompletionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsCreateUserCompletionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsCreateUserCompletionRequest.class, new TypeReference<LmsCreateUserCompletionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsCreateUserCompletionRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsCreateUserCompletionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsCreateUserCompletionResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsCreateUserCompletionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsCreateUserCompletionResponse res = resBuilder.build();
