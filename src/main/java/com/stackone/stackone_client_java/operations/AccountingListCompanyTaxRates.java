...
public class AccountingListCompanyTaxRates {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingListCompanyTaxRatesRequest request) throws Exception {
        ...
        @Override
        public AccountingListCompanyTaxRatesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingTaxRatesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingTaxRatesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
