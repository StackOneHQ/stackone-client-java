...
public class AccountingListCompanyTaxRates {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingListCompanyTaxRatesRequest, AccountingListCompanyTaxRatesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingListCompanyTaxRatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingListCompanyTaxRatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingListCompanyTaxRatesRequest request) {
        ...
        @Override
        public AccountingListCompanyTaxRatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingListCompanyTaxRatesResponse.Builder resBuilder =
            ...
            AccountingListCompanyTaxRatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingTaxRatesPaginated(Utils.unmarshal(response, new TypeReference<AccountingTaxRatesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingListCompanyTaxRatesRequest, com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyTaxRatesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingListCompanyTaxRatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingListCompanyTaxRatesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingListCompanyTaxRatesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyTaxRatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyTaxRatesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyTaxRatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyTaxRatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingTaxRatesPaginated>() {})
                            .thenApply(res::withAccountingTaxRatesPaginated);
                } else {
