...
public class HrisGetTimeOffType {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetTimeOffTypeRequest, HrisGetTimeOffTypeResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetTimeOffTypeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetTimeOffTypeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetTimeOffTypeRequest request) {
        ...
        @Override
        public HrisGetTimeOffTypeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetTimeOffTypeResponse.Builder resBuilder =
            ...
            HrisGetTimeOffTypeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetTimeOffTypeRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetTimeOffTypeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetTimeOffTypeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetTimeOffTypeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetTimeOffTypeRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetTimeOffTypeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetTimeOffTypeResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetTimeOffTypeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetTimeOffTypeResponse res = resBuilder.build();
