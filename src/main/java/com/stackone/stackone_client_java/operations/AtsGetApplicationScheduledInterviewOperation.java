...
public class AtsGetApplicationScheduledInterviewOperation implements RequestOperation<AtsGetApplicationScheduledInterviewRequest, AtsGetApplicationScheduledInterviewResponse> {
    ...
    public AtsGetApplicationScheduledInterviewOperation(
    ...
    public HttpRequest buildRequest(AtsGetApplicationScheduledInterviewRequest request) throws Exception {
