...
public class AtsGetApplicationScorecardOperation implements RequestOperation<AtsGetApplicationScorecardRequest, AtsGetApplicationScorecardResponse> {
    ...
    public AtsGetApplicationScorecardOperation(
    ...
    public HttpRequest buildRequest(AtsGetApplicationScorecardRequest request) throws Exception {
