...
public class AtsListListsOperation implements RequestOperation<AtsListListsRequest, AtsListListsResponse> {
    ...
    public HttpRequest buildRequest(AtsListListsRequest request) throws Exception {
