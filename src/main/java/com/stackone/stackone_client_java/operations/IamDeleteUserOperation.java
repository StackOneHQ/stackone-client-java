...
public class IamDeleteUserOperation implements RequestOperation<IamDeleteUserRequest, IamDeleteUserResponse> {
    ...
    public HttpRequest buildRequest(IamDeleteUserRequest request) throws Exception {
