...
public class HrisGetTimeEntriesOperation implements RequestOperation<HrisGetTimeEntriesRequest, HrisGetTimeEntriesResponse> {
    ...
    public HrisGetTimeEntriesOperation(
    ...
    public HttpRequest buildRequest(HrisGetTimeEntriesRequest request) throws Exception {
