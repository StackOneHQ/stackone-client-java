...
public class AtsGetAssessmentsPackageOperation implements RequestOperation<AtsGetAssessmentsPackageRequest, AtsGetAssessmentsPackageResponse> {
    ...
    public AtsGetAssessmentsPackageOperation(
    ...
    public HttpRequest buildRequest(AtsGetAssessmentsPackageRequest request) throws Exception {
