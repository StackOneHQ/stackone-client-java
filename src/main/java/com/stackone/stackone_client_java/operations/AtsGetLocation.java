...
public class AtsGetLocation {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetLocationRequest, AtsGetLocationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetLocationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetLocationRequest request) {
        ...
        @Override
        public AtsGetLocationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetLocationResponse.Builder resBuilder =
            ...
            AtsGetLocationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withATSLocationResult(Utils.unmarshal(response, new TypeReference<ATSLocationResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetLocationRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetLocationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetLocationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetLocationRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetLocationResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetLocationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetLocationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ATSLocationResult>() {})
                            .thenApply(res::withATSLocationResult);
                } else {
