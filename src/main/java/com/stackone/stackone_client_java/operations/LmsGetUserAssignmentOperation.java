...
public class LmsGetUserAssignmentOperation implements RequestOperation<LmsGetUserAssignmentRequest, LmsGetUserAssignmentResponse> {
    ...
    public LmsGetUserAssignmentOperation(
    ...
    public HttpRequest buildRequest(LmsGetUserAssignmentRequest request) throws Exception {
