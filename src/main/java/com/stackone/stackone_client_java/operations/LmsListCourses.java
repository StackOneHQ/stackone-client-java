...
public class LmsListCourses {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListCoursesRequest request) throws Exception {
        ...
        @Override
        public LmsListCoursesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CoursePaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCoursePaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
