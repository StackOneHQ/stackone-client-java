...
public class LmsListCourses {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsListCoursesRequest, LmsListCoursesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsListCoursesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListCoursesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListCoursesRequest request) {
        ...
        @Override
        public LmsListCoursesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsListCoursesResponse.Builder resBuilder =
            ...
            LmsListCoursesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCoursePaginated(Utils.unmarshal(response, new TypeReference<CoursePaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsListCoursesRequest, com.stackone.stackone_client_java.models.operations.async.LmsListCoursesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsListCoursesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListCoursesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsListCoursesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsListCoursesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsListCoursesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsListCoursesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsListCoursesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CoursePaginated>() {})
                            .thenApply(res::withCoursePaginated);
                } else {
