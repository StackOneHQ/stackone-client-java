...
public class AtsGetInterviewOperation implements RequestOperation<AtsGetInterviewRequest, AtsGetInterviewResponse> {
    ...
    public AtsGetInterviewOperation(
    ...
    public HttpRequest buildRequest(AtsGetInterviewRequest request) throws Exception {
