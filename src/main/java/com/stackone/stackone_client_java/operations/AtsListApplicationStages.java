...
public class AtsListApplicationStages {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListApplicationStagesRequest, AtsListApplicationStagesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListApplicationStagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListApplicationStagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationStagesRequest request) {
        ...
        @Override
        public AtsListApplicationStagesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListApplicationStagesResponse.Builder resBuilder =
            ...
            AtsListApplicationStagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInterviewStagesPaginated(Utils.unmarshal(response, new TypeReference<InterviewStagesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListApplicationStagesRequest, com.stackone.stackone_client_java.models.operations.async.AtsListApplicationStagesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListApplicationStagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListApplicationStagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListApplicationStagesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListApplicationStagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListApplicationStagesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListApplicationStagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListApplicationStagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InterviewStagesPaginated>() {})
                            .thenApply(res::withInterviewStagesPaginated);
                } else {
