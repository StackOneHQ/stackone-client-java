...
public class AtsListApplicationStages {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationStagesRequest request) throws Exception {
        ...
        @Override
        public AtsListApplicationStagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    InterviewStagesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withInterviewStagesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
