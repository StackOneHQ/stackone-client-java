...
public class StackoneListLogs {
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneListLogsRequest, StackoneListLogsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneListLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneListLogsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneListLogsRequest request) {
        ...
        @Override
        public StackoneListLogsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneListLogsResponse.Builder resBuilder =
            ...
            StackoneListLogsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUnifiedLogsPaginated(Utils.unmarshal(response, new TypeReference<UnifiedLogsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneListLogsRequest, com.stackone.stackone_client_java.models.operations.async.StackoneListLogsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StackoneListLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneListLogsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StackoneListLogsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneListLogsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneListLogsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneListLogsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneListLogsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UnifiedLogsPaginated>() {})
                            .thenApply(res::withUnifiedLogsPaginated);
                } else {
