...
public class StackoneListLogs {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneListLogsRequest request) throws Exception {
        ...
        @Override
        public StackoneListLogsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UnifiedLogsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUnifiedLogsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
