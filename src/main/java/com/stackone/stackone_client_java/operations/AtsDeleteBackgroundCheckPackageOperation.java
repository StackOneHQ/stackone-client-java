...
public class AtsDeleteBackgroundCheckPackageOperation implements RequestOperation<AtsDeleteBackgroundCheckPackageRequest, AtsDeleteBackgroundCheckPackageResponse> {
    ...
    public AtsDeleteBackgroundCheckPackageOperation(
    ...
    public HttpRequest buildRequest(AtsDeleteBackgroundCheckPackageRequest request) throws Exception {
