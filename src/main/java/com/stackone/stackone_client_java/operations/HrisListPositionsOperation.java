...
public class HrisListPositionsOperation implements RequestOperation<HrisListPositionsRequest, HrisListPositionsResponse> {
    ...
    public HrisListPositionsOperation(
    ...
    public HttpRequest buildRequest(HrisListPositionsRequest request) throws Exception {
