...
public class LmsGetUserCompletion {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsGetUserCompletionRequest, LmsGetUserCompletionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsGetUserCompletionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetUserCompletionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetUserCompletionRequest request) {
        ...
        @Override
        public LmsGetUserCompletionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsGetUserCompletionResponse.Builder resBuilder =
            ...
            LmsGetUserCompletionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCompletionResult(Utils.unmarshal(response, new TypeReference<CompletionResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsGetUserCompletionRequest, com.stackone.stackone_client_java.models.operations.async.LmsGetUserCompletionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsGetUserCompletionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetUserCompletionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsGetUserCompletionRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsGetUserCompletionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsGetUserCompletionResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsGetUserCompletionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsGetUserCompletionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CompletionResult>() {})
                            .thenApply(res::withCompletionResult);
                } else {
