...
public class LmsGetUserCompletion {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetUserCompletionRequest request) throws Exception {
        ...
        @Override
        public LmsGetUserCompletionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompletionResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompletionResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
