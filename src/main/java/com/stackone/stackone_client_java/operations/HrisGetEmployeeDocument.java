...
public class HrisGetEmployeeDocument {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeeDocumentRequest request) throws Exception {
        ...
        @Override
        public HrisGetEmployeeDocumentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HrisDocumentResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisDocumentResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
