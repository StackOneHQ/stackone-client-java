...
public class HrisListEmployeeTimeOffRequestsOperation implements RequestOperation<HrisListEmployeeTimeOffRequestsRequest, HrisListEmployeeTimeOffRequestsResponse> {
    ...
    public HrisListEmployeeTimeOffRequestsOperation(
    ...
    public HttpRequest buildRequest(HrisListEmployeeTimeOffRequestsRequest request) throws Exception {
