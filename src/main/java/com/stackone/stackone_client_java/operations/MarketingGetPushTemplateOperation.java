...
public class MarketingGetPushTemplateOperation implements RequestOperation<MarketingGetPushTemplateRequest, MarketingGetPushTemplateResponse> {
    ...
    public MarketingGetPushTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingGetPushTemplateRequest request) throws Exception {
