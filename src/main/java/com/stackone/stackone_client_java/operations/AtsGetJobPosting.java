...
public class AtsGetJobPosting {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetJobPostingRequest request) throws Exception {
        ...
        @Override
        public AtsGetJobPostingResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    JobPostingResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withJobPostingResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
