...
public class AtsGetJobPosting {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetJobPostingRequest, AtsGetJobPostingResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetJobPostingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetJobPostingRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetJobPostingRequest request) {
        ...
        @Override
        public AtsGetJobPostingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetJobPostingResponse.Builder resBuilder =
            ...
            AtsGetJobPostingResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withJobPostingResult(Utils.unmarshal(response, new TypeReference<JobPostingResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetJobPostingRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetJobPostingResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetJobPostingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetJobPostingRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetJobPostingRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetJobPostingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetJobPostingResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetJobPostingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetJobPostingResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<JobPostingResult>() {})
                            .thenApply(res::withJobPostingResult);
                } else {
