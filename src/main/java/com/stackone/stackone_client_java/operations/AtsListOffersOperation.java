...
public class AtsListOffersOperation implements RequestOperation<AtsListOffersRequest, AtsListOffersResponse> {
    ...
    public HttpRequest buildRequest(AtsListOffersRequest request) throws Exception {
