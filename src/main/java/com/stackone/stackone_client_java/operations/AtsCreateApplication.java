...
public class AtsCreateApplication {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsCreateApplicationRequest, AtsCreateApplicationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsCreateApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsCreateApplicationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsCreateApplicationRequest request) {
        ...
        @Override
        public AtsCreateApplicationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsCreateApplicationResponse.Builder resBuilder =
            ...
            AtsCreateApplicationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsCreateApplicationRequest, com.stackone.stackone_client_java.models.operations.async.AtsCreateApplicationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsCreateApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsCreateApplicationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsCreateApplicationRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsCreateApplicationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsCreateApplicationResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsCreateApplicationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsCreateApplicationResponse res = resBuilder.build();
