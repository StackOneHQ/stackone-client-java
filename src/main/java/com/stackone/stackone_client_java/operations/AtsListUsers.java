...
public class AtsListUsers {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListUsersRequest, AtsListUsersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListUsersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListUsersRequest request) {
        ...
        @Override
        public AtsListUsersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListUsersResponse.Builder resBuilder =
            ...
            AtsListUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUsersPaginated(Utils.unmarshal(response, new TypeReference<UsersPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListUsersRequest, com.stackone.stackone_client_java.models.operations.async.AtsListUsersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListUsersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListUsersRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListUsersResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListUsersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UsersPaginated>() {})
                            .thenApply(res::withUsersPaginated);
                } else {
