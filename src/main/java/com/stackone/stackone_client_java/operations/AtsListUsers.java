...
public class AtsListUsers {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListUsersRequest request) throws Exception {
        ...
        @Override
        public AtsListUsersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UsersPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUsersPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
