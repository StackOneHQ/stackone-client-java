...
public class AtsRejectApplication {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsRejectApplicationRequest request) throws Exception {
        ...
        @Override
        public AtsRejectApplicationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    RejectApplicationResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRejectApplicationResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
