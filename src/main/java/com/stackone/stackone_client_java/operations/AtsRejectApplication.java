...
public class AtsRejectApplication {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsRejectApplicationRequest, AtsRejectApplicationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsRejectApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsRejectApplicationRequest.class, new TypeReference<AtsRejectApplicationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsRejectApplicationRequest request) {
        ...
        @Override
        public AtsRejectApplicationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsRejectApplicationResponse.Builder resBuilder =
            ...
            AtsRejectApplicationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRejectApplicationResult(Utils.unmarshal(response, new TypeReference<RejectApplicationResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsRejectApplicationRequest, com.stackone.stackone_client_java.models.operations.async.AtsRejectApplicationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsRejectApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsRejectApplicationRequest.class, new TypeReference<AtsRejectApplicationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsRejectApplicationRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsRejectApplicationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsRejectApplicationResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsRejectApplicationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsRejectApplicationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RejectApplicationResult>() {})
                            .thenApply(res::withRejectApplicationResult);
                } else {
