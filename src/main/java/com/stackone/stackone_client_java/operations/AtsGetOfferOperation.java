...
public class AtsGetOfferOperation implements RequestOperation<AtsGetOfferRequest, AtsGetOfferResponse> {
    ...
    public HttpRequest buildRequest(AtsGetOfferRequest request) throws Exception {
