...
public class HrisListGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListGroupsRequest, HrisListGroupsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListGroupsRequest request) {
        ...
        @Override
        public HrisListGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListGroupsResponse.Builder resBuilder =
            ...
            HrisListGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISGroupsPaginated(Utils.unmarshal(response, new TypeReference<HRISGroupsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListGroupsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListGroupsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListGroupsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISGroupsPaginated>() {})
                            .thenApply(res::withHRISGroupsPaginated);
                } else {
