...
public class HrisGetPositionOperation implements RequestOperation<HrisGetPositionRequest, HrisGetPositionResponse> {
    ...
    public HrisGetPositionOperation(
    ...
    public HttpRequest buildRequest(HrisGetPositionRequest request) throws Exception {
