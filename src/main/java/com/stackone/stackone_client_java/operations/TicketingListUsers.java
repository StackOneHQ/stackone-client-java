...
public class TicketingListUsers {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingListUsersRequest, TicketingListUsersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingListUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListUsersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListUsersRequest request) {
        ...
        @Override
        public TicketingListUsersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingListUsersResponse.Builder resBuilder =
            ...
            TicketingListUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingUsersPaginated(Utils.unmarshal(response, new TypeReference<TicketingUsersPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingListUsersRequest, com.stackone.stackone_client_java.models.operations.async.TicketingListUsersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingListUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListUsersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingListUsersRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingListUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingListUsersResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingListUsersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingListUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingUsersPaginated>() {})
                            .thenApply(res::withTicketingUsersPaginated);
                } else {
