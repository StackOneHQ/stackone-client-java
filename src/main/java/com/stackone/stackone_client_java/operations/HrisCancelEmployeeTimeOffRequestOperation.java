...
public class HrisCancelEmployeeTimeOffRequestOperation implements RequestOperation<HrisCancelEmployeeTimeOffRequestRequest, HrisCancelEmployeeTimeOffRequestResponse> {
    ...
    public HrisCancelEmployeeTimeOffRequestOperation(
    ...
    public HttpRequest buildRequest(HrisCancelEmployeeTimeOffRequestRequest request) throws Exception {
