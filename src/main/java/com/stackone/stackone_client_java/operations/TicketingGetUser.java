...
public class TicketingGetUser {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingGetUserRequest, TicketingGetUserResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingGetUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetUserRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingGetUserRequest request) {
        ...
        @Override
        public TicketingGetUserResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingGetUserResponse.Builder resBuilder =
            ...
            TicketingGetUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingUserResult(Utils.unmarshal(response, new TypeReference<TicketingUserResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingGetUserRequest, com.stackone.stackone_client_java.models.operations.async.TicketingGetUserResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingGetUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetUserRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingGetUserRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingGetUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingGetUserResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingGetUserResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingGetUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingUserResult>() {})
                            .thenApply(res::withTicketingUserResult);
                } else {
