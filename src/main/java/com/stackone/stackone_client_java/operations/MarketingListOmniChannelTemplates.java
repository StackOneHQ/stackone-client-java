...
public class MarketingListOmniChannelTemplates {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingListOmniChannelTemplatesRequest, MarketingListOmniChannelTemplatesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingListOmniChannelTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListOmniChannelTemplatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListOmniChannelTemplatesRequest request) {
        ...
        @Override
        public MarketingListOmniChannelTemplatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingListOmniChannelTemplatesResponse.Builder resBuilder =
            ...
            MarketingListOmniChannelTemplatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTemplatesPaginated(Utils.unmarshal(response, new TypeReference<TemplatesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingListOmniChannelTemplatesRequest, com.stackone.stackone_client_java.models.operations.async.MarketingListOmniChannelTemplatesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingListOmniChannelTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListOmniChannelTemplatesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingListOmniChannelTemplatesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingListOmniChannelTemplatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingListOmniChannelTemplatesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingListOmniChannelTemplatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingListOmniChannelTemplatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TemplatesPaginated>() {})
                            .thenApply(res::withTemplatesPaginated);
                } else {
