...
public class MarketingListOmniChannelTemplates {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListOmniChannelTemplatesRequest request) throws Exception {
        ...
        @Override
        public MarketingListOmniChannelTemplatesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TemplatesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTemplatesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
