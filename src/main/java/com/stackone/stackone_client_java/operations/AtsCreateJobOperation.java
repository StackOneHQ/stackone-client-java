...
public class AtsCreateJobOperation implements RequestOperation<AtsCreateJobRequest, AtsCreateJobResponse> {
    ...
    public HttpRequest buildRequest(AtsCreateJobRequest request) throws Exception {
