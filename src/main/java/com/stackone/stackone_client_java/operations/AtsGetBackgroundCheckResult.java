...
public class AtsGetBackgroundCheckResult {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AtsGetBackgroundCheckResultRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetBackgroundCheckResultRequest, AtsGetBackgroundCheckResultResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(AtsGetBackgroundCheckResultRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetBackgroundCheckResultRequest request) throws Exception {
        ...
        @Override
        public AtsGetBackgroundCheckResultResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetBackgroundCheckResultResponse.Builder resBuilder =
            ...
            AtsGetBackgroundCheckResultResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BackgroundCheckResultsResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBackgroundCheckResultsResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
