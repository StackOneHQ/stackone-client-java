...
public class MarketingGetInAppTemplate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingGetInAppTemplateRequest request) throws Exception {
        ...
        @Override
        public MarketingGetInAppTemplateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    InAppTemplateResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withInAppTemplateResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
