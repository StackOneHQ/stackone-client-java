...
public class MarketingGetInAppTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingGetInAppTemplateRequest, MarketingGetInAppTemplateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingGetInAppTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingGetInAppTemplateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingGetInAppTemplateRequest request) {
        ...
        @Override
        public MarketingGetInAppTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingGetInAppTemplateResponse.Builder resBuilder =
            ...
            MarketingGetInAppTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInAppTemplateResult(Utils.unmarshal(response, new TypeReference<InAppTemplateResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingGetInAppTemplateRequest, com.stackone.stackone_client_java.models.operations.async.MarketingGetInAppTemplateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingGetInAppTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingGetInAppTemplateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingGetInAppTemplateRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingGetInAppTemplateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingGetInAppTemplateResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingGetInAppTemplateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingGetInAppTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InAppTemplateResult>() {})
                            .thenApply(res::withInAppTemplateResult);
                } else {
