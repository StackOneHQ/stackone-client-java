...
public class MessagingListConversations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingListConversationsRequest request) throws Exception {
        ...
        @Override
        public MessagingListConversationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MessagingConversationsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMessagingConversationsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
