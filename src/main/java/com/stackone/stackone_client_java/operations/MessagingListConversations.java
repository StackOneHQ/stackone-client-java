...
public class MessagingListConversations {
    ...
    public static class Sync extends Base
            implements RequestOperation<MessagingListConversationsRequest, MessagingListConversationsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MessagingListConversationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingListConversationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingListConversationsRequest request) {
        ...
        @Override
        public MessagingListConversationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MessagingListConversationsResponse.Builder resBuilder =
            ...
            MessagingListConversationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingConversationsPaginated(Utils.unmarshal(response, new TypeReference<MessagingConversationsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MessagingListConversationsRequest, com.stackone.stackone_client_java.models.operations.async.MessagingListConversationsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MessagingListConversationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingListConversationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MessagingListConversationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MessagingListConversationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MessagingListConversationsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MessagingListConversationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MessagingListConversationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MessagingConversationsPaginated>() {})
                            .thenApply(res::withMessagingConversationsPaginated);
                } else {
