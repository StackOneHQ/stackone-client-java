...
public class HrisGetEmployeesWorkEligibilityOperation implements RequestOperation<HrisGetEmployeesWorkEligibilityRequest, HrisGetEmployeesWorkEligibilityResponse> {
    ...
    public HrisGetEmployeesWorkEligibilityOperation(
    ...
    public HttpRequest buildRequest(HrisGetEmployeesWorkEligibilityRequest request) throws Exception {
