...
public class MarketingGetEmailTemplate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingGetEmailTemplateRequest request) throws Exception {
        ...
        @Override
        public MarketingGetEmailTemplateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EmailTemplateResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmailTemplateResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
