...
public class MarketingGetEmailTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingGetEmailTemplateRequest, MarketingGetEmailTemplateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingGetEmailTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingGetEmailTemplateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingGetEmailTemplateRequest request) {
        ...
        @Override
        public MarketingGetEmailTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingGetEmailTemplateResponse.Builder resBuilder =
            ...
            MarketingGetEmailTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEmailTemplateResult(Utils.unmarshal(response, new TypeReference<EmailTemplateResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingGetEmailTemplateRequest, com.stackone.stackone_client_java.models.operations.async.MarketingGetEmailTemplateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingGetEmailTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingGetEmailTemplateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingGetEmailTemplateRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingGetEmailTemplateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingGetEmailTemplateResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingGetEmailTemplateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingGetEmailTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EmailTemplateResult>() {})
                            .thenApply(res::withEmailTemplateResult);
                } else {
