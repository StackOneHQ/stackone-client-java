...
public class AtsGetListOperation implements RequestOperation<AtsGetListRequest, AtsGetListResponse> {
    ...
    public HttpRequest buildRequest(AtsGetListRequest request) throws Exception {
