...
public class AtsListApplicationsOffersOperation implements RequestOperation<AtsListApplicationsOffersRequest, AtsListApplicationsOffersResponse> {
    ...
    public AtsListApplicationsOffersOperation(
    ...
    public HttpRequest buildRequest(AtsListApplicationsOffersRequest request) throws Exception {
