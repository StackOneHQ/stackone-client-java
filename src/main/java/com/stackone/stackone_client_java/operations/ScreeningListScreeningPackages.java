...
public class ScreeningListScreeningPackages {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ScreeningListScreeningPackagesRequest request) throws Exception {
        ...
        @Override
        public ScreeningListScreeningPackagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ScreeningPackagesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withScreeningPackagesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
