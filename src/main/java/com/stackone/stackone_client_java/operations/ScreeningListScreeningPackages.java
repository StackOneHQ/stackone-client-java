...
public class ScreeningListScreeningPackages {
    ...
    public static class Sync extends Base
            implements RequestOperation<ScreeningListScreeningPackagesRequest, ScreeningListScreeningPackagesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ScreeningListScreeningPackagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ScreeningListScreeningPackagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ScreeningListScreeningPackagesRequest request) {
        ...
        @Override
        public ScreeningListScreeningPackagesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ScreeningListScreeningPackagesResponse.Builder resBuilder =
            ...
            ScreeningListScreeningPackagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScreeningPackagesPaginated(Utils.unmarshal(response, new TypeReference<ScreeningPackagesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ScreeningListScreeningPackagesRequest, com.stackone.stackone_client_java.models.operations.async.ScreeningListScreeningPackagesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ScreeningListScreeningPackagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ScreeningListScreeningPackagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ScreeningListScreeningPackagesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.ScreeningListScreeningPackagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.ScreeningListScreeningPackagesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.ScreeningListScreeningPackagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.ScreeningListScreeningPackagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ScreeningPackagesPaginated>() {})
                            .thenApply(res::withScreeningPackagesPaginated);
                } else {
