...
public class HrisListGroupsOperation implements RequestOperation<HrisListGroupsRequest, HrisListGroupsResponse> {
    ...
    public HrisListGroupsOperation(
    ...
    public HttpRequest buildRequest(HrisListGroupsRequest request) throws Exception {
