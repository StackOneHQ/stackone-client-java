...
public class AtsCreateCandidateOperation implements RequestOperation<AtsCreateCandidateRequest, AtsCreateCandidateResponse> {
    ...
    public AtsCreateCandidateOperation(
    ...
    public HttpRequest buildRequest(AtsCreateCandidateRequest request) throws Exception {
