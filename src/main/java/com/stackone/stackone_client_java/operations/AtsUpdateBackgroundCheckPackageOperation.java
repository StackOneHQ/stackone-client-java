...
public class AtsUpdateBackgroundCheckPackageOperation implements RequestOperation<AtsUpdateBackgroundCheckPackageRequest, AtsUpdateBackgroundCheckPackageResponse> {
    ...
    public AtsUpdateBackgroundCheckPackageOperation(
    ...
    public HttpRequest buildRequest(AtsUpdateBackgroundCheckPackageRequest request) throws Exception {
