...
public class HrisListEmployments {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListEmploymentsRequest, HrisListEmploymentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListEmploymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmploymentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmploymentsRequest request) {
        ...
        @Override
        public HrisListEmploymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListEmploymentsResponse.Builder resBuilder =
            ...
            HrisListEmploymentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListEmploymentsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListEmploymentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListEmploymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmploymentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListEmploymentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListEmploymentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListEmploymentsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListEmploymentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListEmploymentsResponse res = resBuilder.build();
