...
public class CrmUpdateContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmUpdateContactRequest, CrmUpdateContactResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmUpdateContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmUpdateContactRequest.class, new TypeReference<CrmUpdateContactRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmUpdateContactRequest request) {
        ...
        @Override
        public CrmUpdateContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmUpdateContactResponse.Builder resBuilder =
            ...
            CrmUpdateContactResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactResult(Utils.unmarshal(response, new TypeReference<ContactResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmUpdateContactRequest, com.stackone.stackone_client_java.models.operations.async.CrmUpdateContactResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmUpdateContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmUpdateContactRequest.class, new TypeReference<CrmUpdateContactRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmUpdateContactRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.CrmUpdateContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.CrmUpdateContactResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.CrmUpdateContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.CrmUpdateContactResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContactResult>() {})
                            .thenApply(res::withContactResult);
                } else {
