...
public class CrmUpdateContact {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmUpdateContactRequest request) throws Exception {
        ...
        @Override
        public CrmUpdateContactResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ContactResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withContactResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
