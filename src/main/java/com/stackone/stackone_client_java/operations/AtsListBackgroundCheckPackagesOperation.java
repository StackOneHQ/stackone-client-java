...
public class AtsListBackgroundCheckPackagesOperation implements RequestOperation<AtsListBackgroundCheckPackagesRequest, AtsListBackgroundCheckPackagesResponse> {
    ...
    public AtsListBackgroundCheckPackagesOperation(
    ...
    public HttpRequest buildRequest(AtsListBackgroundCheckPackagesRequest request) throws Exception {
