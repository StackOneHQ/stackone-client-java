...
public class AtsGetInterviewStageOperation implements RequestOperation<AtsGetInterviewStageRequest, AtsGetInterviewStageResponse> {
    ...
    public AtsGetInterviewStageOperation(
    ...
    public HttpRequest buildRequest(AtsGetInterviewStageRequest request) throws Exception {
