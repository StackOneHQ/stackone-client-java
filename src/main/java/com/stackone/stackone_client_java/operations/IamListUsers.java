...
public class IamListUsers {
    ...
    public static class Sync extends Base
            implements RequestOperation<IamListUsersRequest, IamListUsersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IamListUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamListUsersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamListUsersRequest request) {
        ...
        @Override
        public IamListUsersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IamListUsersResponse.Builder resBuilder =
            ...
            IamListUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIamUsersPaginated(Utils.unmarshal(response, new TypeReference<IamUsersPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IamListUsersRequest, com.stackone.stackone_client_java.models.operations.async.IamListUsersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IamListUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamListUsersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IamListUsersRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.IamListUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.IamListUsersResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.IamListUsersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.IamListUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<IamUsersPaginated>() {})
                            .thenApply(res::withIamUsersPaginated);
                } else {
