...
public class IamListUsers {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamListUsersRequest request) throws Exception {
        ...
        @Override
        public IamListUsersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    IamUsersPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withIamUsersPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
