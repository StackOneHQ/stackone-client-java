...
public class StackoneGetAccountMetaInfo {
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneGetAccountMetaInfoRequest, StackoneGetAccountMetaInfoResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneGetAccountMetaInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneGetAccountMetaInfoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneGetAccountMetaInfoRequest request) {
        ...
        @Override
        public StackoneGetAccountMetaInfoResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLinkedAccountMeta(Utils.unmarshal(response, new TypeReference<LinkedAccountMeta>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneGetAccountMetaInfoRequest, com.stackone.stackone_client_java.models.operations.async.StackoneGetAccountMetaInfoResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StackoneGetAccountMetaInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneGetAccountMetaInfoRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StackoneGetAccountMetaInfoRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneGetAccountMetaInfoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneGetAccountMetaInfoResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneGetAccountMetaInfoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneGetAccountMetaInfoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LinkedAccountMeta>() {})
                            .thenApply(res::withLinkedAccountMeta);
                } else {
