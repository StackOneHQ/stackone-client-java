...
public class HrisListTimeOffPoliciesOperation implements RequestOperation<HrisListTimeOffPoliciesRequest, HrisListTimeOffPoliciesResponse> {
    ...
    public HrisListTimeOffPoliciesOperation(
    ...
    public HttpRequest buildRequest(HrisListTimeOffPoliciesRequest request) throws Exception {
