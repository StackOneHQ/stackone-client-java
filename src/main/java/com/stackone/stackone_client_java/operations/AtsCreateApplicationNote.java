...
public class AtsCreateApplicationNote {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsCreateApplicationNoteRequest, AtsCreateApplicationNoteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsCreateApplicationNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsCreateApplicationNoteRequest.class, new TypeReference<AtsCreateApplicationNoteRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsCreateApplicationNoteRequest request) {
        ...
        @Override
        public AtsCreateApplicationNoteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsCreateApplicationNoteResponse.Builder resBuilder =
            ...
            AtsCreateApplicationNoteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsCreateApplicationNoteRequest, com.stackone.stackone_client_java.models.operations.async.AtsCreateApplicationNoteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsCreateApplicationNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsCreateApplicationNoteRequest.class, new TypeReference<AtsCreateApplicationNoteRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsCreateApplicationNoteRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsCreateApplicationNoteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsCreateApplicationNoteResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsCreateApplicationNoteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsCreateApplicationNoteResponse res = resBuilder.build();
