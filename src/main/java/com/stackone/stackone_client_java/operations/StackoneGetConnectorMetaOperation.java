...
public class StackoneGetConnectorMetaOperation implements RequestOperation<StackoneGetConnectorMetaRequest, StackoneGetConnectorMetaResponse> {
    ...
    public StackoneGetConnectorMetaOperation(
    ...
    public HttpRequest buildRequest(StackoneGetConnectorMetaRequest request) throws Exception {
