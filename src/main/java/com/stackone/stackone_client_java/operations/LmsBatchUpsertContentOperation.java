...
public class LmsBatchUpsertContentOperation implements RequestOperation<LmsBatchUpsertContentRequest, LmsBatchUpsertContentResponse> {
    ...
    public LmsBatchUpsertContentOperation(
    ...
    public HttpRequest buildRequest(LmsBatchUpsertContentRequest request) throws Exception {
