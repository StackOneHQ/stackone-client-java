...
public class IamGetPolicy {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamGetPolicyRequest request) throws Exception {
        ...
        @Override
        public IamGetPolicyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    IamPolicyResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withIamPolicyResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
