...
public class IamGetPolicy {
    ...
    public static class Sync extends Base
            implements RequestOperation<IamGetPolicyRequest, IamGetPolicyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IamGetPolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamGetPolicyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamGetPolicyRequest request) {
        ...
        @Override
        public IamGetPolicyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IamGetPolicyResponse.Builder resBuilder =
            ...
            IamGetPolicyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIamPolicyResult(Utils.unmarshal(response, new TypeReference<IamPolicyResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IamGetPolicyRequest, com.stackone.stackone_client_java.models.operations.async.IamGetPolicyResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IamGetPolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamGetPolicyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IamGetPolicyRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.IamGetPolicyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.IamGetPolicyResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.IamGetPolicyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.IamGetPolicyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<IamPolicyResult>() {})
                            .thenApply(res::withIamPolicyResult);
                } else {
