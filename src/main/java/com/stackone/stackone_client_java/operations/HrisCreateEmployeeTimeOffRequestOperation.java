...
public class HrisCreateEmployeeTimeOffRequestOperation implements RequestOperation<HrisCreateEmployeeTimeOffRequestRequest, HrisCreateEmployeeTimeOffRequestResponse> {
    ...
    public HrisCreateEmployeeTimeOffRequestOperation(
    ...
    public HttpRequest buildRequest(HrisCreateEmployeeTimeOffRequestRequest request) throws Exception {
