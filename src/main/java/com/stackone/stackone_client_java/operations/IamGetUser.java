...
public class IamGetUser {
    ...
    public static class Sync extends Base
            implements RequestOperation<IamGetUserRequest, IamGetUserResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IamGetUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamGetUserRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamGetUserRequest request) {
        ...
        @Override
        public IamGetUserResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IamGetUserResponse.Builder resBuilder =
                    IamGetUserResponse
                            .builder()
            ...
            IamGetUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIamUserResult(Utils.unmarshal(response, new TypeReference<IamUserResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IamGetUserRequest, com.stackone.stackone_client_java.models.operations.async.IamGetUserResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IamGetUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamGetUserRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IamGetUserRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.IamGetUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.IamGetUserResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.IamGetUserResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.IamGetUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<IamUserResult>() {})
                            .thenApply(res::withIamUserResult);
                } else {
