...
public class HrisCreateEmployee {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisCreateEmployeeRequest, HrisCreateEmployeeResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisCreateEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<HrisCreateEmployeeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisCreateEmployeeRequest request) {
        ...
        @Override
        public HrisCreateEmployeeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisCreateEmployeeResponse.Builder resBuilder =
            ...
            HrisCreateEmployeeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisCreateEmployeeRequest, com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisCreateEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<HrisCreateEmployeeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisCreateEmployeeRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeResponse res = resBuilder.build();
