...
public class LmsUpdateContentOperation implements RequestOperation<LmsUpdateContentRequest, LmsUpdateContentResponse> {
    ...
    public LmsUpdateContentOperation(
    ...
    public HttpRequest buildRequest(LmsUpdateContentRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(LmsUpdateContentRequest request) throws Exception {
    ...
    @Override
    public LmsUpdateContentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
