...
public class AtsGetCandidateCustomFieldDefinitionOperation implements RequestOperation<AtsGetCandidateCustomFieldDefinitionRequest, AtsGetCandidateCustomFieldDefinitionResponse> {
    ...
    public AtsGetCandidateCustomFieldDefinitionOperation(
    ...
    public HttpRequest buildRequest(AtsGetCandidateCustomFieldDefinitionRequest request) throws Exception {
