...
public class HrisListEmployeeTimeOffBalances {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeTimeOffBalancesRequest request) throws Exception {
        ...
        @Override
        public HrisListEmployeeTimeOffBalancesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TimeOffBalancesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTimeOffBalancesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
