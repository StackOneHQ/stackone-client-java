...
public class HrisListEmployeeTimeOffBalances {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListEmployeeTimeOffBalancesRequest, HrisListEmployeeTimeOffBalancesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListEmployeeTimeOffBalancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmployeeTimeOffBalancesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListEmployeeTimeOffBalancesRequest request) {
        ...
        @Override
        public HrisListEmployeeTimeOffBalancesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListEmployeeTimeOffBalancesResponse.Builder resBuilder =
            ...
            HrisListEmployeeTimeOffBalancesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTimeOffBalancesPaginated(Utils.unmarshal(response, new TypeReference<TimeOffBalancesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListEmployeeTimeOffBalancesRequest, com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeTimeOffBalancesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListEmployeeTimeOffBalancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListEmployeeTimeOffBalancesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListEmployeeTimeOffBalancesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeTimeOffBalancesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeTimeOffBalancesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeTimeOffBalancesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListEmployeeTimeOffBalancesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TimeOffBalancesPaginated>() {})
                            .thenApply(res::withTimeOffBalancesPaginated);
                } else {
