...
public class MarketingUpdateInAppTemplateOperation implements RequestOperation<MarketingUpdateInAppTemplateRequest, MarketingUpdateInAppTemplateResponse> {
    ...
    public MarketingUpdateInAppTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingUpdateInAppTemplateRequest request) throws Exception {
