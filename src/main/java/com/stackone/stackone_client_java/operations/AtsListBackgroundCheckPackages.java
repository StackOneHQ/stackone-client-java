...
public class AtsListBackgroundCheckPackages {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListBackgroundCheckPackagesRequest request) throws Exception {
        ...
        @Override
        public AtsListBackgroundCheckPackagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BackgroundCheckPackagePaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBackgroundCheckPackagePaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
