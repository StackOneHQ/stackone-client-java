...
public class AtsListBackgroundCheckPackages {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListBackgroundCheckPackagesRequest, AtsListBackgroundCheckPackagesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListBackgroundCheckPackagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListBackgroundCheckPackagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListBackgroundCheckPackagesRequest request) {
        ...
        @Override
        public AtsListBackgroundCheckPackagesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListBackgroundCheckPackagesResponse.Builder resBuilder =
            ...
            AtsListBackgroundCheckPackagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBackgroundCheckPackagePaginated(Utils.unmarshal(response, new TypeReference<BackgroundCheckPackagePaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListBackgroundCheckPackagesRequest, com.stackone.stackone_client_java.models.operations.async.AtsListBackgroundCheckPackagesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListBackgroundCheckPackagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListBackgroundCheckPackagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListBackgroundCheckPackagesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListBackgroundCheckPackagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListBackgroundCheckPackagesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListBackgroundCheckPackagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListBackgroundCheckPackagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BackgroundCheckPackagePaginated>() {})
                            .thenApply(res::withBackgroundCheckPackagePaginated);
                } else {
