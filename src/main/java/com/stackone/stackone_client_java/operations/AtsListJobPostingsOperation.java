...
public class AtsListJobPostingsOperation implements RequestOperation<AtsListJobPostingsRequest, AtsListJobPostingsResponse> {
    ...
    public AtsListJobPostingsOperation(
    ...
    public HttpRequest buildRequest(AtsListJobPostingsRequest request) throws Exception {
