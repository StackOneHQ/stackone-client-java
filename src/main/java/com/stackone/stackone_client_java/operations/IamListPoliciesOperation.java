...
public class IamListPoliciesOperation implements RequestOperation<IamListPoliciesRequest, IamListPoliciesResponse> {
    ...
    public IamListPoliciesOperation(
    ...
    public HttpRequest buildRequest(IamListPoliciesRequest request) throws Exception {
