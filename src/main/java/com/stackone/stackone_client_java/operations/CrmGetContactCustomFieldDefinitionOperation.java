...
public class CrmGetContactCustomFieldDefinitionOperation implements RequestOperation<CrmGetContactCustomFieldDefinitionRequest, CrmGetContactCustomFieldDefinitionResponse> {
    ...
    public CrmGetContactCustomFieldDefinitionOperation(
    ...
    public HttpRequest buildRequest(CrmGetContactCustomFieldDefinitionRequest request) throws Exception {
