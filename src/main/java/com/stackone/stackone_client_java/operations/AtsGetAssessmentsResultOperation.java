...
public class AtsGetAssessmentsResultOperation implements RequestOperation<AtsGetAssessmentsResultRequest, AtsGetAssessmentsResultResponse> {
    ...
    public AtsGetAssessmentsResultOperation(
    ...
    public HttpRequest buildRequest(AtsGetAssessmentsResultRequest request) throws Exception {
