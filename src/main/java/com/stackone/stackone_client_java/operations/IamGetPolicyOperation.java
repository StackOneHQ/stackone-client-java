...
public class IamGetPolicyOperation implements RequestOperation<IamGetPolicyRequest, IamGetPolicyResponse> {
    ...
    public HttpRequest buildRequest(IamGetPolicyRequest request) throws Exception {
