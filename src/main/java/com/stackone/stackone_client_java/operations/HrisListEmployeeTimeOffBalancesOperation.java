...
public class HrisListEmployeeTimeOffBalancesOperation implements RequestOperation<HrisListEmployeeTimeOffBalancesRequest, HrisListEmployeeTimeOffBalancesResponse> {
    ...
    public HrisListEmployeeTimeOffBalancesOperation(
    ...
    public HttpRequest buildRequest(HrisListEmployeeTimeOffBalancesRequest request) throws Exception {
