...
public class AccountingListCompanyAccounts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingListCompanyAccountsRequest request) throws Exception {
        ...
        @Override
        public AccountingListCompanyAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingAccountsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingAccountsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
