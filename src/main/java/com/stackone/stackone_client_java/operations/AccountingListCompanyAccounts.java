...
public class AccountingListCompanyAccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingListCompanyAccountsRequest, AccountingListCompanyAccountsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingListCompanyAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingListCompanyAccountsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingListCompanyAccountsRequest request) {
        ...
        @Override
        public AccountingListCompanyAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingListCompanyAccountsResponse.Builder resBuilder =
            ...
            AccountingListCompanyAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingAccountsPaginated(Utils.unmarshal(response, new TypeReference<AccountingAccountsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingListCompanyAccountsRequest, com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyAccountsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingListCompanyAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingListCompanyAccountsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingListCompanyAccountsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyAccountsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AccountingListCompanyAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingAccountsPaginated>() {})
                            .thenApply(res::withAccountingAccountsPaginated);
                } else {
