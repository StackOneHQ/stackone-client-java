...
public class LmsListUserAssignments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListUserAssignmentsRequest request) throws Exception {
        ...
        @Override
        public LmsListUserAssignmentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AssignmentsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAssignmentsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
