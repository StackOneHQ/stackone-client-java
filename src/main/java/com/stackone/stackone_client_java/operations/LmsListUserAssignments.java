...
public class LmsListUserAssignments {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsListUserAssignmentsRequest, LmsListUserAssignmentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsListUserAssignmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListUserAssignmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListUserAssignmentsRequest request) {
        ...
        @Override
        public LmsListUserAssignmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsListUserAssignmentsResponse.Builder resBuilder =
            ...
            LmsListUserAssignmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAssignmentsPaginated(Utils.unmarshal(response, new TypeReference<AssignmentsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsListUserAssignmentsRequest, com.stackone.stackone_client_java.models.operations.async.LmsListUserAssignmentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsListUserAssignmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListUserAssignmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsListUserAssignmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsListUserAssignmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsListUserAssignmentsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsListUserAssignmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsListUserAssignmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AssignmentsPaginated>() {})
                            .thenApply(res::withAssignmentsPaginated);
                } else {
