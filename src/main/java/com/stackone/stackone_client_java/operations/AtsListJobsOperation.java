...
public class AtsListJobsOperation implements RequestOperation<AtsListJobsRequest, AtsListJobsResponse> {
    ...
    public HttpRequest buildRequest(AtsListJobsRequest request) throws Exception {
