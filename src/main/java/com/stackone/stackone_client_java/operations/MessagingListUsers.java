...
public class MessagingListUsers {
    ...
    public static class Sync extends Base
            implements RequestOperation<MessagingListUsersRequest, MessagingListUsersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MessagingListUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingListUsersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingListUsersRequest request) {
        ...
        @Override
        public MessagingListUsersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MessagingListUsersResponse.Builder resBuilder =
            ...
            MessagingListUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingUsersPaginated(Utils.unmarshal(response, new TypeReference<MessagingUsersPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MessagingListUsersRequest, com.stackone.stackone_client_java.models.operations.async.MessagingListUsersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MessagingListUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingListUsersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MessagingListUsersRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MessagingListUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MessagingListUsersResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MessagingListUsersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MessagingListUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MessagingUsersPaginated>() {})
                            .thenApply(res::withMessagingUsersPaginated);
                } else {
