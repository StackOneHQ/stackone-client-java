...
public class MessagingListUsers {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingListUsersRequest request) throws Exception {
        ...
        @Override
        public MessagingListUsersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MessagingUsersPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMessagingUsersPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
