...
public class HrisListTimeOffRequests {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListTimeOffRequestsRequest, HrisListTimeOffRequestsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListTimeOffRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListTimeOffRequestsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListTimeOffRequestsRequest request) {
        ...
        @Override
        public HrisListTimeOffRequestsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListTimeOffRequestsResponse.Builder resBuilder =
            ...
            HrisListTimeOffRequestsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListTimeOffRequestsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListTimeOffRequestsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListTimeOffRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListTimeOffRequestsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListTimeOffRequestsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListTimeOffRequestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListTimeOffRequestsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListTimeOffRequestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListTimeOffRequestsResponse res = resBuilder.build();
