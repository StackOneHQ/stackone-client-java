...
public class MarketingListInAppTemplatesOperation implements RequestOperation<MarketingListInAppTemplatesRequest, MarketingListInAppTemplatesResponse> {
    ...
    public MarketingListInAppTemplatesOperation(
    ...
    public HttpRequest buildRequest(MarketingListInAppTemplatesRequest request) throws Exception {
