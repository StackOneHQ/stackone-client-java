...
public class AtsCreateCandidate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsCreateCandidateRequest, AtsCreateCandidateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsCreateCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsCreateCandidateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsCreateCandidateRequest request) {
        ...
        @Override
        public AtsCreateCandidateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsCreateCandidateResponse.Builder resBuilder =
            ...
            AtsCreateCandidateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsCreateCandidateRequest, com.stackone.stackone_client_java.models.operations.async.AtsCreateCandidateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsCreateCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AtsCreateCandidateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsCreateCandidateRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsCreateCandidateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsCreateCandidateResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsCreateCandidateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsCreateCandidateResponse res = resBuilder.build();
