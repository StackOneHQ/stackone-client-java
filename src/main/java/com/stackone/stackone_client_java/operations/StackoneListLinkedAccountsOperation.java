...
public class StackoneListLinkedAccountsOperation implements RequestOperation<StackoneListLinkedAccountsRequest, StackoneListLinkedAccountsResponse> {
    ...
    public StackoneListLinkedAccountsOperation(
    ...
    public HttpRequest buildRequest(StackoneListLinkedAccountsRequest request) throws Exception {
