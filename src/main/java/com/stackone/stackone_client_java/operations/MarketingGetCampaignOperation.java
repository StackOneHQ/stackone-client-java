...
public class MarketingGetCampaignOperation implements RequestOperation<MarketingGetCampaignRequest, MarketingGetCampaignResponse> {
    ...
    public MarketingGetCampaignOperation(
    ...
    public HttpRequest buildRequest(MarketingGetCampaignRequest request) throws Exception {
