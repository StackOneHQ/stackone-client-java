...
public class IamListGroupsOperation implements RequestOperation<IamListGroupsRequest, IamListGroupsResponse> {
    ...
    public HttpRequest buildRequest(IamListGroupsRequest request) throws Exception {
