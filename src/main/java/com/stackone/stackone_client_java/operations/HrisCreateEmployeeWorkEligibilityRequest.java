...
public class HrisCreateEmployeeWorkEligibilityRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisCreateEmployeeWorkEligibilityRequestRequest, HrisCreateEmployeeWorkEligibilityRequestResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisCreateEmployeeWorkEligibilityRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCreateEmployeeWorkEligibilityRequestRequest.class, new TypeReference<HrisCreateEmployeeWorkEligibilityRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisCreateEmployeeWorkEligibilityRequestRequest request) {
        ...
        @Override
        public HrisCreateEmployeeWorkEligibilityRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisCreateEmployeeWorkEligibilityRequestResponse.Builder resBuilder =
            ...
            HrisCreateEmployeeWorkEligibilityRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateResult(Utils.unmarshal(response, new TypeReference<CreateResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisCreateEmployeeWorkEligibilityRequestRequest, com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeWorkEligibilityRequestResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisCreateEmployeeWorkEligibilityRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCreateEmployeeWorkEligibilityRequestRequest.class, new TypeReference<HrisCreateEmployeeWorkEligibilityRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisCreateEmployeeWorkEligibilityRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeWorkEligibilityRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeWorkEligibilityRequestResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeWorkEligibilityRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisCreateEmployeeWorkEligibilityRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateResult>() {})
                            .thenApply(res::withCreateResult);
                } else {
