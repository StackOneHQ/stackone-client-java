...
public class MarketingListEmailTemplatesOperation implements RequestOperation<MarketingListEmailTemplatesRequest, MarketingListEmailTemplatesResponse> {
    ...
    public MarketingListEmailTemplatesOperation(
    ...
    public HttpRequest buildRequest(MarketingListEmailTemplatesRequest request) throws Exception {
