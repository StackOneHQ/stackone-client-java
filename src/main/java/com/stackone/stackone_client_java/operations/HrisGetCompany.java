...
public class HrisGetCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetCompanyRequest, HrisGetCompanyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetCompanyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetCompanyRequest request) {
        ...
        @Override
        public HrisGetCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetCompanyResponse.Builder resBuilder =
            ...
            HrisGetCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetCompanyRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetCompanyResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetCompanyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetCompanyResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetCompanyResponse res = resBuilder.build();
