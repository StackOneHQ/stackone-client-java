...
public class AtsUploadApplicationDocumentOperation implements RequestOperation<AtsUploadApplicationDocumentRequest, AtsUploadApplicationDocumentResponse> {
    ...
    public AtsUploadApplicationDocumentOperation(
    ...
    public HttpRequest buildRequest(AtsUploadApplicationDocumentRequest request) throws Exception {
