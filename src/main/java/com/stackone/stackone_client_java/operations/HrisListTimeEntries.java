...
public class HrisListTimeEntries {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListTimeEntriesRequest request) throws Exception {
        ...
        @Override
        public HrisListTimeEntriesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TimeEntriesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTimeEntriesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
