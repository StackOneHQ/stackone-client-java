...
public class HrisListTimeEntries {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListTimeEntriesRequest, HrisListTimeEntriesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListTimeEntriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListTimeEntriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListTimeEntriesRequest request) {
        ...
        @Override
        public HrisListTimeEntriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListTimeEntriesResponse.Builder resBuilder =
            ...
            HrisListTimeEntriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTimeEntriesPaginated(Utils.unmarshal(response, new TypeReference<TimeEntriesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListTimeEntriesRequest, com.stackone.stackone_client_java.models.operations.async.HrisListTimeEntriesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListTimeEntriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListTimeEntriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListTimeEntriesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListTimeEntriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListTimeEntriesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListTimeEntriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListTimeEntriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TimeEntriesPaginated>() {})
                            .thenApply(res::withTimeEntriesPaginated);
                } else {
