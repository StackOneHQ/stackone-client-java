...
public class HrisGetTeamGroupOperation implements RequestOperation<HrisGetTeamGroupRequest, HrisGetTeamGroupResponse> {
    ...
    public HrisGetTeamGroupOperation(
    ...
    public HttpRequest buildRequest(HrisGetTeamGroupRequest request) throws Exception {
