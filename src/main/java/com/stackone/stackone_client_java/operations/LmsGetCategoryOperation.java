...
public class LmsGetCategoryOperation implements RequestOperation<LmsGetCategoryRequest, LmsGetCategoryResponse> {
    ...
    public LmsGetCategoryOperation(
    ...
    public HttpRequest buildRequest(LmsGetCategoryRequest request) throws Exception {
