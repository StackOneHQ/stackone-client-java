...
public class AtsGetApplicationStage {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetApplicationStageRequest, AtsGetApplicationStageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetApplicationStageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetApplicationStageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationStageRequest request) {
        ...
        @Override
        public AtsGetApplicationStageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetApplicationStageResponse.Builder resBuilder =
            ...
            AtsGetApplicationStageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInterviewStageResult(Utils.unmarshal(response, new TypeReference<InterviewStageResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetApplicationStageRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationStageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetApplicationStageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetApplicationStageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetApplicationStageRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationStageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationStageResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationStageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetApplicationStageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InterviewStageResult>() {})
                            .thenApply(res::withInterviewStageResult);
                } else {
