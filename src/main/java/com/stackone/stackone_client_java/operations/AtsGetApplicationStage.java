...
public class AtsGetApplicationStage {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationStageRequest request) throws Exception {
        ...
        @Override
        public AtsGetApplicationStageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    InterviewStageResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withInterviewStageResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
