...
public class CrmListContacts {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmListContactsRequest, CrmListContactsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmListContactsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListContactsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmListContactsRequest request) {
        ...
        @Override
        public CrmListContactsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmListContactsResponse.Builder resBuilder =
            ...
            CrmListContactsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactsPaginated(Utils.unmarshal(response, new TypeReference<ContactsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmListContactsRequest, com.stackone.stackone_client_java.models.operations.async.CrmListContactsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmListContactsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListContactsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmListContactsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.CrmListContactsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.CrmListContactsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.CrmListContactsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.CrmListContactsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContactsPaginated>() {})
                            .thenApply(res::withContactsPaginated);
                } else {
