...
public class HrisListLocationsOperation implements RequestOperation<HrisListLocationsRequest, HrisListLocationsResponse> {
    ...
    public HrisListLocationsOperation(
    ...
    public HttpRequest buildRequest(HrisListLocationsRequest request) throws Exception {
