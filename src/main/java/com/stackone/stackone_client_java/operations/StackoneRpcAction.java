...
public class StackoneRpcAction {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ActionsRpcRequestDto request) throws Exception {
        ...
        @Override
        public StackoneRpcActionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ActionsRpcResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withActionsRpcResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
