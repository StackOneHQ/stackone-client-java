...
public class StackoneListConnectorsMeta {
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneListConnectorsMetaRequest, StackoneListConnectorsMetaResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneListConnectorsMetaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneListConnectorsMetaRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneListConnectorsMetaRequest request) {
        ...
        @Override
        public StackoneListConnectorsMetaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneListConnectorsMetaResponse.Builder resBuilder =
            ...
            StackoneListConnectorsMetaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConnectorsMetas(Utils.unmarshal(response, new TypeReference<List<ConnectorsMeta>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneListConnectorsMetaRequest, com.stackone.stackone_client_java.models.operations.async.StackoneListConnectorsMetaResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StackoneListConnectorsMetaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneListConnectorsMetaRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StackoneListConnectorsMetaRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneListConnectorsMetaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneListConnectorsMetaResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneListConnectorsMetaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneListConnectorsMetaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ConnectorsMeta>>() {})
                            .thenApply(res::withConnectorsMetas);
                } else {
