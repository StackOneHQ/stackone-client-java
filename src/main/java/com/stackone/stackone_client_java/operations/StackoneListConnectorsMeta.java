...
public class StackoneListConnectorsMeta {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneListConnectorsMetaRequest request) throws Exception {
        ...
        @Override
        public StackoneListConnectorsMetaResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ConnectorsMeta> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withConnectorsMetas(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
