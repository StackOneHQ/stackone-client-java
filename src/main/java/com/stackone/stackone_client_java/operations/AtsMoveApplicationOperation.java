...
public class AtsMoveApplicationOperation implements RequestOperation<AtsMoveApplicationRequest, AtsMoveApplicationResponse> {
    ...
    public AtsMoveApplicationOperation(
    ...
    public HttpRequest buildRequest(AtsMoveApplicationRequest request) throws Exception {
