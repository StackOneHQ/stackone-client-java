...
public class MarketingGetSmsTemplateOperation implements RequestOperation<MarketingGetSmsTemplateRequest, MarketingGetSmsTemplateResponse> {
    ...
    public MarketingGetSmsTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingGetSmsTemplateRequest request) throws Exception {
