...
public class AtsGetApplicationDocumentCategoryOperation implements RequestOperation<AtsGetApplicationDocumentCategoryRequest, AtsGetApplicationDocumentCategoryResponse> {
    ...
    public AtsGetApplicationDocumentCategoryOperation(
    ...
    public HttpRequest buildRequest(AtsGetApplicationDocumentCategoryRequest request) throws Exception {
