...
public class HrisGetEmployeeTaskOperation implements RequestOperation<HrisGetEmployeeTaskRequest, HrisGetEmployeeTaskResponse> {
    ...
    public HrisGetEmployeeTaskOperation(
    ...
    public HttpRequest buildRequest(HrisGetEmployeeTaskRequest request) throws Exception {
