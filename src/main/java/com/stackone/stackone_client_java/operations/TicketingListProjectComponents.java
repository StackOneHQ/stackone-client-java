...
public class TicketingListProjectComponents {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListProjectComponentsRequest request) throws Exception {
        ...
        @Override
        public TicketingListProjectComponentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TicketingComponentsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingComponentsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
