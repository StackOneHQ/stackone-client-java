...
public class TicketingListProjectComponents {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingListProjectComponentsRequest, TicketingListProjectComponentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingListProjectComponentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListProjectComponentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingListProjectComponentsRequest request) {
        ...
        @Override
        public TicketingListProjectComponentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingListProjectComponentsResponse.Builder resBuilder =
            ...
            TicketingListProjectComponentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingComponentsPaginated(Utils.unmarshal(response, new TypeReference<TicketingComponentsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingListProjectComponentsRequest, com.stackone.stackone_client_java.models.operations.async.TicketingListProjectComponentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingListProjectComponentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingListProjectComponentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingListProjectComponentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingListProjectComponentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingListProjectComponentsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingListProjectComponentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingListProjectComponentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingComponentsPaginated>() {})
                            .thenApply(res::withTicketingComponentsPaginated);
                } else {
