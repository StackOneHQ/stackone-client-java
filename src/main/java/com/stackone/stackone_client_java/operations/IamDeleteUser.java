...
public class IamDeleteUser {
    ...
    public static class Sync extends Base
            implements RequestOperation<IamDeleteUserRequest, IamDeleteUserResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IamDeleteUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamDeleteUserRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamDeleteUserRequest request) {
        ...
        @Override
        public IamDeleteUserResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IamDeleteUserResponse.Builder resBuilder =
            ...
            IamDeleteUserResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IamDeleteUserRequest, com.stackone.stackone_client_java.models.operations.async.IamDeleteUserResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IamDeleteUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamDeleteUserRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IamDeleteUserRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.IamDeleteUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.IamDeleteUserResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.IamDeleteUserResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.IamDeleteUserResponse res = resBuilder.build();
