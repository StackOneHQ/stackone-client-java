...
public class HrisGetShiftOperation implements RequestOperation<HrisGetShiftRequest, HrisGetShiftResponse> {
    ...
    public HttpRequest buildRequest(HrisGetShiftRequest request) throws Exception {
