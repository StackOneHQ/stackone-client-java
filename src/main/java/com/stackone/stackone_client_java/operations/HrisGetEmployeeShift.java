...
public class HrisGetEmployeeShift {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeeShiftRequest request) throws Exception {
        ...
        @Override
        public HrisGetEmployeeShiftResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HrisShiftResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisShiftResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
