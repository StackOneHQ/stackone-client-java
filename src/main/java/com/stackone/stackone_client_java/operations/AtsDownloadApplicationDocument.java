...
public class AtsDownloadApplicationDocument {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsDownloadApplicationDocumentRequest request) {
        ...
        @Override
        public AtsDownloadApplicationDocumentResponse handleResponse(HttpResponse<InputStream> response) {
        ...
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsDownloadApplicationDocumentResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/gzip")) {
                    ...
                    return Utils.unmarshalAsync(response, new TypeReference<DownloadApiModel>() {})
                            .thenApply(res::withDownloadApiModel1);
                } else {
