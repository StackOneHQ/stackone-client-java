...
public class StackoneListActionsMeta {
    ...
    public static class Sync extends Base
            implements RequestOperation<StackoneListActionsMetaRequest, StackoneListActionsMetaResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StackoneListActionsMetaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneListActionsMetaRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneListActionsMetaRequest request) {
        ...
        @Override
        public StackoneListActionsMetaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StackoneListActionsMetaResponse.Builder resBuilder =
            ...
            StackoneListActionsMetaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withActionsMetaPaginated(Utils.unmarshal(response, new TypeReference<ActionsMetaPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StackoneListActionsMetaRequest, com.stackone.stackone_client_java.models.operations.async.StackoneListActionsMetaResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StackoneListActionsMetaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StackoneListActionsMetaRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StackoneListActionsMetaRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.StackoneListActionsMetaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.StackoneListActionsMetaResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.StackoneListActionsMetaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.StackoneListActionsMetaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ActionsMetaPaginated>() {})
                            .thenApply(res::withActionsMetaPaginated);
                } else {
