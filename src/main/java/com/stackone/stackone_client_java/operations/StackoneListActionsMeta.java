...
public class StackoneListActionsMeta {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StackoneListActionsMetaRequest request) throws Exception {
        ...
        @Override
        public StackoneListActionsMetaResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ActionsMetaPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withActionsMetaPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
