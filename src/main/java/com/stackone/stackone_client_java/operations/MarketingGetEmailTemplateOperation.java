...
public class MarketingGetEmailTemplateOperation implements RequestOperation<MarketingGetEmailTemplateRequest, MarketingGetEmailTemplateResponse> {
    ...
    public MarketingGetEmailTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingGetEmailTemplateRequest request) throws Exception {
