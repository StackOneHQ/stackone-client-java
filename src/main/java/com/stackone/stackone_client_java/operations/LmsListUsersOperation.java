...
public class LmsListUsersOperation implements RequestOperation<LmsListUsersRequest, LmsListUsersResponse> {
    ...
    public HttpRequest buildRequest(LmsListUsersRequest request) throws Exception {
