...
public class MarketingGetOmniChannelTemplate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingGetOmniChannelTemplateRequest request) throws Exception {
        ...
        @Override
        public MarketingGetOmniChannelTemplateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TemplateResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTemplateResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
