...
public class MarketingGetOmniChannelTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingGetOmniChannelTemplateRequest, MarketingGetOmniChannelTemplateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingGetOmniChannelTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingGetOmniChannelTemplateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingGetOmniChannelTemplateRequest request) {
        ...
        @Override
        public MarketingGetOmniChannelTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingGetOmniChannelTemplateResponse.Builder resBuilder =
            ...
            MarketingGetOmniChannelTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTemplateResult(Utils.unmarshal(response, new TypeReference<TemplateResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingGetOmniChannelTemplateRequest, com.stackone.stackone_client_java.models.operations.async.MarketingGetOmniChannelTemplateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingGetOmniChannelTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingGetOmniChannelTemplateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingGetOmniChannelTemplateRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingGetOmniChannelTemplateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingGetOmniChannelTemplateResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingGetOmniChannelTemplateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingGetOmniChannelTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TemplateResult>() {})
                            .thenApply(res::withTemplateResult);
                } else {
