...
public class MessagingSendMessage {
    ...
    public static class Sync extends Base
            implements RequestOperation<MessagingSendMessageRequest, MessagingSendMessageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MessagingSendMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MessagingSendMessageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingSendMessageRequest request) {
        ...
        @Override
        public MessagingSendMessageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MessagingSendMessageResponse.Builder resBuilder =
            ...
            MessagingSendMessageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MessagingSendMessageRequest, com.stackone.stackone_client_java.models.operations.async.MessagingSendMessageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MessagingSendMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MessagingSendMessageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MessagingSendMessageRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MessagingSendMessageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MessagingSendMessageResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MessagingSendMessageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MessagingSendMessageResponse res = resBuilder.build();
