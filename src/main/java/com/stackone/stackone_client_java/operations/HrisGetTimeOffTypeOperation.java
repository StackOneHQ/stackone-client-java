...
public class HrisGetTimeOffTypeOperation implements RequestOperation<HrisGetTimeOffTypeRequest, HrisGetTimeOffTypeResponse> {
    ...
    public HrisGetTimeOffTypeOperation(
    ...
    public HttpRequest buildRequest(HrisGetTimeOffTypeRequest request) throws Exception {
