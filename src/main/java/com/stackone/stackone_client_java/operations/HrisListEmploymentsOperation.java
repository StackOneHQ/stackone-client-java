...
public class HrisListEmploymentsOperation implements RequestOperation<HrisListEmploymentsRequest, HrisListEmploymentsResponse> {
    ...
    public HrisListEmploymentsOperation(
    ...
    public HttpRequest buildRequest(HrisListEmploymentsRequest request) throws Exception {
