...
public class CrmUpdateContactOperation implements RequestOperation<CrmUpdateContactRequest, CrmUpdateContactResponse> {
    ...
    public CrmUpdateContactOperation(
    ...
    public HttpRequest buildRequest(CrmUpdateContactRequest request) throws Exception {
