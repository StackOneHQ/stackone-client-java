...
public class AtsListApplicationDocumentsOperation implements RequestOperation<AtsListApplicationDocumentsRequest, AtsListApplicationDocumentsResponse> {
    ...
    public AtsListApplicationDocumentsOperation(
    ...
    public HttpRequest buildRequest(AtsListApplicationDocumentsRequest request) throws Exception {
