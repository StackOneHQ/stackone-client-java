...
public class HrisListShifts {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListShiftsRequest, HrisListShiftsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListShiftsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListShiftsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListShiftsRequest request) {
        ...
        @Override
        public HrisListShiftsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListShiftsResponse.Builder resBuilder =
            ...
            HrisListShiftsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListShiftsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListShiftsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListShiftsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListShiftsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListShiftsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListShiftsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListShiftsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListShiftsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListShiftsResponse res = resBuilder.build();
