...
public class HrisListEmployeeWorkEligibilityOperation implements RequestOperation<HrisListEmployeeWorkEligibilityRequest, HrisListEmployeeWorkEligibilityResponse> {
    ...
    public HrisListEmployeeWorkEligibilityOperation(
    ...
    public HttpRequest buildRequest(HrisListEmployeeWorkEligibilityRequest request) throws Exception {
