...
public class AtsListInterviews {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListInterviewsRequest, AtsListInterviewsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListInterviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListInterviewsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListInterviewsRequest request) {
        ...
        @Override
        public AtsListInterviewsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListInterviewsResponse.Builder resBuilder =
            ...
            AtsListInterviewsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInterviewsPaginated(Utils.unmarshal(response, new TypeReference<InterviewsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListInterviewsRequest, com.stackone.stackone_client_java.models.operations.async.AtsListInterviewsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListInterviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListInterviewsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListInterviewsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListInterviewsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListInterviewsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListInterviewsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListInterviewsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InterviewsPaginated>() {})
                            .thenApply(res::withInterviewsPaginated);
                } else {
