...
public class AtsListInterviews {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListInterviewsRequest request) throws Exception {
        ...
        @Override
        public AtsListInterviewsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    InterviewsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withInterviewsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
