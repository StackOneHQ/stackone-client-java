...
public class AtsDownloadApplicationDocumentOperation implements RequestOperation<AtsDownloadApplicationDocumentRequest, AtsDownloadApplicationDocumentResponse> {
    ...
    public AtsDownloadApplicationDocumentOperation(
    ...
    public HttpRequest buildRequest(AtsDownloadApplicationDocumentRequest request) throws Exception {
