...
public class TicketingGetProject {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingGetProjectRequest, TicketingGetProjectResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingGetProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetProjectRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingGetProjectRequest request) {
        ...
        @Override
        public TicketingGetProjectResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingGetProjectResponse.Builder resBuilder =
            ...
            TicketingGetProjectResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingProjectResult(Utils.unmarshal(response, new TypeReference<TicketingProjectResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingGetProjectRequest, com.stackone.stackone_client_java.models.operations.async.TicketingGetProjectResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingGetProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetProjectRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingGetProjectRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingGetProjectResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingGetProjectResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingGetProjectResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingGetProjectResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingProjectResult>() {})
                            .thenApply(res::withTicketingProjectResult);
                } else {
