...
public class TicketingGetProject {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingGetProjectRequest request) throws Exception {
        ...
        @Override
        public TicketingGetProjectResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TicketingProjectResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingProjectResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
