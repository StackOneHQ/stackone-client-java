...
public class LmsGetSkillOperation implements RequestOperation<LmsGetSkillRequest, LmsGetSkillResponse> {
    ...
    public HttpRequest buildRequest(LmsGetSkillRequest request) throws Exception {
