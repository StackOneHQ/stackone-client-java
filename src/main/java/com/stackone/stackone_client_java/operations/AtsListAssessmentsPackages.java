...
public class AtsListAssessmentsPackages {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListAssessmentsPackagesRequest request) throws Exception {
        ...
        @Override
        public AtsListAssessmentsPackagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AssessmentPackagePaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAssessmentPackagePaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
