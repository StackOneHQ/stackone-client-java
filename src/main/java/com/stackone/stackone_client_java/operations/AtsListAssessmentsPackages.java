...
public class AtsListAssessmentsPackages {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListAssessmentsPackagesRequest, AtsListAssessmentsPackagesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListAssessmentsPackagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListAssessmentsPackagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListAssessmentsPackagesRequest request) {
        ...
        @Override
        public AtsListAssessmentsPackagesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListAssessmentsPackagesResponse.Builder resBuilder =
            ...
            AtsListAssessmentsPackagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAssessmentPackagePaginated(Utils.unmarshal(response, new TypeReference<AssessmentPackagePaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListAssessmentsPackagesRequest, com.stackone.stackone_client_java.models.operations.async.AtsListAssessmentsPackagesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListAssessmentsPackagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListAssessmentsPackagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListAssessmentsPackagesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListAssessmentsPackagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListAssessmentsPackagesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListAssessmentsPackagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListAssessmentsPackagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AssessmentPackagePaginated>() {})
                            .thenApply(res::withAssessmentPackagePaginated);
                } else {
