...
public class IamListGroups {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamListGroupsRequest request) throws Exception {
        ...
        @Override
        public IamListGroupsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    IamGroupsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withIamGroupsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
