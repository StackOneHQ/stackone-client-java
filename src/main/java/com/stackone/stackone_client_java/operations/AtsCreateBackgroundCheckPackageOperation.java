...
public class AtsCreateBackgroundCheckPackageOperation implements RequestOperation<AtsCreateBackgroundCheckPackageRequest, AtsCreateBackgroundCheckPackageResponse> {
    ...
    public AtsCreateBackgroundCheckPackageOperation(
    ...
    public HttpRequest buildRequest(AtsCreateBackgroundCheckPackageRequest request) throws Exception {
