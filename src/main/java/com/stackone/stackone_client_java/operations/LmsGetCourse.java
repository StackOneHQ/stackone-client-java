...
public class LmsGetCourse {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsGetCourseRequest, LmsGetCourseResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsGetCourseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetCourseRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetCourseRequest request) {
        ...
        @Override
        public LmsGetCourseResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCourseResult(Utils.unmarshal(response, new TypeReference<CourseResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsGetCourseRequest, com.stackone.stackone_client_java.models.operations.async.LmsGetCourseResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsGetCourseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetCourseRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsGetCourseRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsGetCourseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsGetCourseResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsGetCourseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsGetCourseResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CourseResult>() {})
                            .thenApply(res::withCourseResult);
                } else {
