...
public class CrmListLists {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmListListsRequest, CrmListListsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmListListsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListListsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmListListsRequest request) {
        ...
        @Override
        public CrmListListsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmListListsResponse.Builder resBuilder =
            ...
            CrmListListsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListsPaginated(Utils.unmarshal(response, new TypeReference<ListsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmListListsRequest, com.stackone.stackone_client_java.models.operations.async.CrmListListsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmListListsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListListsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmListListsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.CrmListListsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.CrmListListsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.CrmListListsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.CrmListListsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListsPaginated>() {})
                            .thenApply(res::withListsPaginated);
                } else {
