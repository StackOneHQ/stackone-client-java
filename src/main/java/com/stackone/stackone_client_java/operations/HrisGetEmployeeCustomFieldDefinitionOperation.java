...
public class HrisGetEmployeeCustomFieldDefinitionOperation implements RequestOperation<HrisGetEmployeeCustomFieldDefinitionRequest, HrisGetEmployeeCustomFieldDefinitionResponse> {
    ...
    public HrisGetEmployeeCustomFieldDefinitionOperation(
    ...
    public HttpRequest buildRequest(HrisGetEmployeeCustomFieldDefinitionRequest request) throws Exception {
