...
public class AtsUpdateBackgroundCheckResultOperation implements RequestOperation<AtsUpdateBackgroundCheckResultRequest, AtsUpdateBackgroundCheckResultResponse> {
    ...
    public AtsUpdateBackgroundCheckResultOperation(
    ...
    public HttpRequest buildRequest(AtsUpdateBackgroundCheckResultRequest request) throws Exception {
