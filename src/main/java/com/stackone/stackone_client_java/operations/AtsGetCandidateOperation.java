...
public class AtsGetCandidateOperation implements RequestOperation<AtsGetCandidateRequest, AtsGetCandidateResponse> {
    ...
    public AtsGetCandidateOperation(
    ...
    public HttpRequest buildRequest(AtsGetCandidateRequest request) throws Exception {
