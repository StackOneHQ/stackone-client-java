...
public class AtsListApplicationScorecardsOperation implements RequestOperation<AtsListApplicationScorecardsRequest, AtsListApplicationScorecardsResponse> {
    ...
    public AtsListApplicationScorecardsOperation(
    ...
    public HttpRequest buildRequest(AtsListApplicationScorecardsRequest request) throws Exception {
