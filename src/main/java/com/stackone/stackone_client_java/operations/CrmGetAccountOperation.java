...
public class CrmGetAccountOperation implements RequestOperation<CrmGetAccountRequest, CrmGetAccountResponse> {
    ...
    public HttpRequest buildRequest(CrmGetAccountRequest request) throws Exception {
