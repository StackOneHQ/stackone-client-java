...
public class MarketingUpdatePushTemplateOperation implements RequestOperation<MarketingUpdatePushTemplateRequest, MarketingUpdatePushTemplateResponse> {
    ...
    public MarketingUpdatePushTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingUpdatePushTemplateRequest request) throws Exception {
