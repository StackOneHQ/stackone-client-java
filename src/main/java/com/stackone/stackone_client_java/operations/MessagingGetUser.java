...
public class MessagingGetUser {
    ...
    public static class Sync extends Base
            implements RequestOperation<MessagingGetUserRequest, MessagingGetUserResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MessagingGetUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingGetUserRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingGetUserRequest request) {
        ...
        @Override
        public MessagingGetUserResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MessagingGetUserResponse.Builder resBuilder =
            ...
            MessagingGetUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingUserResult(Utils.unmarshal(response, new TypeReference<MessagingUserResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MessagingGetUserRequest, com.stackone.stackone_client_java.models.operations.async.MessagingGetUserResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MessagingGetUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingGetUserRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MessagingGetUserRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MessagingGetUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MessagingGetUserResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MessagingGetUserResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MessagingGetUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MessagingUserResult>() {})
                            .thenApply(res::withMessagingUserResult);
                } else {
