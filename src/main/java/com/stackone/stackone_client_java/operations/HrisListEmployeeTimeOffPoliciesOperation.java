...
public class HrisListEmployeeTimeOffPoliciesOperation implements RequestOperation<HrisListEmployeeTimeOffPoliciesRequest, HrisListEmployeeTimeOffPoliciesResponse> {
    ...
    public HrisListEmployeeTimeOffPoliciesOperation(
    ...
    public HttpRequest buildRequest(HrisListEmployeeTimeOffPoliciesRequest request) throws Exception {
