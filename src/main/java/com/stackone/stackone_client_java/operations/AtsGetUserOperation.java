...
public class AtsGetUserOperation implements RequestOperation<AtsGetUserRequest, AtsGetUserResponse> {
    ...
    public HttpRequest buildRequest(AtsGetUserRequest request) throws Exception {
