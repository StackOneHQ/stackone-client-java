...
public class IamGetRole {
    ...
    public static class Sync extends Base
            implements RequestOperation<IamGetRoleRequest, IamGetRoleResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IamGetRoleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamGetRoleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamGetRoleRequest request) {
        ...
        @Override
        public IamGetRoleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IamGetRoleResponse.Builder resBuilder =
                    IamGetRoleResponse
                            .builder()
            ...
            IamGetRoleResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIamRoleResult(Utils.unmarshal(response, new TypeReference<IamRoleResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IamGetRoleRequest, com.stackone.stackone_client_java.models.operations.async.IamGetRoleResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IamGetRoleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamGetRoleRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IamGetRoleRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.IamGetRoleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.IamGetRoleResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.IamGetRoleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.IamGetRoleResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<IamRoleResult>() {})
                            .thenApply(res::withIamRoleResult);
                } else {
