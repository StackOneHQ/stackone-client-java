...
public class LmsListUsers {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsListUsersRequest, LmsListUsersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsListUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListUsersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListUsersRequest request) {
        ...
        @Override
        public LmsListUsersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsListUsersResponse.Builder resBuilder =
            ...
            LmsListUsersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsListUsersRequest, com.stackone.stackone_client_java.models.operations.async.LmsListUsersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsListUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListUsersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsListUsersRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsListUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsListUsersResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsListUsersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsListUsersResponse res = resBuilder.build();
