...
public class AtsListRejectedReasonsOperation implements RequestOperation<AtsListRejectedReasonsRequest, AtsListRejectedReasonsResponse> {
    ...
    public AtsListRejectedReasonsOperation(
    ...
    public HttpRequest buildRequest(AtsListRejectedReasonsRequest request) throws Exception {
