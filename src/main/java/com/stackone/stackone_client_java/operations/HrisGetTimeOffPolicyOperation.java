...
public class HrisGetTimeOffPolicyOperation implements RequestOperation<HrisGetTimeOffPolicyRequest, HrisGetTimeOffPolicyResponse> {
    ...
    public HrisGetTimeOffPolicyOperation(
    ...
    public HttpRequest buildRequest(HrisGetTimeOffPolicyRequest request) throws Exception {
