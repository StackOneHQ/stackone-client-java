...
public class AtsGetCandidate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetCandidateRequest request) throws Exception {
        ...
        @Override
        public AtsGetCandidateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CandidateResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCandidateResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
