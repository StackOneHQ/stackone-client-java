...
public class AtsGetCandidate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetCandidateRequest, AtsGetCandidateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetCandidateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetCandidateRequest request) {
        ...
        @Override
        public AtsGetCandidateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetCandidateResponse.Builder resBuilder =
            ...
            AtsGetCandidateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCandidateResult(Utils.unmarshal(response, new TypeReference<CandidateResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetCandidateRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetCandidateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetCandidateRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetCandidateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CandidateResult>() {})
                            .thenApply(res::withCandidateResult);
                } else {
