...
public class CrmListListsOperation implements RequestOperation<CrmListListsRequest, CrmListListsResponse> {
    ...
    public HttpRequest buildRequest(CrmListListsRequest request) throws Exception {
