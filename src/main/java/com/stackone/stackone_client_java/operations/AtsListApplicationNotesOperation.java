...
public class AtsListApplicationNotesOperation implements RequestOperation<AtsListApplicationNotesRequest, AtsListApplicationNotesResponse> {
    ...
    public AtsListApplicationNotesOperation(
    ...
    public HttpRequest buildRequest(AtsListApplicationNotesRequest request) throws Exception {
