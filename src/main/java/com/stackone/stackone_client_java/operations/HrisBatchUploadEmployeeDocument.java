...
public class HrisBatchUploadEmployeeDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisBatchUploadEmployeeDocumentRequest, HrisBatchUploadEmployeeDocumentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisBatchUploadEmployeeDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisBatchUploadEmployeeDocumentRequest.class, new TypeReference<HrisBatchUploadEmployeeDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisBatchUploadEmployeeDocumentRequest request) {
        ...
        @Override
        public HrisBatchUploadEmployeeDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisBatchUploadEmployeeDocumentResponse.Builder resBuilder =
            ...
            HrisBatchUploadEmployeeDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisBatchUploadEmployeeDocumentRequest, com.stackone.stackone_client_java.models.operations.async.HrisBatchUploadEmployeeDocumentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisBatchUploadEmployeeDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisBatchUploadEmployeeDocumentRequest.class, new TypeReference<HrisBatchUploadEmployeeDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisBatchUploadEmployeeDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisBatchUploadEmployeeDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisBatchUploadEmployeeDocumentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisBatchUploadEmployeeDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisBatchUploadEmployeeDocumentResponse res = resBuilder.build();
