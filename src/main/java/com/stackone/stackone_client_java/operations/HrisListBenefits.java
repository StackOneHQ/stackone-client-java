...
public class HrisListBenefits {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListBenefitsRequest, HrisListBenefitsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListBenefitsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListBenefitsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListBenefitsRequest request) {
        ...
        @Override
        public HrisListBenefitsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListBenefitsResponse.Builder resBuilder =
            ...
            HrisListBenefitsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISBenefitsPaginated(Utils.unmarshal(response, new TypeReference<HRISBenefitsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListBenefitsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListBenefitsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListBenefitsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListBenefitsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListBenefitsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListBenefitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListBenefitsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListBenefitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListBenefitsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISBenefitsPaginated>() {})
                            .thenApply(res::withHRISBenefitsPaginated);
                } else {
