...
public class HrisUpdateEmployeeWorkEligibilityRequestOperation implements RequestOperation<HrisUpdateEmployeeWorkEligibilityRequestRequest, HrisUpdateEmployeeWorkEligibilityRequestResponse> {
    ...
    public HrisUpdateEmployeeWorkEligibilityRequestOperation(
    ...
    public HttpRequest buildRequest(HrisUpdateEmployeeWorkEligibilityRequestRequest request) throws Exception {
