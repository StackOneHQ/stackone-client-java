...
public class AtsUpdateBackgroundCheckPackage {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsUpdateBackgroundCheckPackageRequest, AtsUpdateBackgroundCheckPackageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsUpdateBackgroundCheckPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsUpdateBackgroundCheckPackageRequest.class, new TypeReference<AtsUpdateBackgroundCheckPackageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsUpdateBackgroundCheckPackageRequest request) throws Exception {
        ...
        @Override
        public AtsUpdateBackgroundCheckPackageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsUpdateBackgroundCheckPackageResponse.Builder resBuilder =
            ...
            AtsUpdateBackgroundCheckPackageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsUpdateBackgroundCheckPackageRequest, com.stackone.stackone_client_java.models.operations.async.AtsUpdateBackgroundCheckPackageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsUpdateBackgroundCheckPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsUpdateBackgroundCheckPackageRequest.class, new TypeReference<AtsUpdateBackgroundCheckPackageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsUpdateBackgroundCheckPackageRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsUpdateBackgroundCheckPackageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsUpdateBackgroundCheckPackageResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsUpdateBackgroundCheckPackageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsUpdateBackgroundCheckPackageResponse res = resBuilder.build();
