...
public class HrisGetEmployeesTimeOffRequestOperation implements RequestOperation<HrisGetEmployeesTimeOffRequestRequest, HrisGetEmployeesTimeOffRequestResponse> {
    ...
    public HrisGetEmployeesTimeOffRequestOperation(
    ...
    public HttpRequest buildRequest(HrisGetEmployeesTimeOffRequestRequest request) throws Exception {
