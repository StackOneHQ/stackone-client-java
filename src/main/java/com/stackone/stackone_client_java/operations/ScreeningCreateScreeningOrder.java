...
public class ScreeningCreateScreeningOrder {
    ...
    public static class Sync extends Base
            implements RequestOperation<ScreeningCreateScreeningOrderRequest, ScreeningCreateScreeningOrderResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ScreeningCreateScreeningOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ScreeningCreateScreeningOrderRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ScreeningCreateScreeningOrderRequest request) {
        ...
        @Override
        public ScreeningCreateScreeningOrderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ScreeningCreateScreeningOrderResponse.Builder resBuilder =
            ...
            ScreeningCreateScreeningOrderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ScreeningCreateScreeningOrderRequest, com.stackone.stackone_client_java.models.operations.async.ScreeningCreateScreeningOrderResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ScreeningCreateScreeningOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ScreeningCreateScreeningOrderRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ScreeningCreateScreeningOrderRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.ScreeningCreateScreeningOrderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.ScreeningCreateScreeningOrderResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.ScreeningCreateScreeningOrderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.ScreeningCreateScreeningOrderResponse res = resBuilder.build();
