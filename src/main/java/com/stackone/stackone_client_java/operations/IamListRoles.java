...
public class IamListRoles {
    ...
    public static class Sync extends Base
            implements RequestOperation<IamListRolesRequest, IamListRolesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IamListRolesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamListRolesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamListRolesRequest request) {
        ...
        @Override
        public IamListRolesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IamListRolesResponse.Builder resBuilder =
            ...
            IamListRolesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIamRolesPaginated(Utils.unmarshal(response, new TypeReference<IamRolesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IamListRolesRequest, com.stackone.stackone_client_java.models.operations.async.IamListRolesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IamListRolesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IamListRolesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IamListRolesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.IamListRolesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.IamListRolesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.IamListRolesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.IamListRolesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<IamRolesPaginated>() {})
                            .thenApply(res::withIamRolesPaginated);
                } else {
