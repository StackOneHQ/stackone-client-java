...
public class IamListRoles {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IamListRolesRequest request) throws Exception {
        ...
        @Override
        public IamListRolesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    IamRolesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withIamRolesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
