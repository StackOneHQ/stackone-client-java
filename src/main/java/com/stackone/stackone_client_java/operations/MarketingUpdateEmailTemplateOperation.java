...
public class MarketingUpdateEmailTemplateOperation implements RequestOperation<MarketingUpdateEmailTemplateRequest, MarketingUpdateEmailTemplateResponse> {
    ...
    public MarketingUpdateEmailTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingUpdateEmailTemplateRequest request) throws Exception {
