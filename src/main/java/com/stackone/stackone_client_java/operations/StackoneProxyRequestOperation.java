...
public class StackoneProxyRequestOperation implements RequestOperation<StackoneProxyRequestRequest, StackoneProxyRequestResponse> {
    ...
    public StackoneProxyRequestOperation(
    ...
    public HttpRequest buildRequest(StackoneProxyRequestRequest request) throws Exception {
