...
public class HrisGetTimeOffPolicy {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetTimeOffPolicyRequest, HrisGetTimeOffPolicyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetTimeOffPolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetTimeOffPolicyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetTimeOffPolicyRequest request) {
        ...
        @Override
        public HrisGetTimeOffPolicyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetTimeOffPolicyResponse.Builder resBuilder =
            ...
            HrisGetTimeOffPolicyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTimeOffPolicyResult(Utils.unmarshal(response, new TypeReference<TimeOffPolicyResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetTimeOffPolicyRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetTimeOffPolicyResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetTimeOffPolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetTimeOffPolicyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetTimeOffPolicyRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetTimeOffPolicyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetTimeOffPolicyResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetTimeOffPolicyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetTimeOffPolicyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TimeOffPolicyResult>() {})
                            .thenApply(res::withTimeOffPolicyResult);
                } else {
