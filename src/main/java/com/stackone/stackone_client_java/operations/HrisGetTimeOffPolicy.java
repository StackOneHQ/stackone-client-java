...
public class HrisGetTimeOffPolicy {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetTimeOffPolicyRequest request) throws Exception {
        ...
        @Override
        public HrisGetTimeOffPolicyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TimeOffPolicyResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTimeOffPolicyResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
