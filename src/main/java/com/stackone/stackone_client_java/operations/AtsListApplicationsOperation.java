...
public class AtsListApplicationsOperation implements RequestOperation<AtsListApplicationsRequest, AtsListApplicationsResponse> {
    ...
    public AtsListApplicationsOperation(
    ...
    public HttpRequest buildRequest(AtsListApplicationsRequest request) throws Exception {
