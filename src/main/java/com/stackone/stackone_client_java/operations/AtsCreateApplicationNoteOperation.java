...
public class AtsCreateApplicationNoteOperation implements RequestOperation<AtsCreateApplicationNoteRequest, AtsCreateApplicationNoteResponse> {
    ...
    public AtsCreateApplicationNoteOperation(
    ...
    public HttpRequest buildRequest(AtsCreateApplicationNoteRequest request) throws Exception {
