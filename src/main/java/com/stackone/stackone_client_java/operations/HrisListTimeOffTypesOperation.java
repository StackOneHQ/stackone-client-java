...
public class HrisListTimeOffTypesOperation implements RequestOperation<HrisListTimeOffTypesRequest, HrisListTimeOffTypesResponse> {
    ...
    public HrisListTimeOffTypesOperation(
    ...
    public HttpRequest buildRequest(HrisListTimeOffTypesRequest request) throws Exception {
