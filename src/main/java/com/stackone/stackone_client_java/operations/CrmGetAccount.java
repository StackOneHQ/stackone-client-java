...
public class CrmGetAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmGetAccountRequest, CrmGetAccountResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmGetAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmGetAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmGetAccountRequest request) {
        ...
        @Override
        public CrmGetAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmGetAccountResponse.Builder resBuilder =
            ...
            CrmGetAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountResult(Utils.unmarshal(response, new TypeReference<AccountResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmGetAccountRequest, com.stackone.stackone_client_java.models.operations.async.CrmGetAccountResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmGetAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmGetAccountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmGetAccountRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.CrmGetAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.CrmGetAccountResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.CrmGetAccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.CrmGetAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountResult>() {})
                            .thenApply(res::withAccountResult);
                } else {
