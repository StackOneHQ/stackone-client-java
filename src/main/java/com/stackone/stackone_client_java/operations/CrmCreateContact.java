...
public class CrmCreateContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCreateContactRequest, CrmCreateContactResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCreateContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CrmCreateContactRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCreateContactRequest request) {
        ...
        @Override
        public CrmCreateContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCreateContactResponse.Builder resBuilder =
            ...
            CrmCreateContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCreateContactRequest, com.stackone.stackone_client_java.models.operations.async.CrmCreateContactResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCreateContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CrmCreateContactRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCreateContactRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.CrmCreateContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.CrmCreateContactResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.CrmCreateContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.CrmCreateContactResponse res = resBuilder.build();
