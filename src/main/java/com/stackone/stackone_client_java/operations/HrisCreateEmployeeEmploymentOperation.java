...
public class HrisCreateEmployeeEmploymentOperation implements RequestOperation<HrisCreateEmployeeEmploymentRequest, HrisCreateEmployeeEmploymentResponse> {
    ...
    public HrisCreateEmployeeEmploymentOperation(
    ...
    public HttpRequest buildRequest(HrisCreateEmployeeEmploymentRequest request) throws Exception {
