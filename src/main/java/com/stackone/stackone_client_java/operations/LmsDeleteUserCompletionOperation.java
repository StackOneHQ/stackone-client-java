...
public class LmsDeleteUserCompletionOperation implements RequestOperation<LmsDeleteUserCompletionRequest, LmsDeleteUserCompletionResponse> {
    ...
    public LmsDeleteUserCompletionOperation(
    ...
    public HttpRequest buildRequest(LmsDeleteUserCompletionRequest request) throws Exception {
