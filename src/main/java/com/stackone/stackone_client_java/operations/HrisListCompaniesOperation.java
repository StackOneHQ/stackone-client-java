...
public class HrisListCompaniesOperation implements RequestOperation<HrisListCompaniesRequest, HrisListCompaniesResponse> {
    ...
    public HrisListCompaniesOperation(
    ...
    public HttpRequest buildRequest(HrisListCompaniesRequest request) throws Exception {
