...
public class HrisGetEmployeeCustomFieldDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetEmployeeCustomFieldDefinitionRequest, HrisGetEmployeeCustomFieldDefinitionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetEmployeeCustomFieldDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetEmployeeCustomFieldDefinitionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetEmployeeCustomFieldDefinitionRequest request) {
        ...
        @Override
        public HrisGetEmployeeCustomFieldDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetEmployeeCustomFieldDefinitionResponse.Builder resBuilder =
            ...
            HrisGetEmployeeCustomFieldDefinitionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetEmployeeCustomFieldDefinitionRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeCustomFieldDefinitionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetEmployeeCustomFieldDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetEmployeeCustomFieldDefinitionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetEmployeeCustomFieldDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeCustomFieldDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeCustomFieldDefinitionResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeCustomFieldDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetEmployeeCustomFieldDefinitionResponse res = resBuilder.build();
