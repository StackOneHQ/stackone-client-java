...
public class AccountingGetCompanyJournal {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(AccountingGetCompanyJournalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGetCompanyJournalRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingGetCompanyJournalRequest request) {
        ...
        @Override
        public AccountingGetCompanyJournalResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingJournalResult(Utils.unmarshal(response, new TypeReference<AccountingJournalResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingGetCompanyJournalRequest, com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyJournalResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingGetCompanyJournalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGetCompanyJournalRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingGetCompanyJournalRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyJournalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyJournalResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyJournalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AccountingGetCompanyJournalResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingJournalResult>() {})
                            .thenApply(res::withAccountingJournalResult);
                } else {
