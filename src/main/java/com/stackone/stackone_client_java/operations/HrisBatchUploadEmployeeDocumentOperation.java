...
public class HrisBatchUploadEmployeeDocumentOperation implements RequestOperation<HrisBatchUploadEmployeeDocumentRequest, HrisBatchUploadEmployeeDocumentResponse> {
    ...
    public HrisBatchUploadEmployeeDocumentOperation(
    ...
    public HttpRequest buildRequest(HrisBatchUploadEmployeeDocumentRequest request) throws Exception {
