...
public class LmsGetUser {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsGetUserRequest, LmsGetUserResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsGetUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetUserRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsGetUserRequest request) {
        ...
        @Override
        public LmsGetUserResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsGetUserResponse.Builder resBuilder =
                    LmsGetUserResponse
                            .builder()
            ...
            LmsGetUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUserResult(Utils.unmarshal(response, new TypeReference<UserResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsGetUserRequest, com.stackone.stackone_client_java.models.operations.async.LmsGetUserResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsGetUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsGetUserRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsGetUserRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsGetUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsGetUserResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsGetUserResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsGetUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UserResult>() {})
                            .thenApply(res::withUserResult);
                } else {
