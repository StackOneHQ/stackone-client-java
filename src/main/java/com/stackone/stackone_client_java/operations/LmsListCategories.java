...
public class LmsListCategories {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListCategoriesRequest request) throws Exception {
        ...
        @Override
        public LmsListCategoriesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CategoriesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCategoriesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
