...
public class LmsListCategories {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsListCategoriesRequest, LmsListCategoriesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsListCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListCategoriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsListCategoriesRequest request) {
        ...
        @Override
        public LmsListCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsListCategoriesResponse.Builder resBuilder =
            ...
            LmsListCategoriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCategoriesPaginated(Utils.unmarshal(response, new TypeReference<CategoriesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsListCategoriesRequest, com.stackone.stackone_client_java.models.operations.async.LmsListCategoriesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsListCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LmsListCategoriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsListCategoriesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsListCategoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsListCategoriesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsListCategoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsListCategoriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CategoriesPaginated>() {})
                            .thenApply(res::withCategoriesPaginated);
                } else {
