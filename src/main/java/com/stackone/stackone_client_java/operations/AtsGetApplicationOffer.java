...
public class AtsGetApplicationOffer {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetApplicationOfferRequest request) throws Exception {
        ...
        @Override
        public AtsGetApplicationOfferResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OffersResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOffersResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
