...
public class AtsGetAssessmentsPackage {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetAssessmentsPackageRequest request) throws Exception {
        ...
        @Override
        public AtsGetAssessmentsPackageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AssessmentPackageResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAssessmentPackageResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
