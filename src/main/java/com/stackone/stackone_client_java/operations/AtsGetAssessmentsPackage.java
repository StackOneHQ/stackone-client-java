...
public class AtsGetAssessmentsPackage {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetAssessmentsPackageRequest, AtsGetAssessmentsPackageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetAssessmentsPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetAssessmentsPackageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetAssessmentsPackageRequest request) {
        ...
        @Override
        public AtsGetAssessmentsPackageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetAssessmentsPackageResponse.Builder resBuilder =
            ...
            AtsGetAssessmentsPackageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAssessmentPackageResult(Utils.unmarshal(response, new TypeReference<AssessmentPackageResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetAssessmentsPackageRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetAssessmentsPackageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetAssessmentsPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetAssessmentsPackageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetAssessmentsPackageRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetAssessmentsPackageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetAssessmentsPackageResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetAssessmentsPackageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetAssessmentsPackageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AssessmentPackageResult>() {})
                            .thenApply(res::withAssessmentPackageResult);
                } else {
