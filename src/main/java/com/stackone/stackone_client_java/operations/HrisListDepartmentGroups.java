...
public class HrisListDepartmentGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListDepartmentGroupsRequest, HrisListDepartmentGroupsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListDepartmentGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListDepartmentGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListDepartmentGroupsRequest request) {
        ...
        @Override
        public HrisListDepartmentGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListDepartmentGroupsResponse.Builder resBuilder =
            ...
            HrisListDepartmentGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISDepartmentsPaginated(Utils.unmarshal(response, new TypeReference<HRISDepartmentsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListDepartmentGroupsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListDepartmentGroupsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListDepartmentGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListDepartmentGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListDepartmentGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListDepartmentGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListDepartmentGroupsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListDepartmentGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListDepartmentGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISDepartmentsPaginated>() {})
                            .thenApply(res::withHRISDepartmentsPaginated);
                } else {
