...
public class HrisListDepartmentGroups {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListDepartmentGroupsRequest request) throws Exception {
        ...
        @Override
        public HrisListDepartmentGroupsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HRISDepartmentsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHRISDepartmentsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
