...
public class TicketingGetTicketType {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingGetTicketTypeRequest request) throws Exception {
        ...
        @Override
        public TicketingGetTicketTypeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TicketingTicketTypeResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingTicketTypeResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
