...
public class TicketingGetTicketType {
    ...
    public static class Sync extends Base
            implements RequestOperation<TicketingGetTicketTypeRequest, TicketingGetTicketTypeResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TicketingGetTicketTypeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetTicketTypeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TicketingGetTicketTypeRequest request) {
        ...
        @Override
        public TicketingGetTicketTypeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TicketingGetTicketTypeResponse.Builder resBuilder =
            ...
            TicketingGetTicketTypeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingTicketTypeResult(Utils.unmarshal(response, new TypeReference<TicketingTicketTypeResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TicketingGetTicketTypeRequest, com.stackone.stackone_client_java.models.operations.async.TicketingGetTicketTypeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TicketingGetTicketTypeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TicketingGetTicketTypeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TicketingGetTicketTypeRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.TicketingGetTicketTypeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.TicketingGetTicketTypeResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.TicketingGetTicketTypeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.TicketingGetTicketTypeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingTicketTypeResult>() {})
                            .thenApply(res::withTicketingTicketTypeResult);
                } else {
