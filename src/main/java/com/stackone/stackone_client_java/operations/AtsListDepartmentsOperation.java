...
public class AtsListDepartmentsOperation implements RequestOperation<AtsListDepartmentsRequest, AtsListDepartmentsResponse> {
    ...
    public AtsListDepartmentsOperation(
    ...
    public HttpRequest buildRequest(AtsListDepartmentsRequest request) throws Exception {
