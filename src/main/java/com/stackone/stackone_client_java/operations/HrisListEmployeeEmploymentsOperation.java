...
public class HrisListEmployeeEmploymentsOperation implements RequestOperation<HrisListEmployeeEmploymentsRequest, HrisListEmployeeEmploymentsResponse> {
    ...
    public HrisListEmployeeEmploymentsOperation(
    ...
    public HttpRequest buildRequest(HrisListEmployeeEmploymentsRequest request) throws Exception {
