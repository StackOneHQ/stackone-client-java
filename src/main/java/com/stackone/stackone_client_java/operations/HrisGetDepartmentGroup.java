...
public class HrisGetDepartmentGroup {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetDepartmentGroupRequest request) throws Exception {
        ...
        @Override
        public HrisGetDepartmentGroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HRISDepartmentsResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHRISDepartmentsResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
