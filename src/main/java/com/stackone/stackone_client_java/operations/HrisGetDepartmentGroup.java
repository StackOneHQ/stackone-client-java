...
public class HrisGetDepartmentGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisGetDepartmentGroupRequest, HrisGetDepartmentGroupResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisGetDepartmentGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetDepartmentGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisGetDepartmentGroupRequest request) {
        ...
        @Override
        public HrisGetDepartmentGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisGetDepartmentGroupResponse.Builder resBuilder =
            ...
            HrisGetDepartmentGroupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISDepartmentsResult(Utils.unmarshal(response, new TypeReference<HRISDepartmentsResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisGetDepartmentGroupRequest, com.stackone.stackone_client_java.models.operations.async.HrisGetDepartmentGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisGetDepartmentGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisGetDepartmentGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisGetDepartmentGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisGetDepartmentGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisGetDepartmentGroupResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisGetDepartmentGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisGetDepartmentGroupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISDepartmentsResult>() {})
                            .thenApply(res::withHRISDepartmentsResult);
                } else {
