...
public class MessagingGetMessage {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingGetMessageRequest request) throws Exception {
        ...
        @Override
        public MessagingGetMessageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MessagingMessageResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMessagingMessageResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
