...
public class MessagingGetMessage {
    ...
    public static class Sync extends Base
            implements RequestOperation<MessagingGetMessageRequest, MessagingGetMessageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MessagingGetMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingGetMessageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingGetMessageRequest request) {
        ...
        @Override
        public MessagingGetMessageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MessagingGetMessageResponse.Builder resBuilder =
            ...
            MessagingGetMessageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingMessageResult(Utils.unmarshal(response, new TypeReference<MessagingMessageResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MessagingGetMessageRequest, com.stackone.stackone_client_java.models.operations.async.MessagingGetMessageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MessagingGetMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingGetMessageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MessagingGetMessageRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MessagingGetMessageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MessagingGetMessageResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MessagingGetMessageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MessagingGetMessageResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MessagingMessageResult>() {})
                            .thenApply(res::withMessagingMessageResult);
                } else {
