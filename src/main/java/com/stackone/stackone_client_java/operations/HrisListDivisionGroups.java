...
public class HrisListDivisionGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisListDivisionGroupsRequest, HrisListDivisionGroupsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisListDivisionGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListDivisionGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListDivisionGroupsRequest request) {
        ...
        @Override
        public HrisListDivisionGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisListDivisionGroupsResponse.Builder resBuilder =
            ...
            HrisListDivisionGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHRISDivisionsPaginated(Utils.unmarshal(response, new TypeReference<HRISDivisionsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisListDivisionGroupsRequest, com.stackone.stackone_client_java.models.operations.async.HrisListDivisionGroupsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisListDivisionGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisListDivisionGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisListDivisionGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisListDivisionGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisListDivisionGroupsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisListDivisionGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisListDivisionGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HRISDivisionsPaginated>() {})
                            .thenApply(res::withHRISDivisionsPaginated);
                } else {
