...
public class HrisListDivisionGroups {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisListDivisionGroupsRequest request) throws Exception {
        ...
        @Override
        public HrisListDivisionGroupsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HRISDivisionsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHRISDivisionsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
