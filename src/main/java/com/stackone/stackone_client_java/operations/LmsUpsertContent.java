...
public class LmsUpsertContent {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsUpsertContentRequest request) throws Exception {
        ...
        @Override
        public LmsUpsertContentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpsertResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpsertResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
