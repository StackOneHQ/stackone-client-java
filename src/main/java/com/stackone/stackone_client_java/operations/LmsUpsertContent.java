...
public class LmsUpsertContent {
    ...
    public static class Sync extends Base
            implements RequestOperation<LmsUpsertContentRequest, LmsUpsertContentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LmsUpsertContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<LmsUpsertContentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LmsUpsertContentRequest request) {
        ...
        @Override
        public LmsUpsertContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LmsUpsertContentResponse.Builder resBuilder =
            ...
            LmsUpsertContentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpsertResult(Utils.unmarshal(response, new TypeReference<UpsertResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LmsUpsertContentRequest, com.stackone.stackone_client_java.models.operations.async.LmsUpsertContentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LmsUpsertContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<LmsUpsertContentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LmsUpsertContentRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.LmsUpsertContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.LmsUpsertContentResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.LmsUpsertContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.LmsUpsertContentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpsertResult>() {})
                            .thenApply(res::withUpsertResult);
                } else {
