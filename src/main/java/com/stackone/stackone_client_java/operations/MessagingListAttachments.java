...
public class MessagingListAttachments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingListAttachmentsRequest request) throws Exception {
        ...
        @Override
        public MessagingListAttachmentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MessagingAttachmentsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMessagingAttachmentsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
