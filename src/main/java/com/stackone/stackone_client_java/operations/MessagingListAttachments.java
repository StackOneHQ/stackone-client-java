...
public class MessagingListAttachments {
    ...
    public static class Sync extends Base
            implements RequestOperation<MessagingListAttachmentsRequest, MessagingListAttachmentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MessagingListAttachmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingListAttachmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingListAttachmentsRequest request) {
        ...
        @Override
        public MessagingListAttachmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MessagingListAttachmentsResponse.Builder resBuilder =
            ...
            MessagingListAttachmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingAttachmentsPaginated(Utils.unmarshal(response, new TypeReference<MessagingAttachmentsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MessagingListAttachmentsRequest, com.stackone.stackone_client_java.models.operations.async.MessagingListAttachmentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MessagingListAttachmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingListAttachmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MessagingListAttachmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MessagingListAttachmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MessagingListAttachmentsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MessagingListAttachmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MessagingListAttachmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MessagingAttachmentsPaginated>() {})
                            .thenApply(res::withMessagingAttachmentsPaginated);
                } else {
