...
public class AtsGetJobPostingOperation implements RequestOperation<AtsGetJobPostingRequest, AtsGetJobPostingResponse> {
    ...
    public AtsGetJobPostingOperation(
    ...
    public HttpRequest buildRequest(AtsGetJobPostingRequest request) throws Exception {
