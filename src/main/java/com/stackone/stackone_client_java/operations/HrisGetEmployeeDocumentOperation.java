...
public class HrisGetEmployeeDocumentOperation implements RequestOperation<HrisGetEmployeeDocumentRequest, HrisGetEmployeeDocumentResponse> {
    ...
    public HrisGetEmployeeDocumentOperation(
    ...
    public HttpRequest buildRequest(HrisGetEmployeeDocumentRequest request) throws Exception {
