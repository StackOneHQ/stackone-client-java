...
public class MarketingGetPushTemplate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingGetPushTemplateRequest request) throws Exception {
        ...
        @Override
        public MarketingGetPushTemplateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PushTemplateResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPushTemplateResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
