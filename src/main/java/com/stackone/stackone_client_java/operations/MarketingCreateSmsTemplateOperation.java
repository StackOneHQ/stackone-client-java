...
public class MarketingCreateSmsTemplateOperation implements RequestOperation<MarketingCreateSmsTemplateRequest, MarketingCreateSmsTemplateResponse> {
    ...
    public MarketingCreateSmsTemplateOperation(
    ...
    public HttpRequest buildRequest(MarketingCreateSmsTemplateRequest request) throws Exception {
