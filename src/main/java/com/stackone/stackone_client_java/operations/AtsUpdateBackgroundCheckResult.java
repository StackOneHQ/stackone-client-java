...
public class AtsUpdateBackgroundCheckResult {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsUpdateBackgroundCheckResultRequest, AtsUpdateBackgroundCheckResultResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(AtsUpdateBackgroundCheckResultRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsUpdateBackgroundCheckResultRequest.class, new TypeReference<AtsUpdateBackgroundCheckResultRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsUpdateBackgroundCheckResultRequest request) throws Exception {
        ...
        @Override
        public AtsUpdateBackgroundCheckResultResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsUpdateBackgroundCheckResultResponse.Builder resBuilder =
            ...
            AtsUpdateBackgroundCheckResultResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsUpdateBackgroundCheckResultRequest, com.stackone.stackone_client_java.models.operations.async.AtsUpdateBackgroundCheckResultResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsUpdateBackgroundCheckResultRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsUpdateBackgroundCheckResultRequest.class, new TypeReference<AtsUpdateBackgroundCheckResultRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsUpdateBackgroundCheckResultRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsUpdateBackgroundCheckResultResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsUpdateBackgroundCheckResultResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsUpdateBackgroundCheckResultResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsUpdateBackgroundCheckResultResponse res = resBuilder.build();
