...
public class HrisListEmployeeTasksOperation implements RequestOperation<HrisListEmployeeTasksRequest, HrisListEmployeeTasksResponse> {
    ...
    public HrisListEmployeeTasksOperation(
    ...
    public HttpRequest buildRequest(HrisListEmployeeTasksRequest request) throws Exception {
