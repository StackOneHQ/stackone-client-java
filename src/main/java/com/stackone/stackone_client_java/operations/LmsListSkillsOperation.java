...
public class LmsListSkillsOperation implements RequestOperation<LmsListSkillsRequest, LmsListSkillsResponse> {
    ...
    public HttpRequest buildRequest(LmsListSkillsRequest request) throws Exception {
