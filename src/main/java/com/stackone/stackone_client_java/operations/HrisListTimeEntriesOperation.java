...
public class HrisListTimeEntriesOperation implements RequestOperation<HrisListTimeEntriesRequest, HrisListTimeEntriesResponse> {
    ...
    public HrisListTimeEntriesOperation(
    ...
    public HttpRequest buildRequest(HrisListTimeEntriesRequest request) throws Exception {
