...
public class DocumentsUploadFile {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(DocumentsUploadFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<DocumentsUploadFileRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DocumentsUploadFileRequest request) {
        ...
        @Override
        public DocumentsUploadFileResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DocumentsUploadFileRequest, com.stackone.stackone_client_java.models.operations.async.DocumentsUploadFileResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DocumentsUploadFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<DocumentsUploadFileRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DocumentsUploadFileRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.DocumentsUploadFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.DocumentsUploadFileResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.DocumentsUploadFileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.DocumentsUploadFileResponse res = resBuilder.build();
