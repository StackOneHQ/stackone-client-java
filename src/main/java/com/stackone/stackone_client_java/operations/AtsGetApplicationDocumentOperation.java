...
public class AtsGetApplicationDocumentOperation implements RequestOperation<AtsGetApplicationDocumentRequest, AtsGetApplicationDocumentResponse> {
    ...
    public AtsGetApplicationDocumentOperation(
    ...
    public HttpRequest buildRequest(AtsGetApplicationDocumentRequest request) throws Exception {
