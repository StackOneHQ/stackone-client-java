...
public class CrmListContactsOperation implements RequestOperation<CrmListContactsRequest, CrmListContactsResponse> {
    ...
    public CrmListContactsOperation(
    ...
    public HttpRequest buildRequest(CrmListContactsRequest request) throws Exception {
