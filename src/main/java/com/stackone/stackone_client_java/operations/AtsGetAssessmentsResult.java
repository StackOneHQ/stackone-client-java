...
public class AtsGetAssessmentsResult {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AtsGetAssessmentsResultRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetAssessmentsResultRequest, AtsGetAssessmentsResultResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(AtsGetAssessmentsResultRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetAssessmentsResultRequest request) throws Exception {
        ...
        @Override
        public AtsGetAssessmentsResultResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetAssessmentsResultResponse.Builder resBuilder =
            ...
            AtsGetAssessmentsResultResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AssessmentResultsResult out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAssessmentResultsResult(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
