...
public class HrisListEmployeeDocumentsOperation implements RequestOperation<HrisListEmployeeDocumentsRequest, HrisListEmployeeDocumentsResponse> {
    ...
    public HrisListEmployeeDocumentsOperation(
    ...
    public HttpRequest buildRequest(HrisListEmployeeDocumentsRequest request) throws Exception {
