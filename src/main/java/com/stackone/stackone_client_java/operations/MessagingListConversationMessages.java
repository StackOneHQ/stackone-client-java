...
public class MessagingListConversationMessages {
    ...
    public static class Sync extends Base
            implements RequestOperation<MessagingListConversationMessagesRequest, MessagingListConversationMessagesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MessagingListConversationMessagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingListConversationMessagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingListConversationMessagesRequest request) {
        ...
        @Override
        public MessagingListConversationMessagesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MessagingListConversationMessagesResponse.Builder resBuilder =
            ...
            MessagingListConversationMessagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingMessagesPaginated(Utils.unmarshal(response, new TypeReference<MessagingMessagesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MessagingListConversationMessagesRequest, com.stackone.stackone_client_java.models.operations.async.MessagingListConversationMessagesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MessagingListConversationMessagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagingListConversationMessagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MessagingListConversationMessagesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MessagingListConversationMessagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MessagingListConversationMessagesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MessagingListConversationMessagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MessagingListConversationMessagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MessagingMessagesPaginated>() {})
                            .thenApply(res::withMessagingMessagesPaginated);
                } else {
