...
public class MessagingListConversationMessages {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MessagingListConversationMessagesRequest request) throws Exception {
        ...
        @Override
        public MessagingListConversationMessagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MessagingMessagesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMessagingMessagesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
