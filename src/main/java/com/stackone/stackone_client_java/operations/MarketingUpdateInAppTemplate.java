...
public class MarketingUpdateInAppTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingUpdateInAppTemplateRequest, MarketingUpdateInAppTemplateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingUpdateInAppTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingUpdateInAppTemplateRequest.class, new TypeReference<MarketingUpdateInAppTemplateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingUpdateInAppTemplateRequest request) {
        ...
        @Override
        public MarketingUpdateInAppTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingUpdateInAppTemplateResponse.Builder resBuilder =
            ...
            MarketingUpdateInAppTemplateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingUpdateInAppTemplateRequest, com.stackone.stackone_client_java.models.operations.async.MarketingUpdateInAppTemplateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingUpdateInAppTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingUpdateInAppTemplateRequest.class, new TypeReference<MarketingUpdateInAppTemplateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingUpdateInAppTemplateRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingUpdateInAppTemplateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingUpdateInAppTemplateResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingUpdateInAppTemplateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingUpdateInAppTemplateResponse res = resBuilder.build();
