...
public class AtsListApplicationsOffers {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListApplicationsOffersRequest request) throws Exception {
        ...
        @Override
        public AtsListApplicationsOffersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OffersPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOffersPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
