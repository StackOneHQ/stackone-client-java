...
public class IamGetUserOperation implements RequestOperation<IamGetUserRequest, IamGetUserResponse> {
    ...
    public HttpRequest buildRequest(IamGetUserRequest request) throws Exception {
