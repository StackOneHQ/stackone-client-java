...
public class CrmGetList {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmGetListRequest, CrmGetListResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmGetListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmGetListRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmGetListRequest request) {
        ...
        @Override
        public CrmGetListResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmGetListResponse.Builder resBuilder =
                    CrmGetListResponse
                            .builder()
            ...
            CrmGetListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListResult(Utils.unmarshal(response, new TypeReference<ListResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmGetListRequest, com.stackone.stackone_client_java.models.operations.async.CrmGetListResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmGetListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmGetListRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmGetListRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.CrmGetListResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.CrmGetListResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.CrmGetListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.CrmGetListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListResult>() {})
                            .thenApply(res::withListResult);
                } else {
