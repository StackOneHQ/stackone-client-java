...
public class AtsListLocations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListLocationsRequest request) throws Exception {
        ...
        @Override
        public AtsListLocationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ATSLocationsPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withATSLocationsPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
