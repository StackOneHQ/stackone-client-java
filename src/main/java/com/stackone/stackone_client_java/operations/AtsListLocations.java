...
public class AtsListLocations {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListLocationsRequest, AtsListLocationsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListLocationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListLocationsRequest request) {
        ...
        @Override
        public AtsListLocationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListLocationsResponse.Builder resBuilder =
            ...
            AtsListLocationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withATSLocationsPaginated(Utils.unmarshal(response, new TypeReference<ATSLocationsPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListLocationsRequest, com.stackone.stackone_client_java.models.operations.async.AtsListLocationsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListLocationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListLocationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListLocationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListLocationsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListLocationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListLocationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ATSLocationsPaginated>() {})
                            .thenApply(res::withATSLocationsPaginated);
                } else {
