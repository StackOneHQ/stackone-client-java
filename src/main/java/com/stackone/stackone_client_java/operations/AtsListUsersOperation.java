...
public class AtsListUsersOperation implements RequestOperation<AtsListUsersRequest, AtsListUsersResponse> {
    ...
    public HttpRequest buildRequest(AtsListUsersRequest request) throws Exception {
