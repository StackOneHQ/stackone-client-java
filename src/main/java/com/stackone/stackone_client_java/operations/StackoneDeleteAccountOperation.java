...
public class StackoneDeleteAccountOperation implements RequestOperation<StackoneDeleteAccountRequest, StackoneDeleteAccountResponse> {
    ...
    public StackoneDeleteAccountOperation(
    ...
    public HttpRequest buildRequest(StackoneDeleteAccountRequest request) throws Exception {
