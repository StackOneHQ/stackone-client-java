...
public class CrmGetListOperation implements RequestOperation<CrmGetListRequest, CrmGetListResponse> {
    ...
    public HttpRequest buildRequest(CrmGetListRequest request) throws Exception {
