...
public class AtsRejectApplicationOperation implements RequestOperation<AtsRejectApplicationRequest, AtsRejectApplicationResponse> {
    ...
    public AtsRejectApplicationOperation(
    ...
    public HttpRequest buildRequest(AtsRejectApplicationRequest request) throws Exception {
