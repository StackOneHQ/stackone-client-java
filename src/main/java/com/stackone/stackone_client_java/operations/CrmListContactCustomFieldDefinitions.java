...
public class CrmListContactCustomFieldDefinitions {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmListContactCustomFieldDefinitionsRequest, CrmListContactCustomFieldDefinitionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmListContactCustomFieldDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListContactCustomFieldDefinitionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmListContactCustomFieldDefinitionsRequest request) {
        ...
        @Override
        public CrmListContactCustomFieldDefinitionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmListContactCustomFieldDefinitionsResponse.Builder resBuilder =
            ...
            CrmListContactCustomFieldDefinitionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmListContactCustomFieldDefinitionsRequest, com.stackone.stackone_client_java.models.operations.async.CrmListContactCustomFieldDefinitionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmListContactCustomFieldDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListContactCustomFieldDefinitionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmListContactCustomFieldDefinitionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.CrmListContactCustomFieldDefinitionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.CrmListContactCustomFieldDefinitionsResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.CrmListContactCustomFieldDefinitionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.CrmListContactCustomFieldDefinitionsResponse res = resBuilder.build();
