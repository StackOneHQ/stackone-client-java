...
public class AtsListCandidates {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListCandidatesRequest request) throws Exception {
        ...
        @Override
        public AtsListCandidatesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CandidatesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCandidatesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
