...
public class AtsListCandidates {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsListCandidatesRequest, AtsListCandidatesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsListCandidatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListCandidatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsListCandidatesRequest request) {
        ...
        @Override
        public AtsListCandidatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsListCandidatesResponse.Builder resBuilder =
            ...
            AtsListCandidatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCandidatesPaginated(Utils.unmarshal(response, new TypeReference<CandidatesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsListCandidatesRequest, com.stackone.stackone_client_java.models.operations.async.AtsListCandidatesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsListCandidatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsListCandidatesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsListCandidatesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsListCandidatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsListCandidatesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsListCandidatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsListCandidatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CandidatesPaginated>() {})
                            .thenApply(res::withCandidatesPaginated);
                } else {
