...
public class MarketingListPushTemplates {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListPushTemplatesRequest request) throws Exception {
        ...
        @Override
        public MarketingListPushTemplatesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PushTemplatesPaginated out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPushTemplatesPaginated(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
