...
public class MarketingListPushTemplates {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarketingListPushTemplatesRequest, MarketingListPushTemplatesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarketingListPushTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListPushTemplatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarketingListPushTemplatesRequest request) {
        ...
        @Override
        public MarketingListPushTemplatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarketingListPushTemplatesResponse.Builder resBuilder =
            ...
            MarketingListPushTemplatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPushTemplatesPaginated(Utils.unmarshal(response, new TypeReference<PushTemplatesPaginated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarketingListPushTemplatesRequest, com.stackone.stackone_client_java.models.operations.async.MarketingListPushTemplatesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarketingListPushTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarketingListPushTemplatesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarketingListPushTemplatesRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.MarketingListPushTemplatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.MarketingListPushTemplatesResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.MarketingListPushTemplatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.MarketingListPushTemplatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PushTemplatesPaginated>() {})
                            .thenApply(res::withPushTemplatesPaginated);
                } else {
