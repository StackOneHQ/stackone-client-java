...
public class AtsGetInterviewStage {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsGetInterviewStageRequest, AtsGetInterviewStageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsGetInterviewStageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetInterviewStageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsGetInterviewStageRequest request) {
        ...
        @Override
        public AtsGetInterviewStageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsGetInterviewStageResponse.Builder resBuilder =
            ...
            AtsGetInterviewStageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsGetInterviewStageRequest, com.stackone.stackone_client_java.models.operations.async.AtsGetInterviewStageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsGetInterviewStageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsGetInterviewStageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsGetInterviewStageRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.AtsGetInterviewStageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.AtsGetInterviewStageResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.AtsGetInterviewStageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.AtsGetInterviewStageResponse res = resBuilder.build();
