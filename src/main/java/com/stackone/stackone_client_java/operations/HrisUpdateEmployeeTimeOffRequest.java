...
public class HrisUpdateEmployeeTimeOffRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisUpdateEmployeeTimeOffRequestRequest, HrisUpdateEmployeeTimeOffRequestResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisUpdateEmployeeTimeOffRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisUpdateEmployeeTimeOffRequestRequest.class, new TypeReference<HrisUpdateEmployeeTimeOffRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisUpdateEmployeeTimeOffRequestRequest request) {
        ...
        @Override
        public HrisUpdateEmployeeTimeOffRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisUpdateEmployeeTimeOffRequestResponse.Builder resBuilder =
            ...
            HrisUpdateEmployeeTimeOffRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisUpdateEmployeeTimeOffRequestRequest, com.stackone.stackone_client_java.models.operations.async.HrisUpdateEmployeeTimeOffRequestResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisUpdateEmployeeTimeOffRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisUpdateEmployeeTimeOffRequestRequest.class, new TypeReference<HrisUpdateEmployeeTimeOffRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisUpdateEmployeeTimeOffRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.stackone.stackone_client_java.models.operations.async.HrisUpdateEmployeeTimeOffRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.stackone.stackone_client_java.models.operations.async.HrisUpdateEmployeeTimeOffRequestResponse.Builder resBuilder =
                    com.stackone.stackone_client_java.models.operations.async.HrisUpdateEmployeeTimeOffRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.stackone.stackone_client_java.models.operations.async.HrisUpdateEmployeeTimeOffRequestResponse res = resBuilder.build();
