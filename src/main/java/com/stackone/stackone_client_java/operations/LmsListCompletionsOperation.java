...
public class LmsListCompletionsOperation implements RequestOperation<LmsListCompletionsRequest, LmsListCompletionsResponse> {
    ...
    public LmsListCompletionsOperation(
    ...
    public HttpRequest buildRequest(LmsListCompletionsRequest request) throws Exception {
