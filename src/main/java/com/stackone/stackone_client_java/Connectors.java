...
public class Connectors implements
    ...
    /**
     * STACKONE_LIST_CONNECTORS_META_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] STACKONE_LIST_CONNECTORS_META_SERVERS = {
        "https://api.stackone.com",
    };
    
    /**
     * STACKONE_GET_CONNECTOR_META_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] STACKONE_GET_CONNECTOR_META_SERVERS = {
        "https://api.stackone.com",
    };
    ...
    public StackoneListConnectorsMetaResponse listConnectorsMetaDirect() throws Exception {
        return listConnectorsMeta(JsonNullable.undefined(), Optional.empty(), Optional.empty());
    }
    ...
    public StackoneListConnectorsMetaResponse listConnectorsMeta(
        ...
        String _baseUrl = Utils.templateUrl(STACKONE_LIST_CONNECTORS_META_SERVERS[0], new HashMap<String, String>());
    ...
    public StackoneGetConnectorMetaResponse getConnectorMeta(
        ...
        return getConnectorMeta(provider, JsonNullable.undefined(), Optional.empty(), Optional.empty());
    }
    ...
    public StackoneGetConnectorMetaResponse getConnectorMeta(
        ...
        String _baseUrl = Utils.templateUrl(STACKONE_GET_CONNECTOR_META_SERVERS[0], new HashMap<String, String>());
        if (serverURL.isPresent() && !serverURL.get().isBlank()) {
            _baseUrl = serverURL.get();
        }
        String _url = Utils.generateURL(
