...
public class CrmListContactCustomFieldDefinitionsRequestBuilder {
    ...
    public CompletableFuture<CrmListContactCustomFieldDefinitionsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;CrmListContactCustomFieldDefinitionsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;CrmListContactCustomFieldDefinitionsResponse&gt;() {
     ...
     */
    public Publisher<CrmListContactCustomFieldDefinitionsResponse> callAsPublisher() {
        CrmListContactCustomFieldDefinitionsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
