...
public class AtsGetApplicationOfferRequest {
    ...
    @JsonCreator
    public AtsGetApplicationOfferRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public AtsGetApplicationOfferRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AtsGetApplicationOfferRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public AtsGetApplicationOfferRequest withSubResourceId(String subResourceId) {
        Utils.checkNotNull(subResourceId, "subResourceId");
        this.subResourceId = subResourceId;
        return this;
    }
     ...
     * value is false)
     */
    public AtsGetApplicationOfferRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public AtsGetApplicationOfferRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public AtsGetApplicationOfferRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public AtsGetApplicationOfferRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public AtsGetApplicationOfferRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public AtsGetApplicationOfferRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsGetApplicationOfferRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsGetApplicationOfferRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsGetApplicationOfferRequest other = (AtsGetApplicationOfferRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsGetApplicationOfferRequest.class,
    ...
    public final static class Builder {
        ...
        public AtsGetApplicationOfferRequest build() {

            return new AtsGetApplicationOfferRequest(
                xAccountId, id, subResourceId,
                raw, proxy, fields,
                prefer);
        }
