...
public class AtsListCandidatesRequest {
    ...
    private JsonNullable<? extends AtsListCandidatesQueryParamFilter> filter;
    ...
    @JsonCreator
    public AtsListCandidatesRequest(
            String xAccountId,
            JsonNullable<Boolean> raw,
            JsonNullable<? extends Map<String, Object>> proxy,
            JsonNullable<String> fields,
            JsonNullable<? extends AtsListCandidatesQueryParamFilter> filter,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<AtsListCandidatesQueryParamFilter> filter() {
        return (JsonNullable<AtsListCandidatesQueryParamFilter>) filter;
    }
     ...
     * The account identifier
     */
    public AtsListCandidatesRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }
     ...
     * ATS Candidate Filter
     */
    public AtsListCandidatesRequest withFilter(AtsListCandidatesQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * ATS Candidate Filter
     */
    public AtsListCandidatesRequest withFilter(JsonNullable<? extends AtsListCandidatesQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListCandidatesRequest withPage(String page) {
        Utils.checkNotNull(page, "page");
     ...
     */
    @Deprecated
    public AtsListCandidatesRequest withPage(JsonNullable<String> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public AtsListCandidatesRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public AtsListCandidatesRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public AtsListCandidatesRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public AtsListCandidatesRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListCandidatesRequest withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     */
    @Deprecated
    public AtsListCandidatesRequest withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListCandidatesRequest withSyncToken(String syncToken) {
        Utils.checkNotNull(syncToken, "syncToken");
     ...
     */
    @Deprecated
    public AtsListCandidatesRequest withSyncToken(JsonNullable<String> syncToken) {
        Utils.checkNotNull(syncToken, "syncToken");
        this.syncToken = syncToken;
        return this;
    }
     ...
     * The comma separated list of fields that will be included in the response
     */
    public AtsListCandidatesRequest withInclude(String include) {
        Utils.checkNotNull(include, "include");
     ...
     * The comma separated list of fields that will be included in the response
     */
    public AtsListCandidatesRequest withInclude(JsonNullable<String> include) {
        Utils.checkNotNull(include, "include");
        this.include = include;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsListCandidatesRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsListCandidatesRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListCandidatesRequest other = (AtsListCandidatesRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListCandidatesRequest.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends AtsListCandidatesQueryParamFilter> filter = JsonNullable.undefined();
         ...
         * ATS Candidate Filter
         */
        public Builder filter(AtsListCandidatesQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * ATS Candidate Filter
         */
        public Builder filter(JsonNullable<? extends AtsListCandidatesQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
        ...
        public AtsListCandidatesRequest build() {
            ...
            return new AtsListCandidatesRequest(
                xAccountId, raw, proxy,
                fields, filter, page,
                pageSize, next, updatedAfter,
                syncToken, include, prefer);
