...
public class AtsGetAssessmentsResultRequest {
    ...
    @JsonCreator
    public AtsGetAssessmentsResultRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public AtsGetAssessmentsResultRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AtsGetAssessmentsResultRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Indicates that the raw request result should be returned in addition to the mapped result (default value is false)
     */
    public AtsGetAssessmentsResultRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Indicates that the raw request result should be returned in addition to the mapped result (default value is false)
     */
    public AtsGetAssessmentsResultRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    public AtsGetAssessmentsResultRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    public AtsGetAssessmentsResultRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * The comma separated list of fields that will be returned in the response (if empty, all fields are returned)
     */
    public AtsGetAssessmentsResultRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * The comma separated list of fields that will be returned in the response (if empty, all fields are returned)
     */
    public AtsGetAssessmentsResultRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsGetAssessmentsResultRequest other = (AtsGetAssessmentsResultRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsGetAssessmentsResultRequest.class,
    ...
    public final static class Builder {
        ...
        public AtsGetAssessmentsResultRequest build() {
            return new AtsGetAssessmentsResultRequest(
                xAccountId,
                id,
                raw,
                proxy,
