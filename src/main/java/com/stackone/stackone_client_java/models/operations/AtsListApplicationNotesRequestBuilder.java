...
public class AtsListApplicationNotesRequestBuilder {
    ...
    public AtsListApplicationNotesResponse call() {
    ...
    * <pre><code>
    * for (AtsListApplicationNotesResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AtsListApplicationNotesResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
