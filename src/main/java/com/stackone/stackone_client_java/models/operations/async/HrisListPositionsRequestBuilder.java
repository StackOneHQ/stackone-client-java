...
public class HrisListPositionsRequestBuilder {
    ...
    public CompletableFuture<HrisListPositionsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisListPositionsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisListPositionsResponse&gt;() {
     ...
     */
    public Publisher<HrisListPositionsResponse> callAsPublisher() {
        HrisListPositionsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    HrisListPositionsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<HrisListPositionsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
