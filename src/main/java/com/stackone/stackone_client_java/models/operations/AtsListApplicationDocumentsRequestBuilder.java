...
public class AtsListApplicationDocumentsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallAtsListApplicationDocuments sdk;

    public AtsListApplicationDocumentsRequestBuilder(SDKMethodInterfaces.MethodCallAtsListApplicationDocuments sdk) {
        this.sdk = sdk;
    }
    ...
    public AtsListApplicationDocumentsResponse call() throws Exception {
        Optional<Options> options = Optional.of(Options.builder()
                                                    .retryConfig(retryConfig)
                                                    .build());
        return sdk.listApplicationDocuments(
            request,
            options);
    }
