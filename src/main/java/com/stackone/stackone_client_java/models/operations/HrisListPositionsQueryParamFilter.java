 ...
 */
public class HrisListPositionsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public HrisListPositionsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public HrisListPositionsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public HrisListPositionsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisListPositionsQueryParamFilter other = (HrisListPositionsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisListPositionsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public HrisListPositionsQueryParamFilter build() {

            return new HrisListPositionsQueryParamFilter(
                updatedAfter);
        }
