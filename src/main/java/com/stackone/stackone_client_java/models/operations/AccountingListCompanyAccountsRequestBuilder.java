...
public class AccountingListCompanyAccountsRequestBuilder {
    ...
    public AccountingListCompanyAccountsResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AccountingListCompanyAccountsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AccountingListCompanyAccountsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AccountingListCompanyAccountsResponse> callAsStream() {
