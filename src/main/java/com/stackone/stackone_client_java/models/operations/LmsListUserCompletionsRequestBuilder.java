...
public class LmsListUserCompletionsRequestBuilder {
    ...
    public LmsListUserCompletionsResponse call() throws Exception {
    ...
    * <pre><code>
    * for (LmsListUserCompletionsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<LmsListUserCompletionsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<LmsListUserCompletionsResponse> callAsStream() {
