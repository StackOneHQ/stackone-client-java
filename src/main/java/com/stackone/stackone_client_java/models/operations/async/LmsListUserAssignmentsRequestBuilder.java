...
public class LmsListUserAssignmentsRequestBuilder {
    ...
    public LmsListUserAssignmentsRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public CompletableFuture<LmsListUserAssignmentsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;LmsListUserAssignmentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;LmsListUserAssignmentsResponse&gt;() {
     ...
     */
    public Publisher<LmsListUserAssignmentsResponse> callAsPublisher() {
        LmsListUserAssignmentsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    LmsListUserAssignmentsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<LmsListUserAssignmentsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
