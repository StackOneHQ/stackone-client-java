...
public class HrisListTimeEntriesRequestBuilder {
    ...
    public CompletableFuture<HrisListTimeEntriesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisListTimeEntriesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisListTimeEntriesResponse&gt;() {
     ...
     */
    public Publisher<HrisListTimeEntriesResponse> callAsPublisher() {
        HrisListTimeEntriesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    HrisListTimeEntriesRequest::withNext,
            operation::doRequest);

        Flow.Publisher<HrisListTimeEntriesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
