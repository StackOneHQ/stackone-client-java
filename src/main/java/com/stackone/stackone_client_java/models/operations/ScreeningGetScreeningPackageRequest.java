...
public class ScreeningGetScreeningPackageRequest {
    /**
    ...
    @JsonCreator
    public ScreeningGetScreeningPackageRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public ScreeningGetScreeningPackageRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public ScreeningGetScreeningPackageRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public ScreeningGetScreeningPackageRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public ScreeningGetScreeningPackageRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public ScreeningGetScreeningPackageRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public ScreeningGetScreeningPackageRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public ScreeningGetScreeningPackageRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public ScreeningGetScreeningPackageRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public ScreeningGetScreeningPackageRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public ScreeningGetScreeningPackageRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ScreeningGetScreeningPackageRequest other = (ScreeningGetScreeningPackageRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ScreeningGetScreeningPackageRequest.class,
    ...
    public final static class Builder {
        ...
        public ScreeningGetScreeningPackageRequest build() {

            return new ScreeningGetScreeningPackageRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
