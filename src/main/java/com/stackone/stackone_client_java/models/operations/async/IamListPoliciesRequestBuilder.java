...
public class IamListPoliciesRequestBuilder {
    ...
    public CompletableFuture<IamListPoliciesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;IamListPoliciesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;IamListPoliciesResponse&gt;() {
     ...
     */
    public Publisher<IamListPoliciesResponse> callAsPublisher() {
        IamListPoliciesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<IamListPoliciesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
