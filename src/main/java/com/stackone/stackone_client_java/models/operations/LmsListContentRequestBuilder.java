...
public class LmsListContentRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallLmsListContent sdk;

    public LmsListContentRequestBuilder(SDKMethodInterfaces.MethodCallLmsListContent sdk) {
        this.sdk = sdk;
    }
    ...
    public LmsListContentResponse call() throws Exception {
        Optional<Options> options = Optional.of(Options.builder()
                                                    .retryConfig(retryConfig)
                                                    .build());
        return sdk.listContent(
            request,
            options);
    }
     ...
     **/  
    public Stream<LmsListContentResponse> callAsStream() {
