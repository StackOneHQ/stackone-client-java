...
public class HrisCreateEmployeeTimeOffRequestRequestBuilder {
    ...
    public HrisCreateEmployeeTimeOffRequestRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public HrisCreateEmployeeTimeOffRequestRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
