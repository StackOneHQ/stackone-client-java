 ...
 * QueryParamActive
 * 
 * <p>Filter to allow filtering of only active content
 */
@JsonDeserialize(using = QueryParamActive._Deserializer.class)
public class QueryParamActive {
    ...
    public static final class _Deserializer extends OneOfDeserializer<QueryParamActive> {

        public _Deserializer() {
            super(QueryParamActive.class, false,
