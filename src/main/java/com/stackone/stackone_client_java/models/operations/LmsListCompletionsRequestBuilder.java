...
public class LmsListCompletionsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallLmsListCompletions sdk;

    public LmsListCompletionsRequestBuilder(SDKMethodInterfaces.MethodCallLmsListCompletions sdk) {
        this.sdk = sdk;
    }
