 ...
 */
public class AtsListListsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public AtsListListsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListListsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListListsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListListsQueryParamFilter other = (AtsListListsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListListsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public AtsListListsQueryParamFilter build() {

            return new AtsListListsQueryParamFilter(
                updatedAfter);
        }
