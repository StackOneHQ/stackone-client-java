...
public class DocumentsGetDriveRequest {
    ...
    @JsonCreator
    public DocumentsGetDriveRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public DocumentsGetDriveRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public DocumentsGetDriveRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public DocumentsGetDriveRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public DocumentsGetDriveRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public DocumentsGetDriveRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public DocumentsGetDriveRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public DocumentsGetDriveRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public DocumentsGetDriveRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public DocumentsGetDriveRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public DocumentsGetDriveRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DocumentsGetDriveRequest other = (DocumentsGetDriveRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DocumentsGetDriveRequest.class,
    ...
    public final static class Builder {
        ...
        public DocumentsGetDriveRequest build() {

            return new DocumentsGetDriveRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
