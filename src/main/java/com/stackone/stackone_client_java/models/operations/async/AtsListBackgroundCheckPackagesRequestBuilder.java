...
public class AtsListBackgroundCheckPackagesRequestBuilder {
    ...
    public CompletableFuture<AtsListBackgroundCheckPackagesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsListBackgroundCheckPackagesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListBackgroundCheckPackagesResponse&gt;() {
     ...
     */
    public Publisher<AtsListBackgroundCheckPackagesResponse> callAsPublisher() {
        AtsListBackgroundCheckPackagesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<AtsListBackgroundCheckPackagesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
