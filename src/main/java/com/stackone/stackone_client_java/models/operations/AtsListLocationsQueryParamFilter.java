 ...
 */
public class AtsListLocationsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public AtsListLocationsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListLocationsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListLocationsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListLocationsQueryParamFilter other = (AtsListLocationsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListLocationsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public AtsListLocationsQueryParamFilter build() {

            return new AtsListLocationsQueryParamFilter(
                updatedAfter);
        }
