 ...
 */
public class IamListRolesQueryParamFilter {
    /**
    ...
    @JsonCreator
    public IamListRolesQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public IamListRolesQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public IamListRolesQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamListRolesQueryParamFilter other = (IamListRolesQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(IamListRolesQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public IamListRolesQueryParamFilter build() {

            return new IamListRolesQueryParamFilter(
                updatedAfter);
        }
