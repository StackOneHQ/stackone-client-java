...
public class AccountingListCompanyTaxRatesRequestBuilder {
    ...
    public CompletableFuture<AccountingListCompanyTaxRatesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AccountingListCompanyTaxRatesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AccountingListCompanyTaxRatesResponse&gt;() {
     ...
     */
    public Publisher<AccountingListCompanyTaxRatesResponse> callAsPublisher() {
        AccountingListCompanyTaxRatesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    AccountingListCompanyTaxRatesRequest::withNext,
            operation::doRequest);

        Flow.Publisher<AccountingListCompanyTaxRatesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
