...
public class TicketingListProjectsRequestBuilder {
    ...
    public CompletableFuture<TicketingListProjectsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;TicketingListProjectsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;TicketingListProjectsResponse&gt;() {
     ...
     */
    public Publisher<TicketingListProjectsResponse> callAsPublisher() {
        TicketingListProjectsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    TicketingListProjectsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<TicketingListProjectsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
