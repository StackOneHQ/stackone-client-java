 ...
 */
public class AtsListRejectedReasonsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public AtsListRejectedReasonsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListRejectedReasonsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListRejectedReasonsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListRejectedReasonsQueryParamFilter other = (AtsListRejectedReasonsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListRejectedReasonsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public AtsListRejectedReasonsQueryParamFilter build() {

            return new AtsListRejectedReasonsQueryParamFilter(
                updatedAfter);
        }
