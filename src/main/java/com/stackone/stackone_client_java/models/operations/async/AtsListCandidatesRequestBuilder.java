...
public class AtsListCandidatesRequestBuilder {
    ...
    public CompletableFuture<AtsListCandidatesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsListCandidatesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListCandidatesResponse&gt;() {
     ...
     */
    public Publisher<AtsListCandidatesResponse> callAsPublisher() {
        AtsListCandidatesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<AtsListCandidatesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
