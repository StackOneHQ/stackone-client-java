...
public class MarketingListCampaignsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallMarketingListCampaigns sdk;

    public MarketingListCampaignsRequestBuilder(SDKMethodInterfaces.MethodCallMarketingListCampaigns sdk) {
        this.sdk = sdk;
    }
