...
public class HrisGetEmployeeShiftRequest {
    ...
    @JsonCreator
    public HrisGetEmployeeShiftRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public HrisGetEmployeeShiftRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public HrisGetEmployeeShiftRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public HrisGetEmployeeShiftRequest withSubResourceId(String subResourceId) {
        Utils.checkNotNull(subResourceId, "subResourceId");
        this.subResourceId = subResourceId;
        return this;
    }
     ...
     * value is false)
     */
    public HrisGetEmployeeShiftRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public HrisGetEmployeeShiftRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public HrisGetEmployeeShiftRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public HrisGetEmployeeShiftRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * The comma separated list of fields to return in the response (if empty, all fields are returned)
     */
    public HrisGetEmployeeShiftRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * The comma separated list of fields to return in the response (if empty, all fields are returned)
     */
    public HrisGetEmployeeShiftRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisGetEmployeeShiftRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisGetEmployeeShiftRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisGetEmployeeShiftRequest other = (HrisGetEmployeeShiftRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisGetEmployeeShiftRequest.class,
    ...
    public final static class Builder {
        ...
        public HrisGetEmployeeShiftRequest build() {

            return new HrisGetEmployeeShiftRequest(
                xAccountId, id, subResourceId,
                raw, proxy, fields,
                prefer);
        }
