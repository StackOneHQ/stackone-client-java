...
public class TicketingListProjectTicketTypesRequestBuilder {
    ...
    public TicketingListProjectTicketTypesResponse call() throws Exception {
    ...
    * <pre><code>
    * for (TicketingListProjectTicketTypesResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<TicketingListProjectTicketTypesResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<TicketingListProjectTicketTypesResponse> callAsStream() {
