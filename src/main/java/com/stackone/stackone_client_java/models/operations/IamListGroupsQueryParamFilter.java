 ...
 */
public class IamListGroupsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public IamListGroupsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public IamListGroupsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public IamListGroupsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamListGroupsQueryParamFilter other = (IamListGroupsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(IamListGroupsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public IamListGroupsQueryParamFilter build() {

            return new IamListGroupsQueryParamFilter(
                updatedAfter);
        }
