...
public class AtsListOffersResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public AtsListOffersResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public AtsListOffersResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AtsListOffersResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * The list of offers was retrieved.
     */
    public AtsListOffersResponse withOffersPaginated(OffersPaginated offersPaginated) {
        Utils.checkNotNull(offersPaginated, "offersPaginated");
     ...
     * The list of offers was retrieved.
     */
    public AtsListOffersResponse withOffersPaginated(Optional<? extends OffersPaginated> offersPaginated) {
        Utils.checkNotNull(offersPaginated, "offersPaginated");
        this.offersPaginated = offersPaginated;
        return this;
    }

    public AtsListOffersResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListOffersResponse other = (AtsListOffersResponse) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            offersPaginated, headers);
    }
    
    @Override
    public String toString() {
        return Utils.toString(AtsListOffersResponse.class,
