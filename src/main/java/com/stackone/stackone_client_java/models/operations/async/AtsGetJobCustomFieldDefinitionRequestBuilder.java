...
public class AtsGetJobCustomFieldDefinitionRequestBuilder {
    ...
    public AtsGetJobCustomFieldDefinitionRequestBuilder retryConfig(RetryConfig retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = Optional.of(retryConfig);
        return this;
    }

    public AtsGetJobCustomFieldDefinitionRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<AtsGetJobCustomFieldDefinitionResponse> call() throws Exception {
