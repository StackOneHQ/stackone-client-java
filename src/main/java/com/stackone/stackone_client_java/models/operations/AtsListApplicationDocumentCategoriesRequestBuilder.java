...
public class AtsListApplicationDocumentCategoriesRequestBuilder {
    ...
    public AtsListApplicationDocumentCategoriesResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AtsListApplicationDocumentCategoriesResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AtsListApplicationDocumentCategoriesResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AtsListApplicationDocumentCategoriesResponse> callAsStream() {
