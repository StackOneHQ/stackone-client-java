...
public class MarketingGetCampaignRequest {
    ...
    @JsonCreator
    public MarketingGetCampaignRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public MarketingGetCampaignRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public MarketingGetCampaignRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public MarketingGetCampaignRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public MarketingGetCampaignRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public MarketingGetCampaignRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public MarketingGetCampaignRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public MarketingGetCampaignRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public MarketingGetCampaignRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public MarketingGetCampaignRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public MarketingGetCampaignRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MarketingGetCampaignRequest other = (MarketingGetCampaignRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MarketingGetCampaignRequest.class,
    ...
    public final static class Builder {
        ...
        public MarketingGetCampaignRequest build() {

            return new MarketingGetCampaignRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
