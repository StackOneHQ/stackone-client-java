...
public class HrisUpdateTimeOffRequestRequest {
    ...
    @JsonCreator
    public HrisUpdateTimeOffRequestRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public HrisUpdateTimeOffRequestRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public HrisUpdateTimeOffRequestRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public HrisUpdateTimeOffRequestRequest withHrisCreateTimeOffRequestDto(HrisCreateTimeOffRequestDto hrisCreateTimeOffRequestDto) {
        Utils.checkNotNull(hrisCreateTimeOffRequestDto, "hrisCreateTimeOffRequestDto");
        this.hrisCreateTimeOffRequestDto = hrisCreateTimeOffRequestDto;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisUpdateTimeOffRequestRequest other = (HrisUpdateTimeOffRequestRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisUpdateTimeOffRequestRequest.class,
    ...
    public final static class Builder {
        ...
        public HrisUpdateTimeOffRequestRequest build() {
            return new HrisUpdateTimeOffRequestRequest(
                xAccountId,
                id,
                hrisCreateTimeOffRequestDto);
        }
