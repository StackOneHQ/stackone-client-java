 ...
 */
public class TicketingListProjectsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public TicketingListProjectsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public TicketingListProjectsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public TicketingListProjectsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TicketingListProjectsQueryParamFilter other = (TicketingListProjectsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TicketingListProjectsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public TicketingListProjectsQueryParamFilter build() {

            return new TicketingListProjectsQueryParamFilter(
                updatedAfter);
        }
