...
public class TicketingListTicketsRequestBuilder {
    ...
    public CompletableFuture<TicketingListTicketsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;TicketingListTicketsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;TicketingListTicketsResponse&gt;() {
     ...
     */
    public Publisher<TicketingListTicketsResponse> callAsPublisher() {
        TicketingListTicketsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    TicketingListTicketsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<TicketingListTicketsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
