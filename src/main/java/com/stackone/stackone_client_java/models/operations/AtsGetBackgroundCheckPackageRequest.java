...
public class AtsGetBackgroundCheckPackageRequest {
    ...
    @JsonCreator
    public AtsGetBackgroundCheckPackageRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public AtsGetBackgroundCheckPackageRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AtsGetBackgroundCheckPackageRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public AtsGetBackgroundCheckPackageRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public AtsGetBackgroundCheckPackageRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public AtsGetBackgroundCheckPackageRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public AtsGetBackgroundCheckPackageRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public AtsGetBackgroundCheckPackageRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public AtsGetBackgroundCheckPackageRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsGetBackgroundCheckPackageRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsGetBackgroundCheckPackageRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsGetBackgroundCheckPackageRequest other = (AtsGetBackgroundCheckPackageRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsGetBackgroundCheckPackageRequest.class,
    ...
    public final static class Builder {
        ...
        public AtsGetBackgroundCheckPackageRequest build() {

            return new AtsGetBackgroundCheckPackageRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
