...
public class HrisGetEmployeeDocumentCategoryRequest {
    ...
    @JsonCreator
    public HrisGetEmployeeDocumentCategoryRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public HrisGetEmployeeDocumentCategoryRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public HrisGetEmployeeDocumentCategoryRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public HrisGetEmployeeDocumentCategoryRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public HrisGetEmployeeDocumentCategoryRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public HrisGetEmployeeDocumentCategoryRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public HrisGetEmployeeDocumentCategoryRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public HrisGetEmployeeDocumentCategoryRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public HrisGetEmployeeDocumentCategoryRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisGetEmployeeDocumentCategoryRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisGetEmployeeDocumentCategoryRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisGetEmployeeDocumentCategoryRequest other = (HrisGetEmployeeDocumentCategoryRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisGetEmployeeDocumentCategoryRequest.class,
    ...
    public final static class Builder {
        ...
        public HrisGetEmployeeDocumentCategoryRequest build() {

            return new HrisGetEmployeeDocumentCategoryRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
