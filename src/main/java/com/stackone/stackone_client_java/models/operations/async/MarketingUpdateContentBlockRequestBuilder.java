...
public class MarketingUpdateContentBlockRequestBuilder {
    ...
    public MarketingUpdateContentBlockRequestBuilder prefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = Optional.of(prefer);
        return this;
    }

    public MarketingUpdateContentBlockRequestBuilder prefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public CompletableFuture<MarketingUpdateContentBlockResponse> call() {
