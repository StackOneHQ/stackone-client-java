 ...
 */
public class MessagingListUsersQueryParamFilter {
    /**
    ...
    @JsonCreator
    public MessagingListUsersQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public MessagingListUsersQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public MessagingListUsersQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MessagingListUsersQueryParamFilter other = (MessagingListUsersQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MessagingListUsersQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public MessagingListUsersQueryParamFilter build() {

            return new MessagingListUsersQueryParamFilter(
                updatedAfter);
        }
