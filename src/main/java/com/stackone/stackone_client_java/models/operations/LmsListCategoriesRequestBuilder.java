...
public class LmsListCategoriesRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallLmsListCategories sdk;

    public LmsListCategoriesRequestBuilder(SDKMethodInterfaces.MethodCallLmsListCategories sdk) {
        this.sdk = sdk;
    }
