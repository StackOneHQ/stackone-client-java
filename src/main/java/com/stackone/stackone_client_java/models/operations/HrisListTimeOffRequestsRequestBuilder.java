...
public class HrisListTimeOffRequestsRequestBuilder {
    ...
    public HrisListTimeOffRequestsResponse call() {
    ...
    * <pre><code>
    * for (HrisListTimeOffRequestsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<HrisListTimeOffRequestsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
