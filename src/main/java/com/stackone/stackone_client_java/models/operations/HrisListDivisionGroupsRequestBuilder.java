...
public class HrisListDivisionGroupsRequestBuilder {
    ...
    public HrisListDivisionGroupsResponse call() throws Exception {
    ...
    * <pre><code>
    * for (HrisListDivisionGroupsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<HrisListDivisionGroupsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<HrisListDivisionGroupsResponse> callAsStream() {
