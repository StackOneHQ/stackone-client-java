...
public class HrisListEmployeeWorkEligibilityRequestBuilder {
    ...
    public CompletableFuture<HrisListEmployeeWorkEligibilityResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisListEmployeeWorkEligibilityResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisListEmployeeWorkEligibilityResponse&gt;() {
     ...
     */
    public Publisher<HrisListEmployeeWorkEligibilityResponse> callAsPublisher() {
        HrisListEmployeeWorkEligibilityRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HrisListEmployeeWorkEligibilityResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
