...
public class HrisListEmployeeTimeOffRequestsRequest {
    ...
    private JsonNullable<? extends HrisListEmployeeTimeOffRequestsQueryParamFilter> filter;
    ...
    public HrisListEmployeeTimeOffRequestsRequest(
            ...
            JsonNullable<? extends HrisListEmployeeTimeOffRequestsQueryParamFilter> filter,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<HrisListEmployeeTimeOffRequestsQueryParamFilter> filter() {
        return (JsonNullable<HrisListEmployeeTimeOffRequestsQueryParamFilter>) filter;
    }
     ...
     * The account identifier
     */
    public HrisListEmployeeTimeOffRequestsRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public HrisListEmployeeTimeOffRequestsRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public HrisListEmployeeTimeOffRequestsRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public HrisListEmployeeTimeOffRequestsRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public HrisListEmployeeTimeOffRequestsRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public HrisListEmployeeTimeOffRequestsRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public HrisListEmployeeTimeOffRequestsRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public HrisListEmployeeTimeOffRequestsRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * HRIS Time Off filters
     */
    public HrisListEmployeeTimeOffRequestsRequest withFilter(HrisListEmployeeTimeOffRequestsQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * HRIS Time Off filters
     */
    public HrisListEmployeeTimeOffRequestsRequest withFilter(JsonNullable<? extends HrisListEmployeeTimeOffRequestsQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     */
    @Deprecated
    public HrisListEmployeeTimeOffRequestsRequest withPage(String page) {
        Utils.checkNotNull(page, "page");
     ...
     */
    @Deprecated
    public HrisListEmployeeTimeOffRequestsRequest withPage(JsonNullable<String> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public HrisListEmployeeTimeOffRequestsRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public HrisListEmployeeTimeOffRequestsRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public HrisListEmployeeTimeOffRequestsRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public HrisListEmployeeTimeOffRequestsRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     */
    @Deprecated
    public HrisListEmployeeTimeOffRequestsRequest withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     */
    @Deprecated
    public HrisListEmployeeTimeOffRequestsRequest withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
     ...
     * The comma separated list of fields that will be expanded in the response
     */
    public HrisListEmployeeTimeOffRequestsRequest withExpand(String expand) {
        Utils.checkNotNull(expand, "expand");
     ...
     * The comma separated list of fields that will be expanded in the response
     */
    public HrisListEmployeeTimeOffRequestsRequest withExpand(JsonNullable<String> expand) {
        Utils.checkNotNull(expand, "expand");
        this.expand = expand;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisListEmployeeTimeOffRequestsRequest other = (HrisListEmployeeTimeOffRequestsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisListEmployeeTimeOffRequestsRequest.class,
    ...
    public final static class Builder {
         ...
         * HRIS Time Off filters
         */
        public Builder filter(HrisListEmployeeTimeOffRequestsQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * HRIS Time Off filters
         */
        public Builder filter(JsonNullable<? extends HrisListEmployeeTimeOffRequestsQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
