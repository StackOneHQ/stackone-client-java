...
public class HrisListEmployeesRequestBuilder {
    ...
    public CompletableFuture<HrisListEmployeesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisListEmployeesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisListEmployeesResponse&gt;() {
     ...
     */
    public Publisher<HrisListEmployeesResponse> callAsPublisher() {
        HrisListEmployeesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HrisListEmployeesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
