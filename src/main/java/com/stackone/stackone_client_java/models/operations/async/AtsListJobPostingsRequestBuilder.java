...
public class AtsListJobPostingsRequestBuilder {
    ...
    public AtsListJobPostingsRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<AtsListJobPostingsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsListJobPostingsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListJobPostingsResponse&gt;() {
     ...
     */
    public Publisher<AtsListJobPostingsResponse> callAsPublisher() {
        AtsListJobPostingsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    AtsListJobPostingsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<AtsListJobPostingsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
