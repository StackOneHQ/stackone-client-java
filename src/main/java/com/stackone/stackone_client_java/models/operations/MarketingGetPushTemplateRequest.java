...
public class MarketingGetPushTemplateRequest {
    ...
    @JsonCreator
    public MarketingGetPushTemplateRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public MarketingGetPushTemplateRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public MarketingGetPushTemplateRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public MarketingGetPushTemplateRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public MarketingGetPushTemplateRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public MarketingGetPushTemplateRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public MarketingGetPushTemplateRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public MarketingGetPushTemplateRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public MarketingGetPushTemplateRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public MarketingGetPushTemplateRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public MarketingGetPushTemplateRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MarketingGetPushTemplateRequest other = (MarketingGetPushTemplateRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MarketingGetPushTemplateRequest.class,
    ...
    public final static class Builder {
        ...
        public MarketingGetPushTemplateRequest build() {

            return new MarketingGetPushTemplateRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
