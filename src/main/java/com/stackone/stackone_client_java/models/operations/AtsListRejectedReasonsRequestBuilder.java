...
public class AtsListRejectedReasonsRequestBuilder {
    ...
    public AtsListRejectedReasonsResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AtsListRejectedReasonsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AtsListRejectedReasonsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AtsListRejectedReasonsResponse> callAsStream() {
