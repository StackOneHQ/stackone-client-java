...
public class AtsListApplicationCustomFieldDefinitionsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallAtsListApplicationCustomFieldDefinitions sdk;

    public AtsListApplicationCustomFieldDefinitionsRequestBuilder(SDKMethodInterfaces.MethodCallAtsListApplicationCustomFieldDefinitions sdk) {
        this.sdk = sdk;
    }
    ...
    public AtsListApplicationCustomFieldDefinitionsResponse call() throws Exception {
        Optional<Options> options = Optional.of(Options.builder()
                                                    ...
                                                    .build());
        return sdk.listApplicationCustomFieldDefinitions(
            request,
            options);
    }
