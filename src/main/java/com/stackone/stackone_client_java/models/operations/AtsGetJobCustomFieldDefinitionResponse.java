...
public class AtsGetJobCustomFieldDefinitionResponse implements Response {
    /**
    ...
    @JsonCreator
    public AtsGetJobCustomFieldDefinitionResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public AtsGetJobCustomFieldDefinitionResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public AtsGetJobCustomFieldDefinitionResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AtsGetJobCustomFieldDefinitionResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * The job custom field definition was retrieved.
     */
    public AtsGetJobCustomFieldDefinitionResponse withCustomFieldDefinitionResultApiModel(CustomFieldDefinitionResultApiModel customFieldDefinitionResultApiModel) {
        Utils.checkNotNull(customFieldDefinitionResultApiModel, "customFieldDefinitionResultApiModel");
     ...
     * The job custom field definition was retrieved.
     */
    public AtsGetJobCustomFieldDefinitionResponse withCustomFieldDefinitionResultApiModel(Optional<? extends CustomFieldDefinitionResultApiModel> customFieldDefinitionResultApiModel) {
        Utils.checkNotNull(customFieldDefinitionResultApiModel, "customFieldDefinitionResultApiModel");
        this.customFieldDefinitionResultApiModel = customFieldDefinitionResultApiModel;
        return this;
    }

    public AtsGetJobCustomFieldDefinitionResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsGetJobCustomFieldDefinitionResponse other = (AtsGetJobCustomFieldDefinitionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsGetJobCustomFieldDefinitionResponse.class,
    ...
    public final static class Builder {
        ...
        public AtsGetJobCustomFieldDefinitionResponse build() {

            return new AtsGetJobCustomFieldDefinitionResponse(
                contentType, statusCode, rawResponse,
                customFieldDefinitionResultApiModel, headers);
        }
