...
public class AtsCreateCandidateNoteRequestBuilder {
    ...
    public AtsCreateCandidateNoteRequestBuilder prefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = Optional.of(prefer);
        return this;
    }

    public AtsCreateCandidateNoteRequestBuilder prefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public CompletableFuture<AtsCreateCandidateNoteResponse> call() {
