...
public class HrisUpdateEmployeeResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public HrisUpdateEmployeeResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Record updated successfully
     */
    public HrisUpdateEmployeeResponse withUpdateResult(UpdateResult updateResult) {
        Utils.checkNotNull(updateResult, "updateResult");
     ...
     * Record updated successfully
     */
    public HrisUpdateEmployeeResponse withUpdateResult(Optional<? extends UpdateResult> updateResult) {
        Utils.checkNotNull(updateResult, "updateResult");
        this.updateResult = updateResult;
        return this;
    }
