...
public class HrisGetEmployeesWorkEligibilityRequestBuilder {
    ...
    public HrisGetEmployeesWorkEligibilityRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public HrisGetEmployeesWorkEligibilityRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
