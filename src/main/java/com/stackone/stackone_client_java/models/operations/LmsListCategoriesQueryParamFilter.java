 ...
 */
public class LmsListCategoriesQueryParamFilter {
    /**
    ...
    @JsonCreator
    public LmsListCategoriesQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public LmsListCategoriesQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public LmsListCategoriesQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LmsListCategoriesQueryParamFilter other = (LmsListCategoriesQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LmsListCategoriesQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public LmsListCategoriesQueryParamFilter build() {

            return new LmsListCategoriesQueryParamFilter(
                updatedAfter);
        }
