...
public class LmsListContentRequestBuilder {
    ...
    private LmsListContentRequest request;
    ...
    public LmsListContentRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<LmsListContentResponse> call() throws Exception {
     ...
     */
    public Publisher<LmsListContentResponse> callAsPublisher() {
        LmsListContentRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    LmsListContentRequest::withNext,
            operation::doRequest);

        Flow.Publisher<LmsListContentResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
