 ...
 */
public class LmsListSkillsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public LmsListSkillsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public LmsListSkillsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public LmsListSkillsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LmsListSkillsQueryParamFilter other = (LmsListSkillsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LmsListSkillsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public LmsListSkillsQueryParamFilter build() {

            return new LmsListSkillsQueryParamFilter(
                updatedAfter);
        }
