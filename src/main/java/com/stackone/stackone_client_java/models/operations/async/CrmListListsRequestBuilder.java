...
public class CrmListListsRequestBuilder {

    private CrmListListsRequest request;
    ...
    public CrmListListsRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<CrmListListsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;CrmListListsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;CrmListListsResponse&gt;() {
     ...
     */
    public Publisher<CrmListListsResponse> callAsPublisher() {
        CrmListListsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    CrmListListsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<CrmListListsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
