...
public class AtsListApplicationChangesRequestBuilder {
    ...
    public AtsListApplicationChangesResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AtsListApplicationChangesResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AtsListApplicationChangesResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AtsListApplicationChangesResponse> callAsStream() {
