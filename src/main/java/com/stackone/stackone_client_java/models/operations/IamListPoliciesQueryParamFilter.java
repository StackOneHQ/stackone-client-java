...
public class IamListPoliciesQueryParamFilter {
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public IamListPoliciesQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public IamListPoliciesQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamListPoliciesQueryParamFilter other = (IamListPoliciesQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(IamListPoliciesQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public IamListPoliciesQueryParamFilter build() {

            return new IamListPoliciesQueryParamFilter(
                updatedAfter);
        }
