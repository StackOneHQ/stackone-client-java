...
public class AtsListLocationsRequestBuilder {
    ...
    public CompletableFuture<AtsListLocationsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;AtsListLocationsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListLocationsResponse&gt;() {
    ...
    public Publisher<AtsListLocationsResponse> callAsPublisher() {
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    AtsListLocationsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<AtsListLocationsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
