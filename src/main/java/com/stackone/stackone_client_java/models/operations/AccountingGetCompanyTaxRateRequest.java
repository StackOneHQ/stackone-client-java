...
public class AccountingGetCompanyTaxRateRequest {
    ...
    @JsonCreator
    public AccountingGetCompanyTaxRateRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public AccountingGetCompanyTaxRateRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AccountingGetCompanyTaxRateRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public AccountingGetCompanyTaxRateRequest withSubResourceId(String subResourceId) {
        Utils.checkNotNull(subResourceId, "subResourceId");
        this.subResourceId = subResourceId;
        return this;
    }
     ...
     * value is false)
     */
    public AccountingGetCompanyTaxRateRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public AccountingGetCompanyTaxRateRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public AccountingGetCompanyTaxRateRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public AccountingGetCompanyTaxRateRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public AccountingGetCompanyTaxRateRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public AccountingGetCompanyTaxRateRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AccountingGetCompanyTaxRateRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AccountingGetCompanyTaxRateRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingGetCompanyTaxRateRequest other = (AccountingGetCompanyTaxRateRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountingGetCompanyTaxRateRequest.class,
    ...
    public final static class Builder {
        ...
        public AccountingGetCompanyTaxRateRequest build() {

            return new AccountingGetCompanyTaxRateRequest(
                xAccountId, id, subResourceId,
                raw, proxy, fields,
                prefer);
        }
