...
public class LmsListUserCompletionsRequestBuilder {

    private LmsListUserCompletionsRequest request;
    ...
    public LmsListUserCompletionsRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<LmsListUserCompletionsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;LmsListUserCompletionsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;LmsListUserCompletionsResponse&gt;() {
     ...
     */
    public Publisher<LmsListUserCompletionsResponse> callAsPublisher() {
        LmsListUserCompletionsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    LmsListUserCompletionsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<LmsListUserCompletionsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
