...
public class HrisListDivisionGroupsRequestBuilder {

    private HrisListDivisionGroupsRequest request;
    private Optional<RetryConfig> retryConfig = Optional.empty();
    private final SDKConfiguration sdkConfiguration;

    public HrisListDivisionGroupsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public HrisListDivisionGroupsRequestBuilder request(HrisListDivisionGroupsRequest request) {
        Utils.checkNotNull(request, "request");
        this.request = request;
        return this;
    }
                
    public HrisListDivisionGroupsRequestBuilder retryConfig(RetryConfig retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = Optional.of(retryConfig);
        return this;
    }

    public HrisListDivisionGroupsRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<HrisListDivisionGroupsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisListDivisionGroupsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisListDivisionGroupsResponse&gt;() {
     ...
     */
    public Publisher<HrisListDivisionGroupsResponse> callAsPublisher() {
        HrisListDivisionGroupsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    HrisListDivisionGroupsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<HrisListDivisionGroupsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
