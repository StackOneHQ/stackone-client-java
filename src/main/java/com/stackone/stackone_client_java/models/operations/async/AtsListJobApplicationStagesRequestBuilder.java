...
public class AtsListJobApplicationStagesRequestBuilder {

    private AtsListJobApplicationStagesRequest request;
    ...
    public AtsListJobApplicationStagesRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<AtsListJobApplicationStagesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsListJobApplicationStagesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListJobApplicationStagesResponse&gt;() {
     ...
     */
    public Publisher<AtsListJobApplicationStagesResponse> callAsPublisher() {
        AtsListJobApplicationStagesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    AtsListJobApplicationStagesRequest::withNext,
            operation::doRequest);

        Flow.Publisher<AtsListJobApplicationStagesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
