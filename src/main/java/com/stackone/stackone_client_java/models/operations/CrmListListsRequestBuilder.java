...
public class CrmListListsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallCrmListLists sdk;

    public CrmListListsRequestBuilder(SDKMethodInterfaces.MethodCallCrmListLists sdk) {
        this.sdk = sdk;
    }
    ...
    public CrmListListsResponse call() throws Exception {
     ...
     **/  
    public Stream<CrmListListsResponse> callAsStream() {
