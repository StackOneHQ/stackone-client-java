...
public class MarketingListSmsTemplatesRequestBuilder {
    ...
    public MarketingListSmsTemplatesResponse call() throws Exception {
    ...
    * <pre><code>
    * for (MarketingListSmsTemplatesResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<MarketingListSmsTemplatesResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<MarketingListSmsTemplatesResponse> callAsStream() {
