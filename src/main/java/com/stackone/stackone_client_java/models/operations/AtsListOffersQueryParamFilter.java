 ...
 */
public class AtsListOffersQueryParamFilter {
    /**
    ...
    @JsonCreator
    public AtsListOffersQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListOffersQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListOffersQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListOffersQueryParamFilter other = (AtsListOffersQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListOffersQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public AtsListOffersQueryParamFilter build() {

            return new AtsListOffersQueryParamFilter(
                updatedAfter);
        }
