...
public class MarketingListPushTemplatesRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallMarketingListPushTemplates sdk;

    public MarketingListPushTemplatesRequestBuilder(SDKMethodInterfaces.MethodCallMarketingListPushTemplates sdk) {
        this.sdk = sdk;
    }
