...
public class AtsListCandidateCustomFieldDefinitionsRequestBuilder {
    ...
    public CompletableFuture<AtsListCandidateCustomFieldDefinitionsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsListCandidateCustomFieldDefinitionsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListCandidateCustomFieldDefinitionsResponse&gt;() {
     ...
     */
    public Publisher<AtsListCandidateCustomFieldDefinitionsResponse> callAsPublisher() {
        AtsListCandidateCustomFieldDefinitionsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<AtsListCandidateCustomFieldDefinitionsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
