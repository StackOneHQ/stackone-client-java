...
public class AtsListApplicationScorecardsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallAtsListApplicationScorecards sdk;

    public AtsListApplicationScorecardsRequestBuilder(SDKMethodInterfaces.MethodCallAtsListApplicationScorecards sdk) {
        this.sdk = sdk;
    }
    ...
    public AtsListApplicationScorecardsResponse call() throws Exception {
        Optional<Options> options = Optional.of(Options.builder()
                                                    .retryConfig(retryConfig)
                                                    .build());
        return sdk.listApplicationScorecards(
            request,
            options);
    }
     ...
     **/  
    public Stream<AtsListApplicationScorecardsResponse> callAsStream() {
