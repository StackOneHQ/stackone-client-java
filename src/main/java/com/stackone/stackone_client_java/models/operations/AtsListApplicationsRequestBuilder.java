...
public class AtsListApplicationsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallAtsListApplications sdk;

    public AtsListApplicationsRequestBuilder(SDKMethodInterfaces.MethodCallAtsListApplications sdk) {
        this.sdk = sdk;
    }
