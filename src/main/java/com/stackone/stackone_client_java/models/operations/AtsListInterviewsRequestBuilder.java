...
public class AtsListInterviewsRequestBuilder {
    ...
    public AtsListInterviewsResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AtsListInterviewsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AtsListInterviewsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AtsListInterviewsResponse> callAsStream() {
