...
public class AtsListInterviewsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallAtsListInterviews sdk;

    public AtsListInterviewsRequestBuilder(SDKMethodInterfaces.MethodCallAtsListInterviews sdk) {
        this.sdk = sdk;
    }
