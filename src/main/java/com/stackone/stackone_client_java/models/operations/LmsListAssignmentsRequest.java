...
public class LmsListAssignmentsRequest {
    ...
    private JsonNullable<? extends LmsListAssignmentsQueryParamFilter> filter;
    ...
    public LmsListAssignmentsRequest(
            ...
            JsonNullable<? extends LmsListAssignmentsQueryParamFilter> filter,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<LmsListAssignmentsQueryParamFilter> filter() {
        return (JsonNullable<LmsListAssignmentsQueryParamFilter>) filter;
    }
     ...
     * The account identifier
     */
    public LmsListAssignmentsRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }
     ...
     * LMS Assignment Filter
     */
    public LmsListAssignmentsRequest withFilter(LmsListAssignmentsQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * LMS Assignment Filter
     */
    public LmsListAssignmentsRequest withFilter(JsonNullable<? extends LmsListAssignmentsQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     */
    @Deprecated
    public LmsListAssignmentsRequest withPage(String page) {
        Utils.checkNotNull(page, "page");
     ...
     */
    @Deprecated
    public LmsListAssignmentsRequest withPage(JsonNullable<String> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public LmsListAssignmentsRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public LmsListAssignmentsRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public LmsListAssignmentsRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public LmsListAssignmentsRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     */
    @Deprecated
    public LmsListAssignmentsRequest withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     */
    @Deprecated
    public LmsListAssignmentsRequest withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
     ...
     * The user ID associated with this assignment
     */
    public LmsListAssignmentsRequest withUserId(String userId) {
        Utils.checkNotNull(userId, "userId");
     ...
     * The user ID associated with this assignment
     */
    public LmsListAssignmentsRequest withUserId(JsonNullable<String> userId) {
        Utils.checkNotNull(userId, "userId");
        this.userId = userId;
        return this;
    }
     ...
     * Provider's unique identifier of the user related to the assignment
     */
    public LmsListAssignmentsRequest withRemoteUserId(String remoteUserId) {
        Utils.checkNotNull(remoteUserId, "remoteUserId");
     ...
     * Provider's unique identifier of the user related to the assignment
     */
    public LmsListAssignmentsRequest withRemoteUserId(JsonNullable<String> remoteUserId) {
        Utils.checkNotNull(remoteUserId, "remoteUserId");
        this.remoteUserId = remoteUserId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LmsListAssignmentsRequest other = (LmsListAssignmentsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LmsListAssignmentsRequest.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends LmsListAssignmentsQueryParamFilter> filter = JsonNullable.undefined();
         ...
         * LMS Assignment Filter
         */
        public Builder filter(LmsListAssignmentsQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * LMS Assignment Filter
         */
        public Builder filter(JsonNullable<? extends LmsListAssignmentsQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
