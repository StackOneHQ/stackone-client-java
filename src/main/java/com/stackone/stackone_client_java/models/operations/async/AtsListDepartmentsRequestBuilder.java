...
public class AtsListDepartmentsRequestBuilder {
    ...
    public CompletableFuture<AtsListDepartmentsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsListDepartmentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListDepartmentsResponse&gt;() {
     ...
     */
    public Publisher<AtsListDepartmentsResponse> callAsPublisher() {
        AtsListDepartmentsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    AtsListDepartmentsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<AtsListDepartmentsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
