...
public class MessagingDownloadMessagingAttachmentRequestBuilder {
    ...
    public MessagingDownloadMessagingAttachmentRequestBuilder request(MessagingDownloadMessagingAttachmentRequest request) {
        Utils.checkNotNull(request, "request");
        this.request = request;
        return this;
    }
                
    public MessagingDownloadMessagingAttachmentRequestBuilder retryConfig(RetryConfig retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = Optional.of(retryConfig);
        return this;
    }

    public MessagingDownloadMessagingAttachmentRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<MessagingDownloadMessagingAttachmentResponse> call() throws Exception {
