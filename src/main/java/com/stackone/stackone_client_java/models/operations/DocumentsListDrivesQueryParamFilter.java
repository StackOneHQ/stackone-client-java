 ...
 */
public class DocumentsListDrivesQueryParamFilter {
    /**
    ...
    @JsonCreator
    public DocumentsListDrivesQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public DocumentsListDrivesQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public DocumentsListDrivesQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DocumentsListDrivesQueryParamFilter other = (DocumentsListDrivesQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DocumentsListDrivesQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public DocumentsListDrivesQueryParamFilter build() {

            return new DocumentsListDrivesQueryParamFilter(
                updatedAfter);
        }
