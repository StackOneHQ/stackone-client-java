...
public class AtsListApplicationsScheduledInterviewsRequest {
    ...
    private JsonNullable<? extends AtsListApplicationsScheduledInterviewsQueryParamFilter> filter;
    ...
    public AtsListApplicationsScheduledInterviewsRequest(
            ...
            JsonNullable<? extends AtsListApplicationsScheduledInterviewsQueryParamFilter> filter,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<AtsListApplicationsScheduledInterviewsQueryParamFilter> filter() {
        return (JsonNullable<AtsListApplicationsScheduledInterviewsQueryParamFilter>) filter;
    }
     ...
     * The account identifier
     */
    public AtsListApplicationsScheduledInterviewsRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AtsListApplicationsScheduledInterviewsRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public AtsListApplicationsScheduledInterviewsRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public AtsListApplicationsScheduledInterviewsRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public AtsListApplicationsScheduledInterviewsRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public AtsListApplicationsScheduledInterviewsRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public AtsListApplicationsScheduledInterviewsRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public AtsListApplicationsScheduledInterviewsRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    public AtsListApplicationsScheduledInterviewsRequest withFilter(AtsListApplicationsScheduledInterviewsQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    public AtsListApplicationsScheduledInterviewsRequest withFilter(JsonNullable<? extends AtsListApplicationsScheduledInterviewsQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListApplicationsScheduledInterviewsRequest withPage(String page) {
        Utils.checkNotNull(page, "page");
     ...
     */
    @Deprecated
    public AtsListApplicationsScheduledInterviewsRequest withPage(JsonNullable<String> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public AtsListApplicationsScheduledInterviewsRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public AtsListApplicationsScheduledInterviewsRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public AtsListApplicationsScheduledInterviewsRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public AtsListApplicationsScheduledInterviewsRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListApplicationsScheduledInterviewsRequest withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     */
    @Deprecated
    public AtsListApplicationsScheduledInterviewsRequest withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListApplicationsScheduledInterviewsRequest withSyncToken(String syncToken) {
        Utils.checkNotNull(syncToken, "syncToken");
     ...
     */
    @Deprecated
    public AtsListApplicationsScheduledInterviewsRequest withSyncToken(JsonNullable<String> syncToken) {
        Utils.checkNotNull(syncToken, "syncToken");
        this.syncToken = syncToken;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsListApplicationsScheduledInterviewsRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsListApplicationsScheduledInterviewsRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListApplicationsScheduledInterviewsRequest other = (AtsListApplicationsScheduledInterviewsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListApplicationsScheduledInterviewsRequest.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends AtsListApplicationsScheduledInterviewsQueryParamFilter> filter = JsonNullable.undefined();
         ...
         * Filter parameters that allow greater customisation of the list response
         */
        public Builder filter(AtsListApplicationsScheduledInterviewsQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * Filter parameters that allow greater customisation of the list response
         */
        public Builder filter(JsonNullable<? extends AtsListApplicationsScheduledInterviewsQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
        ...
        public AtsListApplicationsScheduledInterviewsRequest build() {
            ...
            return new AtsListApplicationsScheduledInterviewsRequest(
                xAccountId, id, raw,
                proxy, fields, filter,
                page, pageSize, next,
                updatedAfter, syncToken, prefer);
