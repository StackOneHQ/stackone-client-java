...
public class TicketingGetAttachmentRequest {
    ...
    @JsonCreator
    public TicketingGetAttachmentRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public TicketingGetAttachmentRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public TicketingGetAttachmentRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public TicketingGetAttachmentRequest withSubResourceId(String subResourceId) {
        Utils.checkNotNull(subResourceId, "subResourceId");
        this.subResourceId = subResourceId;
        return this;
    }
     ...
     * value is false)
     */
    public TicketingGetAttachmentRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public TicketingGetAttachmentRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public TicketingGetAttachmentRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public TicketingGetAttachmentRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public TicketingGetAttachmentRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public TicketingGetAttachmentRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public TicketingGetAttachmentRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public TicketingGetAttachmentRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TicketingGetAttachmentRequest other = (TicketingGetAttachmentRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TicketingGetAttachmentRequest.class,
    ...
    public final static class Builder {
        ...
        public TicketingGetAttachmentRequest build() {

            return new TicketingGetAttachmentRequest(
                xAccountId, id, subResourceId,
                raw, proxy, fields,
                prefer);
        }
