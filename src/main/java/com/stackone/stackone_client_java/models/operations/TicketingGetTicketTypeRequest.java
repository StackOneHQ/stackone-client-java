...
public class TicketingGetTicketTypeRequest {
    ...
    @JsonCreator
    public TicketingGetTicketTypeRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public TicketingGetTicketTypeRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public TicketingGetTicketTypeRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public TicketingGetTicketTypeRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public TicketingGetTicketTypeRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public TicketingGetTicketTypeRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public TicketingGetTicketTypeRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public TicketingGetTicketTypeRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public TicketingGetTicketTypeRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public TicketingGetTicketTypeRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public TicketingGetTicketTypeRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TicketingGetTicketTypeRequest other = (TicketingGetTicketTypeRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TicketingGetTicketTypeRequest.class,
    ...
    public final static class Builder {
        ...
        public TicketingGetTicketTypeRequest build() {

            return new TicketingGetTicketTypeRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
