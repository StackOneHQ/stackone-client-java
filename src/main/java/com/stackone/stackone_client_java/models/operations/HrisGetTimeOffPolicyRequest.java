...
public class HrisGetTimeOffPolicyRequest {
    ...
    @JsonCreator
    public HrisGetTimeOffPolicyRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public HrisGetTimeOffPolicyRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public HrisGetTimeOffPolicyRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public HrisGetTimeOffPolicyRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public HrisGetTimeOffPolicyRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public HrisGetTimeOffPolicyRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public HrisGetTimeOffPolicyRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public HrisGetTimeOffPolicyRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public HrisGetTimeOffPolicyRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisGetTimeOffPolicyRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisGetTimeOffPolicyRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisGetTimeOffPolicyRequest other = (HrisGetTimeOffPolicyRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisGetTimeOffPolicyRequest.class,
    ...
    public final static class Builder {
        ...
        public HrisGetTimeOffPolicyRequest build() {

            return new HrisGetTimeOffPolicyRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
