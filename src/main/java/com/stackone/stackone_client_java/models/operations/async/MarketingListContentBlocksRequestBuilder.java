...
public class MarketingListContentBlocksRequestBuilder {
    ...
    public CompletableFuture<MarketingListContentBlocksResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;MarketingListContentBlocksResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;MarketingListContentBlocksResponse&gt;() {
     ...
     */
    public Publisher<MarketingListContentBlocksResponse> callAsPublisher() {
        MarketingListContentBlocksRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    MarketingListContentBlocksRequest::withNext,
            operation::doRequest);

        Flow.Publisher<MarketingListContentBlocksResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
