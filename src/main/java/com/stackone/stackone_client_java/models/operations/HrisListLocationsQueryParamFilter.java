 ...
 */
public class HrisListLocationsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public HrisListLocationsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public HrisListLocationsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public HrisListLocationsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisListLocationsQueryParamFilter other = (HrisListLocationsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisListLocationsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public HrisListLocationsQueryParamFilter build() {

            return new HrisListLocationsQueryParamFilter(
                updatedAfter);
        }
