...
public class StackoneGetConnectorMetaRequestBuilder {
    ...
    public StackoneGetConnectorMetaRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public StackoneGetConnectorMetaRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
