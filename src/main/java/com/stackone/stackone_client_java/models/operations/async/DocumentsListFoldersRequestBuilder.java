...
public class DocumentsListFoldersRequestBuilder {
    ...
    public CompletableFuture<DocumentsListFoldersResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;DocumentsListFoldersResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;DocumentsListFoldersResponse&gt;() {
     ...
     */
    public Publisher<DocumentsListFoldersResponse> callAsPublisher() {
        DocumentsListFoldersRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    DocumentsListFoldersRequest::withNext,
            operation::doRequest);

        Flow.Publisher<DocumentsListFoldersResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
