...
public class AccountingGetCompanyJournalRequest {
    ...
    @JsonCreator
    public AccountingGetCompanyJournalRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public AccountingGetCompanyJournalRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AccountingGetCompanyJournalRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public AccountingGetCompanyJournalRequest withSubResourceId(String subResourceId) {
        Utils.checkNotNull(subResourceId, "subResourceId");
        this.subResourceId = subResourceId;
        return this;
    }
     ...
     * value is false)
     */
    public AccountingGetCompanyJournalRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public AccountingGetCompanyJournalRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public AccountingGetCompanyJournalRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public AccountingGetCompanyJournalRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public AccountingGetCompanyJournalRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public AccountingGetCompanyJournalRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AccountingGetCompanyJournalRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AccountingGetCompanyJournalRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingGetCompanyJournalRequest other = (AccountingGetCompanyJournalRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountingGetCompanyJournalRequest.class,
    ...
    public final static class Builder {
        ...
        public AccountingGetCompanyJournalRequest build() {

            return new AccountingGetCompanyJournalRequest(
                xAccountId, id, subResourceId,
                raw, proxy, fields,
                prefer);
        }
