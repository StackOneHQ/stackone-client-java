...
public class MarketingListOmniChannelTemplatesRequestBuilder {
    ...
    public MarketingListOmniChannelTemplatesResponse call() {
    ...
    * <pre><code>
    * for (MarketingListOmniChannelTemplatesResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<MarketingListOmniChannelTemplatesResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
