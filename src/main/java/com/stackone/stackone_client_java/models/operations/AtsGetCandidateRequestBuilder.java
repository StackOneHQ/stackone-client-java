...
public class AtsGetCandidateRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallAtsGetCandidate sdk;

    public AtsGetCandidateRequestBuilder(SDKMethodInterfaces.MethodCallAtsGetCandidate sdk) {
        this.sdk = sdk;
    }
