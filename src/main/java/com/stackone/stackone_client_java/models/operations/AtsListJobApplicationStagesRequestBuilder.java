...
public class AtsListJobApplicationStagesRequestBuilder {
    ...
    public AtsListJobApplicationStagesResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AtsListJobApplicationStagesResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AtsListJobApplicationStagesResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AtsListJobApplicationStagesResponse> callAsStream() {
