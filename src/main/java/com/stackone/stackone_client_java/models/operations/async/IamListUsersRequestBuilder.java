...
public class IamListUsersRequestBuilder {
    ...
    public CompletableFuture<IamListUsersResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;IamListUsersResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;IamListUsersResponse&gt;() {
     ...
     */
    public Publisher<IamListUsersResponse> callAsPublisher() {
        IamListUsersRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    IamListUsersRequest::withNext,
            operation::doRequest);

        Flow.Publisher<IamListUsersResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
