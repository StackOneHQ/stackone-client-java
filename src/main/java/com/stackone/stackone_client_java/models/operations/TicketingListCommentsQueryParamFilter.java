 ...
 */
public class TicketingListCommentsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public TicketingListCommentsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public TicketingListCommentsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public TicketingListCommentsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TicketingListCommentsQueryParamFilter other = (TicketingListCommentsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TicketingListCommentsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public TicketingListCommentsQueryParamFilter build() {

            return new TicketingListCommentsQueryParamFilter(
                updatedAfter);
        }
