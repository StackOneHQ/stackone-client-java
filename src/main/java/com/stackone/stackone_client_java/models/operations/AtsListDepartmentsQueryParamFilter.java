 ...
 */
public class AtsListDepartmentsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public AtsListDepartmentsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListDepartmentsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListDepartmentsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListDepartmentsQueryParamFilter other = (AtsListDepartmentsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListDepartmentsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public AtsListDepartmentsQueryParamFilter build() {

            return new AtsListDepartmentsQueryParamFilter(
                updatedAfter);
        }
