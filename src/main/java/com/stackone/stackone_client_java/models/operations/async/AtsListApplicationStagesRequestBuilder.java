...
public class AtsListApplicationStagesRequestBuilder {

    private AtsListApplicationStagesRequest request;
    ...
    public AtsListApplicationStagesRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<AtsListApplicationStagesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsListApplicationStagesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListApplicationStagesResponse&gt;() {
     ...
     */
    public Publisher<AtsListApplicationStagesResponse> callAsPublisher() {
        AtsListApplicationStagesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    AtsListApplicationStagesRequest::withNext,
            operation::doRequest);

        Flow.Publisher<AtsListApplicationStagesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
