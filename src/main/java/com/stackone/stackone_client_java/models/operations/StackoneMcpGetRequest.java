...
public class StackoneMcpGetRequest {
     ...
     * provided)
     */
    public StackoneMcpGetRequest withXAccountId(Optional<String> xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }
     ...
     * Account secure id (alternative to x-account-id header)
     */
    public StackoneMcpGetRequest withXAccountIdQueryParameter(Object xAccountIdQueryParameter) {
        Utils.checkNotNull(xAccountIdQueryParameter, "xAccountIdQueryParameter");
     ...
     * Account secure id (alternative to x-account-id header)
     */
    public StackoneMcpGetRequest withXAccountIdQueryParameter(Optional<? extends Object> xAccountIdQueryParameter) {
        Utils.checkNotNull(xAccountIdQueryParameter, "xAccountIdQueryParameter");
        this.xAccountIdQueryParameter = xAccountIdQueryParameter;
        return this;
    }
