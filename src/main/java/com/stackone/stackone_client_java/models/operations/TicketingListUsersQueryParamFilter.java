 ...
 */
public class TicketingListUsersQueryParamFilter {
    /**
    ...
    @JsonCreator
    public TicketingListUsersQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public TicketingListUsersQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public TicketingListUsersQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TicketingListUsersQueryParamFilter other = (TicketingListUsersQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TicketingListUsersQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public TicketingListUsersQueryParamFilter build() {

            return new TicketingListUsersQueryParamFilter(
                updatedAfter);
        }
