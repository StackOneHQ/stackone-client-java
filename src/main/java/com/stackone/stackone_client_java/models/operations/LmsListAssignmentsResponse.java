...
public class LmsListAssignmentsResponse implements Response {
    ...
    private Callable<Optional<LmsListAssignmentsResponse>> next = () -> Optional.empty();

    @JsonCreator
    public LmsListAssignmentsResponse(
            String contentType,
            int statusCode,
    ...
    public Optional<LmsListAssignmentsResponse> next() throws Exception {
        return this.next.call();
    }
    
    // internal use only
    private LmsListAssignmentsResponse withNext(Callable<Optional<LmsListAssignmentsResponse>> next) {
        this.next = next;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(LmsListAssignmentsResponse.class,
    ...
    public final static class Builder {
        private Callable<Optional<LmsListAssignmentsResponse>> next;
         ...
         */
        @Deprecated
        public Builder next(Callable<Optional<LmsListAssignmentsResponse>> next) {
        ...
        public LmsListAssignmentsResponse build() {
            return new LmsListAssignmentsResponse(
                contentType,
                statusCode,
                rawResponse,
                assignmentsPaginated,
