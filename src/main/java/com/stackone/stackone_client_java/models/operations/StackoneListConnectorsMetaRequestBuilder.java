...
public class StackoneListConnectorsMetaRequestBuilder {
    ...
    public StackoneListConnectorsMetaRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public StackoneListConnectorsMetaRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
