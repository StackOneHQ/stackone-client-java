...
public class HrisListEmployeeTasksRequest {
    ...
    private JsonNullable<? extends HrisListEmployeeTasksQueryParamFilter> filter;
    ...
    @JsonCreator
    public HrisListEmployeeTasksRequest(
            String xAccountId,
            String id,
            JsonNullable<Boolean> raw,
            JsonNullable<? extends Map<String, Object>> proxy,
            JsonNullable<String> fields,
            JsonNullable<? extends HrisListEmployeeTasksQueryParamFilter> filter,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<HrisListEmployeeTasksQueryParamFilter> filter() {
        return (JsonNullable<HrisListEmployeeTasksQueryParamFilter>) filter;
    }
     ...
     * The account identifier
     */
    public HrisListEmployeeTasksRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public HrisListEmployeeTasksRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public HrisListEmployeeTasksRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public HrisListEmployeeTasksRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public HrisListEmployeeTasksRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public HrisListEmployeeTasksRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public HrisListEmployeeTasksRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public HrisListEmployeeTasksRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    public HrisListEmployeeTasksRequest withFilter(HrisListEmployeeTasksQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    public HrisListEmployeeTasksRequest withFilter(JsonNullable<? extends HrisListEmployeeTasksQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     */
    @Deprecated
    public HrisListEmployeeTasksRequest withPage(String page) {
        Utils.checkNotNull(page, "page");
     ...
     */
    @Deprecated
    public HrisListEmployeeTasksRequest withPage(JsonNullable<String> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public HrisListEmployeeTasksRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public HrisListEmployeeTasksRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public HrisListEmployeeTasksRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public HrisListEmployeeTasksRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     */
    @Deprecated
    public HrisListEmployeeTasksRequest withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     */
    @Deprecated
    public HrisListEmployeeTasksRequest withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
     ...
     * The comma separated list of fields that will be expanded in the response
     */
    public HrisListEmployeeTasksRequest withExpand(String expand) {
        Utils.checkNotNull(expand, "expand");
     ...
     * The comma separated list of fields that will be expanded in the response
     */
    public HrisListEmployeeTasksRequest withExpand(JsonNullable<String> expand) {
        Utils.checkNotNull(expand, "expand");
        this.expand = expand;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisListEmployeeTasksRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisListEmployeeTasksRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisListEmployeeTasksRequest other = (HrisListEmployeeTasksRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisListEmployeeTasksRequest.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends HrisListEmployeeTasksQueryParamFilter> filter = JsonNullable.undefined();
         ...
         * Filter parameters that allow greater customisation of the list response
         */
        public Builder filter(HrisListEmployeeTasksQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * Filter parameters that allow greater customisation of the list response
         */
        public Builder filter(JsonNullable<? extends HrisListEmployeeTasksQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
        ...
        public HrisListEmployeeTasksRequest build() {

            return new HrisListEmployeeTasksRequest(
                xAccountId, id, raw,
                proxy, fields, filter,
                page, pageSize, next,
                updatedAfter, expand, prefer);
