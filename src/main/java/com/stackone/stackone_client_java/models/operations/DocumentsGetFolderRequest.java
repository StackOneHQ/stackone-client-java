...
public class DocumentsGetFolderRequest {
    ...
    @JsonCreator
    public DocumentsGetFolderRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public DocumentsGetFolderRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public DocumentsGetFolderRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public DocumentsGetFolderRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public DocumentsGetFolderRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public DocumentsGetFolderRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public DocumentsGetFolderRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public DocumentsGetFolderRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public DocumentsGetFolderRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * The comma separated list of fields that will be included in the response
     */
    public DocumentsGetFolderRequest withInclude(String include) {
        Utils.checkNotNull(include, "include");
     ...
     * The comma separated list of fields that will be included in the response
     */
    public DocumentsGetFolderRequest withInclude(JsonNullable<String> include) {
        Utils.checkNotNull(include, "include");
        this.include = include;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public DocumentsGetFolderRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public DocumentsGetFolderRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DocumentsGetFolderRequest other = (DocumentsGetFolderRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DocumentsGetFolderRequest.class,
    ...
    public final static class Builder {
        ...
        public DocumentsGetFolderRequest build() {
            ...
            return new DocumentsGetFolderRequest(
                xAccountId, id, raw,
                proxy, fields, include,
                prefer);
        }
