...
public class AtsGetRejectedReasonRequest {
    ...
    @JsonCreator
    public AtsGetRejectedReasonRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public AtsGetRejectedReasonRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AtsGetRejectedReasonRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public AtsGetRejectedReasonRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public AtsGetRejectedReasonRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public AtsGetRejectedReasonRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public AtsGetRejectedReasonRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public AtsGetRejectedReasonRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public AtsGetRejectedReasonRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsGetRejectedReasonRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsGetRejectedReasonRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsGetRejectedReasonRequest other = (AtsGetRejectedReasonRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsGetRejectedReasonRequest.class,
    ...
    public final static class Builder {
        ...
        public AtsGetRejectedReasonRequest build() {

            return new AtsGetRejectedReasonRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
