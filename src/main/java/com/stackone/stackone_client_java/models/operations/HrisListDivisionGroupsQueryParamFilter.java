 ...
 */
public class HrisListDivisionGroupsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public HrisListDivisionGroupsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public HrisListDivisionGroupsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public HrisListDivisionGroupsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisListDivisionGroupsQueryParamFilter other = (HrisListDivisionGroupsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisListDivisionGroupsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public HrisListDivisionGroupsQueryParamFilter build() {

            return new HrisListDivisionGroupsQueryParamFilter(
                updatedAfter);
        }
