...
public class LmsListUserCompletionsRequest {
    ...
    private JsonNullable<? extends LmsListUserCompletionsQueryParamFilter> filter;
    ...
    public LmsListUserCompletionsRequest(
            ...
            JsonNullable<? extends LmsListUserCompletionsQueryParamFilter> filter,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<LmsListUserCompletionsQueryParamFilter> filter() {
        return (JsonNullable<LmsListUserCompletionsQueryParamFilter>) filter;
    }
     ...
     * The account identifier
     */
    public LmsListUserCompletionsRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public LmsListUserCompletionsRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public LmsListUserCompletionsRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public LmsListUserCompletionsRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public LmsListUserCompletionsRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public LmsListUserCompletionsRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public LmsListUserCompletionsRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public LmsListUserCompletionsRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * LMS Completions Filter
     */
    public LmsListUserCompletionsRequest withFilter(LmsListUserCompletionsQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * LMS Completions Filter
     */
    public LmsListUserCompletionsRequest withFilter(JsonNullable<? extends LmsListUserCompletionsQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     */
    @Deprecated
    public LmsListUserCompletionsRequest withPage(String page) {
        Utils.checkNotNull(page, "page");
     ...
     */
    @Deprecated
    public LmsListUserCompletionsRequest withPage(JsonNullable<String> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public LmsListUserCompletionsRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public LmsListUserCompletionsRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public LmsListUserCompletionsRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public LmsListUserCompletionsRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public LmsListUserCompletionsRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public LmsListUserCompletionsRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LmsListUserCompletionsRequest other = (LmsListUserCompletionsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LmsListUserCompletionsRequest.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends LmsListUserCompletionsQueryParamFilter> filter = JsonNullable.undefined();
         ...
         * LMS Completions Filter
         */
        public Builder filter(LmsListUserCompletionsQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * LMS Completions Filter
         */
        public Builder filter(JsonNullable<? extends LmsListUserCompletionsQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
        ...
        public LmsListUserCompletionsRequest build() {
            ...
            return new LmsListUserCompletionsRequest(
                xAccountId, id, raw,
                proxy, fields, filter,
                page, pageSize, next,
                updatedAfter, prefer);
