 ...
 */
public class AtsListInterviewStagesQueryParamFilter {
    /**
    ...
    @JsonCreator
    public AtsListInterviewStagesQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListInterviewStagesQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListInterviewStagesQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListInterviewStagesQueryParamFilter other = (AtsListInterviewStagesQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListInterviewStagesQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public AtsListInterviewStagesQueryParamFilter build() {

            return new AtsListInterviewStagesQueryParamFilter(
                updatedAfter);
        }
