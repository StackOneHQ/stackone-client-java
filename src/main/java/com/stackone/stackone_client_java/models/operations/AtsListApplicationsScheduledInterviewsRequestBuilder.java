...
public class AtsListApplicationsScheduledInterviewsRequestBuilder {
    ...
    * <pre><code>
    * for (AtsListApplicationsScheduledInterviewsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AtsListApplicationsScheduledInterviewsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
