...
public class AtsListApplicationsScheduledInterviewsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallAtsListApplicationsScheduledInterviews sdk;

    public AtsListApplicationsScheduledInterviewsRequestBuilder(SDKMethodInterfaces.MethodCallAtsListApplicationsScheduledInterviews sdk) {
        this.sdk = sdk;
    }
    ...
    public AtsListApplicationsScheduledInterviewsResponse call() throws Exception {
        Optional<Options> options = Optional.of(Options.builder()
                                                    .retryConfig(retryConfig)
                                                    .build());
        return sdk.listApplicationsScheduledInterviews(
            request,
            options);
    }
     ...
     **/  
    public Stream<AtsListApplicationsScheduledInterviewsResponse> callAsStream() {
