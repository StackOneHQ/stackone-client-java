...
public class ScreeningListScreeningPackagesRequestBuilder {
    ...
    public ScreeningListScreeningPackagesResponse call() throws Exception {
    ...
    * <pre><code>
    * for (ScreeningListScreeningPackagesResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<ScreeningListScreeningPackagesResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<ScreeningListScreeningPackagesResponse> callAsStream() {
