...
public class HrisListTeamGroupsRequestBuilder {
    ...
    public HrisListTeamGroupsRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public CompletableFuture<HrisListTeamGroupsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisListTeamGroupsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisListTeamGroupsResponse&gt;() {
     ...
     */
    public Publisher<HrisListTeamGroupsResponse> callAsPublisher() {
        HrisListTeamGroupsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    HrisListTeamGroupsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<HrisListTeamGroupsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
