...
public class MarketingListPushTemplatesResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public MarketingListPushTemplatesResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            pushTemplatesPaginated, headers);
    }
