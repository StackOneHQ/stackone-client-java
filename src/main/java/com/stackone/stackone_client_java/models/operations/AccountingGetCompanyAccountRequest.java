...
public class AccountingGetCompanyAccountRequest {
    ...
    @JsonCreator
    public AccountingGetCompanyAccountRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public AccountingGetCompanyAccountRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AccountingGetCompanyAccountRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public AccountingGetCompanyAccountRequest withSubResourceId(String subResourceId) {
        Utils.checkNotNull(subResourceId, "subResourceId");
        this.subResourceId = subResourceId;
        return this;
    }
     ...
     * value is false)
     */
    public AccountingGetCompanyAccountRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public AccountingGetCompanyAccountRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public AccountingGetCompanyAccountRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public AccountingGetCompanyAccountRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public AccountingGetCompanyAccountRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public AccountingGetCompanyAccountRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AccountingGetCompanyAccountRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AccountingGetCompanyAccountRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingGetCompanyAccountRequest other = (AccountingGetCompanyAccountRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountingGetCompanyAccountRequest.class,
    ...
    public final static class Builder {
        ...
        public AccountingGetCompanyAccountRequest build() {

            return new AccountingGetCompanyAccountRequest(
                xAccountId, id, subResourceId,
                raw, proxy, fields,
                prefer);
        }
