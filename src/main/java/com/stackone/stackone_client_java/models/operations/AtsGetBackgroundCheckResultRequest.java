...
public class AtsGetBackgroundCheckResultRequest {
    ...
    @JsonCreator
    public AtsGetBackgroundCheckResultRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public AtsGetBackgroundCheckResultRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AtsGetBackgroundCheckResultRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Indicates that the raw request result is returned
     */
    public AtsGetBackgroundCheckResultRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Indicates that the raw request result is returned
     */
    public AtsGetBackgroundCheckResultRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    public AtsGetBackgroundCheckResultRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    public AtsGetBackgroundCheckResultRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * The comma separated list of fields that will be returned in the response (if empty, all fields are returned)
     */
    public AtsGetBackgroundCheckResultRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * The comma separated list of fields that will be returned in the response (if empty, all fields are returned)
     */
    public AtsGetBackgroundCheckResultRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsGetBackgroundCheckResultRequest other = (AtsGetBackgroundCheckResultRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsGetBackgroundCheckResultRequest.class,
    ...
    public final static class Builder {
        ...
        public AtsGetBackgroundCheckResultRequest build() {
            if (raw == null) {
                raw = _SINGLETON_VALUE_Raw.value();
            }            return new AtsGetBackgroundCheckResultRequest(
                xAccountId,
                id,
                raw,
                proxy,
