...
public class AtsListListsRequestBuilder {
    ...
    public CompletableFuture<AtsListListsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsListListsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListListsResponse&gt;() {
     ...
     */
    public Publisher<AtsListListsResponse> callAsPublisher() {
        AtsListListsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<AtsListListsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
