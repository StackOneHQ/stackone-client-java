...
public class AtsListApplicationCustomFieldDefinitionsRequestBuilder {
    ...
    public CompletableFuture<AtsListApplicationCustomFieldDefinitionsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsListApplicationCustomFieldDefinitionsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListApplicationCustomFieldDefinitionsResponse&gt;() {
     ...
     */
    public Publisher<AtsListApplicationCustomFieldDefinitionsResponse> callAsPublisher() {
        AtsListApplicationCustomFieldDefinitionsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<AtsListApplicationCustomFieldDefinitionsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
