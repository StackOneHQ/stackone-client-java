...
public class AtsListApplicationStagesRequestBuilder {
    ...
    public AtsListApplicationStagesResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AtsListApplicationStagesResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AtsListApplicationStagesResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AtsListApplicationStagesResponse> callAsStream() {
