...
public class TicketingListCommentsRequestBuilder {
    ...
    public CompletableFuture<TicketingListCommentsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;TicketingListCommentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;TicketingListCommentsResponse&gt;() {
     ...
     */
    public Publisher<TicketingListCommentsResponse> callAsPublisher() {
        TicketingListCommentsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<TicketingListCommentsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
