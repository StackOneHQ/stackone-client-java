...
public class HrisGetEmployeeTaskRequest {
    ...
    @JsonCreator
    public HrisGetEmployeeTaskRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public HrisGetEmployeeTaskRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public HrisGetEmployeeTaskRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public HrisGetEmployeeTaskRequest withSubResourceId(String subResourceId) {
        Utils.checkNotNull(subResourceId, "subResourceId");
        this.subResourceId = subResourceId;
        return this;
    }
     ...
     * The comma separated list of fields that will be expanded in the response
     */
    public HrisGetEmployeeTaskRequest withExpand(String expand) {
        Utils.checkNotNull(expand, "expand");
     ...
     * The comma separated list of fields that will be expanded in the response
     */
    public HrisGetEmployeeTaskRequest withExpand(JsonNullable<String> expand) {
        Utils.checkNotNull(expand, "expand");
        this.expand = expand;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisGetEmployeeTaskRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisGetEmployeeTaskRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisGetEmployeeTaskRequest other = (HrisGetEmployeeTaskRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisGetEmployeeTaskRequest.class,
    ...
    public final static class Builder {
        ...
        public HrisGetEmployeeTaskRequest build() {

            return new HrisGetEmployeeTaskRequest(
                xAccountId, id, subResourceId,
                raw, proxy, fields,
                expand, prefer);
        }
