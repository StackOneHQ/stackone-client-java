...
public class HrisListLocationsRequestBuilder {
    ...
    public CompletableFuture<HrisListLocationsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisListLocationsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisListLocationsResponse&gt;() {
     ...
     */
    public Publisher<HrisListLocationsResponse> callAsPublisher() {
        HrisListLocationsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HrisListLocationsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
