...
public class HrisListBenefitsRequestBuilder {
    ...
    public HrisListBenefitsRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public HrisListBenefitsRequestBuilder retryConfig(RetryConfig retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = Optional.of(retryConfig);
        return this;
    }

    public HrisListBenefitsRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<HrisListBenefitsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisListBenefitsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisListBenefitsResponse&gt;() {
     ...
     */
    public Publisher<HrisListBenefitsResponse> callAsPublisher() {
        HrisListBenefitsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    HrisListBenefitsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<HrisListBenefitsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
