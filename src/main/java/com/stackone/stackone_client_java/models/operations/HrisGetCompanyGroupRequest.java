...
public class HrisGetCompanyGroupRequest {
    ...
    @JsonCreator
    public HrisGetCompanyGroupRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public HrisGetCompanyGroupRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public HrisGetCompanyGroupRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public HrisGetCompanyGroupRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public HrisGetCompanyGroupRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public HrisGetCompanyGroupRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public HrisGetCompanyGroupRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public HrisGetCompanyGroupRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public HrisGetCompanyGroupRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisGetCompanyGroupRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisGetCompanyGroupRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisGetCompanyGroupRequest other = (HrisGetCompanyGroupRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisGetCompanyGroupRequest.class,
    ...
    public final static class Builder {
        ...
        public HrisGetCompanyGroupRequest build() {

            return new HrisGetCompanyGroupRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
