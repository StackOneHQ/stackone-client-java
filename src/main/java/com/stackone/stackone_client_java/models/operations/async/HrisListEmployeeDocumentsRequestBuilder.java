...
public class HrisListEmployeeDocumentsRequestBuilder {
    ...
    public CompletableFuture<HrisListEmployeeDocumentsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisListEmployeeDocumentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisListEmployeeDocumentsResponse&gt;() {
     ...
     */
    public Publisher<HrisListEmployeeDocumentsResponse> callAsPublisher() {
        HrisListEmployeeDocumentsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HrisListEmployeeDocumentsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
