...
public class StackoneMcpDeleteSecurity implements HasSecurity {
    ...
    @JsonCreator
    public StackoneMcpDeleteSecurity(
    ...
    public StackoneMcpDeleteSecurity withBasic(SchemeBasic basic) {
        Utils.checkNotNull(basic, "basic");
    ...
    public StackoneMcpDeleteSecurity withBasic(Optional<? extends SchemeBasic> basic) {
        Utils.checkNotNull(basic, "basic");
        this.basic = basic;
        return this;
    }

    public StackoneMcpDeleteSecurity withApiKey(String apiKey) {
        Utils.checkNotNull(apiKey, "apiKey");
    ...
    public StackoneMcpDeleteSecurity withApiKey(Optional<String> apiKey) {
        Utils.checkNotNull(apiKey, "apiKey");
        this.apiKey = apiKey;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        StackoneMcpDeleteSecurity other = (StackoneMcpDeleteSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(StackoneMcpDeleteSecurity.class,
                "basic", basic,
                "apiKey", apiKey);
    }
    ...
    public final static class Builder {
        ...
        public StackoneMcpDeleteSecurity build() {

            return new StackoneMcpDeleteSecurity(
                basic, apiKey);
        }
