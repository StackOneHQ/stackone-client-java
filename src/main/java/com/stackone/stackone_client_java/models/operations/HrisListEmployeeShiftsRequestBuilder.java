...
public class HrisListEmployeeShiftsRequestBuilder {
    ...
    public HrisListEmployeeShiftsResponse call() throws Exception {
    ...
    * <pre><code>
    * for (HrisListEmployeeShiftsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<HrisListEmployeeShiftsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<HrisListEmployeeShiftsResponse> callAsStream() {
