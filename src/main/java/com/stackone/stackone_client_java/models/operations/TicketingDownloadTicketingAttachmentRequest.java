...
public class TicketingDownloadTicketingAttachmentRequest {
    ...
    @JsonCreator
    public TicketingDownloadTicketingAttachmentRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public TicketingDownloadTicketingAttachmentRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public TicketingDownloadTicketingAttachmentRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public TicketingDownloadTicketingAttachmentRequest withSubResourceId(String subResourceId) {
        Utils.checkNotNull(subResourceId, "subResourceId");
        this.subResourceId = subResourceId;
        return this;
    }
     ...
     * The format to download the file in
     */
    public TicketingDownloadTicketingAttachmentRequest withFormat(String format) {
        Utils.checkNotNull(format, "format");
     ...
     * The format to download the file in
     */
    public TicketingDownloadTicketingAttachmentRequest withFormat(JsonNullable<String> format) {
        Utils.checkNotNull(format, "format");
        this.format = format;
        return this;
    }
     ...
     * The export format of the file
     */
    public TicketingDownloadTicketingAttachmentRequest withExportFormat(String exportFormat) {
        Utils.checkNotNull(exportFormat, "exportFormat");
     ...
     * The export format of the file
     */
    public TicketingDownloadTicketingAttachmentRequest withExportFormat(JsonNullable<String> exportFormat) {
        Utils.checkNotNull(exportFormat, "exportFormat");
        this.exportFormat = exportFormat;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public TicketingDownloadTicketingAttachmentRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public TicketingDownloadTicketingAttachmentRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TicketingDownloadTicketingAttachmentRequest other = (TicketingDownloadTicketingAttachmentRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TicketingDownloadTicketingAttachmentRequest.class,
    ...
    public final static class Builder {
        ...
        public TicketingDownloadTicketingAttachmentRequest build() {
            ...
            return new TicketingDownloadTicketingAttachmentRequest(
                xAccountId, id, subResourceId,
                format, exportFormat, prefer);
        }
