...
public class LmsListSkillsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallLmsListSkills sdk;

    public LmsListSkillsRequestBuilder(SDKMethodInterfaces.MethodCallLmsListSkills sdk) {
        this.sdk = sdk;
    }
