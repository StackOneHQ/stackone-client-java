...
public class AtsListApplicationsOffersRequestBuilder {
    ...
    public AtsListApplicationsOffersResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AtsListApplicationsOffersResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AtsListApplicationsOffersResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AtsListApplicationsOffersResponse> callAsStream() {
