...
public class AtsListBackgroundCheckPackagesQueryParamFilter {
    ...
    @JsonCreator
    public AtsListBackgroundCheckPackagesQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListBackgroundCheckPackagesQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListBackgroundCheckPackagesQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListBackgroundCheckPackagesQueryParamFilter other = (AtsListBackgroundCheckPackagesQueryParamFilter) o;
        return 
