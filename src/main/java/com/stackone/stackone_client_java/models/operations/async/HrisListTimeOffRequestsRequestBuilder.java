...
public class HrisListTimeOffRequestsRequestBuilder {
    ...
    public HrisListTimeOffRequestsRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public CompletableFuture<HrisListTimeOffRequestsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisListTimeOffRequestsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisListTimeOffRequestsResponse&gt;() {
     ...
     */
    public Publisher<HrisListTimeOffRequestsResponse> callAsPublisher() {
        HrisListTimeOffRequestsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    HrisListTimeOffRequestsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<HrisListTimeOffRequestsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
