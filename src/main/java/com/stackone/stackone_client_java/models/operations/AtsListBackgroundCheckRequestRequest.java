...
public class AtsListBackgroundCheckRequestRequest {
    ...
    private JsonNullable<? extends AtsListBackgroundCheckRequestQueryParamFilter> filter;
    ...
    @JsonCreator
    public AtsListBackgroundCheckRequestRequest(
            String xAccountId,
            JsonNullable<Boolean> raw,
            JsonNullable<? extends Map<String, Object>> proxy,
            JsonNullable<String> fields,
            JsonNullable<? extends AtsListBackgroundCheckRequestQueryParamFilter> filter,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<AtsListBackgroundCheckRequestQueryParamFilter> filter() {
        return (JsonNullable<AtsListBackgroundCheckRequestQueryParamFilter>) filter;
    }
     ...
     * The account identifier
     */
    public AtsListBackgroundCheckRequestRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }
     ...
     * Indicates that the raw request result should be returned in addition to the mapped result (default value is false)
     */
    public AtsListBackgroundCheckRequestRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Indicates that the raw request result should be returned in addition to the mapped result (default value is false)
     */
    public AtsListBackgroundCheckRequestRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    public AtsListBackgroundCheckRequestRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    public AtsListBackgroundCheckRequestRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * The comma separated list of fields that will be returned in the response (if empty, all fields are returned)
     */
    public AtsListBackgroundCheckRequestRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * The comma separated list of fields that will be returned in the response (if empty, all fields are returned)
     */
    public AtsListBackgroundCheckRequestRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    public AtsListBackgroundCheckRequestRequest withFilter(AtsListBackgroundCheckRequestQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    public AtsListBackgroundCheckRequestRequest withFilter(JsonNullable<? extends AtsListBackgroundCheckRequestQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListBackgroundCheckRequestRequest withPage(String page) {
        Utils.checkNotNull(page, "page");
     ...
     */
    @Deprecated
    public AtsListBackgroundCheckRequestRequest withPage(JsonNullable<String> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public AtsListBackgroundCheckRequestRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public AtsListBackgroundCheckRequestRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public AtsListBackgroundCheckRequestRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public AtsListBackgroundCheckRequestRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListBackgroundCheckRequestRequest withUpdatedAfter(String updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     */
    @Deprecated
    public AtsListBackgroundCheckRequestRequest withUpdatedAfter(JsonNullable<String> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListBackgroundCheckRequestRequest other = (AtsListBackgroundCheckRequestRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListBackgroundCheckRequestRequest.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends AtsListBackgroundCheckRequestQueryParamFilter> filter = JsonNullable.undefined();
         ...
         * Filter parameters that allow greater customisation of the list response
         */
        public Builder filter(AtsListBackgroundCheckRequestQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * Filter parameters that allow greater customisation of the list response
         */
        public Builder filter(JsonNullable<? extends AtsListBackgroundCheckRequestQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
        ...
        public AtsListBackgroundCheckRequestRequest build() {
            return new AtsListBackgroundCheckRequestRequest(
                xAccountId,
                raw,
                proxy,
                fields,
