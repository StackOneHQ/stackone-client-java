...
public class AccountingListCompaniesResponse implements Response {
    /**
    ...
    @JsonCreator
    public AccountingListCompaniesResponse(
            String contentType,
            int statusCode,
            HttpResponse<InputStream> rawResponse,
            Optional<? extends AccountingCompaniesPaginated> accountingCompaniesPaginated,
    ...
    public Optional<AccountingCompaniesPaginated> accountingCompaniesPaginated() {
        return (Optional<AccountingCompaniesPaginated>) accountingCompaniesPaginated;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AccountingListCompaniesResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.accountingCompaniesPaginated, other.accountingCompaniesPaginated) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            accountingCompaniesPaginated, headers);
    }
    
    @Override
    public String toString() {
        return Utils.toString(AccountingListCompaniesResponse.class,
    ...
    public final static class Builder {
        ...
        public AccountingListCompaniesResponse build() {
            ...
            return new AccountingListCompaniesResponse(
                contentType, statusCode, rawResponse,
                accountingCompaniesPaginated, headers);
        }
