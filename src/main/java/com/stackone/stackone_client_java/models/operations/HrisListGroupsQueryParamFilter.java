 ...
 */
public class HrisListGroupsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public HrisListGroupsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public HrisListGroupsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public HrisListGroupsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisListGroupsQueryParamFilter other = (HrisListGroupsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisListGroupsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public HrisListGroupsQueryParamFilter build() {

            return new HrisListGroupsQueryParamFilter(
                updatedAfter);
        }
