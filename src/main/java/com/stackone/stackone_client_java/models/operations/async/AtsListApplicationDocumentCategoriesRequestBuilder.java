...
public class AtsListApplicationDocumentCategoriesRequestBuilder {
    ...
    public CompletableFuture<AtsListApplicationDocumentCategoriesResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;AtsListApplicationDocumentCategoriesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListApplicationDocumentCategoriesResponse&gt;() {
    ...
    public Publisher<AtsListApplicationDocumentCategoriesResponse> callAsPublisher() {
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    AtsListApplicationDocumentCategoriesRequest::withNext,
            operation::doRequest);

        Flow.Publisher<AtsListApplicationDocumentCategoriesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
