...
public class HrisGetTaskResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public HrisGetTaskResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public HrisGetTaskResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public HrisGetTaskResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * The task with the given identifier was retrieved.
     */
    public HrisGetTaskResponse withTaskResult(TaskResult taskResult) {
        Utils.checkNotNull(taskResult, "taskResult");
     ...
     * The task with the given identifier was retrieved.
     */
    public HrisGetTaskResponse withTaskResult(Optional<? extends TaskResult> taskResult) {
        Utils.checkNotNull(taskResult, "taskResult");
        this.taskResult = taskResult;
        return this;
    }

    public HrisGetTaskResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisGetTaskResponse other = (HrisGetTaskResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisGetTaskResponse.class,
    ...
    public final static class Builder {
        ...
        public HrisGetTaskResponse build() {
            ...
            return new HrisGetTaskResponse(
                contentType, statusCode, rawResponse,
                taskResult, headers);
        }
