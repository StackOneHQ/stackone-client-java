 ...
 */
public class IamListUsersQueryParamFilter {
    /**
    ...
    @JsonCreator
    public IamListUsersQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public IamListUsersQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public IamListUsersQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamListUsersQueryParamFilter other = (IamListUsersQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(IamListUsersQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public IamListUsersQueryParamFilter build() {

            return new IamListUsersQueryParamFilter(
                updatedAfter);
        }
