...
public class HrisListBenefitsRequestBuilder {
    ...
    public HrisListBenefitsResponse call() throws Exception {
    ...
    * <pre><code>
    * for (HrisListBenefitsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<HrisListBenefitsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<HrisListBenefitsResponse> callAsStream() {
