...
public class LmsListCategoriesRequestBuilder {
    ...
    public CompletableFuture<LmsListCategoriesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;LmsListCategoriesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;LmsListCategoriesResponse&gt;() {
     ...
     */
    public Publisher<LmsListCategoriesResponse> callAsPublisher() {
        LmsListCategoriesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<LmsListCategoriesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
