 ...
 * Active
 * 
 * <p>Filter to allow filtering of only active courses
 */
...
public class Active {
    ...
    public static Active of(String value) {
        Utils.checkNotNull(value, "value");
        return new Active(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<String>(){}));
    }
