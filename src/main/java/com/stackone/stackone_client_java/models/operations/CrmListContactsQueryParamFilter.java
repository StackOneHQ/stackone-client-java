 ...
 */
public class CrmListContactsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public CrmListContactsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public CrmListContactsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public CrmListContactsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CrmListContactsQueryParamFilter other = (CrmListContactsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CrmListContactsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public CrmListContactsQueryParamFilter build() {

            return new CrmListContactsQueryParamFilter(
                updatedAfter);
        }
