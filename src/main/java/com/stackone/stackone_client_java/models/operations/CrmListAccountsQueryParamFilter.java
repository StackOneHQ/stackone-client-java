 ...
 */
public class CrmListAccountsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public CrmListAccountsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public CrmListAccountsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public CrmListAccountsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CrmListAccountsQueryParamFilter other = (CrmListAccountsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CrmListAccountsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public CrmListAccountsQueryParamFilter build() {

            return new CrmListAccountsQueryParamFilter(
                updatedAfter);
        }
