...
public class HrisListEmployeeEmploymentsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallHrisListEmployeeEmployments sdk;

    public HrisListEmployeeEmploymentsRequestBuilder(SDKMethodInterfaces.MethodCallHrisListEmployeeEmployments sdk) {
        this.sdk = sdk;
    }
    ...
    public HrisListEmployeeEmploymentsRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public HrisListEmployeeEmploymentsRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
    ...
    public HrisListEmployeeEmploymentsResponse call() throws Exception {
        Optional<Options> options = Optional.of(Options.builder()
                                                    .retryConfig(retryConfig)
                                                    .build());
        return sdk.listEmployeeEmployments(
            request,
            serverURL,
            options);
    }
     ...
     **/  
    public Stream<HrisListEmployeeEmploymentsResponse> callAsStream() {
