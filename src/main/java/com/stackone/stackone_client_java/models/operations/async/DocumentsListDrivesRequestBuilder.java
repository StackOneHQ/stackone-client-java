...
public class DocumentsListDrivesRequestBuilder {
    ...
    public CompletableFuture<DocumentsListDrivesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;DocumentsListDrivesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;DocumentsListDrivesResponse&gt;() {
     ...
     */
    public Publisher<DocumentsListDrivesResponse> callAsPublisher() {
        DocumentsListDrivesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    DocumentsListDrivesRequest::withNext,
            operation::doRequest);

        Flow.Publisher<DocumentsListDrivesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
