...
public class HrisListTimeOffPoliciesRequest {
    ...
    private JsonNullable<? extends HrisListTimeOffPoliciesQueryParamFilter> filter;
    ...
    public HrisListTimeOffPoliciesRequest(
            ...
            JsonNullable<? extends HrisListTimeOffPoliciesQueryParamFilter> filter,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<HrisListTimeOffPoliciesQueryParamFilter> filter() {
        return (JsonNullable<HrisListTimeOffPoliciesQueryParamFilter>) filter;
    }
     ...
     * The account identifier
     */
    public HrisListTimeOffPoliciesRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }
     ...
     * Indicates that the raw request result should be returned in addition to the mapped result (default value is false)
     */
    public HrisListTimeOffPoliciesRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Indicates that the raw request result should be returned in addition to the mapped result (default value is false)
     */
    public HrisListTimeOffPoliciesRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    public HrisListTimeOffPoliciesRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    public HrisListTimeOffPoliciesRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * The comma separated list of fields that will be returned in the response (if empty, all fields are returned)
     */
    public HrisListTimeOffPoliciesRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * The comma separated list of fields that will be returned in the response (if empty, all fields are returned)
     */
    public HrisListTimeOffPoliciesRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * HRIS Time-Off Policies filters
     */
    public HrisListTimeOffPoliciesRequest withFilter(HrisListTimeOffPoliciesQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * HRIS Time-Off Policies filters
     */
    public HrisListTimeOffPoliciesRequest withFilter(JsonNullable<? extends HrisListTimeOffPoliciesQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     */
    @Deprecated
    public HrisListTimeOffPoliciesRequest withPage(String page) {
        Utils.checkNotNull(page, "page");
     ...
     */
    @Deprecated
    public HrisListTimeOffPoliciesRequest withPage(JsonNullable<String> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public HrisListTimeOffPoliciesRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public HrisListTimeOffPoliciesRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public HrisListTimeOffPoliciesRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public HrisListTimeOffPoliciesRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     */
    @Deprecated
    public HrisListTimeOffPoliciesRequest withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     */
    @Deprecated
    public HrisListTimeOffPoliciesRequest withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisListTimeOffPoliciesRequest other = (HrisListTimeOffPoliciesRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisListTimeOffPoliciesRequest.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends HrisListTimeOffPoliciesQueryParamFilter> filter = JsonNullable.undefined();
         ...
         * HRIS Time-Off Policies filters
         */
        public Builder filter(HrisListTimeOffPoliciesQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * HRIS Time-Off Policies filters
         */
        public Builder filter(JsonNullable<? extends HrisListTimeOffPoliciesQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
