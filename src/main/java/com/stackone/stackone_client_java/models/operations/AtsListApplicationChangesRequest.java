...
public class AtsListApplicationChangesRequest {
     ...
     * The account identifier
     */
    public AtsListApplicationChangesRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AtsListApplicationChangesRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public AtsListApplicationChangesRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public AtsListApplicationChangesRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public AtsListApplicationChangesRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public AtsListApplicationChangesRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public AtsListApplicationChangesRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public AtsListApplicationChangesRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public AtsListApplicationChangesRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public AtsListApplicationChangesRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public AtsListApplicationChangesRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public AtsListApplicationChangesRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     * Filter parameters for application changes (supports created_after and change_type)
     */
    public AtsListApplicationChangesRequest withFilter(AtsListApplicationChangesQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Filter parameters for application changes (supports created_after and change_type)
     */
    public AtsListApplicationChangesRequest withFilter(JsonNullable<? extends AtsListApplicationChangesQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListApplicationChangesRequest other = (AtsListApplicationChangesRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListApplicationChangesRequest.class,
    ...
    public final static class Builder {
         ...
         * Filter parameters for application changes (supports created_after and change_type)
         */
        public Builder filter(AtsListApplicationChangesQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * Filter parameters for application changes (supports created_after and change_type)
         */
        public Builder filter(JsonNullable<? extends AtsListApplicationChangesQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
