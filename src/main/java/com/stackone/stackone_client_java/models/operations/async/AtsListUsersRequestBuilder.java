...
public class AtsListUsersRequestBuilder {
    ...
    public CompletableFuture<AtsListUsersResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsListUsersResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListUsersResponse&gt;() {
     ...
     */
    public Publisher<AtsListUsersResponse> callAsPublisher() {
        AtsListUsersRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<AtsListUsersResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
