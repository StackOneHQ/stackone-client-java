...
public class AtsListJobPostingsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallAtsListJobPostings sdk;

    public AtsListJobPostingsRequestBuilder(SDKMethodInterfaces.MethodCallAtsListJobPostings sdk) {
        this.sdk = sdk;
    }
    ...
    public AtsListJobPostingsResponse call() throws Exception {
        Optional<Options> options = Optional.of(Options.builder()
                                                    .retryConfig(retryConfig)
                                                    .build());
        return sdk.listJobPostings(
            request,
            options);
    }
     ...
     **/  
    public Stream<AtsListJobPostingsResponse> callAsStream() {
