...
public class AtsGetApplicationDocumentCategoryRequest {
    ...
    @JsonCreator
    public AtsGetApplicationDocumentCategoryRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public AtsGetApplicationDocumentCategoryRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AtsGetApplicationDocumentCategoryRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public AtsGetApplicationDocumentCategoryRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public AtsGetApplicationDocumentCategoryRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public AtsGetApplicationDocumentCategoryRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public AtsGetApplicationDocumentCategoryRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public AtsGetApplicationDocumentCategoryRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public AtsGetApplicationDocumentCategoryRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsGetApplicationDocumentCategoryRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsGetApplicationDocumentCategoryRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsGetApplicationDocumentCategoryRequest other = (AtsGetApplicationDocumentCategoryRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsGetApplicationDocumentCategoryRequest.class,
    ...
    public final static class Builder {
        ...
        public AtsGetApplicationDocumentCategoryRequest build() {

            return new AtsGetApplicationDocumentCategoryRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
