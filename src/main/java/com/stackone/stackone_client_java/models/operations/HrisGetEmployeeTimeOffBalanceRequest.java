...
public class HrisGetEmployeeTimeOffBalanceRequest {
     ...
     * The account identifier
     */
    public HrisGetEmployeeTimeOffBalanceRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public HrisGetEmployeeTimeOffBalanceRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public HrisGetEmployeeTimeOffBalanceRequest withSubResourceId(String subResourceId) {
        Utils.checkNotNull(subResourceId, "subResourceId");
        this.subResourceId = subResourceId;
        return this;
    }
     ...
     * Indicates that the raw request result should be returned in addition to the mapped result (default value is false)
     */
    public HrisGetEmployeeTimeOffBalanceRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Indicates that the raw request result should be returned in addition to the mapped result (default value is false)
     */
    public HrisGetEmployeeTimeOffBalanceRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    public HrisGetEmployeeTimeOffBalanceRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    public HrisGetEmployeeTimeOffBalanceRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * The comma separated list of fields that will be returned in the response (if empty, all fields are returned)
     */
    public HrisGetEmployeeTimeOffBalanceRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * The comma separated list of fields that will be returned in the response (if empty, all fields are returned)
     */
    public HrisGetEmployeeTimeOffBalanceRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * The comma separated list of fields that will be expanded in the response
     */
    public HrisGetEmployeeTimeOffBalanceRequest withExpand(String expand) {
        Utils.checkNotNull(expand, "expand");
     ...
     * The comma separated list of fields that will be expanded in the response
     */
    public HrisGetEmployeeTimeOffBalanceRequest withExpand(JsonNullable<String> expand) {
        Utils.checkNotNull(expand, "expand");
        this.expand = expand;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisGetEmployeeTimeOffBalanceRequest other = (HrisGetEmployeeTimeOffBalanceRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisGetEmployeeTimeOffBalanceRequest.class,
