...
public class HrisListShiftsRequestBuilder {
    ...
    public CompletableFuture<HrisListShiftsResponse> call() {
    ...
    public Publisher<HrisListShiftsResponse> callAsPublisher() {
        ...
        Flow.Publisher<HrisListShiftsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
