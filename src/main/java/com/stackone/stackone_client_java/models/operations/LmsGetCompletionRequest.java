...
public class LmsGetCompletionRequest {
    ...
    @JsonCreator
    public LmsGetCompletionRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public LmsGetCompletionRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public LmsGetCompletionRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public LmsGetCompletionRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public LmsGetCompletionRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public LmsGetCompletionRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public LmsGetCompletionRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * The comma separated list of fields to return in the response (if empty, all fields are returned)
     */
    public LmsGetCompletionRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * The comma separated list of fields to return in the response (if empty, all fields are returned)
     */
    public LmsGetCompletionRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public LmsGetCompletionRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public LmsGetCompletionRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LmsGetCompletionRequest other = (LmsGetCompletionRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LmsGetCompletionRequest.class,
    ...
    public final static class Builder {
        ...
        public LmsGetCompletionRequest build() {

            return new LmsGetCompletionRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
