...
public class HrisListLocationsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallHrisListLocations sdk;

    public HrisListLocationsRequestBuilder(SDKMethodInterfaces.MethodCallHrisListLocations sdk) {
        this.sdk = sdk;
    }
    ...
    public HrisListLocationsRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public HrisListLocationsRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
