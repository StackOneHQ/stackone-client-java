...
public class AtsGetAssessmentsPackageRequest {
    ...
    @JsonCreator
    public AtsGetAssessmentsPackageRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public AtsGetAssessmentsPackageRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AtsGetAssessmentsPackageRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The comma separated list of fields to return in the response (if empty, all fields are returned)
     */
    public AtsGetAssessmentsPackageRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * The comma separated list of fields to return in the response (if empty, all fields are returned)
     */
    public AtsGetAssessmentsPackageRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsGetAssessmentsPackageRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsGetAssessmentsPackageRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsGetAssessmentsPackageRequest other = (AtsGetAssessmentsPackageRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsGetAssessmentsPackageRequest.class,
    ...
    public final static class Builder {
        ...
        public AtsGetAssessmentsPackageRequest build() {

            return new AtsGetAssessmentsPackageRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
