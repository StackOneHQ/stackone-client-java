...
public class MarketingListOmniChannelTemplatesRequestBuilder {
    ...
    public MarketingListOmniChannelTemplatesRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public CompletableFuture<MarketingListOmniChannelTemplatesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;MarketingListOmniChannelTemplatesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;MarketingListOmniChannelTemplatesResponse&gt;() {
     ...
     */
    public Publisher<MarketingListOmniChannelTemplatesResponse> callAsPublisher() {
        MarketingListOmniChannelTemplatesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
