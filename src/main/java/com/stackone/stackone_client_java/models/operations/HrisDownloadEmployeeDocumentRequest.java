...
public class HrisDownloadEmployeeDocumentRequest {
    ...
    @JsonCreator
    public HrisDownloadEmployeeDocumentRequest(
            String xAccountId,
            String id,
     ...
     * The export format of the file
     */
    public HrisDownloadEmployeeDocumentRequest withExportFormat(String exportFormat) {
        Utils.checkNotNull(exportFormat, "exportFormat");
     ...
     * The export format of the file
     */
    public HrisDownloadEmployeeDocumentRequest withExportFormat(JsonNullable<String> exportFormat) {
        Utils.checkNotNull(exportFormat, "exportFormat");
        this.exportFormat = exportFormat;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisDownloadEmployeeDocumentRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisDownloadEmployeeDocumentRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(HrisDownloadEmployeeDocumentRequest.class,
    ...
    public final static class Builder {
        ...
        public HrisDownloadEmployeeDocumentRequest build() {
            ...
            return new HrisDownloadEmployeeDocumentRequest(
                xAccountId, id, subResourceId,
                format, exportFormat, prefer);
        }
