...
public class AtsGetApplicationNoteRequest {
    ...
    @JsonCreator
    public AtsGetApplicationNoteRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public AtsGetApplicationNoteRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public AtsGetApplicationNoteRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public AtsGetApplicationNoteRequest withSubResourceId(String subResourceId) {
        Utils.checkNotNull(subResourceId, "subResourceId");
        this.subResourceId = subResourceId;
        return this;
    }
     ...
     * value is false)
     */
    public AtsGetApplicationNoteRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public AtsGetApplicationNoteRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public AtsGetApplicationNoteRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public AtsGetApplicationNoteRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public AtsGetApplicationNoteRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public AtsGetApplicationNoteRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsGetApplicationNoteRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsGetApplicationNoteRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsGetApplicationNoteRequest other = (AtsGetApplicationNoteRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsGetApplicationNoteRequest.class,
    ...
    public final static class Builder {
        ...
        public AtsGetApplicationNoteRequest build() {

            return new AtsGetApplicationNoteRequest(
                xAccountId, id, subResourceId,
                raw, proxy, fields,
                prefer);
        }
