 ...
 */
public class AtsListUsersQueryParamFilter {
    /**
    ...
    @JsonCreator
    public AtsListUsersQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListUsersQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListUsersQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListUsersQueryParamFilter other = (AtsListUsersQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListUsersQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public AtsListUsersQueryParamFilter build() {

            return new AtsListUsersQueryParamFilter(
                updatedAfter);
        }
