...
public class HrisListCostCenterGroupsResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public HrisListCostCenterGroupsResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            hrisCostCenterPaginated, headers);
    }
