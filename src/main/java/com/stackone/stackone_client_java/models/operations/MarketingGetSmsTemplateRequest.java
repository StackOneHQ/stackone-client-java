...
public class MarketingGetSmsTemplateRequest {
    ...
    @JsonCreator
    public MarketingGetSmsTemplateRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public MarketingGetSmsTemplateRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public MarketingGetSmsTemplateRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public MarketingGetSmsTemplateRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public MarketingGetSmsTemplateRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public MarketingGetSmsTemplateRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public MarketingGetSmsTemplateRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public MarketingGetSmsTemplateRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public MarketingGetSmsTemplateRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public MarketingGetSmsTemplateRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public MarketingGetSmsTemplateRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MarketingGetSmsTemplateRequest other = (MarketingGetSmsTemplateRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MarketingGetSmsTemplateRequest.class,
    ...
    public final static class Builder {
        ...
        public MarketingGetSmsTemplateRequest build() {

            return new MarketingGetSmsTemplateRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
