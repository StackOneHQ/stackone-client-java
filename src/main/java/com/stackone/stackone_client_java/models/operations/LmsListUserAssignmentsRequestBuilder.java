...
public class LmsListUserAssignmentsRequestBuilder {
    ...
    public LmsListUserAssignmentsResponse call() {
    ...
    * <pre><code>
    * for (LmsListUserAssignmentsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<LmsListUserAssignmentsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
