...
public class AtsListBackgroundCheckPackagesRequest {
    ...
    private JsonNullable<? extends AtsListBackgroundCheckPackagesQueryParamFilter> filter;
    ...
    @JsonCreator
    public AtsListBackgroundCheckPackagesRequest(
            String xAccountId,
            JsonNullable<Boolean> raw,
            JsonNullable<? extends Map<String, Object>> proxy,
            JsonNullable<String> fields,
            JsonNullable<? extends AtsListBackgroundCheckPackagesQueryParamFilter> filter,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<AtsListBackgroundCheckPackagesQueryParamFilter> filter() {
        return (JsonNullable<AtsListBackgroundCheckPackagesQueryParamFilter>) filter;
    }
     ...
     * The account identifier
     */
    public AtsListBackgroundCheckPackagesRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }
     ...
     * value is false)
     */
    public AtsListBackgroundCheckPackagesRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public AtsListBackgroundCheckPackagesRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public AtsListBackgroundCheckPackagesRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public AtsListBackgroundCheckPackagesRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public AtsListBackgroundCheckPackagesRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public AtsListBackgroundCheckPackagesRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    public AtsListBackgroundCheckPackagesRequest withFilter(AtsListBackgroundCheckPackagesQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    public AtsListBackgroundCheckPackagesRequest withFilter(JsonNullable<? extends AtsListBackgroundCheckPackagesQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListBackgroundCheckPackagesRequest withPage(String page) {
        Utils.checkNotNull(page, "page");
     ...
     */
    @Deprecated
    public AtsListBackgroundCheckPackagesRequest withPage(JsonNullable<String> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public AtsListBackgroundCheckPackagesRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public AtsListBackgroundCheckPackagesRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public AtsListBackgroundCheckPackagesRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public AtsListBackgroundCheckPackagesRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListBackgroundCheckPackagesRequest withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     */
    @Deprecated
    public AtsListBackgroundCheckPackagesRequest withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsListBackgroundCheckPackagesRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsListBackgroundCheckPackagesRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListBackgroundCheckPackagesRequest other = (AtsListBackgroundCheckPackagesRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListBackgroundCheckPackagesRequest.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends AtsListBackgroundCheckPackagesQueryParamFilter> filter = JsonNullable.undefined();
         ...
         * Filter parameters that allow greater customisation of the list response
         */
        public Builder filter(AtsListBackgroundCheckPackagesQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * Filter parameters that allow greater customisation of the list response
         */
        public Builder filter(JsonNullable<? extends AtsListBackgroundCheckPackagesQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
        ...
        public AtsListBackgroundCheckPackagesRequest build() {

            return new AtsListBackgroundCheckPackagesRequest(
                xAccountId, raw, proxy,
                fields, filter, page,
                pageSize, next, updatedAfter,
                prefer);
