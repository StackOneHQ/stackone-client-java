...
public class HrisGetEmployeeEmploymentRequest {
    ...
    @JsonCreator
    public HrisGetEmployeeEmploymentRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public HrisGetEmployeeEmploymentRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public HrisGetEmployeeEmploymentRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public HrisGetEmployeeEmploymentRequest withSubResourceId(String subResourceId) {
        Utils.checkNotNull(subResourceId, "subResourceId");
        this.subResourceId = subResourceId;
        return this;
    }
     ...
     * value is false)
     */
    public HrisGetEmployeeEmploymentRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public HrisGetEmployeeEmploymentRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public HrisGetEmployeeEmploymentRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public HrisGetEmployeeEmploymentRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public HrisGetEmployeeEmploymentRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public HrisGetEmployeeEmploymentRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * The comma separated list of fields that will be expanded in the response
     */
    public HrisGetEmployeeEmploymentRequest withExpand(String expand) {
        Utils.checkNotNull(expand, "expand");
     ...
     * The comma separated list of fields that will be expanded in the response
     */
    public HrisGetEmployeeEmploymentRequest withExpand(JsonNullable<String> expand) {
        Utils.checkNotNull(expand, "expand");
        this.expand = expand;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisGetEmployeeEmploymentRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisGetEmployeeEmploymentRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(HrisGetEmployeeEmploymentRequest.class,
    ...
    public final static class Builder {
        ...
        public HrisGetEmployeeEmploymentRequest build() {

            return new HrisGetEmployeeEmploymentRequest(
                xAccountId, id, subResourceId,
                raw, proxy, fields,
                expand, prefer);
        }
