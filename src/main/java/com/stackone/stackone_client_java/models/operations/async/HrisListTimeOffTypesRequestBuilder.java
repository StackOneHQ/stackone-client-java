...
public class HrisListTimeOffTypesRequestBuilder {
    ...
    public HrisListTimeOffTypesRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public CompletableFuture<HrisListTimeOffTypesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisListTimeOffTypesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisListTimeOffTypesResponse&gt;() {
     ...
     */
    public Publisher<HrisListTimeOffTypesResponse> callAsPublisher() {
        HrisListTimeOffTypesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    HrisListTimeOffTypesRequest::withNext,
            operation::doRequest);

        Flow.Publisher<HrisListTimeOffTypesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
