 ...
 */
public class MessagingListConversationMessagesQueryParamFilter {
    /**
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public MessagingListConversationMessagesQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public MessagingListConversationMessagesQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MessagingListConversationMessagesQueryParamFilter other = (MessagingListConversationMessagesQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MessagingListConversationMessagesQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public MessagingListConversationMessagesQueryParamFilter build() {

            return new MessagingListConversationMessagesQueryParamFilter(
                updatedAfter);
        }
