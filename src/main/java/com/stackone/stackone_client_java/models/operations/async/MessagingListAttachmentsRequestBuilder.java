...
public class MessagingListAttachmentsRequestBuilder {
    ...
    public CompletableFuture<MessagingListAttachmentsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;MessagingListAttachmentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;MessagingListAttachmentsResponse&gt;() {
    ...
    public Publisher<MessagingListAttachmentsResponse> callAsPublisher() {
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    MessagingListAttachmentsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<MessagingListAttachmentsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
