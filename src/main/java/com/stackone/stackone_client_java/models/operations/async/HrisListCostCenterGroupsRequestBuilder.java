...
public class HrisListCostCenterGroupsRequestBuilder {
    ...
    public CompletableFuture<HrisListCostCenterGroupsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisListCostCenterGroupsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisListCostCenterGroupsResponse&gt;() {
     ...
     */
    public Publisher<HrisListCostCenterGroupsResponse> callAsPublisher() {
        HrisListCostCenterGroupsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HrisListCostCenterGroupsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
