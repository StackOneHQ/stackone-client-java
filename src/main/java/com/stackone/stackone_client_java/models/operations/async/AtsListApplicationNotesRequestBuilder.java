...
public class AtsListApplicationNotesRequestBuilder {
    ...
    public AtsListApplicationNotesRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public CompletableFuture<AtsListApplicationNotesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsListApplicationNotesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListApplicationNotesResponse&gt;() {
     ...
     */
    public Publisher<AtsListApplicationNotesResponse> callAsPublisher() {
        AtsListApplicationNotesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    AtsListApplicationNotesRequest::withNext,
            operation::doRequest);

        Flow.Publisher<AtsListApplicationNotesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
