...
public class TicketingListAttachmentsRequestBuilder {
    ...
    public CompletableFuture<TicketingListAttachmentsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;TicketingListAttachmentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;TicketingListAttachmentsResponse&gt;() {
    ...
    public Publisher<TicketingListAttachmentsResponse> callAsPublisher() {
        ...
        Flow.Publisher<TicketingListAttachmentsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
