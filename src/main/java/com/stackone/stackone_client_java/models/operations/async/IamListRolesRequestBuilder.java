...
public class IamListRolesRequestBuilder {
    ...
    public CompletableFuture<IamListRolesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;IamListRolesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;IamListRolesResponse&gt;() {
     ...
     */
    public Publisher<IamListRolesResponse> callAsPublisher() {
        IamListRolesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    IamListRolesRequest::withNext,
            operation::doRequest);

        Flow.Publisher<IamListRolesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
