...
public class LmsListAssignmentsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallLmsListAssignments sdk;

    public LmsListAssignmentsRequestBuilder(SDKMethodInterfaces.MethodCallLmsListAssignments sdk) {
        this.sdk = sdk;
    }
