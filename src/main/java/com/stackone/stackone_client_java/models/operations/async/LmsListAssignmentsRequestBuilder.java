...
public class LmsListAssignmentsRequestBuilder {
    ...
    public CompletableFuture<LmsListAssignmentsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;LmsListAssignmentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;LmsListAssignmentsResponse&gt;() {
     ...
     */
    public Publisher<LmsListAssignmentsResponse> callAsPublisher() {
        LmsListAssignmentsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    LmsListAssignmentsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<LmsListAssignmentsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
