...
public class LmsListSkillsRequestBuilder {
    ...
    public CompletableFuture<LmsListSkillsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;LmsListSkillsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;LmsListSkillsResponse&gt;() {
     ...
     */
    public Publisher<LmsListSkillsResponse> callAsPublisher() {
        LmsListSkillsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    LmsListSkillsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<LmsListSkillsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
