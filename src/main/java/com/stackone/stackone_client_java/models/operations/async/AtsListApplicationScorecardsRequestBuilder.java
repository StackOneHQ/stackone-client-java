...
public class AtsListApplicationScorecardsRequestBuilder {

    private AtsListApplicationScorecardsRequest request;
    ...
    public AtsListApplicationScorecardsRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<AtsListApplicationScorecardsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsListApplicationScorecardsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsListApplicationScorecardsResponse&gt;() {
     ...
     */
    public Publisher<AtsListApplicationScorecardsResponse> callAsPublisher() {
        AtsListApplicationScorecardsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    AtsListApplicationScorecardsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<AtsListApplicationScorecardsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
