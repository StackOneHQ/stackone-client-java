...
public class MarketingGetEmailTemplateRequest {
    ...
    @JsonCreator
    public MarketingGetEmailTemplateRequest(
            String xAccountId,
            String id,
     ...
     * The account identifier
     */
    public MarketingGetEmailTemplateRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public MarketingGetEmailTemplateRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public MarketingGetEmailTemplateRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public MarketingGetEmailTemplateRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public MarketingGetEmailTemplateRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public MarketingGetEmailTemplateRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public MarketingGetEmailTemplateRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public MarketingGetEmailTemplateRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public MarketingGetEmailTemplateRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public MarketingGetEmailTemplateRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MarketingGetEmailTemplateRequest other = (MarketingGetEmailTemplateRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MarketingGetEmailTemplateRequest.class,
    ...
    public final static class Builder {
        ...
        public MarketingGetEmailTemplateRequest build() {

            return new MarketingGetEmailTemplateRequest(
                xAccountId, id, raw,
                proxy, fields, prefer);
        }
