...
public class AtsListJobPostingsRequest {
    ...
    private JsonNullable<? extends AtsListJobPostingsQueryParamFilter> filter;
    ...
    public AtsListJobPostingsRequest(
            ...
            JsonNullable<? extends AtsListJobPostingsQueryParamFilter> filter,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<AtsListJobPostingsQueryParamFilter> filter() {
        return (JsonNullable<AtsListJobPostingsQueryParamFilter>) filter;
    }
     ...
     * The account identifier
     */
    public AtsListJobPostingsRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }
     ...
     * value is false)
     */
    public AtsListJobPostingsRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public AtsListJobPostingsRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public AtsListJobPostingsRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public AtsListJobPostingsRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public AtsListJobPostingsRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public AtsListJobPostingsRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * ATS Job Postings Filter
     */
    public AtsListJobPostingsRequest withFilter(AtsListJobPostingsQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * ATS Job Postings Filter
     */
    public AtsListJobPostingsRequest withFilter(JsonNullable<? extends AtsListJobPostingsQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListJobPostingsRequest withPage(String page) {
        Utils.checkNotNull(page, "page");
     ...
     */
    @Deprecated
    public AtsListJobPostingsRequest withPage(JsonNullable<String> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public AtsListJobPostingsRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public AtsListJobPostingsRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public AtsListJobPostingsRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public AtsListJobPostingsRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListJobPostingsRequest withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     */
    @Deprecated
    public AtsListJobPostingsRequest withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsListJobPostingsRequest withSyncToken(String syncToken) {
        Utils.checkNotNull(syncToken, "syncToken");
     ...
     */
    @Deprecated
    public AtsListJobPostingsRequest withSyncToken(JsonNullable<String> syncToken) {
        Utils.checkNotNull(syncToken, "syncToken");
        this.syncToken = syncToken;
        return this;
    }
     ...
     * The comma separated list of fields that will be included in the response
     */
    public AtsListJobPostingsRequest withInclude(String include) {
        Utils.checkNotNull(include, "include");
     ...
     * The comma separated list of fields that will be included in the response
     */
    public AtsListJobPostingsRequest withInclude(JsonNullable<String> include) {
        Utils.checkNotNull(include, "include");
        this.include = include;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsListJobPostingsRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public AtsListJobPostingsRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListJobPostingsRequest other = (AtsListJobPostingsRequest) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            syncToken, include, prefer);
    }
    
    @Override
    public String toString() {
        return Utils.toString(AtsListJobPostingsRequest.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends AtsListJobPostingsQueryParamFilter> filter = JsonNullable.undefined();
         ...
         * ATS Job Postings Filter
         */
        public Builder filter(AtsListJobPostingsQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * ATS Job Postings Filter
         */
        public Builder filter(JsonNullable<? extends AtsListJobPostingsQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
        ...
        public AtsListJobPostingsRequest build() {

            return new AtsListJobPostingsRequest(
                xAccountId, raw, proxy,
                fields, filter, page,
                pageSize, next, updatedAfter,
                syncToken, include, prefer);
