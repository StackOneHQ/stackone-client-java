 ...
 */
public class AtsListApplicationsScheduledInterviewsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public AtsListApplicationsScheduledInterviewsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListApplicationsScheduledInterviewsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public AtsListApplicationsScheduledInterviewsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsListApplicationsScheduledInterviewsQueryParamFilter other = (AtsListApplicationsScheduledInterviewsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsListApplicationsScheduledInterviewsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public AtsListApplicationsScheduledInterviewsQueryParamFilter build() {
            ...
            return new AtsListApplicationsScheduledInterviewsQueryParamFilter(
                updatedAfter);
        }
