...
public class HrisListEmployeeWorkEligibilityRequest {
    ...
    private JsonNullable<? extends HrisListEmployeeWorkEligibilityQueryParamFilter> filter;
    ...
    public HrisListEmployeeWorkEligibilityRequest(
            ...
            JsonNullable<? extends HrisListEmployeeWorkEligibilityQueryParamFilter> filter,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<HrisListEmployeeWorkEligibilityQueryParamFilter> filter() {
        return (JsonNullable<HrisListEmployeeWorkEligibilityQueryParamFilter>) filter;
    }
     ...
     * value is false)
     */
    public HrisListEmployeeWorkEligibilityRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public HrisListEmployeeWorkEligibilityRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public HrisListEmployeeWorkEligibilityRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public HrisListEmployeeWorkEligibilityRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public HrisListEmployeeWorkEligibilityRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public HrisListEmployeeWorkEligibilityRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    public HrisListEmployeeWorkEligibilityRequest withFilter(HrisListEmployeeWorkEligibilityQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    public HrisListEmployeeWorkEligibilityRequest withFilter(JsonNullable<? extends HrisListEmployeeWorkEligibilityQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     */
    @Deprecated
    public HrisListEmployeeWorkEligibilityRequest withPage(String page) {
        Utils.checkNotNull(page, "page");
     ...
     */
    @Deprecated
    public HrisListEmployeeWorkEligibilityRequest withPage(JsonNullable<String> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public HrisListEmployeeWorkEligibilityRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public HrisListEmployeeWorkEligibilityRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public HrisListEmployeeWorkEligibilityRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public HrisListEmployeeWorkEligibilityRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     * The account identifier
     */
    public HrisListEmployeeWorkEligibilityRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisListEmployeeWorkEligibilityRequest other = (HrisListEmployeeWorkEligibilityRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisListEmployeeWorkEligibilityRequest.class,
                "id", id,
                "raw", raw,
                "proxy", proxy,
                "fields", fields,
    ...
    public final static class Builder {
         ...
         * Filter parameters that allow greater customisation of the list response
         */
        public Builder filter(HrisListEmployeeWorkEligibilityQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * Filter parameters that allow greater customisation of the list response
         */
        public Builder filter(JsonNullable<? extends HrisListEmployeeWorkEligibilityQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
