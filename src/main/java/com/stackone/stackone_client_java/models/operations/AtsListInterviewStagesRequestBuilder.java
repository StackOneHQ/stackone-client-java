...
public class AtsListInterviewStagesRequestBuilder {
    ...
    public AtsListInterviewStagesResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AtsListInterviewStagesResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AtsListInterviewStagesResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AtsListInterviewStagesResponse> callAsStream() {
