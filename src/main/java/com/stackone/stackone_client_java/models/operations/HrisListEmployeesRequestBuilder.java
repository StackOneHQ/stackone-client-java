...
public class HrisListEmployeesRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallHrisListEmployees sdk;

    public HrisListEmployeesRequestBuilder(SDKMethodInterfaces.MethodCallHrisListEmployees sdk) {
        this.sdk = sdk;
    }
    ...
    public HrisListEmployeesRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public HrisListEmployeesRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
