...
public class HrisListTimeEntriesRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallHrisListTimeEntries sdk;

    public HrisListTimeEntriesRequestBuilder(SDKMethodInterfaces.MethodCallHrisListTimeEntries sdk) {
        this.sdk = sdk;
    }
    ...
    public HrisListTimeEntriesRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public HrisListTimeEntriesRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
