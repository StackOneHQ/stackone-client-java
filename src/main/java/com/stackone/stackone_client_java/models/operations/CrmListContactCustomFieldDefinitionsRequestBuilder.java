...
public class CrmListContactCustomFieldDefinitionsRequestBuilder {

    private CrmListContactCustomFieldDefinitionsRequest request;
    private Optional<RetryConfig> retryConfig = Optional.empty();
    private final SDKMethodInterfaces.MethodCallCrmListContactCustomFieldDefinitions sdk;

    public CrmListContactCustomFieldDefinitionsRequestBuilder(SDKMethodInterfaces.MethodCallCrmListContactCustomFieldDefinitions sdk) {
        this.sdk = sdk;
    }
    ...
    public CrmListContactCustomFieldDefinitionsRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CrmListContactCustomFieldDefinitionsResponse call() throws Exception {
        Optional<Options> options = Optional.of(Options.builder()
                                                    .retryConfig(retryConfig)
                                                    .build());
        return sdk.listContactCustomFieldDefinitions(
            request,
            options);
    }
     ...
     **/  
    public Stream<CrmListContactCustomFieldDefinitionsResponse> callAsStream() {
