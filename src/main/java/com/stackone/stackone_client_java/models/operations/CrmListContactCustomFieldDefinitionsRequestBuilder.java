...
public class CrmListContactCustomFieldDefinitionsRequestBuilder {
    ...
    * <pre><code>
    * for (CrmListContactCustomFieldDefinitionsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<CrmListContactCustomFieldDefinitionsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
