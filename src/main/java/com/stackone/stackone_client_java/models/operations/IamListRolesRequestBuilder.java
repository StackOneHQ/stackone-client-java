...
public class IamListRolesRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallIamListRoles sdk;

    public IamListRolesRequestBuilder(SDKMethodInterfaces.MethodCallIamListRoles sdk) {
        this.sdk = sdk;
    }
