 ...
 */
public class HrisListTeamGroupsQueryParamFilter {
    /**
    ...
    @JsonCreator
    public HrisListTeamGroupsQueryParamFilter(
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public HrisListTeamGroupsQueryParamFilter withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     * Use a string with a date to only select results updated after that given date
     */
    public HrisListTeamGroupsQueryParamFilter withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisListTeamGroupsQueryParamFilter other = (HrisListTeamGroupsQueryParamFilter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisListTeamGroupsQueryParamFilter.class,
    ...
    public final static class Builder {
        ...
        public HrisListTeamGroupsQueryParamFilter build() {

            return new HrisListTeamGroupsQueryParamFilter(
                updatedAfter);
        }
