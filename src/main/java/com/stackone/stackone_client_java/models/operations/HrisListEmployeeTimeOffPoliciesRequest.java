...
public class HrisListEmployeeTimeOffPoliciesRequest {
    ...
    private JsonNullable<? extends HrisListEmployeeTimeOffPoliciesQueryParamFilter> filter;
    ...
    @JsonCreator
    public HrisListEmployeeTimeOffPoliciesRequest(
            String xAccountId,
            String id,
            JsonNullable<Boolean> raw,
            JsonNullable<? extends Map<String, Object>> proxy,
            JsonNullable<String> fields,
            JsonNullable<? extends HrisListEmployeeTimeOffPoliciesQueryParamFilter> filter,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<HrisListEmployeeTimeOffPoliciesQueryParamFilter> filter() {
        return (JsonNullable<HrisListEmployeeTimeOffPoliciesQueryParamFilter>) filter;
    }
     ...
     * The account identifier
     */
    public HrisListEmployeeTimeOffPoliciesRequest withXAccountId(String xAccountId) {
        Utils.checkNotNull(xAccountId, "xAccountId");
        this.xAccountId = xAccountId;
        return this;
    }

    public HrisListEmployeeTimeOffPoliciesRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * value is false)
     */
    public HrisListEmployeeTimeOffPoliciesRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * value is false)
     */
    public HrisListEmployeeTimeOffPoliciesRequest withRaw(JsonNullable<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * surrounding them with 'proxy' key
     */
    public HrisListEmployeeTimeOffPoliciesRequest withProxy(Map<String, Object> proxy) {
        Utils.checkNotNull(proxy, "proxy");
     ...
     * surrounding them with 'proxy' key
     */
    public HrisListEmployeeTimeOffPoliciesRequest withProxy(JsonNullable<? extends Map<String, Object>> proxy) {
        Utils.checkNotNull(proxy, "proxy");
        this.proxy = proxy;
        return this;
    }
     ...
     * returned)
     */
    public HrisListEmployeeTimeOffPoliciesRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * returned)
     */
    public HrisListEmployeeTimeOffPoliciesRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * HRIS Time-Off Policies filters
     */
    public HrisListEmployeeTimeOffPoliciesRequest withFilter(HrisListEmployeeTimeOffPoliciesQueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * HRIS Time-Off Policies filters
     */
    public HrisListEmployeeTimeOffPoliciesRequest withFilter(JsonNullable<? extends HrisListEmployeeTimeOffPoliciesQueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     */
    @Deprecated
    public HrisListEmployeeTimeOffPoliciesRequest withPage(String page) {
        Utils.checkNotNull(page, "page");
     ...
     */
    @Deprecated
    public HrisListEmployeeTimeOffPoliciesRequest withPage(JsonNullable<String> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results per page (default value is 25)
     */
    public HrisListEmployeeTimeOffPoliciesRequest withPageSize(String pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of results per page (default value is 25)
     */
    public HrisListEmployeeTimeOffPoliciesRequest withPageSize(JsonNullable<String> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The unified cursor
     */
    public HrisListEmployeeTimeOffPoliciesRequest withNext(String next) {
        Utils.checkNotNull(next, "next");
     ...
     * The unified cursor
     */
    public HrisListEmployeeTimeOffPoliciesRequest withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     */
    @Deprecated
    public HrisListEmployeeTimeOffPoliciesRequest withUpdatedAfter(OffsetDateTime updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
     ...
     */
    @Deprecated
    public HrisListEmployeeTimeOffPoliciesRequest withUpdatedAfter(JsonNullable<OffsetDateTime> updatedAfter) {
        Utils.checkNotNull(updatedAfter, "updatedAfter");
        this.updatedAfter = updatedAfter;
        return this;
    }
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisListEmployeeTimeOffPoliciesRequest withPrefer(String prefer) {
        Utils.checkNotNull(prefer, "prefer");
     ...
     * includes Preference-Applied: heartbeat header when honored. (RFC 7240)
     */
    public HrisListEmployeeTimeOffPoliciesRequest withPrefer(Optional<String> prefer) {
        Utils.checkNotNull(prefer, "prefer");
        this.prefer = prefer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisListEmployeeTimeOffPoliciesRequest other = (HrisListEmployeeTimeOffPoliciesRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisListEmployeeTimeOffPoliciesRequest.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends HrisListEmployeeTimeOffPoliciesQueryParamFilter> filter = JsonNullable.undefined();
         ...
         * HRIS Time-Off Policies filters
         */
        public Builder filter(HrisListEmployeeTimeOffPoliciesQueryParamFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = JsonNullable.of(filter);
            return this;
        }
         ...
         * HRIS Time-Off Policies filters
         */
        public Builder filter(JsonNullable<? extends HrisListEmployeeTimeOffPoliciesQueryParamFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
        ...
        public HrisListEmployeeTimeOffPoliciesRequest build() {

            return new HrisListEmployeeTimeOffPoliciesRequest(
                xAccountId, id, raw,
                proxy, fields, filter,
                page, pageSize, next,
                updatedAfter, prefer);
