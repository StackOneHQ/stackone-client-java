...
public class StackoneListActionsMetaRequestBuilder {
    ...
    public CompletableFuture<StackoneListActionsMetaResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;StackoneListActionsMetaResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;StackoneListActionsMetaResponse&gt;() {
     ...
     */
    public Publisher<StackoneListActionsMetaResponse> callAsPublisher() {
        StackoneListActionsMetaRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<StackoneListActionsMetaResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
