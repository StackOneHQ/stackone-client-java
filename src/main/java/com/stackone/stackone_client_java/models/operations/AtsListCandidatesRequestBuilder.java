...
public class AtsListCandidatesRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallAtsListCandidates sdk;

    public AtsListCandidatesRequestBuilder(SDKMethodInterfaces.MethodCallAtsListCandidates sdk) {
        this.sdk = sdk;
    }
