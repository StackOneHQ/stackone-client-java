...
public class AccountingListCompanyAccountsRequestBuilder {

    private AccountingListCompanyAccountsRequest request;
    ...
    public AccountingListCompanyAccountsRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<AccountingListCompanyAccountsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AccountingListCompanyAccountsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AccountingListCompanyAccountsResponse&gt;() {
     ...
     */
    public Publisher<AccountingListCompanyAccountsResponse> callAsPublisher() {
        AccountingListCompanyAccountsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next", String.class),
                    AccountingListCompanyAccountsRequest::withNext,
            operation::doRequest);

        Flow.Publisher<AccountingListCompanyAccountsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
