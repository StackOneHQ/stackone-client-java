...
public class AtsListJobsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallAtsListJobs sdk;

    public AtsListJobsRequestBuilder(SDKMethodInterfaces.MethodCallAtsListJobs sdk) {
        this.sdk = sdk;
    }
    ...
    public AtsListJobsResponse call() throws Exception {
     ...
     **/  
    public Stream<AtsListJobsResponse> callAsStream() {
