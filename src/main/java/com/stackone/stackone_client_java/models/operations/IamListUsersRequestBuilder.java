...
public class IamListUsersRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallIamListUsers sdk;

    public IamListUsersRequestBuilder(SDKMethodInterfaces.MethodCallIamListUsers sdk) {
        this.sdk = sdk;
    }
    ...
    public IamListUsersResponse call() throws Exception {
