...
public class HrisListEmployeeCustomFieldDefinitionsRequest {
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    public HrisListEmployeeCustomFieldDefinitionsRequest withFilter(QueryParamFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    public HrisListEmployeeCustomFieldDefinitionsRequest withFilter(JsonNullable<? extends QueryParamFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
