...
public class LmsListUsersRequestBuilder {
    ...
    public CompletableFuture<LmsListUsersResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;LmsListUsersResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;LmsListUsersResponse&gt;() {
     ...
     */
    public Publisher<LmsListUsersResponse> callAsPublisher() {
        LmsListUsersRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<LmsListUsersResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
