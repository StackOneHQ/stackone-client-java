...
public class TicketingListTicketStatusesRequestBuilder {
    ...
    public TicketingListTicketStatusesResponse call() throws Exception {
    ...
    * <pre><code>
    * for (TicketingListTicketStatusesResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<TicketingListTicketStatusesResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<TicketingListTicketStatusesResponse> callAsStream() {
