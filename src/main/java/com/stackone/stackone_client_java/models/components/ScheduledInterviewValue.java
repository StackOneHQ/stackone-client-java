 ...
 */
@JsonDeserialize(using = ScheduledInterviewValue._Deserializer.class)
@JsonSerialize(using = ScheduledInterviewValue._Serializer.class)
public class ScheduledInterviewValue {
    ...
    public static final class _Serializer extends StdSerializer<ScheduledInterviewValue> {

        protected _Serializer() {
            super(ScheduledInterviewValue.class);
        }

        @Override
        public void serialize(ScheduledInterviewValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<ScheduledInterviewValue> {
        ...
        @Override
        public ScheduledInterviewValue deserialize(JsonParser p, DeserializationContext ctxt)
                throws IOException, JacksonException {
            String v = p.readValueAs(new TypeReference<String>() {});
            // use the factory method to ensure we get singletons
            return ScheduledInterviewValue.of(v);
        }
    }
