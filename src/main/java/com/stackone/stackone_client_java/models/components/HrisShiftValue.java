 ...
 */
@JsonDeserialize(using = HrisShiftValue._Deserializer.class)
@JsonSerialize(using = HrisShiftValue._Serializer.class)
public class HrisShiftValue {
    ...
    public static final class _Serializer extends StdSerializer<HrisShiftValue> {
        ...
        @Override
        public void serialize(HrisShiftValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<HrisShiftValue> {
        ...
        @Override
        public HrisShiftValue deserialize(JsonParser p, DeserializationContext ctxt)
