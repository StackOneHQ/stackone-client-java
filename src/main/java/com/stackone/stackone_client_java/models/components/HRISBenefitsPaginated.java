...
public class HRISBenefitsPaginated {
     ...
     */
    @Deprecated
    public HRISBenefitsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public HRISBenefitsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public HRISBenefitsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public HRISBenefitsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public HRISBenefitsPaginated withData(List<HRISBenefit> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public HRISBenefitsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public HRISBenefitsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HRISBenefitsPaginated other = (HRISBenefitsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HRISBenefitsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<HRISBenefit> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public HRISBenefitsPaginated build() {
            return new HRISBenefitsPaginated(
                nextPage,
                next,
                data,
                raw);
