...
public class RejectedReasonsPaginated {
    ...
    @JsonProperty("data")
    private List<RejectedReason> data;
    ...
    @JsonIgnore
    public List<RejectedReason> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public RejectedReasonsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public RejectedReasonsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public RejectedReasonsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public RejectedReasonsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public RejectedReasonsPaginated withData(List<RejectedReason> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public RejectedReasonsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public RejectedReasonsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RejectedReasonsPaginated other = (RejectedReasonsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RejectedReasonsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<RejectedReason> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public RejectedReasonsPaginated build() {
            return new RejectedReasonsPaginated(
                nextPage,
                next,
                data,
                raw);
