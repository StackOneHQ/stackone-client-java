 ...
 */
@JsonDeserialize(using = AccountingTaxRateResultActive._Deserializer.class)
public class AccountingTaxRateResultActive {
     ...
     * <ul>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.AccountingTaxRateResultActive2}</li>
     * </ul>
     * 
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingTaxRateResultActive other = (AccountingTaxRateResultActive) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<AccountingTaxRateResultActive> {

        public _Deserializer() {
            super(AccountingTaxRateResultActive.class, false,
                  TypeReferenceWithShape.of(new TypeReference<AccountingTaxRateResultActive2>() {}, JsonShape.DEFAULT),
    ...
    public String toString() {
        return Utils.toString(AccountingTaxRateResultActive.class,
                "value", value);
    }
