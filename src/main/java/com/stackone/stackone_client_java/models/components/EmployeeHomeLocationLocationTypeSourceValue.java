...
/**
 * EmployeeHomeLocationLocationTypeSourceValue - The source value of the location type.
 */

@JsonDeserialize(using = EmployeeHomeLocationLocationTypeSourceValue._Deserializer.class)
public class EmployeeHomeLocationLocationTypeSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.EmployeeSourceValueHomeLocationLocationType4}</li>
    ...
    public static final class _Deserializer extends OneOfDeserializer<EmployeeHomeLocationLocationTypeSourceValue> {

        public _Deserializer() {
            super(EmployeeHomeLocationLocationTypeSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<EmployeeSourceValueHomeLocationLocationType4>() {}, JsonShape.DEFAULT));
        }
    }
