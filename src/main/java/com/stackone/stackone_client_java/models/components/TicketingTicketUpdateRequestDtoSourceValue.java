 ...
 */
@JsonDeserialize(using = TicketingTicketUpdateRequestDtoSourceValue._Deserializer.class)
public class TicketingTicketUpdateRequestDtoSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.TicketingTicketUpdateRequestDtoSourceValue4}</li>
    ...
    public static final class _Deserializer extends OneOfDeserializer<TicketingTicketUpdateRequestDtoSourceValue> {

        public _Deserializer() {
            super(TicketingTicketUpdateRequestDtoSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<TicketingTicketUpdateRequestDtoSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
