...
public class TimeEntriesPaginated {
     ...
     */
    @Deprecated
    public TimeEntriesPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public TimeEntriesPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public TimeEntriesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public TimeEntriesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public TimeEntriesPaginated withData(List<TimeEntries> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public TimeEntriesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public TimeEntriesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TimeEntriesPaginated other = (TimeEntriesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TimeEntriesPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<TimeEntries> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public TimeEntriesPaginated build() {
            return new TimeEntriesPaginated(
                nextPage,
                next,
                data,
                raw);
