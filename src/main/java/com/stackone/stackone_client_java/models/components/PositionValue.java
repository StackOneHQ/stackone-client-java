 ...
 */
@JsonDeserialize(using = PositionValue._Deserializer.class)
@JsonSerialize(using = PositionValue._Serializer.class)
public class PositionValue {
    ...
    public static final class _Serializer extends StdSerializer<PositionValue> {

        protected _Serializer() {
            super(PositionValue.class);
        }

        @Override
        public void serialize(PositionValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<PositionValue> {
        ...
        @Override
        public PositionValue deserialize(JsonParser p, DeserializationContext ctxt)
                throws IOException, JacksonException {
            String v = p.readValueAs(new TypeReference<String>() {});
            // use the factory method to ensure we get singletons
            return PositionValue.of(v);
        }
    }
