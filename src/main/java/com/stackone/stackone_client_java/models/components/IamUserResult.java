...
public class IamUserResult {
    ...
    @JsonCreator
    public IamUserResult(
            @JsonProperty("data") IamUser data,
    ...
    public IamUserResult withData(IamUser data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public IamUserResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public IamUserResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamUserResult other = (IamUserResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(IamUserResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(IamUser data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
