...
public class CompanyResult {
    ...
    public CompanyResult withData(Company data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public CompanyResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public CompanyResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CompanyResult other = (CompanyResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CompanyResult.class,
                "data", data,
                "raw", raw);
    }
