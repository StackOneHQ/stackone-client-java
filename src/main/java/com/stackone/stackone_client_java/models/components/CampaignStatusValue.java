 ...
 */
/**
 * CampaignStatusValue - The Status of the campaign.
 */
@JsonDeserialize(using = CampaignStatusValue._Deserializer.class)
@JsonSerialize(using = CampaignStatusValue._Serializer.class)
public class CampaignStatusValue {
    ...
    public static final class _Serializer extends StdSerializer<CampaignStatusValue> {
        ...
        @Override
        public void serialize(CampaignStatusValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<CampaignStatusValue> {
        ...
        @Override
        public CampaignStatusValue deserialize(JsonParser p, DeserializationContext ctxt)
