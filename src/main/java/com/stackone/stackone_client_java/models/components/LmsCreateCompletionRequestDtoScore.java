...
public class LmsCreateCompletionRequestDtoScore {
     ...
     * The score percentage
     */
    public LmsCreateCompletionRequestDtoScore withPercentage(double percentage) {
        Utils.checkNotNull(percentage, "percentage");
     ...
     * The score percentage
     */
    public LmsCreateCompletionRequestDtoScore withPercentage(JsonNullable<Double> percentage) {
        Utils.checkNotNull(percentage, "percentage");
        this.percentage = percentage;
        return this;
    }
     ...
     * The raw string score value
     */
    public LmsCreateCompletionRequestDtoScore withRawValue(String rawValue) {
        Utils.checkNotNull(rawValue, "rawValue");
     ...
     * The raw string score value
     */
    public LmsCreateCompletionRequestDtoScore withRawValue(JsonNullable<String> rawValue) {
        Utils.checkNotNull(rawValue, "rawValue");
        this.rawValue = rawValue;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LmsCreateCompletionRequestDtoScore other = (LmsCreateCompletionRequestDtoScore) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LmsCreateCompletionRequestDtoScore.class,
    ...
    public final static class Builder {
        ...
        public LmsCreateCompletionRequestDtoScore build() {
            ...
            return new LmsCreateCompletionRequestDtoScore(
                percentage, rawValue);
        }
