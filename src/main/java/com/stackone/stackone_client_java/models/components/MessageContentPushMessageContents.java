...
public class MessageContentPushMessageContents {
    ...
    @JsonCreator
    public MessageContentPushMessageContents(
    ...
    public MessageContentPushMessageContents withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }

    public MessageContentPushMessageContents withSubtitle(String subtitle) {
        Utils.checkNotNull(subtitle, "subtitle");
        this.subtitle = JsonNullable.of(subtitle);
        return this;
    }

    public MessageContentPushMessageContents withSubtitle(JsonNullable<String> subtitle) {
        Utils.checkNotNull(subtitle, "subtitle");
        this.subtitle = subtitle;
        return this;
    }

    public MessageContentPushMessageContents withBody(String body) {
        Utils.checkNotNull(body, "body");
        this.body = JsonNullable.of(body);
        return this;
    }

    public MessageContentPushMessageContents withBody(JsonNullable<String> body) {
        Utils.checkNotNull(body, "body");
        this.body = body;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(MessageContentPushMessageContents.class,
                "title", title,
                "subtitle", subtitle,
                "body", body);
    }
