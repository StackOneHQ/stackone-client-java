...
public class MarketingCreateSmsTemplateRequestDto {
    ...
    public MarketingCreateSmsTemplateRequestDto withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public MarketingCreateSmsTemplateRequestDto withTags(List<String> tags) {
        Utils.checkNotNull(tags, "tags");
        this.tags = JsonNullable.of(tags);
        return this;
    }

    public MarketingCreateSmsTemplateRequestDto withTags(JsonNullable<? extends List<String>> tags) {
        Utils.checkNotNull(tags, "tags");
        this.tags = tags;
        return this;
    }

    public MarketingCreateSmsTemplateRequestDto withMessages(List<SmsMessages> messages) {
        Utils.checkNotNull(messages, "messages");
        this.messages = JsonNullable.of(messages);
        return this;
    }

    public MarketingCreateSmsTemplateRequestDto withMessages(JsonNullable<? extends List<SmsMessages>> messages) {
        Utils.checkNotNull(messages, "messages");
        this.messages = messages;
        return this;
    }
     ...
     * Value to pass through to the provider
     */
    public MarketingCreateSmsTemplateRequestDto withPassthrough(Map<String, Object> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
     ...
     * Value to pass through to the provider
     */
    public MarketingCreateSmsTemplateRequestDto withPassthrough(JsonNullable<? extends Map<String, Object>> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
        this.passthrough = passthrough;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MarketingCreateSmsTemplateRequestDto other = (MarketingCreateSmsTemplateRequestDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MarketingCreateSmsTemplateRequestDto.class,
                "name", name,
                "tags", tags,
                "messages", messages,
