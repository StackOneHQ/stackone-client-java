...
public class Task {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    private JsonNullable<? extends TaskType> type;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("status")
    private JsonNullable<? extends TaskStatus> status;
    ...
    public Task(
            ...
            @JsonProperty("type") JsonNullable<? extends TaskType> type,
            @JsonProperty("status") JsonNullable<? extends TaskStatus> status,
    ...
    @JsonIgnore
    public JsonNullable<TaskType> type() {
        return (JsonNullable<TaskType>) type;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<TaskStatus> status() {
        return (JsonNullable<TaskStatus>) status;
    }
     ...
     * Unique identifier
     */
    public Task withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public Task withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public Task withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * The employee ID associated with this task
     */
    public Task withEmployeeId(String employeeId) {
        Utils.checkNotNull(employeeId, "employeeId");
     ...
     * The employee ID associated with this task
     */
    public Task withEmployeeId(JsonNullable<String> employeeId) {
        Utils.checkNotNull(employeeId, "employeeId");
        this.employeeId = employeeId;
        return this;
    }
     ...
     * The name of the task
     */
    public Task withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The description of the task
     */
    public Task withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The type of the task
     */
    public Task withType(JsonNullable<? extends TaskType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The status of the task
     */
    public Task withStatus(JsonNullable<? extends TaskStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The due date of the task
     */
    public Task withDueDate(JsonNullable<OffsetDateTime> dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
        this.dueDate = dueDate;
        return this;
    }
     ...
     * The completion date of the task
     */
    public Task withCompletionDate(OffsetDateTime completionDate) {
        Utils.checkNotNull(completionDate, "completionDate");
     ...
     * The completion date of the task
     */
    public Task withCompletionDate(JsonNullable<OffsetDateTime> completionDate) {
        Utils.checkNotNull(completionDate, "completionDate");
        this.completionDate = completionDate;
        return this;
    }
     ...
     * The ID of the employee who assigned this task
     */
    public Task withAssignedByEmployeeId(String assignedByEmployeeId) {
        Utils.checkNotNull(assignedByEmployeeId, "assignedByEmployeeId");
     ...
     * The ID of the employee who assigned this task
     */
    public Task withAssignedByEmployeeId(JsonNullable<String> assignedByEmployeeId) {
        Utils.checkNotNull(assignedByEmployeeId, "assignedByEmployeeId");
        this.assignedByEmployeeId = assignedByEmployeeId;
        return this;
    }
     ...
     * The name of the employee who assigned this task
     */
    public Task withAssignedByEmployeeName(String assignedByEmployeeName) {
        Utils.checkNotNull(assignedByEmployeeName, "assignedByEmployeeName");
     ...
     * The name of the employee who assigned this task
     */
    public Task withAssignedByEmployeeName(JsonNullable<String> assignedByEmployeeName) {
        Utils.checkNotNull(assignedByEmployeeName, "assignedByEmployeeName");
        this.assignedByEmployeeName = assignedByEmployeeName;
        return this;
    }
     ...
     * Link to the task in the provider system
     */
    public Task withLinkToTask(String linkToTask) {
        Utils.checkNotNull(linkToTask, "linkToTask");
     ...
     * Link to the task in the provider system
     */
    public Task withLinkToTask(JsonNullable<String> linkToTask) {
        Utils.checkNotNull(linkToTask, "linkToTask");
        this.linkToTask = linkToTask;
        return this;
    }
     ...
     * List of extracted links from the task
     */
    public Task withExtractedLinks(List<String> extractedLinks) {
        Utils.checkNotNull(extractedLinks, "extractedLinks");
     ...
     * List of extracted links from the task
     */
    public Task withExtractedLinks(JsonNullable<? extends List<String>> extractedLinks) {
        Utils.checkNotNull(extractedLinks, "extractedLinks");
        this.extractedLinks = extractedLinks;
        return this;
    }
     ...
     * ID of the next task in sequence
     */
    public Task withNextTaskId(String nextTaskId) {
        Utils.checkNotNull(nextTaskId, "nextTaskId");
     ...
     * ID of the next task in sequence
     */
    public Task withNextTaskId(JsonNullable<String> nextTaskId) {
        Utils.checkNotNull(nextTaskId, "nextTaskId");
        this.nextTaskId = nextTaskId;
        return this;
    }
     ...
     * Name of the parent process of this task
     */
    public Task withParentProcessName(String parentProcessName) {
        Utils.checkNotNull(parentProcessName, "parentProcessName");
     ...
     * Name of the parent process of this task
     */
    public Task withParentProcessName(JsonNullable<String> parentProcessName) {
        Utils.checkNotNull(parentProcessName, "parentProcessName");
        this.parentProcessName = parentProcessName;
        return this;
    }
     ...
     * The comments associated with this task
     */
    public Task withComments(List<TaskCommentApiModel> comments) {
        Utils.checkNotNull(comments, "comments");
     ...
     * The comments associated with this task
     */
    public Task withComments(JsonNullable<? extends List<TaskCommentApiModel>> comments) {
        Utils.checkNotNull(comments, "comments");
        this.comments = comments;
        return this;
    }
     ...
     * The documents attached to this task
     */
    public Task withAttachments(List<File> attachments) {
        Utils.checkNotNull(attachments, "attachments");
     ...
     * The documents attached to this task
     */
    public Task withAttachments(JsonNullable<? extends List<File>> attachments) {
        Utils.checkNotNull(attachments, "attachments");
        this.attachments = attachments;
        return this;
    }
     ...
     * The creation date of this task
     */
    public Task withCreatedAt(JsonNullable<OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The last updated date of this task
     */
    public Task withUpdatedAt(JsonNullable<OffsetDateTime> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * The type of the task
         */
        public Builder type(JsonNullable<? extends TaskType> type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
         ...
         * The status of the task
         */
        public Builder status(JsonNullable<? extends TaskStatus> status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
