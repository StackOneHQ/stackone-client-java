 ...
 */
@JsonDeserialize(using = TicketingUserValue._Deserializer.class)
@JsonSerialize(using = TicketingUserValue._Serializer.class)
public class TicketingUserValue {
    ...
    public static final class _Serializer extends StdSerializer<TicketingUserValue> {

        protected _Serializer() {
            super(TicketingUserValue.class);
        }

        @Override
        public void serialize(TicketingUserValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<TicketingUserValue> {
        ...
        @Override
        public TicketingUserValue deserialize(JsonParser p, DeserializationContext ctxt)
                throws IOException, JacksonException {
            String v = p.readValueAs(new TypeReference<String>() {});
            // use the factory method to ensure we get singletons
            return TicketingUserValue.of(v);
        }
    }
