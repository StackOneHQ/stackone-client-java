...
public class SkillResult {
    ...
    public SkillResult withData(Skills data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public SkillResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public SkillResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SkillResult other = (SkillResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SkillResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(Skills data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
