 ...
 * format.
 */
@JsonDeserialize(using = CreateSkillsApiModelSourceValue._Deserializer.class)
public class CreateSkillsApiModelSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.CreateSkillsApiModelSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateSkillsApiModelSourceValue other = (CreateSkillsApiModelSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<CreateSkillsApiModelSourceValue> {

        public _Deserializer() {
            super(CreateSkillsApiModelSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<CreateSkillsApiModelSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(CreateSkillsApiModelSourceValue.class,
                "value", value);
    }
