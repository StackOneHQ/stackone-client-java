...
public class AccountingCompanyResultData {
    ...
    private JsonNullable<? extends AccountingCompanyResultBaseCurrency> baseCurrency;
    ...
    public AccountingCompanyResultData(
            ...
            @JsonProperty("base_currency") JsonNullable<? extends AccountingCompanyResultBaseCurrency> baseCurrency,
    ...
    @JsonIgnore
    public JsonNullable<AccountingCompanyResultBaseCurrency> baseCurrency() {
        return (JsonNullable<AccountingCompanyResultBaseCurrency>) baseCurrency;
    }
     ...
     * Unique identifier
     */
    public AccountingCompanyResultData withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public AccountingCompanyResultData withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public AccountingCompanyResultData withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public AccountingCompanyResultData withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Name of the company
     */
    public AccountingCompanyResultData withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * Name of the company
     */
    public AccountingCompanyResultData withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Default currency for the company
     */
    public AccountingCompanyResultData withBaseCurrency(JsonNullable<? extends AccountingCompanyResultBaseCurrency> baseCurrency) {
        Utils.checkNotNull(baseCurrency, "baseCurrency");
        this.baseCurrency = baseCurrency;
        return this;
    }
     ...
     * Fiscal year start month (1-12)
     */
    public AccountingCompanyResultData withFiscalYearStartMonth(JsonNullable<Double> fiscalYearStartMonth) {
        Utils.checkNotNull(fiscalYearStartMonth, "fiscalYearStartMonth");
        this.fiscalYearStartMonth = fiscalYearStartMonth;
        return this;
    }
     ...
     * Fiscal year start day (1-31)
     */
    public AccountingCompanyResultData withFiscalYearStartDay(JsonNullable<Double> fiscalYearStartDay) {
        Utils.checkNotNull(fiscalYearStartDay, "fiscalYearStartDay");
        this.fiscalYearStartDay = fiscalYearStartDay;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingCompanyResultData other = (AccountingCompanyResultData) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountingCompanyResultData.class,
                "id", id,
                "remoteId", remoteId,
                "name", name,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends AccountingCompanyResultBaseCurrency> baseCurrency = JsonNullable.undefined();
         ...
         * Default currency for the company
         */
        public Builder baseCurrency(AccountingCompanyResultBaseCurrency baseCurrency) {
            Utils.checkNotNull(baseCurrency, "baseCurrency");
            this.baseCurrency = JsonNullable.of(baseCurrency);
            return this;
        }
         ...
         * Default currency for the company
         */
        public Builder baseCurrency(JsonNullable<? extends AccountingCompanyResultBaseCurrency> baseCurrency) {
            Utils.checkNotNull(baseCurrency, "baseCurrency");
            this.baseCurrency = baseCurrency;
            return this;
        }
        ...
        public AccountingCompanyResultData build() {
            ...
            return new AccountingCompanyResultData(
                id, remoteId, name,
                baseCurrency, fiscalYearStartMonth, fiscalYearStartDay);
        }
