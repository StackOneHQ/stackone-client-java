...
public class AssignmentSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.AssignmentSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AssignmentSourceValue other = (AssignmentSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<AssignmentSourceValue> {

        public _Deserializer() {
            super(AssignmentSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<AssignmentSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(AssignmentSourceValue.class,
                "value", value);
    }
