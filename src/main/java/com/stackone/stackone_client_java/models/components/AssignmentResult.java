...
public class AssignmentResult {
    ...
    public AssignmentResult(
            @JsonProperty("data") Assignment data,
    ...
    public AssignmentResult withData(Assignment data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public AssignmentResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public AssignmentResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(AssignmentResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(Assignment data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
