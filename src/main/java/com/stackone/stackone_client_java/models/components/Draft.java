...
@JsonDeserialize(using = Draft._Deserializer.class)
public class Draft {
     ...
     * <ul>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.Draft2}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<Draft> {
