...
@JsonDeserialize(using = EntitySkillsCreateRequestDtoSourceValue._Deserializer.class)
public class EntitySkillsCreateRequestDtoSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.EntitySkillsCreateRequestDtoSourceValue4}</li>
    ...
    public static final class _Deserializer extends OneOfDeserializer<EntitySkillsCreateRequestDtoSourceValue> {

        public _Deserializer() {
            super(EntitySkillsCreateRequestDtoSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<EntitySkillsCreateRequestDtoSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
