...
public class AtsUpdateJobRequestDto {
     ...
     * Hiring team for the job.
     */
    public AtsUpdateJobRequestDto withHiringTeam(List<AtsJobHiringTeam> hiringTeam) {
        Utils.checkNotNull(hiringTeam, "hiringTeam");
     ...
     * Hiring team for the job.
     */
    public AtsUpdateJobRequestDto withHiringTeam(JsonNullable<? extends List<AtsJobHiringTeam>> hiringTeam) {
        Utils.checkNotNull(hiringTeam, "hiringTeam");
        this.hiringTeam = hiringTeam;
        return this;
    }
