...
public class CourseResult {
    ...
    public CourseResult withData(Course data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public CourseResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public CourseResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CourseResult other = (CourseResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CourseResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(Course data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
