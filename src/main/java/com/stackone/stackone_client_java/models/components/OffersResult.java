...
public class OffersResult {
    ...
    public OffersResult withData(Offer data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public OffersResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public OffersResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OffersResult other = (OffersResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(OffersResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(Offer data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public OffersResult build() {

            return new OffersResult(
                data, raw);
        }
