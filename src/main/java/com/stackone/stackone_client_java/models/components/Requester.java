...
public class Requester {
     ...
     * User ID of the hiring team member.
     */
    public Requester withUserId(String userId) {
        Utils.checkNotNull(userId, "userId");
     ...
     * User ID of the hiring team member.
     */
    public Requester withUserId(JsonNullable<String> userId) {
        Utils.checkNotNull(userId, "userId");
        this.userId = userId;
        return this;
    }
     ...
     * Provider's unique identifier of the user
     */
    public Requester withRemoteUserId(String remoteUserId) {
        Utils.checkNotNull(remoteUserId, "remoteUserId");
     ...
     * Provider's unique identifier of the user
     */
    public Requester withRemoteUserId(JsonNullable<String> remoteUserId) {
        Utils.checkNotNull(remoteUserId, "remoteUserId");
        this.remoteUserId = remoteUserId;
        return this;
    }
     ...
     * First name of the hiring team member.
     */
    public Requester withFirstName(String firstName) {
        Utils.checkNotNull(firstName, "firstName");
     ...
     * First name of the hiring team member.
     */
    public Requester withFirstName(JsonNullable<String> firstName) {
        Utils.checkNotNull(firstName, "firstName");
        this.firstName = firstName;
        return this;
    }
     ...
     * Last name of the hiring team member.
     */
    public Requester withLastName(String lastName) {
        Utils.checkNotNull(lastName, "lastName");
     ...
     * Last name of the hiring team member.
     */
    public Requester withLastName(JsonNullable<String> lastName) {
        Utils.checkNotNull(lastName, "lastName");
        this.lastName = lastName;
        return this;
    }
     ...
     * Email of the hiring team member.
     */
    public Requester withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * Email of the hiring team member.
     */
    public Requester withEmail(JsonNullable<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * Role of the hiring team member.
     */
    public Requester withRole(String role) {
        Utils.checkNotNull(role, "role");
     ...
     * Role of the hiring team member.
     */
    public Requester withRole(JsonNullable<String> role) {
        Utils.checkNotNull(role, "role");
        this.role = role;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Requester.class,
                "userId", userId,
