...
public class AtsCreateBackgroundCheckOrderRequestDtoRequester {
     ...
     * User ID of the hiring team member.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoRequester withUserId(String userId) {
        Utils.checkNotNull(userId, "userId");
     ...
     * User ID of the hiring team member.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoRequester withUserId(JsonNullable<String> userId) {
        Utils.checkNotNull(userId, "userId");
        this.userId = userId;
        return this;
    }
     ...
     * Provider's unique identifier of the user
     */
    public AtsCreateBackgroundCheckOrderRequestDtoRequester withRemoteUserId(String remoteUserId) {
        Utils.checkNotNull(remoteUserId, "remoteUserId");
     ...
     * Provider's unique identifier of the user
     */
    public AtsCreateBackgroundCheckOrderRequestDtoRequester withRemoteUserId(JsonNullable<String> remoteUserId) {
        Utils.checkNotNull(remoteUserId, "remoteUserId");
        this.remoteUserId = remoteUserId;
        return this;
    }
     ...
     * First name of the hiring team member.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoRequester withFirstName(String firstName) {
        Utils.checkNotNull(firstName, "firstName");
     ...
     * First name of the hiring team member.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoRequester withFirstName(JsonNullable<String> firstName) {
        Utils.checkNotNull(firstName, "firstName");
        this.firstName = firstName;
        return this;
    }
     ...
     * Last name of the hiring team member.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoRequester withLastName(String lastName) {
        Utils.checkNotNull(lastName, "lastName");
     ...
     * Last name of the hiring team member.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoRequester withLastName(JsonNullable<String> lastName) {
        Utils.checkNotNull(lastName, "lastName");
        this.lastName = lastName;
        return this;
    }
     ...
     * Email of the hiring team member.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoRequester withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * Email of the hiring team member.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoRequester withEmail(JsonNullable<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * Role of the hiring team member.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoRequester withRole(String role) {
        Utils.checkNotNull(role, "role");
     ...
     * Role of the hiring team member.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoRequester withRole(JsonNullable<String> role) {
        Utils.checkNotNull(role, "role");
        this.role = role;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsCreateBackgroundCheckOrderRequestDtoRequester other = (AtsCreateBackgroundCheckOrderRequestDtoRequester) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsCreateBackgroundCheckOrderRequestDtoRequester.class,
                "userId", userId,
