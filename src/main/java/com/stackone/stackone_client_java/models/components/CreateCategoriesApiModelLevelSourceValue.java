 ...
 * format.
 */
@JsonDeserialize(using = CreateCategoriesApiModelLevelSourceValue._Deserializer.class)
public class CreateCategoriesApiModelLevelSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.CreateCategoriesApiModelSourceValueLevel4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCategoriesApiModelLevelSourceValue other = (CreateCategoriesApiModelLevelSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<CreateCategoriesApiModelLevelSourceValue> {

        public _Deserializer() {
            super(CreateCategoriesApiModelLevelSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<CreateCategoriesApiModelSourceValueLevel4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(CreateCategoriesApiModelLevelSourceValue.class,
                "value", value);
    }
