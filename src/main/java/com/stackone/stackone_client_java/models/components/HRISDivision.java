...
public class HRISDivision {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    private JsonNullable<? extends HRISDivisionType> type;
    ...
    public HRISDivision(
            ...
            @JsonProperty("type") JsonNullable<? extends HRISDivisionType> type) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<HRISDivisionType> type() {
        return (JsonNullable<HRISDivisionType>) type;
    }
     ...
     * Unique identifier
     */
    public HRISDivision withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public HRISDivision withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public HRISDivision withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public HRISDivision withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Custom Unified Fields configured in your StackOne project
     */
    public HRISDivision withUnifiedCustomFields(Map<String, Object> unifiedCustomFields) {
        Utils.checkNotNull(unifiedCustomFields, "unifiedCustomFields");
     ...
     * Custom Unified Fields configured in your StackOne project
     */
    public HRISDivision withUnifiedCustomFields(JsonNullable<? extends Map<String, Object>> unifiedCustomFields) {
        Utils.checkNotNull(unifiedCustomFields, "unifiedCustomFields");
        this.unifiedCustomFields = unifiedCustomFields;
        return this;
    }
     ...
     * The name of the group
     */
    public HRISDivision withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the group
     */
    public HRISDivision withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The list of parent group ids of the given group
     */
    public HRISDivision withParentIds(List<String> parentIds) {
        Utils.checkNotNull(parentIds, "parentIds");
     ...
     * The list of parent group ids of the given group
     */
    public HRISDivision withParentIds(JsonNullable<? extends List<String>> parentIds) {
        Utils.checkNotNull(parentIds, "parentIds");
        this.parentIds = parentIds;
        return this;
    }
     ...
     * Provider's list of parent group remote ids of the given group
     */
    public HRISDivision withRemoteParentIds(List<String> remoteParentIds) {
        Utils.checkNotNull(remoteParentIds, "remoteParentIds");
     ...
     * Provider's list of parent group remote ids of the given group
     */
    public HRISDivision withRemoteParentIds(JsonNullable<? extends List<String>> remoteParentIds) {
        Utils.checkNotNull(remoteParentIds, "remoteParentIds");
        this.remoteParentIds = remoteParentIds;
        return this;
    }
     ...
     * The list of group owner ids of the given group
     */
    public HRISDivision withOwnerIds(List<String> ownerIds) {
        Utils.checkNotNull(ownerIds, "ownerIds");
     ...
     * The list of group owner ids of the given group
     */
    public HRISDivision withOwnerIds(JsonNullable<? extends List<String>> ownerIds) {
        Utils.checkNotNull(ownerIds, "ownerIds");
        this.ownerIds = ownerIds;
        return this;
    }
     ...
     * The list of remote group owner ids of the given group
     */
    public HRISDivision withRemoteOwnerIds(List<String> remoteOwnerIds) {
        Utils.checkNotNull(remoteOwnerIds, "remoteOwnerIds");
     ...
     * The list of remote group owner ids of the given group
     */
    public HRISDivision withRemoteOwnerIds(JsonNullable<? extends List<String>> remoteOwnerIds) {
        Utils.checkNotNull(remoteOwnerIds, "remoteOwnerIds");
        this.remoteOwnerIds = remoteOwnerIds;
        return this;
    }
     ...
     * The id of the company that the group belongs to
     */
    public HRISDivision withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * The id of the company that the group belongs to
     */
    public HRISDivision withCompanyId(JsonNullable<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Provider's id of the company that the group belongs to
     */
    public HRISDivision withRemoteCompanyId(String remoteCompanyId) {
        Utils.checkNotNull(remoteCompanyId, "remoteCompanyId");
     ...
     * Provider's id of the company that the group belongs to
     */
    public HRISDivision withRemoteCompanyId(JsonNullable<String> remoteCompanyId) {
        Utils.checkNotNull(remoteCompanyId, "remoteCompanyId");
        this.remoteCompanyId = remoteCompanyId;
        return this;
    }
     ...
     * The type of the division group
     */
    public HRISDivision withType(HRISDivisionType type) {
        Utils.checkNotNull(type, "type");
     ...
     * The type of the division group
     */
    public HRISDivision withType(JsonNullable<? extends HRISDivisionType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HRISDivision other = (HRISDivision) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HRISDivision.class,
                "id", id,
                "remoteId", remoteId,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends HRISDivisionType> type = JsonNullable.undefined();
         ...
         * The type of the division group
         */
        public Builder type(HRISDivisionType type) {
            Utils.checkNotNull(type, "type");
            this.type = JsonNullable.of(type);
            return this;
        }
         ...
         * The type of the division group
         */
        public Builder type(JsonNullable<? extends HRISDivisionType> type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
