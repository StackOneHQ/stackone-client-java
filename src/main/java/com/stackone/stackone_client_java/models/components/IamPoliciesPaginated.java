...
public class IamPoliciesPaginated {
     ...
     */
    @Deprecated
    public IamPoliciesPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public IamPoliciesPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public IamPoliciesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public IamPoliciesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public IamPoliciesPaginated withData(List<IamPolicy> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public IamPoliciesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public IamPoliciesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamPoliciesPaginated other = (IamPoliciesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(IamPoliciesPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<IamPolicy> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public IamPoliciesPaginated build() {
            return new IamPoliciesPaginated(
                nextPage,
                next,
                data,
                raw);
