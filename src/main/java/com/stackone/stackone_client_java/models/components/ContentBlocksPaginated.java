...
public class ContentBlocksPaginated {
    ...
    @JsonProperty("data")
    private List<ContentBlock> data;
     ...
     */
    @Deprecated
    public ContentBlocksPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public ContentBlocksPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public ContentBlocksPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public ContentBlocksPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public ContentBlocksPaginated withData(List<ContentBlock> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public ContentBlocksPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public ContentBlocksPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ContentBlocksPaginated other = (ContentBlocksPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ContentBlocksPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<ContentBlock> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public ContentBlocksPaginated build() {
            ...
            return new ContentBlocksPaginated(
                nextPage, next, data,
                raw);
        }
