...
public class AtsJobHiringTeam {
     ...
     * User ID of the hiring team member.
     */
    public AtsJobHiringTeam withUserId(String userId) {
        Utils.checkNotNull(userId, "userId");
     ...
     * User ID of the hiring team member.
     */
    public AtsJobHiringTeam withUserId(JsonNullable<String> userId) {
        Utils.checkNotNull(userId, "userId");
        this.userId = userId;
        return this;
    }
     ...
     * Provider's unique identifier of the user
     */
    public AtsJobHiringTeam withRemoteUserId(String remoteUserId) {
        Utils.checkNotNull(remoteUserId, "remoteUserId");
     ...
     * Provider's unique identifier of the user
     */
    public AtsJobHiringTeam withRemoteUserId(JsonNullable<String> remoteUserId) {
        Utils.checkNotNull(remoteUserId, "remoteUserId");
        this.remoteUserId = remoteUserId;
        return this;
    }
     ...
     * First name of the hiring team member.
     */
    public AtsJobHiringTeam withFirstName(String firstName) {
        Utils.checkNotNull(firstName, "firstName");
     ...
     * First name of the hiring team member.
     */
    public AtsJobHiringTeam withFirstName(JsonNullable<String> firstName) {
        Utils.checkNotNull(firstName, "firstName");
        this.firstName = firstName;
        return this;
    }
     ...
     * Last name of the hiring team member.
     */
    public AtsJobHiringTeam withLastName(String lastName) {
        Utils.checkNotNull(lastName, "lastName");
     ...
     * Last name of the hiring team member.
     */
    public AtsJobHiringTeam withLastName(JsonNullable<String> lastName) {
        Utils.checkNotNull(lastName, "lastName");
        this.lastName = lastName;
        return this;
    }
     ...
     * Email of the hiring team member.
     */
    public AtsJobHiringTeam withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * Email of the hiring team member.
     */
    public AtsJobHiringTeam withEmail(JsonNullable<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * Role of the hiring team member.
     */
    public AtsJobHiringTeam withRole(String role) {
        Utils.checkNotNull(role, "role");
     ...
     * Role of the hiring team member.
     */
    public AtsJobHiringTeam withRole(JsonNullable<String> role) {
        Utils.checkNotNull(role, "role");
        this.role = role;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsJobHiringTeam other = (AtsJobHiringTeam) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsJobHiringTeam.class,
                "userId", userId,
    ...
    public final static class Builder {
        ...
        public AtsJobHiringTeam build() {

            return new AtsJobHiringTeam(
                userId, remoteUserId, firstName,
                lastName, email, role);
        }
