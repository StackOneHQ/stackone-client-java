 ...
 */
@JsonDeserialize(using = NoteValue._Deserializer.class)
@JsonSerialize(using = NoteValue._Serializer.class)
public class NoteValue {
    ...
    public static final class _Serializer extends StdSerializer<NoteValue> {
        ...
        @Override
        public void serialize(NoteValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<NoteValue> {
        ...
        @Override
        public NoteValue deserialize(JsonParser p, DeserializationContext ctxt)
