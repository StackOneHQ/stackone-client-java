 ...
 */
@JsonDeserialize(using = LmsCreateContentRequestDtoActive._Deserializer.class)
public class LmsCreateContentRequestDtoActive {
     ...
     * <ul>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.LmsCreateContentRequestDtoActive2}</li>
     * </ul>
     * 
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LmsCreateContentRequestDtoActive other = (LmsCreateContentRequestDtoActive) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<LmsCreateContentRequestDtoActive> {

        public _Deserializer() {
            super(LmsCreateContentRequestDtoActive.class, false,
                  TypeReferenceWithShape.of(new TypeReference<LmsCreateContentRequestDtoActive2>() {}, JsonShape.DEFAULT),
    ...
    public String toString() {
        return Utils.toString(LmsCreateContentRequestDtoActive.class,
                "value", value);
    }
