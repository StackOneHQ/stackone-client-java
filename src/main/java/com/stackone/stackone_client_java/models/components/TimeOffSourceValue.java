...
@JsonDeserialize(using = TimeOffSourceValue._Deserializer.class)
public class TimeOffSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.TimeOffSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TimeOffSourceValue other = (TimeOffSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<TimeOffSourceValue> {

        public _Deserializer() {
            super(TimeOffSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<TimeOffSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(TimeOffSourceValue.class,
                "value", value);
    }
