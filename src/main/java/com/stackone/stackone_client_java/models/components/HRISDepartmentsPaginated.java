...
public class HRISDepartmentsPaginated {
    ...
    @JsonProperty("data")
    private List<HRISDepartment> data;
    ...
    @JsonIgnore
    public List<HRISDepartment> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public HRISDepartmentsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public HRISDepartmentsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public HRISDepartmentsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public HRISDepartmentsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public HRISDepartmentsPaginated withData(List<HRISDepartment> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public HRISDepartmentsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public HRISDepartmentsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HRISDepartmentsPaginated other = (HRISDepartmentsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HRISDepartmentsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<HRISDepartment> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public HRISDepartmentsPaginated build() {
            return new HRISDepartmentsPaginated(
                nextPage,
                next,
                data,
                raw);
