...
public class CategorySourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.CategorySourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CategorySourceValue other = (CategorySourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<CategorySourceValue> {

        public _Deserializer() {
            super(CategorySourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<CategorySourceValue4>() {}, JsonShape.DEFAULT),
    ...
    public String toString() {
        return Utils.toString(CategorySourceValue.class,
                "value", value);
    }
