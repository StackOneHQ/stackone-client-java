...
@JsonDeserialize(using = HRISBankDetailsCurrencyCodeSourceValue._Deserializer.class)
public class HRISBankDetailsCurrencyCodeSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.HRISBankDetailsSourceValueCurrencyCode4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HRISBankDetailsCurrencyCodeSourceValue other = (HRISBankDetailsCurrencyCodeSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<HRISBankDetailsCurrencyCodeSourceValue> {

        public _Deserializer() {
            super(HRISBankDetailsCurrencyCodeSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<HRISBankDetailsSourceValueCurrencyCode4>() {}, JsonShape.DEFAULT),
    ...
    public String toString() {
        return Utils.toString(HRISBankDetailsCurrencyCodeSourceValue.class,
                "value", value);
    }
