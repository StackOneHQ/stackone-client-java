 ...
 *
 */
@JsonDeserialize(using = EmployeeValue._Deserializer.class)
@JsonSerialize(using = EmployeeValue._Serializer.class)
public class EmployeeValue {
    ...
    public static final class _Serializer extends StdSerializer<EmployeeValue> {

        protected _Serializer() {
            super(EmployeeValue.class);
        }

        @Override
        public void serialize(EmployeeValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<EmployeeValue> {
        ...
        @Override
        public EmployeeValue deserialize(JsonParser p, DeserializationContext ctxt)
                throws IOException, JacksonException {
            String v = p.readValueAs(new TypeReference<String>() {});
            // use the factory method to ensure we get singletons
            return EmployeeValue.of(v);
        }
    }
