...
public class FilesPaginated {
    ...
    @JsonCreator
    public FilesPaginated(
            @JsonProperty("next") JsonNullable<String> next,
            @JsonProperty("data") List<Files> data,
    ...
    public FilesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public FilesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public FilesPaginated withData(List<Files> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public FilesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public FilesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FilesPaginated other = (FilesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FilesPaginated.class,
                "next", next,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(List<Files> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public FilesPaginated build() {

            return new FilesPaginated(
                next, data, raw);
        }
