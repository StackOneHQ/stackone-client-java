...
@JsonDeserialize(using = EmployeeEthnicitySourceValue._Deserializer.class)
public class EmployeeEthnicitySourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.EmployeeSourceValueEthnicity4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EmployeeEthnicitySourceValue other = (EmployeeEthnicitySourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<EmployeeEthnicitySourceValue> {

        public _Deserializer() {
            super(EmployeeEthnicitySourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<EmployeeSourceValueEthnicity4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(EmployeeEthnicitySourceValue.class,
                "value", value);
    }
