...
public class LmsCreateContentRequestDto {
     ...
     * The authors of the content
     */
    public LmsCreateContentRequestDto withAuthors(List<AuthorModel> authors) {
        Utils.checkNotNull(authors, "authors");
     ...
     * The authors of the content
     */
    public LmsCreateContentRequestDto withAuthors(JsonNullable<? extends List<AuthorModel>> authors) {
        Utils.checkNotNull(authors, "authors");
        this.authors = authors;
        return this;
    }
