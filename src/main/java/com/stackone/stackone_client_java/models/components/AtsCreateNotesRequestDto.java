...
public class AtsCreateNotesRequestDto {
    ...
    private JsonNullable<? extends AtsCreateNotesRequestDtoVisibility> visibility;
    ...
    public AtsCreateNotesRequestDto(
            ...
            @JsonProperty("visibility") JsonNullable<? extends AtsCreateNotesRequestDtoVisibility> visibility,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<AtsCreateNotesRequestDtoVisibility> visibility() {
        return (JsonNullable<AtsCreateNotesRequestDtoVisibility>) visibility;
    }
    ...
    public AtsCreateNotesRequestDto withContent(JsonNullable<? extends List<NoteContentApiModel>> content) {
        Utils.checkNotNull(content, "content");
        this.content = content;
        return this;
    }
     ...
     * Unique identifier of the author
     */
    public AtsCreateNotesRequestDto withAuthorId(String authorId) {
        Utils.checkNotNull(authorId, "authorId");
     ...
     * Unique identifier of the author
     */
    public AtsCreateNotesRequestDto withAuthorId(JsonNullable<String> authorId) {
        Utils.checkNotNull(authorId, "authorId");
        this.authorId = authorId;
        return this;
    }
     ...
     * Visibility of the note
     */
    public AtsCreateNotesRequestDto withVisibility(JsonNullable<? extends AtsCreateNotesRequestDtoVisibility> visibility) {
        Utils.checkNotNull(visibility, "visibility");
        this.visibility = visibility;
        return this;
    }
     ...
     * Value to pass through to the provider
     */
    public AtsCreateNotesRequestDto withPassthrough(Map<String, Object> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
     ...
     * Value to pass through to the provider
     */
    public AtsCreateNotesRequestDto withPassthrough(JsonNullable<? extends Map<String, Object>> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
        this.passthrough = passthrough;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(AtsCreateNotesRequestDto.class,
                "content", content,
                "authorId", authorId,
    ...
    public final static class Builder {
         ...
         * Visibility of the note
         */
        public Builder visibility(AtsCreateNotesRequestDtoVisibility visibility) {
            Utils.checkNotNull(visibility, "visibility");
            this.visibility = JsonNullable.of(visibility);
            return this;
        }
         ...
         * Visibility of the note
         */
        public Builder visibility(JsonNullable<? extends AtsCreateNotesRequestDtoVisibility> visibility) {
            Utils.checkNotNull(visibility, "visibility");
            this.visibility = visibility;
            return this;
        }
