...
/**
 * CustomFieldsValue - The value associated with the custom field.
 */

@JsonDeserialize(using = CustomFieldsValue._Deserializer.class)
public class CustomFieldsValue {
    ...
    public static final class _Deserializer extends OneOfDeserializer<CustomFieldsValue> {
        ...
        public _Deserializer() {
            super(CustomFieldsValue.class, false,
                  ...
                  TypeReferenceWithShape.of(new TypeReference<Value4>() {}, JsonShape.DEFAULT));
        }
    }
