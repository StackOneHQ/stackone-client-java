...
public class HRISDivisionsPaginated {
    ...
    @JsonProperty("data")
    private List<HRISDivision> data;
     ...
     */
    @Deprecated
    public HRISDivisionsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public HRISDivisionsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public HRISDivisionsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public HRISDivisionsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public HRISDivisionsPaginated withData(List<HRISDivision> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public HRISDivisionsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public HRISDivisionsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HRISDivisionsPaginated other = (HRISDivisionsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HRISDivisionsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<HRISDivision> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public HRISDivisionsPaginated build() {

            return new HRISDivisionsPaginated(
                nextPage, next, data,
                raw);
        }
