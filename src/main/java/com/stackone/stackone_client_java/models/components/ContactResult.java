...
public class ContactResult {
    ...
    public ContactResult withData(Contact data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public ContactResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public ContactResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ContactResult other = (ContactResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ContactResult.class,
                "data", data,
                "raw", raw);
    }
