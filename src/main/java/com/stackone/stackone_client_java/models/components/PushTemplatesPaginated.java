...
public class PushTemplatesPaginated {
    ...
    @JsonProperty("data")
    private List<PushTemplate> data;
     ...
     */
    @Deprecated
    public PushTemplatesPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public PushTemplatesPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public PushTemplatesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public PushTemplatesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public PushTemplatesPaginated withData(List<PushTemplate> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public PushTemplatesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public PushTemplatesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PushTemplatesPaginated other = (PushTemplatesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PushTemplatesPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<PushTemplate> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public PushTemplatesPaginated build() {
            return new PushTemplatesPaginated(
                nextPage,
                next,
                data,
                raw);
