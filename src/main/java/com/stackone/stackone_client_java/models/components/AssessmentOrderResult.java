...
public class AssessmentOrderResult {
    ...
    @JsonCreator
    public AssessmentOrderResult(
            @JsonProperty("data") AssessmentOrder data,
    ...
    public String toString() {
        return Utils.toString(AssessmentOrderResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public AssessmentOrderResult build() {
            return new AssessmentOrderResult(
                data,
                raw);
        }
    }
