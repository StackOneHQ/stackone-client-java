...
public class HrisDocumentApiModel {
    ...
    private JsonNullable<? extends HrisDocumentApiModelCategory> category;
    ...
    private JsonNullable<? extends HrisDocumentApiModelFileFormat> fileFormat;
    ...
    @JsonProperty("type")
    @Deprecated
    private JsonNullable<? extends HrisDocumentApiModelType> type;
    ...
    public HrisDocumentApiModel(
            ...
            @JsonProperty("file_format") JsonNullable<? extends HrisDocumentApiModelFileFormat> fileFormat,
            @JsonProperty("unified_custom_fields") JsonNullable<? extends Map<String, Object>> unifiedCustomFields,
            @JsonProperty("type") JsonNullable<? extends HrisDocumentApiModelType> type) {
    ...
    @JsonIgnore
    public JsonNullable<HrisDocumentApiModelCategory> category() {
        return (JsonNullable<HrisDocumentApiModelCategory>) category;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<HrisDocumentApiModelFileFormat> fileFormat() {
        return (JsonNullable<HrisDocumentApiModelFileFormat>) fileFormat;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<HrisDocumentApiModelType> type() {
     ...
     * Unique identifier
     */
    public HrisDocumentApiModel withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public HrisDocumentApiModel withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public HrisDocumentApiModel withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public HrisDocumentApiModel withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * The name of the file
     */
    public HrisDocumentApiModel withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The category of the the document
     */
    public HrisDocumentApiModel withCategory(JsonNullable<? extends HrisDocumentApiModelCategory> category) {
        Utils.checkNotNull(category, "category");
        this.category = category;
        return this;
    }
     ...
     */
    @Deprecated
    public HrisDocumentApiModel withContents(List<Content> contents) {
        Utils.checkNotNull(contents, "contents");
     ...
     */
    @Deprecated
    public HrisDocumentApiModel withContents(JsonNullable<? extends List<Content>> contents) {
        Utils.checkNotNull(contents, "contents");
        this.contents = contents;
        return this;
    }
     ...
     * The categoryId of the documents
     */
    public HrisDocumentApiModel withCategoryId(String categoryId) {
        Utils.checkNotNull(categoryId, "categoryId");
     ...
     * The categoryId of the documents
     */
    public HrisDocumentApiModel withCategoryId(JsonNullable<String> categoryId) {
        Utils.checkNotNull(categoryId, "categoryId");
        this.categoryId = categoryId;
        return this;
    }
     ...
     * The creation date of the file
     */
    public HrisDocumentApiModel withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * The creation date of the file
     */
    public HrisDocumentApiModel withCreatedAt(JsonNullable<OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The update date of the file
     */
    public HrisDocumentApiModel withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
     ...
     * The update date of the file
     */
    public HrisDocumentApiModel withUpdatedAt(JsonNullable<OffsetDateTime> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     * URL where the file content is located
     */
    public HrisDocumentApiModel withRemoteUrl(String remoteUrl) {
        Utils.checkNotNull(remoteUrl, "remoteUrl");
     ...
     * URL where the file content is located
     */
    public HrisDocumentApiModel withRemoteUrl(JsonNullable<String> remoteUrl) {
        Utils.checkNotNull(remoteUrl, "remoteUrl");
        this.remoteUrl = remoteUrl;
        return this;
    }
     ...
     * The file format of the file
     */
    public HrisDocumentApiModel withFileFormat(JsonNullable<? extends HrisDocumentApiModelFileFormat> fileFormat) {
        Utils.checkNotNull(fileFormat, "fileFormat");
        this.fileFormat = fileFormat;
        return this;
    }
     ...
     * Custom Unified Fields configured in your StackOne project
     */
    public HrisDocumentApiModel withUnifiedCustomFields(Map<String, Object> unifiedCustomFields) {
        Utils.checkNotNull(unifiedCustomFields, "unifiedCustomFields");
     ...
     * Custom Unified Fields configured in your StackOne project
     */
    public HrisDocumentApiModel withUnifiedCustomFields(JsonNullable<? extends Map<String, Object>> unifiedCustomFields) {
        Utils.checkNotNull(unifiedCustomFields, "unifiedCustomFields");
        this.unifiedCustomFields = unifiedCustomFields;
        return this;
    }
     ...
     */
    @Deprecated
    public HrisDocumentApiModel withType(HrisDocumentApiModelType type) {
        Utils.checkNotNull(type, "type");
     ...
     */
    @Deprecated
    public HrisDocumentApiModel withType(JsonNullable<? extends HrisDocumentApiModelType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisDocumentApiModel other = (HrisDocumentApiModel) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisDocumentApiModel.class,
                "id", id,
                "remoteId", remoteId,
                "name", name,
                "path", path,
    ...
    public final static class Builder {
         ...
         * The category of the the document
         */
        public Builder category(HrisDocumentApiModelCategory category) {
            Utils.checkNotNull(category, "category");
            this.category = JsonNullable.of(category);
            return this;
        }
         ...
         * The category of the the document
         */
        public Builder category(JsonNullable<? extends HrisDocumentApiModelCategory> category) {
            Utils.checkNotNull(category, "category");
            this.category = category;
            return this;
        }
         ...
         * The file format of the file
         */
        public Builder fileFormat(HrisDocumentApiModelFileFormat fileFormat) {
            Utils.checkNotNull(fileFormat, "fileFormat");
            this.fileFormat = JsonNullable.of(fileFormat);
            return this;
        }
         ...
         * The file format of the file
         */
        public Builder fileFormat(JsonNullable<? extends HrisDocumentApiModelFileFormat> fileFormat) {
            Utils.checkNotNull(fileFormat, "fileFormat");
            this.fileFormat = fileFormat;
            return this;
        }
         ...
         */
        @Deprecated
        public Builder type(HrisDocumentApiModelType type) {
            Utils.checkNotNull(type, "type");
            this.type = JsonNullable.of(type);
            return this;
        }
         ...
         */
        @Deprecated
        public Builder type(JsonNullable<? extends HrisDocumentApiModelType> type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
