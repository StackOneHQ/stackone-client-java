...
public class ApplicationChangesPaginated {
    ...
    @JsonCreator
    public ApplicationChangesPaginated(
            @JsonProperty("next") JsonNullable<String> next,
            @JsonProperty("data") JsonNullable<? extends List<ApplicationChanges>> data,
    ...
    @JsonIgnore
    public JsonNullable<List<ApplicationChanges>> data() {
        return (JsonNullable<List<ApplicationChanges>>) data;
    }
    ...
    public ApplicationChangesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public ApplicationChangesPaginated withData(List<ApplicationChanges> data) {
        Utils.checkNotNull(data, "data");
        this.data = JsonNullable.of(data);
        return this;
    }

    public ApplicationChangesPaginated withData(JsonNullable<? extends List<ApplicationChanges>> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public ApplicationChangesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public ApplicationChangesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApplicationChangesPaginated other = (ApplicationChangesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ApplicationChangesPaginated.class,
                "next", next,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(JsonNullable<? extends List<ApplicationChanges>> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
