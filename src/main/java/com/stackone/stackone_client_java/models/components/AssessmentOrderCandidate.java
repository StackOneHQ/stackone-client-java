...
public class AssessmentOrderCandidate {
    ...
    @JsonCreator
    public AssessmentOrderCandidate(
     ...
     * Unique identifier
     */
    public AssessmentOrderCandidate withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public AssessmentOrderCandidate withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public AssessmentOrderCandidate withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public AssessmentOrderCandidate withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Candidate first name
     */
    public AssessmentOrderCandidate withFirstName(String firstName) {
        Utils.checkNotNull(firstName, "firstName");
     ...
     * Candidate first name
     */
    public AssessmentOrderCandidate withFirstName(JsonNullable<String> firstName) {
        Utils.checkNotNull(firstName, "firstName");
        this.firstName = firstName;
        return this;
    }
     ...
     * Candidate last name
     */
    public AssessmentOrderCandidate withLastName(String lastName) {
        Utils.checkNotNull(lastName, "lastName");
     ...
     * Candidate last name
     */
    public AssessmentOrderCandidate withLastName(JsonNullable<String> lastName) {
        Utils.checkNotNull(lastName, "lastName");
        this.lastName = lastName;
        return this;
    }
     ...
     * List of candidate emails
     */
    public AssessmentOrderCandidate withEmails(List<CandidateEmail> emails) {
        Utils.checkNotNull(emails, "emails");
     ...
     * List of candidate emails
     */
    public AssessmentOrderCandidate withEmails(JsonNullable<? extends List<CandidateEmail>> emails) {
        Utils.checkNotNull(emails, "emails");
        this.emails = emails;
        return this;
    }
     ...
     * Value to pass through to the provider
     */
    public AssessmentOrderCandidate withPassthrough(Map<String, Object> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
     ...
     * Value to pass through to the provider
     */
    public AssessmentOrderCandidate withPassthrough(JsonNullable<? extends Map<String, Object>> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
        this.passthrough = passthrough;
        return this;
    }
     ...
     * Candidate profile url
     */
    public AssessmentOrderCandidate withProfileUrl(String profileUrl) {
        Utils.checkNotNull(profileUrl, "profileUrl");
     ...
     * Candidate profile url
     */
    public AssessmentOrderCandidate withProfileUrl(JsonNullable<String> profileUrl) {
        Utils.checkNotNull(profileUrl, "profileUrl");
        this.profileUrl = profileUrl;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AssessmentOrderCandidate other = (AssessmentOrderCandidate) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AssessmentOrderCandidate.class,
                "id", id,
                "remoteId", remoteId,
                "firstName", firstName,
                "lastName", lastName,
    ...
    public final static class Builder {
        ...
        public AssessmentOrderCandidate build() {
            return new AssessmentOrderCandidate(
                id,
                remoteId,
                firstName,
                lastName,
