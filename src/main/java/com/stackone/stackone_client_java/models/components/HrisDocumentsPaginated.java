...
public class HrisDocumentsPaginated {
    ...
    @JsonProperty("data")
    private List<HrisDocumentApiModel> data;
    ...
    public HrisDocumentsPaginated(
            List<HrisDocumentApiModel> data) {
    ...
    @JsonIgnore
    public List<HrisDocumentApiModel> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public HrisDocumentsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public HrisDocumentsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public HrisDocumentsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public HrisDocumentsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public HrisDocumentsPaginated withData(List<HrisDocumentApiModel> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public HrisDocumentsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public HrisDocumentsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisDocumentsPaginated other = (HrisDocumentsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisDocumentsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<HrisDocumentApiModel> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public HrisDocumentsPaginated build() {
            return new HrisDocumentsPaginated(
                nextPage,
                next,
                data,
                raw);
