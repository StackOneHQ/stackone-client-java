 ...
 * <p>Type of account
 */
@JsonDeserialize(using = AccountingAccountResultValue._Deserializer.class)
@JsonSerialize(using = AccountingAccountResultValue._Serializer.class)
public class AccountingAccountResultValue {
    ...
    public static final class _Serializer extends StdSerializer<AccountingAccountResultValue> {
        ...
        @Override
        public void serialize(AccountingAccountResultValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<AccountingAccountResultValue> {
        ...
        @Override
        public AccountingAccountResultValue deserialize(JsonParser p, DeserializationContext ctxt)
