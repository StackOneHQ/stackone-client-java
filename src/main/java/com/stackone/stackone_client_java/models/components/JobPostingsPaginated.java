...
public class JobPostingsPaginated {
     ...
     */
    @Deprecated
    public JobPostingsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public JobPostingsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public JobPostingsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public JobPostingsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public JobPostingsPaginated withData(List<JobPosting> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public JobPostingsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public JobPostingsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        JobPostingsPaginated other = (JobPostingsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(JobPostingsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<JobPosting> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public JobPostingsPaginated build() {

            return new JobPostingsPaginated(
                nextPage, next, data,
                raw);
        }
