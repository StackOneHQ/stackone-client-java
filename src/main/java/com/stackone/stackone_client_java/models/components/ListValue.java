 ...
 */
@JsonDeserialize(using = ListValue._Deserializer.class)
@JsonSerialize(using = ListValue._Serializer.class)
public class ListValue {
    ...
    public static final class _Serializer extends StdSerializer<ListValue> {
        ...
        @Override
        public void serialize(ListValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<ListValue> {
