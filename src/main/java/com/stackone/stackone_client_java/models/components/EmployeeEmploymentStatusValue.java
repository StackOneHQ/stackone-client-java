 ...
 *
 */
@JsonDeserialize(using = EmployeeEmploymentStatusValue._Deserializer.class)
@JsonSerialize(using = EmployeeEmploymentStatusValue._Serializer.class)
public class EmployeeEmploymentStatusValue {
    ...
    public static final class _Serializer extends StdSerializer<EmployeeEmploymentStatusValue> {
        ...
        @Override
        public void serialize(EmployeeEmploymentStatusValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<EmployeeEmploymentStatusValue> {
        ...
        @Override
        public EmployeeEmploymentStatusValue deserialize(JsonParser p, DeserializationContext ctxt)
