...
@JsonDeserialize(using = HRISLocationSourceValue._Deserializer.class)
public class HRISLocationSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.HRISLocationSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HRISLocationSourceValue other = (HRISLocationSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<HRISLocationSourceValue> {

        public _Deserializer() {
            super(HRISLocationSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<HRISLocationSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(HRISLocationSourceValue.class,
                "value", value);
    }
