...
@JsonDeserialize(using = HrisDocumentsUploadRequestDtoSourceValue._Deserializer.class)
public class HrisDocumentsUploadRequestDtoSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.HrisDocumentsUploadRequestDtoSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisDocumentsUploadRequestDtoSourceValue other = (HrisDocumentsUploadRequestDtoSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<HrisDocumentsUploadRequestDtoSourceValue> {

        public _Deserializer() {
            super(HrisDocumentsUploadRequestDtoSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<HrisDocumentsUploadRequestDtoSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(HrisDocumentsUploadRequestDtoSourceValue.class,
                "value", value);
    }
