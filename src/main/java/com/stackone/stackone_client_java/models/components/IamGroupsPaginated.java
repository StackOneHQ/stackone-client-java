...
public class IamGroupsPaginated {
    ...
    public IamGroupsPaginated(
            ...
            @JsonProperty("data") List<IamGroup> data,
     ...
     */
    @Deprecated
    public IamGroupsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public IamGroupsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public IamGroupsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public IamGroupsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public IamGroupsPaginated withData(List<IamGroup> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public IamGroupsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public IamGroupsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamGroupsPaginated other = (IamGroupsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(IamGroupsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
