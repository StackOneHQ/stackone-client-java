...
public class EmployeesPaginated {
     ...
     */
    @Deprecated
    public EmployeesPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public EmployeesPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public EmployeesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public EmployeesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public EmployeesPaginated withData(List<Employee> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public EmployeesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public EmployeesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EmployeesPaginated other = (EmployeesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EmployeesPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
