...
@JsonDeserialize(using = HrisShiftApprovalStatusSourceValue._Deserializer.class)
public class HrisShiftApprovalStatusSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.HrisShiftSourceValueApprovalStatus4}</li>
    ...
    public static final class _Deserializer extends OneOfDeserializer<HrisShiftApprovalStatusSourceValue> {

        public _Deserializer() {
            super(HrisShiftApprovalStatusSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<HrisShiftSourceValueApprovalStatus4>() {}, JsonShape.DEFAULT));
        }
    }
