...
public class BackgroundCheckResultScore {
     ...
     * The label of the score
     */
    public BackgroundCheckResultScore withLabel(String label) {
        Utils.checkNotNull(label, "label");
     ...
     * The label of the score
     */
    public BackgroundCheckResultScore withLabel(JsonNullable<String> label) {
        Utils.checkNotNull(label, "label");
        this.label = label;
        return this;
    }
     ...
     * The value is the actual score
     */
    public BackgroundCheckResultScore withValue(String value) {
        Utils.checkNotNull(value, "value");
     ...
     * The value is the actual score
     */
    public BackgroundCheckResultScore withValue(JsonNullable<String> value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
     ...
     * The minimum value of the score
     */
    public BackgroundCheckResultScore withMin(String min) {
        Utils.checkNotNull(min, "min");
     ...
     * The minimum value of the score
     */
    public BackgroundCheckResultScore withMin(JsonNullable<String> min) {
        Utils.checkNotNull(min, "min");
        this.min = min;
        return this;
    }
     ...
     * The maximum value of the score
     */
    public BackgroundCheckResultScore withMax(String max) {
        Utils.checkNotNull(max, "max");
     ...
     * The maximum value of the score
     */
    public BackgroundCheckResultScore withMax(JsonNullable<String> max) {
        Utils.checkNotNull(max, "max");
        this.max = max;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BackgroundCheckResultScore other = (BackgroundCheckResultScore) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BackgroundCheckResultScore.class,
                "label", label,
                "value", value,
                "min", min,
                "max", max);
    ...
    public final static class Builder {
        ...
        public BackgroundCheckResultScore build() {
            return new BackgroundCheckResultScore(
                label,
                value,
                min,
                max);
