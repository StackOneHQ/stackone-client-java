...
public class Visibility {
    ...
    @JsonCreator
    public Visibility(
            @JsonProperty("value") JsonNullable<? extends NoteValue> value,
            @JsonProperty("source_value") JsonNullable<? extends NoteSourceValue> sourceValue) {
    ...
    public JsonNullable<NoteValue> value() {
        return (JsonNullable<NoteValue>) value;
    }
    ...
    public JsonNullable<NoteSourceValue> sourceValue() {
        return (JsonNullable<NoteSourceValue>) sourceValue;
    }
    ...
    public String toString() {
        return Utils.toString(Visibility.class,
                "value", value,
