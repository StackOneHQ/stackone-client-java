...
public class AssessmentPackagePaginated {
    ...
    @JsonProperty("data")
    private List<AssessmentPackage> data;
    ...
    @JsonIgnore
    public List<AssessmentPackage> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public AssessmentPackagePaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public AssessmentPackagePaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public AssessmentPackagePaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public AssessmentPackagePaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public AssessmentPackagePaginated withData(List<AssessmentPackage> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public AssessmentPackagePaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public AssessmentPackagePaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AssessmentPackagePaginated other = (AssessmentPackagePaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AssessmentPackagePaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<AssessmentPackage> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public AssessmentPackagePaginated build() {

            return new AssessmentPackagePaginated(
                nextPage, next, data,
                raw);
        }
