 ...
 * IsPaid
 * 
 * <p>Whether the break is paid
 */
@JsonDeserialize(using = IsPaid._Deserializer.class)
public class IsPaid {
     ...
     * <ul>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.IsPaid2}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<IsPaid> {
