...
@JsonDeserialize(using = TimeOffTypeSourceValue._Deserializer.class)
public class TimeOffTypeSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.TimeOffSourceValueType4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TimeOffTypeSourceValue other = (TimeOffTypeSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<TimeOffTypeSourceValue> {

        public _Deserializer() {
            super(TimeOffTypeSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<TimeOffSourceValueType4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(TimeOffTypeSourceValue.class,
                "value", value);
    }
