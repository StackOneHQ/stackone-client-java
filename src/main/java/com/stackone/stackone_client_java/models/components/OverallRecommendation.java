 ...
 */
@JsonDeserialize(using = OverallRecommendation._Deserializer.class)
@JsonSerialize(using = OverallRecommendation._Serializer.class)
public class OverallRecommendation {
    ...
    public static final class _Serializer extends StdSerializer<OverallRecommendation> {
        ...
        @Override
        public void serialize(OverallRecommendation value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<OverallRecommendation> {
        ...
        @Override
        public OverallRecommendation deserialize(JsonParser p, DeserializationContext ctxt)
