...
public class HrisCreateEmployeeRequestDtoEmployment {
     ...
     * Unique identifier
     */
    public HrisCreateEmployeeRequestDtoEmployment withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public HrisCreateEmployeeRequestDtoEmployment withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The time worked for the employee in ISO 8601 duration format
     */
    public HrisCreateEmployeeRequestDtoEmployment withTimeWorked(String timeWorked) {
        Utils.checkNotNull(timeWorked, "timeWorked");
     ...
     * The time worked for the employee in ISO 8601 duration format
     */
    public HrisCreateEmployeeRequestDtoEmployment withTimeWorked(JsonNullable<String> timeWorked) {
        Utils.checkNotNull(timeWorked, "timeWorked");
        this.timeWorked = timeWorked;
        return this;
    }
