...
public class CampaignsPaginated {
     ...
     */
    @Deprecated
    public CampaignsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public CampaignsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public CampaignsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public CampaignsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public CampaignsPaginated withData(List<Campaign> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public CampaignsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public CampaignsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CampaignsPaginated other = (CampaignsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CampaignsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public CampaignsPaginated build() {

            return new CampaignsPaginated(
                nextPage, next, data,
                raw);
        }
