...
public class QuestionType {
    ...
    @JsonCreator
    public QuestionType(
            @JsonProperty("value") JsonNullable<? extends QuestionValue> value,
            @JsonProperty("source_value") JsonNullable<? extends QuestionSourceValue> sourceValue) {
    ...
    public JsonNullable<QuestionValue> value() {
        return (JsonNullable<QuestionValue>) value;
    }
    ...
    public JsonNullable<QuestionSourceValue> sourceValue() {
        return (JsonNullable<QuestionSourceValue>) sourceValue;
    }
    ...
    public String toString() {
        return Utils.toString(QuestionType.class,
                "value", value,
