...
public class IamPolicyResult {
    ...
    @JsonCreator
    public IamPolicyResult(
            @JsonProperty("data") IamPolicy data,
    ...
    public IamPolicyResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public IamPolicyResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamPolicyResult other = (IamPolicyResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(IamPolicyResult.class,
                "data", data,
                "raw", raw);
    }
