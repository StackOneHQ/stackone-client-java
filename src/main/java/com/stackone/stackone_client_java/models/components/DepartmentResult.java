...
public class DepartmentResult {
    ...
    public DepartmentResult withData(Department data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public DepartmentResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public DepartmentResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DepartmentResult other = (DepartmentResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DepartmentResult.class,
                "data", data,
                "raw", raw);
    }
