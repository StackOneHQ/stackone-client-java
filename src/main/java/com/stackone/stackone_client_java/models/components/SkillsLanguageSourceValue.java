 ...
 * format.
 */
@JsonDeserialize(using = SkillsLanguageSourceValue._Deserializer.class)
public class SkillsLanguageSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.SkillsSourceValueLanguage4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SkillsLanguageSourceValue other = (SkillsLanguageSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<SkillsLanguageSourceValue> {

        public _Deserializer() {
            super(SkillsLanguageSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<SkillsSourceValueLanguage4>() {}, JsonShape.DEFAULT),
    ...
    public String toString() {
        return Utils.toString(SkillsLanguageSourceValue.class,
                "value", value);
    }
