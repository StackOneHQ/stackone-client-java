...
public class Content {
     ...
     * Whether the content is active and available for users.
     */
    public Content withActive(boolean active) {
        Utils.checkNotNull(active, "active");
     ...
     * Whether the content is active and available for users.
     */
    public Content withActive(JsonNullable<Boolean> active) {
        Utils.checkNotNull(active, "active");
        this.active = active;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Objects.deepEquals(this.courseIds, other.courseIds) &&
            Objects.deepEquals(this.remoteCourseIds, other.remoteCourseIds) &&
