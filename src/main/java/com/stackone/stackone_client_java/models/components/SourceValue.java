...
public class SourceValue {
    ...
    private SourceValue(TypedObject value) {
        this.value = value;
    }

    public static SourceValue of(String value) {
        Utils.checkNotNull(value, "value");
        return new SourceValue(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<String>(){}));
    }

    public static SourceValue of(double value) {
        Utils.checkNotNull(value, "value");
        return new SourceValue(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<java.lang.Double>(){}));
    }

    public static SourceValue of(boolean value) {
        Utils.checkNotNull(value, "value");
    ...
    public static SourceValue of(List<Object> value) {
        Utils.checkNotNull(value, "value");
        return new SourceValue(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<List<Object>>(){}));
    }
    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceValue> {

        public _Deserializer() {
            super(SourceValue.class, false,
    ...
    public String toString() {
        return Utils.toString(SourceValue.class,
                "value", value);
    }
