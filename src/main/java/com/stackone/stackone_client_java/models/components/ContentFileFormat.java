...
public class ContentFileFormat {
     ...
     * The file format of the file, expressed as a file extension
     */
    public ContentFileFormat withValue(ContentValue value) {
        Utils.checkNotNull(value, "value");
     ...
     * The file format of the file, expressed as a file extension
     */
    public ContentFileFormat withValue(JsonNullable<? extends ContentValue> value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }

    public ContentFileFormat withSourceValue(ContentSourceValue sourceValue) {
        Utils.checkNotNull(sourceValue, "sourceValue");
        this.sourceValue = JsonNullable.of(sourceValue);
        return this;
    }

    public ContentFileFormat withSourceValue(JsonNullable<? extends ContentSourceValue> sourceValue) {
        Utils.checkNotNull(sourceValue, "sourceValue");
        this.sourceValue = sourceValue;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ContentFileFormat other = (ContentFileFormat) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ContentFileFormat.class,
                "value", value,
    ...
    public final static class Builder {
        ...
        public ContentFileFormat build() {
            return new ContentFileFormat(
                value,
                sourceValue);
        }
    }
