...
public class CustomFieldDefinitionsPaginated {
    ...
    @JsonProperty("data")
    private List<CustomFieldDefinition> data;
    ...
    public CustomFieldDefinitionsPaginated(
            List<CustomFieldDefinition> data) {
    ...
    @JsonIgnore
    public List<CustomFieldDefinition> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public CustomFieldDefinitionsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public CustomFieldDefinitionsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public CustomFieldDefinitionsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public CustomFieldDefinitionsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public CustomFieldDefinitionsPaginated withData(List<CustomFieldDefinition> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public CustomFieldDefinitionsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public CustomFieldDefinitionsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CustomFieldDefinitionsPaginated other = (CustomFieldDefinitionsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CustomFieldDefinitionsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<CustomFieldDefinition> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public CustomFieldDefinitionsPaginated build() {
            return new CustomFieldDefinitionsPaginated(
                nextPage,
                next,
                data,
                raw);
