...
public class FolderResult {
    ...
    @JsonCreator
    public FolderResult(
            @JsonProperty("data") Folders data,
    ...
    public FolderResult withData(Folders data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public FolderResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public FolderResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FolderResult other = (FolderResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FolderResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(Folders data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
