 ...
 */
@JsonDeserialize(using = MessagingCreateConversationRequestDtoPrivate._Deserializer.class)
public class MessagingCreateConversationRequestDtoPrivate {
     ...
     * <ul>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.MessagingCreateConversationRequestDtoPrivate2}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<MessagingCreateConversationRequestDtoPrivate> {
