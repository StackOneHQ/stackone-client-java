 ...
 */
@JsonDeserialize(using = AccountingJournalValue._Deserializer.class)
@JsonSerialize(using = AccountingJournalValue._Serializer.class)
public class AccountingJournalValue {
    ...
    public static final class _Serializer extends StdSerializer<AccountingJournalValue> {
        ...
        @Override
        public void serialize(AccountingJournalValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<AccountingJournalValue> {
        ...
        @Override
        public AccountingJournalValue deserialize(JsonParser p, DeserializationContext ctxt)
