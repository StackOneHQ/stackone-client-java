...
@JsonDeserialize(using = HrisCreateWorkEligibilityRequestDtoTypeSourceValue._Deserializer.class)
public class HrisCreateWorkEligibilityRequestDtoTypeSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.HrisCreateWorkEligibilityRequestDtoSourceValueType4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisCreateWorkEligibilityRequestDtoTypeSourceValue other = (HrisCreateWorkEligibilityRequestDtoTypeSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<HrisCreateWorkEligibilityRequestDtoTypeSourceValue> {

        public _Deserializer() {
            super(HrisCreateWorkEligibilityRequestDtoTypeSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<HrisCreateWorkEligibilityRequestDtoSourceValueType4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(HrisCreateWorkEligibilityRequestDtoTypeSourceValue.class,
                "value", value);
    }
