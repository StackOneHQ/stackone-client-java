...
public class IamRoleResult {
    ...
    @JsonCreator
    public IamRoleResult(
            @JsonProperty("data") IamRole data,
    ...
    public IamRoleResult withData(IamRole data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public IamRoleResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public IamRoleResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamRoleResult other = (IamRoleResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(IamRoleResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(IamRole data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
