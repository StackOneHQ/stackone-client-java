...
public class SmsMessageContents {
    ...
    public SmsMessageContents withBody(String body) {
        Utils.checkNotNull(body, "body");
        this.body = JsonNullable.of(body);
        return this;
    }

    public SmsMessageContents withBody(JsonNullable<String> body) {
        Utils.checkNotNull(body, "body");
        this.body = body;
        return this;
    }

    public SmsMessageContents withFrom(String from) {
        Utils.checkNotNull(from, "from");
        this.from = JsonNullable.of(from);
        return this;
    }

    public SmsMessageContents withFrom(JsonNullable<String> from) {
        Utils.checkNotNull(from, "from");
        this.from = from;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SmsMessageContents other = (SmsMessageContents) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SmsMessageContents.class,
                "body", body,
                "from", from);
    }
    ...
    public final static class Builder {
        ...
        public SmsMessageContents build() {
            return new SmsMessageContents(
                body,
                from);
        }
    }
