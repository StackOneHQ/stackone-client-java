...
public class AtsJobResult {
    ...
    public AtsJobResult withData(AtsJob data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public AtsJobResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public AtsJobResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsJobResult other = (AtsJobResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsJobResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(AtsJob data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public AtsJobResult build() {

            return new AtsJobResult(
                data, raw);
        }
