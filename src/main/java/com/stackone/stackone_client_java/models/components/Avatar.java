...
public class Avatar {
    ...
    public Avatar withUrl(JsonNullable<String> url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }

    public Avatar withBase64(String base64) {
        Utils.checkNotNull(base64, "base64");
        this.base64 = JsonNullable.of(base64);
        return this;
    }

    public Avatar withBase64(JsonNullable<String> base64) {
        Utils.checkNotNull(base64, "base64");
        this.base64 = base64;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Avatar.class,
                "url", url,
                "base64", base64);
    }
