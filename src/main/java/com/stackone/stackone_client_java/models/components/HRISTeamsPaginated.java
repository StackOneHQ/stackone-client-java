...
public class HRISTeamsPaginated {
     ...
     */
    @Deprecated
    public HRISTeamsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public HRISTeamsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public HRISTeamsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public HRISTeamsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public HRISTeamsPaginated withData(List<HRISTeam> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public HRISTeamsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public HRISTeamsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HRISTeamsPaginated other = (HRISTeamsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HRISTeamsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<HRISTeam> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public HRISTeamsPaginated build() {
            return new HRISTeamsPaginated(
                nextPage,
                next,
                data,
                raw);
