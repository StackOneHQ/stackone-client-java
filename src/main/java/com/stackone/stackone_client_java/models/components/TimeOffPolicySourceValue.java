...
@JsonDeserialize(using = TimeOffPolicySourceValue._Deserializer.class)
public class TimeOffPolicySourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.TimeOffSourceValuePolicy4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TimeOffPolicySourceValue other = (TimeOffPolicySourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<TimeOffPolicySourceValue> {

        public _Deserializer() {
            super(TimeOffPolicySourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<TimeOffSourceValuePolicy4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(TimeOffPolicySourceValue.class,
                "value", value);
    }
