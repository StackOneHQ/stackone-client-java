...
public class HrisJobsPaginated {
     ...
     */
    @Deprecated
    public HrisJobsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public HrisJobsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public HrisJobsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public HrisJobsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public HrisJobsPaginated withData(List<HrisJob> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public HrisJobsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public HrisJobsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisJobsPaginated other = (HrisJobsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisJobsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<HrisJob> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
