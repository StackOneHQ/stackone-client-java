...
public class TimeOffResult {
    ...
    @JsonCreator
    public TimeOffResult(
            @JsonProperty("data") TimeOff data,
    ...
    public TimeOffResult withData(TimeOff data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public TimeOffResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public TimeOffResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TimeOffResult other = (TimeOffResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TimeOffResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(TimeOff data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
