...
@JsonDeserialize(using = WorkEligibilitySourceValue._Deserializer.class)
public class WorkEligibilitySourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.WorkEligibilitySourceValue4}</li>
    ...
    public static final class _Deserializer extends OneOfDeserializer<WorkEligibilitySourceValue> {

        public _Deserializer() {
            super(WorkEligibilitySourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<WorkEligibilitySourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
