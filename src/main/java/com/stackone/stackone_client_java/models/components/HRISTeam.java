...
public class HRISTeam {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    private JsonNullable<? extends HRISTeamType> type;
    ...
    public HRISTeam(
            ...
            @JsonProperty("type") JsonNullable<? extends HRISTeamType> type) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<HRISTeamType> type() {
        return (JsonNullable<HRISTeamType>) type;
    }
     ...
     * Unique identifier
     */
    public HRISTeam withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public HRISTeam withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public HRISTeam withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public HRISTeam withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Custom Unified Fields configured in your StackOne project
     */
    public HRISTeam withUnifiedCustomFields(Map<String, Object> unifiedCustomFields) {
        Utils.checkNotNull(unifiedCustomFields, "unifiedCustomFields");
     ...
     * Custom Unified Fields configured in your StackOne project
     */
    public HRISTeam withUnifiedCustomFields(JsonNullable<? extends Map<String, Object>> unifiedCustomFields) {
        Utils.checkNotNull(unifiedCustomFields, "unifiedCustomFields");
        this.unifiedCustomFields = unifiedCustomFields;
        return this;
    }
     ...
     * The name of the group
     */
    public HRISTeam withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the group
     */
    public HRISTeam withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The list of parent group ids of the given group
     */
    public HRISTeam withParentIds(List<String> parentIds) {
        Utils.checkNotNull(parentIds, "parentIds");
     ...
     * The list of parent group ids of the given group
     */
    public HRISTeam withParentIds(JsonNullable<? extends List<String>> parentIds) {
        Utils.checkNotNull(parentIds, "parentIds");
        this.parentIds = parentIds;
        return this;
    }
     ...
     * Provider's list of parent group remote ids of the given group
     */
    public HRISTeam withRemoteParentIds(List<String> remoteParentIds) {
        Utils.checkNotNull(remoteParentIds, "remoteParentIds");
     ...
     * Provider's list of parent group remote ids of the given group
     */
    public HRISTeam withRemoteParentIds(JsonNullable<? extends List<String>> remoteParentIds) {
        Utils.checkNotNull(remoteParentIds, "remoteParentIds");
        this.remoteParentIds = remoteParentIds;
        return this;
    }
     ...
     * The list of group owner ids of the given group
     */
    public HRISTeam withOwnerIds(List<String> ownerIds) {
        Utils.checkNotNull(ownerIds, "ownerIds");
     ...
     * The list of group owner ids of the given group
     */
    public HRISTeam withOwnerIds(JsonNullable<? extends List<String>> ownerIds) {
        Utils.checkNotNull(ownerIds, "ownerIds");
        this.ownerIds = ownerIds;
        return this;
    }
     ...
     * The list of remote group owner ids of the given group
     */
    public HRISTeam withRemoteOwnerIds(List<String> remoteOwnerIds) {
        Utils.checkNotNull(remoteOwnerIds, "remoteOwnerIds");
     ...
     * The list of remote group owner ids of the given group
     */
    public HRISTeam withRemoteOwnerIds(JsonNullable<? extends List<String>> remoteOwnerIds) {
        Utils.checkNotNull(remoteOwnerIds, "remoteOwnerIds");
        this.remoteOwnerIds = remoteOwnerIds;
        return this;
    }
     ...
     * The id of the company that the group belongs to
     */
    public HRISTeam withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * The id of the company that the group belongs to
     */
    public HRISTeam withCompanyId(JsonNullable<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Provider's id of the company that the group belongs to
     */
    public HRISTeam withRemoteCompanyId(String remoteCompanyId) {
        Utils.checkNotNull(remoteCompanyId, "remoteCompanyId");
     ...
     * Provider's id of the company that the group belongs to
     */
    public HRISTeam withRemoteCompanyId(JsonNullable<String> remoteCompanyId) {
        Utils.checkNotNull(remoteCompanyId, "remoteCompanyId");
        this.remoteCompanyId = remoteCompanyId;
        return this;
    }
     ...
     * The type of the team group
     */
    public HRISTeam withType(JsonNullable<? extends HRISTeamType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(HRISTeam.class,
                "id", id,
                "remoteId", remoteId,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends HRISTeamType> type = JsonNullable.undefined();
         ...
         * The type of the team group
         */
        public Builder type(HRISTeamType type) {
            Utils.checkNotNull(type, "type");
            this.type = JsonNullable.of(type);
            return this;
        }
         ...
         * The type of the team group
         */
        public Builder type(JsonNullable<? extends HRISTeamType> type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
        
        public HRISTeam build() {
            return new HRISTeam(
                id,
                remoteId,
                unifiedCustomFields,
