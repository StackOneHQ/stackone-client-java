...
public class MessagingAttachmentResultData {
     ...
     * Unique identifier
     */
    public MessagingAttachmentResultData withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public MessagingAttachmentResultData withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public MessagingAttachmentResultData withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public MessagingAttachmentResultData withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Name of the attached file
     */
    public MessagingAttachmentResultData withFileName(String fileName) {
        Utils.checkNotNull(fileName, "fileName");
     ...
     * Name of the attached file
     */
    public MessagingAttachmentResultData withFileName(JsonNullable<String> fileName) {
        Utils.checkNotNull(fileName, "fileName");
        this.fileName = fileName;
        return this;
    }
     ...
     * Size of the attached file
     */
    public MessagingAttachmentResultData withFileSize(JsonNullable<Double> fileSize) {
        Utils.checkNotNull(fileSize, "fileSize");
        this.fileSize = fileSize;
        return this;
    }
     ...
     * MIME type of the attached file
     */
    public MessagingAttachmentResultData withFileType(String fileType) {
        Utils.checkNotNull(fileType, "fileType");
     ...
     * MIME type of the attached file
     */
    public MessagingAttachmentResultData withFileType(JsonNullable<String> fileType) {
        Utils.checkNotNull(fileType, "fileType");
        this.fileType = fileType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MessagingAttachmentResultData other = (MessagingAttachmentResultData) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MessagingAttachmentResultData.class,
                "id", id,
                "remoteId", remoteId,
                "fileName", fileName,
                "fileSize", fileSize,
    ...
    public final static class Builder {
        ...
        public MessagingAttachmentResultData build() {
            ...
            return new MessagingAttachmentResultData(
                id, remoteId, fileName,
                fileSize, fileType);
        }
