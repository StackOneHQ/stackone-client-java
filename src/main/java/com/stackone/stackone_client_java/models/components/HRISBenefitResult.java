...
public class HRISBenefitResult {
    ...
    @JsonCreator
    public HRISBenefitResult(
            @JsonProperty("data") HRISBenefit data,
    ...
    public HRISBenefitResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public HRISBenefitResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HRISBenefitResult other = (HRISBenefitResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HRISBenefitResult.class,
                "data", data,
                "raw", raw);
    }
