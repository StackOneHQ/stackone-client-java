...
public class AtsCreateBackgroundCheckOrderRequestDtoCandidate {
     ...
     * Unique identifier
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Candidate first name
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withFirstName(String firstName) {
        Utils.checkNotNull(firstName, "firstName");
     ...
     * Candidate first name
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withFirstName(JsonNullable<String> firstName) {
        Utils.checkNotNull(firstName, "firstName");
        this.firstName = firstName;
        return this;
    }
     ...
     * Candidate last name
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withLastName(String lastName) {
        Utils.checkNotNull(lastName, "lastName");
     ...
     * Candidate last name
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withLastName(JsonNullable<String> lastName) {
        Utils.checkNotNull(lastName, "lastName");
        this.lastName = lastName;
        return this;
    }
     ...
     * List of candidate emails
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withEmails(List<CandidateEmail> emails) {
        Utils.checkNotNull(emails, "emails");
     ...
     * List of candidate emails
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withEmails(JsonNullable<? extends List<CandidateEmail>> emails) {
        Utils.checkNotNull(emails, "emails");
        this.emails = emails;
        return this;
    }
     ...
     * Value to pass through to the provider
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withPassthrough(Map<String, Object> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
     ...
     * Value to pass through to the provider
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withPassthrough(JsonNullable<? extends Map<String, Object>> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
        this.passthrough = passthrough;
        return this;
    }
     ...
     * Candidate profile url
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withProfileUrl(String profileUrl) {
        Utils.checkNotNull(profileUrl, "profileUrl");
     ...
     * Candidate profile url
     */
    public AtsCreateBackgroundCheckOrderRequestDtoCandidate withProfileUrl(JsonNullable<String> profileUrl) {
        Utils.checkNotNull(profileUrl, "profileUrl");
        this.profileUrl = profileUrl;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(AtsCreateBackgroundCheckOrderRequestDtoCandidate.class,
                "id", id,
                "remoteId", remoteId,
                "firstName", firstName,
                "lastName", lastName,
    ...
    public final static class Builder {
        ...
        public AtsCreateBackgroundCheckOrderRequestDtoCandidate build() {
            return new AtsCreateBackgroundCheckOrderRequestDtoCandidate(
                id,
                remoteId,
                firstName,
                lastName,
