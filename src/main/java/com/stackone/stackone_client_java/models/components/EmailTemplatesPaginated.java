...
public class EmailTemplatesPaginated {
    ...
    @JsonIgnore
    public List<EmailTemplate> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public EmailTemplatesPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public EmailTemplatesPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public EmailTemplatesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public EmailTemplatesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public EmailTemplatesPaginated withData(List<EmailTemplate> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public EmailTemplatesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public EmailTemplatesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EmailTemplatesPaginated other = (EmailTemplatesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EmailTemplatesPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<EmailTemplate> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public EmailTemplatesPaginated build() {

            return new EmailTemplatesPaginated(
                nextPage, next, data,
                raw);
        }
