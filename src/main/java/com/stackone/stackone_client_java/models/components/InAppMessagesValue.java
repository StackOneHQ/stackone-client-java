 ...
 */
@JsonDeserialize(using = InAppMessagesValue._Deserializer.class)
@JsonSerialize(using = InAppMessagesValue._Serializer.class)
public class InAppMessagesValue {
    ...
    public static final class _Serializer extends StdSerializer<InAppMessagesValue> {
        ...
        @Override
        public void serialize(InAppMessagesValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<InAppMessagesValue> {
        ...
        @Override
        public InAppMessagesValue deserialize(JsonParser p, DeserializationContext ctxt)
