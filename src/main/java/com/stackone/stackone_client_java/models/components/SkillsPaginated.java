...
public class SkillsPaginated {
    ...
    @JsonCreator
    public SkillsPaginated(
            @JsonProperty("next") JsonNullable<String> next,
            @JsonProperty("data") List<Skills> data,
    ...
    public SkillsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public SkillsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public SkillsPaginated withData(List<Skills> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public SkillsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public SkillsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SkillsPaginated other = (SkillsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SkillsPaginated.class,
                "next", next,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(List<Skills> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public SkillsPaginated build() {
            return new SkillsPaginated(
                next,
                data,
                raw);
        }
