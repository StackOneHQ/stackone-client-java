...
public class Division {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    private JsonNullable<? extends EmploymentDivisionType> type;
    ...
    public Division(
            ...
            @JsonProperty("type") JsonNullable<? extends EmploymentDivisionType> type) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<EmploymentDivisionType> type() {
        return (JsonNullable<EmploymentDivisionType>) type;
    }
     ...
     * Unique identifier
     */
    public Division withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public Division withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public Division withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Custom Unified Fields configured in your StackOne project
     */
    public Division withUnifiedCustomFields(Map<String, Object> unifiedCustomFields) {
        Utils.checkNotNull(unifiedCustomFields, "unifiedCustomFields");
     ...
     * Custom Unified Fields configured in your StackOne project
     */
    public Division withUnifiedCustomFields(JsonNullable<? extends Map<String, Object>> unifiedCustomFields) {
        Utils.checkNotNull(unifiedCustomFields, "unifiedCustomFields");
        this.unifiedCustomFields = unifiedCustomFields;
        return this;
    }
     ...
     * The name of the group
     */
    public Division withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The list of parent group ids of the given group
     */
    public Division withParentIds(List<String> parentIds) {
        Utils.checkNotNull(parentIds, "parentIds");
     ...
     * The list of parent group ids of the given group
     */
    public Division withParentIds(JsonNullable<? extends List<String>> parentIds) {
        Utils.checkNotNull(parentIds, "parentIds");
        this.parentIds = parentIds;
        return this;
    }
     ...
     * Provider's list of parent group remote ids of the given group
     */
    public Division withRemoteParentIds(List<String> remoteParentIds) {
        Utils.checkNotNull(remoteParentIds, "remoteParentIds");
     ...
     * Provider's list of parent group remote ids of the given group
     */
    public Division withRemoteParentIds(JsonNullable<? extends List<String>> remoteParentIds) {
        Utils.checkNotNull(remoteParentIds, "remoteParentIds");
        this.remoteParentIds = remoteParentIds;
        return this;
    }
     ...
     * The list of group owner ids of the given group
     */
    public Division withOwnerIds(List<String> ownerIds) {
        Utils.checkNotNull(ownerIds, "ownerIds");
     ...
     * The list of group owner ids of the given group
     */
    public Division withOwnerIds(JsonNullable<? extends List<String>> ownerIds) {
        Utils.checkNotNull(ownerIds, "ownerIds");
        this.ownerIds = ownerIds;
        return this;
    }
     ...
     * The list of remote group owner ids of the given group
     */
    public Division withRemoteOwnerIds(List<String> remoteOwnerIds) {
        Utils.checkNotNull(remoteOwnerIds, "remoteOwnerIds");
     ...
     * The list of remote group owner ids of the given group
     */
    public Division withRemoteOwnerIds(JsonNullable<? extends List<String>> remoteOwnerIds) {
        Utils.checkNotNull(remoteOwnerIds, "remoteOwnerIds");
        this.remoteOwnerIds = remoteOwnerIds;
        return this;
    }
     ...
     * The id of the company that the group belongs to
     */
    public Division withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * The id of the company that the group belongs to
     */
    public Division withCompanyId(JsonNullable<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Provider's id of the company that the group belongs to
     */
    public Division withRemoteCompanyId(String remoteCompanyId) {
        Utils.checkNotNull(remoteCompanyId, "remoteCompanyId");
     ...
     * Provider's id of the company that the group belongs to
     */
    public Division withRemoteCompanyId(JsonNullable<String> remoteCompanyId) {
        Utils.checkNotNull(remoteCompanyId, "remoteCompanyId");
        this.remoteCompanyId = remoteCompanyId;
        return this;
    }
     ...
     * The type of the group
     */
    public Division withType(EmploymentDivisionType type) {
        Utils.checkNotNull(type, "type");
     ...
     * The type of the group
     */
    public Division withType(JsonNullable<? extends EmploymentDivisionType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Division.class,
                "id", id,
                "remoteId", remoteId,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends EmploymentDivisionType> type = JsonNullable.undefined();
         ...
         * The type of the group
         */
        public Builder type(EmploymentDivisionType type) {
            Utils.checkNotNull(type, "type");
            this.type = JsonNullable.of(type);
            return this;
        }
         ...
         * The type of the group
         */
        public Builder type(JsonNullable<? extends EmploymentDivisionType> type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
