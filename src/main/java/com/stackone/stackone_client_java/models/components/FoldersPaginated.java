...
public class FoldersPaginated {
    ...
    @JsonCreator
    public FoldersPaginated(
            @JsonProperty("next") JsonNullable<String> next,
            @JsonProperty("data") List<Folders> data,
    ...
    public FoldersPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public FoldersPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public FoldersPaginated withData(List<Folders> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public FoldersPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public FoldersPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FoldersPaginated other = (FoldersPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FoldersPaginated.class,
                "next", next,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(List<Folders> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public FoldersPaginated build() {

            return new FoldersPaginated(
                next, data, raw);
        }
