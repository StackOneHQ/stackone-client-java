...
@JsonDeserialize(using = HrisCreateTimeOffRequestDtoSourceValue._Deserializer.class)
public class HrisCreateTimeOffRequestDtoSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.HrisCreateTimeOffRequestDtoSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisCreateTimeOffRequestDtoSourceValue other = (HrisCreateTimeOffRequestDtoSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<HrisCreateTimeOffRequestDtoSourceValue> {

        public _Deserializer() {
            super(HrisCreateTimeOffRequestDtoSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<HrisCreateTimeOffRequestDtoSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(HrisCreateTimeOffRequestDtoSourceValue.class,
                "value", value);
    }
