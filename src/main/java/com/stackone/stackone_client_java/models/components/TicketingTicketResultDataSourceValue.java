 ...
 */
@JsonDeserialize(using = TicketingTicketResultDataSourceValue._Deserializer.class)
public class TicketingTicketResultDataSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.TicketingTicketResultSourceValueData4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TicketingTicketResultDataSourceValue other = (TicketingTicketResultDataSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<TicketingTicketResultDataSourceValue> {

        public _Deserializer() {
            super(TicketingTicketResultDataSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<TicketingTicketResultSourceValueData4>() {}, JsonShape.DEFAULT),
    ...
    public String toString() {
        return Utils.toString(TicketingTicketResultDataSourceValue.class,
                "value", value);
    }
