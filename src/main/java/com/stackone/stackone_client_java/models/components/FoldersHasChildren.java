 ...
 * FoldersHasChildren
 * 
 * <p>Whether the folder has children
 */
@JsonDeserialize(using = FoldersHasChildren._Deserializer.class)
public class FoldersHasChildren {
     ...
     * <ul>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.FoldersHasChildren2}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<FoldersHasChildren> {

        public _Deserializer() {
            super(FoldersHasChildren.class, false,
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<FoldersHasChildren2>() {}, JsonShape.DEFAULT));
        }
    }
