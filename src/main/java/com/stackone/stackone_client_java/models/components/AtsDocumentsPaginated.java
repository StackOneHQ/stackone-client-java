...
public class AtsDocumentsPaginated {
    ...
    @JsonProperty("data")
    private List<AtsDocumentApiModel> data;
    ...
    @JsonIgnore
    public List<AtsDocumentApiModel> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public AtsDocumentsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public AtsDocumentsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public AtsDocumentsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public AtsDocumentsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public AtsDocumentsPaginated withData(List<AtsDocumentApiModel> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public AtsDocumentsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public AtsDocumentsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsDocumentsPaginated other = (AtsDocumentsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsDocumentsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<AtsDocumentApiModel> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public AtsDocumentsPaginated build() {
            ...
            return new AtsDocumentsPaginated(
                nextPage, next, data,
                raw);
        }
