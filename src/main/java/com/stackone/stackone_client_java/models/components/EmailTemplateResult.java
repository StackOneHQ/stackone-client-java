...
public class EmailTemplateResult {
    ...
    @JsonCreator
    public EmailTemplateResult(
            @JsonProperty("data") EmailTemplate data,
    ...
    public EmailTemplateResult withData(EmailTemplate data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public EmailTemplateResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public EmailTemplateResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EmailTemplateResult other = (EmailTemplateResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EmailTemplateResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(EmailTemplate data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public EmailTemplateResult build() {
