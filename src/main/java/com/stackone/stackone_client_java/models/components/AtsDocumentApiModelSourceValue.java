...
@JsonDeserialize(using = AtsDocumentApiModelSourceValue._Deserializer.class)
public class AtsDocumentApiModelSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.AtsDocumentApiModelSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsDocumentApiModelSourceValue other = (AtsDocumentApiModelSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<AtsDocumentApiModelSourceValue> {

        public _Deserializer() {
            super(AtsDocumentApiModelSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<AtsDocumentApiModelSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(AtsDocumentApiModelSourceValue.class,
                "value", value);
    }
