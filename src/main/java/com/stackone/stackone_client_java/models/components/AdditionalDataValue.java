 ...
 * AdditionalDataValue
 * 
 * <p>The value of the additional data
 */
@JsonDeserialize(using = AdditionalDataValue._Deserializer.class)
public class AdditionalDataValue {
    ...
    public static final class _Deserializer extends OneOfDeserializer<AdditionalDataValue> {
