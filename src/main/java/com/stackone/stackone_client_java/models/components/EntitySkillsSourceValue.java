 ...
 * format.
 */
@JsonDeserialize(using = EntitySkillsSourceValue._Deserializer.class)
public class EntitySkillsSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.EntitySkillsSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EntitySkillsSourceValue other = (EntitySkillsSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<EntitySkillsSourceValue> {

        public _Deserializer() {
            super(EntitySkillsSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<EntitySkillsSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(EntitySkillsSourceValue.class,
                "value", value);
    }
