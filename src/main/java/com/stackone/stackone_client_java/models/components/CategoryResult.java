...
public class CategoryResult {
    ...
    public CategoryResult withData(Category data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public CategoryResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public CategoryResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CategoryResult other = (CategoryResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CategoryResult.class,
                "data", data,
                "raw", raw);
    }
