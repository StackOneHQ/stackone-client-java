...
@JsonDeserialize(using = AccountingCompanyResultSourceValue._Deserializer.class)
public class AccountingCompanyResultSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.AccountingCompanyResultSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingCompanyResultSourceValue other = (AccountingCompanyResultSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<AccountingCompanyResultSourceValue> {

        public _Deserializer() {
            super(AccountingCompanyResultSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<AccountingCompanyResultSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(AccountingCompanyResultSourceValue.class,
                "value", value);
    }
