 ...
 * Value
 * 
 * <p>The human readable value of the option
 */
...
public class Value {
    ...
    public static Value of(List<Object> value) {
        Utils.checkNotNull(value, "value");
        return new Value(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<List<Object>>(){}));
    }
