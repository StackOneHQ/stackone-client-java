...
public class AtsJob {
    ...
    private JsonNullable<? extends AtsJobConfidential> confidential;
    ...
    public AtsJob(
            ...
            @JsonProperty("confidential") JsonNullable<? extends AtsJobConfidential> confidential,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<AtsJobConfidential> confidential() {
        return (JsonNullable<AtsJobConfidential>) confidential;
    }
     ...
     * Unique identifier
     */
    public AtsJob withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public AtsJob withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public AtsJob withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Custom Unified Fields configured in your StackOne project
     */
    public AtsJob withUnifiedCustomFields(Map<String, Object> unifiedCustomFields) {
        Utils.checkNotNull(unifiedCustomFields, "unifiedCustomFields");
     ...
     * Custom Unified Fields configured in your StackOne project
     */
    public AtsJob withUnifiedCustomFields(JsonNullable<? extends Map<String, Object>> unifiedCustomFields) {
        Utils.checkNotNull(unifiedCustomFields, "unifiedCustomFields");
        this.unifiedCustomFields = unifiedCustomFields;
        return this;
    }
     ...
     * Code of the job
     */
    public AtsJob withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * Code of the job
     */
    public AtsJob withCode(JsonNullable<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * Title of the job
     */
    public AtsJob withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * Title of the job
     */
    public AtsJob withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * Description of the job
     */
    public AtsJob withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     */
    @Deprecated
    public AtsJob withStatus(String status) {
        Utils.checkNotNull(status, "status");
     ...
     */
    @Deprecated
    public AtsJob withStatus(JsonNullable<String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Status of the job
     */
    public AtsJob withJobStatus(JobStatus jobStatus) {
        Utils.checkNotNull(jobStatus, "jobStatus");
     ...
     * Status of the job
     */
    public AtsJob withJobStatus(JsonNullable<? extends JobStatus> jobStatus) {
        Utils.checkNotNull(jobStatus, "jobStatus");
        this.jobStatus = jobStatus;
        return this;
    }
     ...
     * Department ids of the job
     */
    public AtsJob withDepartmentIds(List<String> departmentIds) {
        Utils.checkNotNull(departmentIds, "departmentIds");
     ...
     * Department ids of the job
     */
    public AtsJob withDepartmentIds(JsonNullable<? extends List<String>> departmentIds) {
        Utils.checkNotNull(departmentIds, "departmentIds");
        this.departmentIds = departmentIds;
        return this;
    }
     ...
     * Provider's department ids of the job
     */
    public AtsJob withRemoteDepartmentIds(List<String> remoteDepartmentIds) {
        Utils.checkNotNull(remoteDepartmentIds, "remoteDepartmentIds");
     ...
     * Provider's department ids of the job
     */
    public AtsJob withRemoteDepartmentIds(JsonNullable<? extends List<String>> remoteDepartmentIds) {
        Utils.checkNotNull(remoteDepartmentIds, "remoteDepartmentIds");
        this.remoteDepartmentIds = remoteDepartmentIds;
        return this;
    }
     ...
     * Location ids of the job
     */
    public AtsJob withLocationIds(List<String> locationIds) {
        Utils.checkNotNull(locationIds, "locationIds");
     ...
     * Location ids of the job
     */
    public AtsJob withLocationIds(JsonNullable<? extends List<String>> locationIds) {
        Utils.checkNotNull(locationIds, "locationIds");
        this.locationIds = locationIds;
        return this;
    }
     ...
     * Provider's location ids of the job
     */
    public AtsJob withRemoteLocationIds(List<String> remoteLocationIds) {
        Utils.checkNotNull(remoteLocationIds, "remoteLocationIds");
     ...
     * Provider's location ids of the job
     */
    public AtsJob withRemoteLocationIds(JsonNullable<? extends List<String>> remoteLocationIds) {
        Utils.checkNotNull(remoteLocationIds, "remoteLocationIds");
        this.remoteLocationIds = remoteLocationIds;
        return this;
    }
     ...
     * Hiring team for the job.
     */
    public AtsJob withHiringTeam(List<AtsJobHiringTeam> hiringTeam) {
        Utils.checkNotNull(hiringTeam, "hiringTeam");
     ...
     * Hiring team for the job.
     */
    public AtsJob withHiringTeam(JsonNullable<? extends List<AtsJobHiringTeam>> hiringTeam) {
        Utils.checkNotNull(hiringTeam, "hiringTeam");
        this.hiringTeam = hiringTeam;
        return this;
    }
     ...
     * Interview stages for the job.
     */
    public AtsJob withInterviewStages(List<InterviewStage> interviewStages) {
        Utils.checkNotNull(interviewStages, "interviewStages");
     ...
     * Interview stages for the job.
     */
    public AtsJob withInterviewStages(JsonNullable<? extends List<InterviewStage>> interviewStages) {
        Utils.checkNotNull(interviewStages, "interviewStages");
        this.interviewStages = interviewStages;
        return this;
    }
     ...
     * Confidential status of the job
     */
    public AtsJob withConfidential(JsonNullable<? extends AtsJobConfidential> confidential) {
        Utils.checkNotNull(confidential, "confidential");
        this.confidential = confidential;
        return this;
    }
     ...
     * The job custom fields
     */
    public AtsJob withCustomFields(List<CustomFields> customFields) {
        Utils.checkNotNull(customFields, "customFields");
     ...
     * The job custom fields
     */
    public AtsJob withCustomFields(JsonNullable<? extends List<CustomFields>> customFields) {
        Utils.checkNotNull(customFields, "customFields");
        this.customFields = customFields;
        return this;
    }
     ...
     * Date of creation
     */
    public AtsJob withCreatedAt(JsonNullable<OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * Date of last update
     */
    public AtsJob withUpdatedAt(JsonNullable<OffsetDateTime> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends AtsJobConfidential> confidential = JsonNullable.undefined();
         ...
         * Confidential status of the job
         */
        public Builder confidential(AtsJobConfidential confidential) {
            Utils.checkNotNull(confidential, "confidential");
            this.confidential = JsonNullable.of(confidential);
            return this;
        }
         ...
         * Confidential status of the job
         */
        public Builder confidential(JsonNullable<? extends AtsJobConfidential> confidential) {
            Utils.checkNotNull(confidential, "confidential");
            this.confidential = confidential;
            return this;
        }
