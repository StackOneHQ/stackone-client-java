...
@JsonDeserialize(using = IamPermissionSourceValue._Deserializer.class)
public class IamPermissionSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.IamPermissionSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamPermissionSourceValue other = (IamPermissionSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<IamPermissionSourceValue> {

        public _Deserializer() {
            super(IamPermissionSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<IamPermissionSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(IamPermissionSourceValue.class,
                "value", value);
    }
