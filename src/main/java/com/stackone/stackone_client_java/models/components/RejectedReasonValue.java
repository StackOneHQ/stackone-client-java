 ...
 */
@JsonDeserialize(using = RejectedReasonValue._Deserializer.class)
@JsonSerialize(using = RejectedReasonValue._Serializer.class)
public class RejectedReasonValue {
    ...
    public static final class _Serializer extends StdSerializer<RejectedReasonValue> {
        ...
        @Override
        public void serialize(RejectedReasonValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<RejectedReasonValue> {
        ...
        @Override
        public RejectedReasonValue deserialize(JsonParser p, DeserializationContext ctxt)
