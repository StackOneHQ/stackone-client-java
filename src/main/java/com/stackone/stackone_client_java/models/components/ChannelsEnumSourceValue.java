...
/**
 * ChannelsEnumSourceValue - The source value of the Channels.
 */

@JsonDeserialize(using = ChannelsEnumSourceValue._Deserializer.class)
public class ChannelsEnumSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.ChannelsEnumSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ChannelsEnumSourceValue other = (ChannelsEnumSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<ChannelsEnumSourceValue> {

        public _Deserializer() {
            super(ChannelsEnumSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<ChannelsEnumSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(ChannelsEnumSourceValue.class,
                "value", value);
    }
