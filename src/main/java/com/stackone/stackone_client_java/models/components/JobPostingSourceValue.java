...
/**
 * JobPostingSourceValue - The source value of the job postings status.
 */

@JsonDeserialize(using = JobPostingSourceValue._Deserializer.class)
public class JobPostingSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.JobPostingSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        JobPostingSourceValue other = (JobPostingSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<JobPostingSourceValue> {

        public _Deserializer() {
            super(JobPostingSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<JobPostingSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(JobPostingSourceValue.class,
                "value", value);
    }
