...
public class HRISCostCenterPaginated {
    ...
    @JsonProperty("data")
    private List<HRISCostCenter> data;
    ...
    @JsonIgnore
    public List<HRISCostCenter> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public HRISCostCenterPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public HRISCostCenterPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public HRISCostCenterPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public HRISCostCenterPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public HRISCostCenterPaginated withData(List<HRISCostCenter> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public HRISCostCenterPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public HRISCostCenterPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HRISCostCenterPaginated other = (HRISCostCenterPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HRISCostCenterPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<HRISCostCenter> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public HRISCostCenterPaginated build() {
            return new HRISCostCenterPaginated(
                nextPage,
                next,
                data,
                raw);
