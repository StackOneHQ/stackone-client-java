...
public class DrivesPaginated {
    ...
    @JsonCreator
    public DrivesPaginated(
            @JsonProperty("next") JsonNullable<String> next,
            @JsonProperty("data") List<Drives> data,
    ...
    public DrivesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public DrivesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public DrivesPaginated withData(List<Drives> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public DrivesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public DrivesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DrivesPaginated other = (DrivesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DrivesPaginated.class,
                "next", next,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(List<Drives> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
