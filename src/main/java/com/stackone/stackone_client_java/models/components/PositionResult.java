...
public class PositionResult {
    ...
    public PositionResult(
            @JsonProperty("data") Position data,
    ...
    public PositionResult withData(Position data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public PositionResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public PositionResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PositionResult other = (PositionResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PositionResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(Position data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
