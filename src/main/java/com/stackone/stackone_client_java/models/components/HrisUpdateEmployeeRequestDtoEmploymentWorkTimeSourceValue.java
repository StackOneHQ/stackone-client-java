...
@JsonDeserialize(using = HrisUpdateEmployeeRequestDtoEmploymentWorkTimeSourceValue._Deserializer.class)
public class HrisUpdateEmployeeRequestDtoEmploymentWorkTimeSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.HrisUpdateEmployeeRequestDtoSourceValueEmploymentWorkTime4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisUpdateEmployeeRequestDtoEmploymentWorkTimeSourceValue other = (HrisUpdateEmployeeRequestDtoEmploymentWorkTimeSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<HrisUpdateEmployeeRequestDtoEmploymentWorkTimeSourceValue> {

        public _Deserializer() {
            super(HrisUpdateEmployeeRequestDtoEmploymentWorkTimeSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<HrisUpdateEmployeeRequestDtoSourceValueEmploymentWorkTime4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(HrisUpdateEmployeeRequestDtoEmploymentWorkTimeSourceValue.class,
                "value", value);
    }
