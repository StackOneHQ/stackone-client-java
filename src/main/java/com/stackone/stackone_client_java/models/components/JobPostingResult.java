...
public class JobPostingResult {
    ...
    @JsonCreator
    public JobPostingResult(
            @JsonProperty("data") JobPosting data,
    ...
    public JobPostingResult withData(JobPosting data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public JobPostingResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public JobPostingResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        JobPostingResult other = (JobPostingResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(JobPostingResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(JobPosting data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
