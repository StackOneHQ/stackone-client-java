...
public class TaskResultValue {
    ...
    public static final class _Serializer extends StdSerializer<TaskResultValue> {
        ...
        @Override
        public void serialize(TaskResultValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<TaskResultValue> {
        ...
        @Override
        public TaskResultValue deserialize(JsonParser p, DeserializationContext ctxt)
