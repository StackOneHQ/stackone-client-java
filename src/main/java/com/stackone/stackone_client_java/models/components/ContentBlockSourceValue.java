...
/**
 * ContentBlockSourceValue - The source value of the type.
 */

@JsonDeserialize(using = ContentBlockSourceValue._Deserializer.class)
public class ContentBlockSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.ContentBlockSourceValue4}</li>
    ...
    public static final class _Deserializer extends OneOfDeserializer<ContentBlockSourceValue> {

        public _Deserializer() {
            super(ContentBlockSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<ContentBlockSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
