 ...
 *
 */
@JsonDeserialize(using = TimeEntriesValue._Deserializer.class)
@JsonSerialize(using = TimeEntriesValue._Serializer.class)
public class TimeEntriesValue {
    ...
    public static final class _Serializer extends StdSerializer<TimeEntriesValue> {

        protected _Serializer() {
            super(TimeEntriesValue.class);
        }

        @Override
        public void serialize(TimeEntriesValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<TimeEntriesValue> {
        ...
        @Override
        public TimeEntriesValue deserialize(JsonParser p, DeserializationContext ctxt)
                throws IOException, JacksonException {
            String v = p.readValueAs(new TypeReference<String>() {});
            // use the factory method to ensure we get singletons
            return TimeEntriesValue.of(v);
        }
    }
