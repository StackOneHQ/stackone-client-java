...
public class AtsJobsPaginated {
     ...
     */
    @Deprecated
    public AtsJobsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public AtsJobsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public AtsJobsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public AtsJobsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public AtsJobsPaginated withData(List<AtsJob> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public AtsJobsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public AtsJobsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsJobsPaginated other = (AtsJobsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsJobsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<AtsJob> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public AtsJobsPaginated build() {

            return new AtsJobsPaginated(
                nextPage, next, data,
                raw);
        }
