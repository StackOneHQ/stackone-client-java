...
public class InterviewStagesPaginated {
    ...
    @JsonProperty("data")
    private List<InterviewStage> data;
    ...
    @JsonIgnore
    public List<InterviewStage> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public InterviewStagesPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public InterviewStagesPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public InterviewStagesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public InterviewStagesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public InterviewStagesPaginated withData(List<InterviewStage> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public InterviewStagesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public InterviewStagesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        InterviewStagesPaginated other = (InterviewStagesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(InterviewStagesPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<InterviewStage> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public InterviewStagesPaginated build() {
            return new InterviewStagesPaginated(
                nextPage,
                next,
                data,
                raw);
