...
@JsonDeserialize(using = IamGroupSourceValue._Deserializer.class)
public class IamGroupSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.IamGroupSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamGroupSourceValue other = (IamGroupSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<IamGroupSourceValue> {

        public _Deserializer() {
            super(IamGroupSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<IamGroupSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(IamGroupSourceValue.class,
                "value", value);
    }
