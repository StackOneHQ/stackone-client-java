...
public class BackgroundCheckOrderJob {
     ...
     * Unique identifier
     */
    public BackgroundCheckOrderJob withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public BackgroundCheckOrderJob withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public BackgroundCheckOrderJob withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public BackgroundCheckOrderJob withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Title of the job
     */
    public BackgroundCheckOrderJob withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * Title of the job
     */
    public BackgroundCheckOrderJob withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * Hiring team for the job.
     */
    public BackgroundCheckOrderJob withHiringTeam(List<JobHiringTeam> hiringTeam) {
        Utils.checkNotNull(hiringTeam, "hiringTeam");
     ...
     * Hiring team for the job.
     */
    public BackgroundCheckOrderJob withHiringTeam(JsonNullable<? extends List<JobHiringTeam>> hiringTeam) {
        Utils.checkNotNull(hiringTeam, "hiringTeam");
        this.hiringTeam = hiringTeam;
        return this;
    }
     ...
     * Value to pass through to the provider
     */
    public BackgroundCheckOrderJob withPassthrough(Map<String, Object> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
     ...
     * Value to pass through to the provider
     */
    public BackgroundCheckOrderJob withPassthrough(JsonNullable<? extends Map<String, Object>> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
        this.passthrough = passthrough;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BackgroundCheckOrderJob other = (BackgroundCheckOrderJob) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BackgroundCheckOrderJob.class,
                "id", id,
                "remoteId", remoteId,
                "title", title,
    ...
    public final static class Builder {
        ...
        public BackgroundCheckOrderJob build() {
            return new BackgroundCheckOrderJob(
                id,
                remoteId,
                title,
                hiringTeam,
