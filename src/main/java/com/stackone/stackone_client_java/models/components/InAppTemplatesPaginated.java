...
public class InAppTemplatesPaginated {
    ...
    @JsonProperty("data")
    private List<InAppTemplate> data;
    ...
    @JsonIgnore
    public List<InAppTemplate> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public InAppTemplatesPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public InAppTemplatesPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public InAppTemplatesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public InAppTemplatesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public InAppTemplatesPaginated withData(List<InAppTemplate> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public InAppTemplatesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public InAppTemplatesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        InAppTemplatesPaginated other = (InAppTemplatesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(InAppTemplatesPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<InAppTemplate> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public InAppTemplatesPaginated build() {

            return new InAppTemplatesPaginated(
                nextPage, next, data,
                raw);
        }
