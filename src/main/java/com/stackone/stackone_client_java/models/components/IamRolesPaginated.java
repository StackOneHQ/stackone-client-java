...
public class IamRolesPaginated {
     ...
     */
    @Deprecated
    public IamRolesPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public IamRolesPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public IamRolesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public IamRolesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public IamRolesPaginated withData(List<IamRole> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public IamRolesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public IamRolesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamRolesPaginated other = (IamRolesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(IamRolesPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<IamRole> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
