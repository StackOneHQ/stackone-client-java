...
@JsonDeserialize(using = TaskResultSourceValue._Deserializer.class)
public class TaskResultSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.TaskResultSourceValue4}</li>
    ...
    public static final class _Deserializer extends OneOfDeserializer<TaskResultSourceValue> {

        public _Deserializer() {
            super(TaskResultSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<TaskResultSourceValue4>() {}, JsonShape.DEFAULT),
