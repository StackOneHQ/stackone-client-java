...
public class ApplicationStagesPaginated {
    ...
    @JsonProperty("data")
    private List<ApplicationStage> data;
    ...
    @JsonIgnore
    public List<ApplicationStage> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public ApplicationStagesPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public ApplicationStagesPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public ApplicationStagesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public ApplicationStagesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public ApplicationStagesPaginated withData(List<ApplicationStage> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public ApplicationStagesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public ApplicationStagesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApplicationStagesPaginated other = (ApplicationStagesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ApplicationStagesPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<ApplicationStage> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public ApplicationStagesPaginated build() {

            return new ApplicationStagesPaginated(
                nextPage, next, data,
                raw);
        }
