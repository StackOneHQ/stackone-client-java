 ...
 */
@JsonDeserialize(using = TicketingUserResultSourceValue._Deserializer.class)
public class TicketingUserResultSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.TicketingUserResultSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TicketingUserResultSourceValue other = (TicketingUserResultSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<TicketingUserResultSourceValue> {

        public _Deserializer() {
            super(TicketingUserResultSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<TicketingUserResultSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(TicketingUserResultSourceValue.class,
                "value", value);
    }
