...
public class AssignmentLearningObjectTypeSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.AssignmentSourceValueLearningObjectType4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AssignmentLearningObjectTypeSourceValue other = (AssignmentLearningObjectTypeSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<AssignmentLearningObjectTypeSourceValue> {

        public _Deserializer() {
            super(AssignmentLearningObjectTypeSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<AssignmentSourceValueLearningObjectType4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(AssignmentLearningObjectTypeSourceValue.class,
                "value", value);
    }
