...
public class AssessmentOrderJob {
     ...
     * Unique identifier
     */
    public AssessmentOrderJob withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public AssessmentOrderJob withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public AssessmentOrderJob withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public AssessmentOrderJob withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Title of the job
     */
    public AssessmentOrderJob withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * Title of the job
     */
    public AssessmentOrderJob withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * Hiring team for the job.
     */
    public AssessmentOrderJob withHiringTeam(List<JobHiringTeam> hiringTeam) {
        Utils.checkNotNull(hiringTeam, "hiringTeam");
     ...
     * Hiring team for the job.
     */
    public AssessmentOrderJob withHiringTeam(JsonNullable<? extends List<JobHiringTeam>> hiringTeam) {
        Utils.checkNotNull(hiringTeam, "hiringTeam");
        this.hiringTeam = hiringTeam;
        return this;
    }
     ...
     * Value to pass through to the provider
     */
    public AssessmentOrderJob withPassthrough(Map<String, Object> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
     ...
     * Value to pass through to the provider
     */
    public AssessmentOrderJob withPassthrough(JsonNullable<? extends Map<String, Object>> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
        this.passthrough = passthrough;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AssessmentOrderJob other = (AssessmentOrderJob) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AssessmentOrderJob.class,
                "id", id,
                "remoteId", remoteId,
                "title", title,
    ...
    public final static class Builder {
        ...
        public AssessmentOrderJob build() {
            return new AssessmentOrderJob(
                id,
                remoteId,
                title,
                hiringTeam,
