...
@JsonDeserialize(using = AccountingJournalCreateRequestDtoSourceValue._Deserializer.class)
public class AccountingJournalCreateRequestDtoSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.AccountingJournalCreateRequestDtoSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingJournalCreateRequestDtoSourceValue other = (AccountingJournalCreateRequestDtoSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<AccountingJournalCreateRequestDtoSourceValue> {

        public _Deserializer() {
            super(AccountingJournalCreateRequestDtoSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<AccountingJournalCreateRequestDtoSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(AccountingJournalCreateRequestDtoSourceValue.class,
                "value", value);
    }
