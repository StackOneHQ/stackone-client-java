...
public class AtsCreateCandidatesAssessmentsRequestDtoJob {
    ...
    @JsonCreator
    public AtsCreateCandidatesAssessmentsRequestDtoJob(
     ...
     * Unique identifier
     */
    public AtsCreateCandidatesAssessmentsRequestDtoJob withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public AtsCreateCandidatesAssessmentsRequestDtoJob withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public AtsCreateCandidatesAssessmentsRequestDtoJob withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public AtsCreateCandidatesAssessmentsRequestDtoJob withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Title of the job
     */
    public AtsCreateCandidatesAssessmentsRequestDtoJob withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * Title of the job
     */
    public AtsCreateCandidatesAssessmentsRequestDtoJob withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * Value to pass through to the provider
     */
    public AtsCreateCandidatesAssessmentsRequestDtoJob withPassthrough(Map<String, Object> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
     ...
     * Value to pass through to the provider
     */
    public AtsCreateCandidatesAssessmentsRequestDtoJob withPassthrough(JsonNullable<? extends Map<String, Object>> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
        this.passthrough = passthrough;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsCreateCandidatesAssessmentsRequestDtoJob other = (AtsCreateCandidatesAssessmentsRequestDtoJob) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsCreateCandidatesAssessmentsRequestDtoJob.class,
                "id", id,
                "remoteId", remoteId,
                "title", title,
    ...
    public final static class Builder {
        ...
        public AtsCreateCandidatesAssessmentsRequestDtoJob build() {
            return new AtsCreateCandidatesAssessmentsRequestDtoJob(
                id,
                remoteId,
                title,
                hiringTeam,
