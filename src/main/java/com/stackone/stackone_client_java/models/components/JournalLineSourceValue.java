...
@JsonDeserialize(using = JournalLineSourceValue._Deserializer.class)
public class JournalLineSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.JournalLineSourceValue4}</li>
    ...
    public static final class _Deserializer extends OneOfDeserializer<JournalLineSourceValue> {

        public _Deserializer() {
            super(JournalLineSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<JournalLineSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
