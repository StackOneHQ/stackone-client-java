...
public class MarketingCreateInAppTemplateRequestDto {
    ...
    @JsonCreator
    public MarketingCreateInAppTemplateRequestDto(
    ...
    public MarketingCreateInAppTemplateRequestDto withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = JsonNullable.of(name);
        return this;
    }

    public MarketingCreateInAppTemplateRequestDto withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public MarketingCreateInAppTemplateRequestDto withTags(List<String> tags) {
        Utils.checkNotNull(tags, "tags");
        this.tags = JsonNullable.of(tags);
        return this;
    }

    public MarketingCreateInAppTemplateRequestDto withTags(JsonNullable<? extends List<String>> tags) {
        Utils.checkNotNull(tags, "tags");
        this.tags = tags;
        return this;
    }

    public MarketingCreateInAppTemplateRequestDto withMessages(List<InAppMessages> messages) {
        Utils.checkNotNull(messages, "messages");
        this.messages = JsonNullable.of(messages);
        return this;
    }

    public MarketingCreateInAppTemplateRequestDto withMessages(JsonNullable<? extends List<InAppMessages>> messages) {
        Utils.checkNotNull(messages, "messages");
        this.messages = messages;
        return this;
    }
     ...
     * Value to pass through to the provider
     */
    public MarketingCreateInAppTemplateRequestDto withPassthrough(Map<String, Object> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
     ...
     * Value to pass through to the provider
     */
    public MarketingCreateInAppTemplateRequestDto withPassthrough(JsonNullable<? extends Map<String, Object>> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
        this.passthrough = passthrough;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MarketingCreateInAppTemplateRequestDto other = (MarketingCreateInAppTemplateRequestDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MarketingCreateInAppTemplateRequestDto.class,
                "name", name,
                "tags", tags,
                "messages", messages,
    ...
    public final static class Builder {
        ...
        public MarketingCreateInAppTemplateRequestDto build() {
            return new MarketingCreateInAppTemplateRequestDto(
                name,
                tags,
                messages,
                passthrough);
