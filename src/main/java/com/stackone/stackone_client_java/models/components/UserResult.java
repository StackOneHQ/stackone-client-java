...
public class UserResult {
    ...
    @JsonCreator
    public UserResult(
            @JsonProperty("data") LmsUser data,
    ...
    public UserResult withData(LmsUser data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public UserResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public UserResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(UserResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(LmsUser data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
