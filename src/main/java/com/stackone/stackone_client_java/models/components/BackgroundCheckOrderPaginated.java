...
public class BackgroundCheckOrderPaginated {
    ...
    @JsonProperty("data")
    private List<BackgroundCheckOrder> data;
    ...
    public BackgroundCheckOrderPaginated(
            List<BackgroundCheckOrder> data) {
    ...
    @JsonIgnore
    public List<BackgroundCheckOrder> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public BackgroundCheckOrderPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public BackgroundCheckOrderPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public BackgroundCheckOrderPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public BackgroundCheckOrderPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public BackgroundCheckOrderPaginated withData(List<BackgroundCheckOrder> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public BackgroundCheckOrderPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public BackgroundCheckOrderPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BackgroundCheckOrderPaginated other = (BackgroundCheckOrderPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BackgroundCheckOrderPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<BackgroundCheckOrder> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public BackgroundCheckOrderPaginated build() {
            return new BackgroundCheckOrderPaginated(
                nextPage,
                next,
                data,
                raw);
