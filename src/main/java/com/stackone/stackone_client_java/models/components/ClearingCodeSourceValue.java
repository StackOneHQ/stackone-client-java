...
@JsonDeserialize(using = ClearingCodeSourceValue._Deserializer.class)
public class ClearingCodeSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.ClearingCodeSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClearingCodeSourceValue other = (ClearingCodeSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<ClearingCodeSourceValue> {

        public _Deserializer() {
            super(ClearingCodeSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<ClearingCodeSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(ClearingCodeSourceValue.class,
                "value", value);
    }
