...
public class ReferenceResult {
    ...
    public ReferenceResult(
            @JsonProperty("data") Reference data,
    ...
    public ReferenceResult withData(Reference data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public ReferenceResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public ReferenceResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ReferenceResult other = (ReferenceResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ReferenceResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(Reference data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
