...
public class TicketingTicketType {
     ...
     * The id of the ticket type.
     */
    public TicketingTicketType withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * The id of the ticket type.
     */
    public TicketingTicketType withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The name of the ticket type.
     */
    public TicketingTicketType withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the ticket type.
     */
    public TicketingTicketType withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The project the ticket type belongs to.
     */
    public TicketingTicketType withProjectId(String projectId) {
        Utils.checkNotNull(projectId, "projectId");
     ...
     * The project the ticket type belongs to.
     */
    public TicketingTicketType withProjectId(JsonNullable<String> projectId) {
        Utils.checkNotNull(projectId, "projectId");
        this.projectId = projectId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TicketingTicketType other = (TicketingTicketType) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TicketingTicketType.class,
                "id", id,
                "name", name,
                "projectId", projectId);
    }
    ...
    public final static class Builder {
        ...
        public TicketingTicketType build() {
            ...
            return new TicketingTicketType(
                id, name, projectId);
        }
