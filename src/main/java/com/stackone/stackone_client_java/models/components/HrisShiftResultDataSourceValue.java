...
@JsonDeserialize(using = HrisShiftResultDataSourceValue._Deserializer.class)
public class HrisShiftResultDataSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.HrisShiftResultSourceValueData4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisShiftResultDataSourceValue other = (HrisShiftResultDataSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<HrisShiftResultDataSourceValue> {

        public _Deserializer() {
            super(HrisShiftResultDataSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<HrisShiftResultSourceValueData4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(HrisShiftResultDataSourceValue.class,
                "value", value);
    }
