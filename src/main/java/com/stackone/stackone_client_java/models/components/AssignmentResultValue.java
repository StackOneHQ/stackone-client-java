 ...
 */
@JsonDeserialize(using = AssignmentResultValue._Deserializer.class)
@JsonSerialize(using = AssignmentResultValue._Serializer.class)
public class AssignmentResultValue {
    ...
    public static final class _Serializer extends StdSerializer<AssignmentResultValue> {
        ...
        @Override
        public void serialize(AssignmentResultValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<AssignmentResultValue> {
        ...
        @Override
        public AssignmentResultValue deserialize(JsonParser p, DeserializationContext ctxt)
