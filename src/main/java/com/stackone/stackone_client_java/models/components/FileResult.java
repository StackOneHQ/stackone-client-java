...
public class FileResult {
    ...
    public FileResult withData(Files data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public FileResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public FileResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(FileResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(Files data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
