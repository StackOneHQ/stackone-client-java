...
public class TicketingUser {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    private JsonNullable<? extends TicketingUserType> type;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("active")
    private JsonNullable<? extends TicketingUserActive> active;
    ...
    public TicketingUser(
            ...
            @JsonProperty("type") JsonNullable<? extends TicketingUserType> type,
            ...
            @JsonProperty("active") JsonNullable<? extends TicketingUserActive> active,
    ...
    @JsonIgnore
    public JsonNullable<TicketingUserType> type() {
        return (JsonNullable<TicketingUserType>) type;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<TicketingUserActive> active() {
        return (JsonNullable<TicketingUserActive>) active;
    }
     ...
     * Unique identifier
     */
    public TicketingUser withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public TicketingUser withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public TicketingUser withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public TicketingUser withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
    ...
    public TicketingUser withType(JsonNullable<? extends TicketingUserType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * John Doe
     */
    public TicketingUser withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * John Doe
     */
    public TicketingUser withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The user's primary email address
     */
    public TicketingUser withPrimaryEmail(String primaryEmail) {
        Utils.checkNotNull(primaryEmail, "primaryEmail");
     ...
     * The user's primary email address
     */
    public TicketingUser withPrimaryEmail(JsonNullable<String> primaryEmail) {
        Utils.checkNotNull(primaryEmail, "primaryEmail");
        this.primaryEmail = primaryEmail;
        return this;
    }
     ...
     * The user's primary phone number
     */
    public TicketingUser withPrimaryPhone(String primaryPhone) {
        Utils.checkNotNull(primaryPhone, "primaryPhone");
     ...
     * The user's primary phone number
     */
    public TicketingUser withPrimaryPhone(JsonNullable<String> primaryPhone) {
        Utils.checkNotNull(primaryPhone, "primaryPhone");
        this.primaryPhone = primaryPhone;
        return this;
    }
     ...
     * The username of the user in the provider system
     */
    public TicketingUser withUsername(String username) {
        Utils.checkNotNull(username, "username");
     ...
     * The username of the user in the provider system
     */
    public TicketingUser withUsername(JsonNullable<String> username) {
        Utils.checkNotNull(username, "username");
        this.username = username;
        return this;
    }
     ...
     * If the user is active
     */
    public TicketingUser withActive(JsonNullable<? extends TicketingUserActive> active) {
        Utils.checkNotNull(active, "active");
        this.active = active;
        return this;
    }
     ...
     * The first name of the user
     */
    public TicketingUser withFirstName(String firstName) {
        Utils.checkNotNull(firstName, "firstName");
     ...
     * The first name of the user
     */
    public TicketingUser withFirstName(JsonNullable<String> firstName) {
        Utils.checkNotNull(firstName, "firstName");
        this.firstName = firstName;
        return this;
    }
     ...
     * The last name of the user
     */
    public TicketingUser withLastName(String lastName) {
        Utils.checkNotNull(lastName, "lastName");
     ...
     * The last name of the user
     */
    public TicketingUser withLastName(JsonNullable<String> lastName) {
        Utils.checkNotNull(lastName, "lastName");
        this.lastName = lastName;
        return this;
    }
     ...
     * The timestamp when the record was created
     */
    public TicketingUser withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * The timestamp when the record was created
     */
    public TicketingUser withCreatedAt(JsonNullable<OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The timestamp when the record was last updated
     */
    public TicketingUser withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
     ...
     * The timestamp when the record was last updated
     */
    public TicketingUser withUpdatedAt(JsonNullable<OffsetDateTime> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TicketingUser other = (TicketingUser) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TicketingUser.class,
                "id", id,
                "remoteId", remoteId,
                "type", type,
                "name", name,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends TicketingUserType> type = JsonNullable.undefined();
        ...
        private JsonNullable<? extends TicketingUserActive> active = JsonNullable.undefined();
        ...
        public Builder type(TicketingUserType type) {
            Utils.checkNotNull(type, "type");
            this.type = JsonNullable.of(type);
            return this;
        }

        public Builder type(JsonNullable<? extends TicketingUserType> type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
         ...
         * If the user is active
         */
        public Builder active(TicketingUserActive active) {
            Utils.checkNotNull(active, "active");
            this.active = JsonNullable.of(active);
            return this;
        }
         ...
         * If the user is active
         */
        public Builder active(JsonNullable<? extends TicketingUserActive> active) {
            Utils.checkNotNull(active, "active");
            this.active = active;
            return this;
        }
