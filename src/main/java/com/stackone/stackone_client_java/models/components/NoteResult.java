...
public class NoteResult {
    ...
    public NoteResult withData(Note data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public NoteResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public NoteResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(NoteResult.class,
                "data", data,
                "raw", raw);
    }
