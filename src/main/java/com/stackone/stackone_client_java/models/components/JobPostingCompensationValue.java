 ...
 */
/**
 * JobPostingCompensationValue - The type of the compensation.
 */
@JsonDeserialize(using = JobPostingCompensationValue._Deserializer.class)
@JsonSerialize(using = JobPostingCompensationValue._Serializer.class)
public class JobPostingCompensationValue {
    ...
    public static final class _Serializer extends StdSerializer<JobPostingCompensationValue> {
        ...
        @Override
        public void serialize(JobPostingCompensationValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<JobPostingCompensationValue> {
        ...
        @Override
        public JobPostingCompensationValue deserialize(JsonParser p, DeserializationContext ctxt)
