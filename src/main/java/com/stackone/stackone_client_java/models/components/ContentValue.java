...
public class ContentValue {
    ...
    // convention)
    private static final Map<String, ContentValue> values = createValuesMap();
    private static final Map<String, ContentValueEnum> enums = createEnumsMap();
    ...
    /**
     * Returns a ContentValue with the given value. For a specific value the 
     * returned object will always be a singleton so reference equality 
     * is satisfied when the values are the same.
     * 
     * @param value value to be wrapped as ContentValue
     */ 
    public static ContentValue of(String value) {
        synchronized (ContentValue.class) {
            return values.computeIfAbsent(value, v -> new ContentValue(v));
        }
    }
    ...
    public static ContentValue[] values() {
        synchronized (ContentValue.class) {
            return values.values().toArray(new ContentValue[] {});
        }
    }

    private static final Map<String, ContentValue> createValuesMap() {
        Map<String, ContentValue> map = new LinkedHashMap<>();
        map.put("video", VIDEO);
        map.put("quiz", QUIZ);
    ...
    private static final Map<String, ContentValueEnum> createEnumsMap() {
        Map<String, ContentValueEnum> map = new HashMap<>();
    ...
    public static final class _Serializer extends StdSerializer<ContentValue> {
        ...
        @Override
        public void serialize(ContentValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<ContentValue> {
        ...
        @Override
        public ContentValue deserialize(JsonParser p, DeserializationContext ctxt)
