...
public class CompletionResult {
    ...
    public CompletionResult(
            @JsonProperty("data") Completion data,
    ...
    public CompletionResult withData(Completion data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public CompletionResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public CompletionResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(CompletionResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(Completion data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
