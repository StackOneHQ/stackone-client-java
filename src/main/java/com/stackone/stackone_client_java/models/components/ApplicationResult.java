...
public class ApplicationResult {
    ...
    public ApplicationResult withData(Application data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public ApplicationResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public ApplicationResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(ApplicationResult.class,
                "data", data,
                "raw", raw);
    }
