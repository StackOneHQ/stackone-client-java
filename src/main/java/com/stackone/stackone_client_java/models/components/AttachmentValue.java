 ...
 */
@JsonDeserialize(using = AttachmentValue._Deserializer.class)
@JsonSerialize(using = AttachmentValue._Serializer.class)
public class AttachmentValue {
    ...
    public static final class _Serializer extends StdSerializer<AttachmentValue> {
        ...
        @Override
        public void serialize(AttachmentValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<AttachmentValue> {
        ...
        @Override
        public AttachmentValue deserialize(JsonParser p, DeserializationContext ctxt)
