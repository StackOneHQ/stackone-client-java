...
public class EmploymentResult {
    ...
    public EmploymentResult(
            @JsonProperty("data") Employment data,
    ...
    public EmploymentResult withData(Employment data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public EmploymentResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public EmploymentResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EmploymentResult other = (EmploymentResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EmploymentResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(Employment data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public EmploymentResult build() {
            return new EmploymentResult(
                data,
                raw);
        }
    }
