...
public class BackgroundCheckPackagePaginated {
    ...
    @JsonProperty("data")
    private List<BackgroundCheckPackage> data;
    ...
    public BackgroundCheckPackagePaginated(
            List<BackgroundCheckPackage> data) {
    ...
    @JsonIgnore
    public List<BackgroundCheckPackage> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public BackgroundCheckPackagePaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public BackgroundCheckPackagePaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public BackgroundCheckPackagePaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public BackgroundCheckPackagePaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public BackgroundCheckPackagePaginated withData(List<BackgroundCheckPackage> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public BackgroundCheckPackagePaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public BackgroundCheckPackagePaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BackgroundCheckPackagePaginated other = (BackgroundCheckPackagePaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BackgroundCheckPackagePaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<BackgroundCheckPackage> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public BackgroundCheckPackagePaginated build() {
            return new BackgroundCheckPackagePaginated(
                nextPage,
                next,
                data,
                raw);
