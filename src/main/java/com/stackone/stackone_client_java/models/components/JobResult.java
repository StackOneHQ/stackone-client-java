...
public class JobResult {
    ...
    public JobResult withData(Job data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public JobResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public JobResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(JobResult.class,
                "data", data,
                "raw", raw);
    }
