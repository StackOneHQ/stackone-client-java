...
public class BackgroundCheckOrderRequester {
     ...
     * User ID of the hiring team member.
     */
    public BackgroundCheckOrderRequester withUserId(String userId) {
        Utils.checkNotNull(userId, "userId");
     ...
     * User ID of the hiring team member.
     */
    public BackgroundCheckOrderRequester withUserId(JsonNullable<String> userId) {
        Utils.checkNotNull(userId, "userId");
        this.userId = userId;
        return this;
    }
     ...
     * Provider's unique identifier of the user
     */
    public BackgroundCheckOrderRequester withRemoteUserId(String remoteUserId) {
        Utils.checkNotNull(remoteUserId, "remoteUserId");
     ...
     * Provider's unique identifier of the user
     */
    public BackgroundCheckOrderRequester withRemoteUserId(JsonNullable<String> remoteUserId) {
        Utils.checkNotNull(remoteUserId, "remoteUserId");
        this.remoteUserId = remoteUserId;
        return this;
    }
     ...
     * First name of the hiring team member.
     */
    public BackgroundCheckOrderRequester withFirstName(String firstName) {
        Utils.checkNotNull(firstName, "firstName");
     ...
     * First name of the hiring team member.
     */
    public BackgroundCheckOrderRequester withFirstName(JsonNullable<String> firstName) {
        Utils.checkNotNull(firstName, "firstName");
        this.firstName = firstName;
        return this;
    }
     ...
     * Last name of the hiring team member.
     */
    public BackgroundCheckOrderRequester withLastName(String lastName) {
        Utils.checkNotNull(lastName, "lastName");
     ...
     * Last name of the hiring team member.
     */
    public BackgroundCheckOrderRequester withLastName(JsonNullable<String> lastName) {
        Utils.checkNotNull(lastName, "lastName");
        this.lastName = lastName;
        return this;
    }
     ...
     * Email of the hiring team member.
     */
    public BackgroundCheckOrderRequester withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * Email of the hiring team member.
     */
    public BackgroundCheckOrderRequester withEmail(JsonNullable<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * Role of the hiring team member.
     */
    public BackgroundCheckOrderRequester withRole(String role) {
        Utils.checkNotNull(role, "role");
     ...
     * Role of the hiring team member.
     */
    public BackgroundCheckOrderRequester withRole(JsonNullable<String> role) {
        Utils.checkNotNull(role, "role");
        this.role = role;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BackgroundCheckOrderRequester other = (BackgroundCheckOrderRequester) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BackgroundCheckOrderRequester.class,
                "userId", userId,
    ...
    public final static class Builder {
        ...
        public BackgroundCheckOrderRequester build() {
            return new BackgroundCheckOrderRequester(
                userId,
                remoteUserId,
                firstName,
                lastName,
