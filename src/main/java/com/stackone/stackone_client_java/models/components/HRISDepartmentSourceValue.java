...
@JsonDeserialize(using = HRISDepartmentSourceValue._Deserializer.class)
public class HRISDepartmentSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.HRISDepartmentSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HRISDepartmentSourceValue other = (HRISDepartmentSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<HRISDepartmentSourceValue> {

        public _Deserializer() {
            super(HRISDepartmentSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<HRISDepartmentSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(HRISDepartmentSourceValue.class,
                "value", value);
    }
