...
public class TemplatesPaginated {
     ...
     */
    @Deprecated
    public TemplatesPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public TemplatesPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public TemplatesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public TemplatesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public TemplatesPaginated withData(List<Template> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public TemplatesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public TemplatesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TemplatesPaginated other = (TemplatesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TemplatesPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public TemplatesPaginated build() {
            return new TemplatesPaginated(
                nextPage,
                next,
                data,
                raw);
