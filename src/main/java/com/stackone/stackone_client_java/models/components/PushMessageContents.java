...
public class PushMessageContents {
    ...
    public PushMessageContents withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = JsonNullable.of(title);
        return this;
    }

    public PushMessageContents withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }

    public PushMessageContents withSubtitle(String subtitle) {
        Utils.checkNotNull(subtitle, "subtitle");
        this.subtitle = JsonNullable.of(subtitle);
        return this;
    }

    public PushMessageContents withSubtitle(JsonNullable<String> subtitle) {
        Utils.checkNotNull(subtitle, "subtitle");
        this.subtitle = subtitle;
        return this;
    }

    public PushMessageContents withBody(String body) {
        Utils.checkNotNull(body, "body");
        this.body = JsonNullable.of(body);
        return this;
    }

    public PushMessageContents withBody(JsonNullable<String> body) {
        Utils.checkNotNull(body, "body");
        this.body = body;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PushMessageContents other = (PushMessageContents) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PushMessageContents.class,
                "title", title,
                "subtitle", subtitle,
                "body", body);
    }
    ...
    public final static class Builder {
        ...
        public PushMessageContents build() {
            return new PushMessageContents(
                title,
                subtitle,
                body);
        }
