...
public class AssessmentResultValue {
    ...
    public static final AssessmentResultValue UNMAPPED_VALUE = new AssessmentResultValue("unmapped_value");
    ...
    private static final Map<String, AssessmentResultValueEnum> createEnumsMap() {
        ...
        map.put("unmapped_value", AssessmentResultValueEnum.UNMAPPED_VALUE);
        return map;
    }
