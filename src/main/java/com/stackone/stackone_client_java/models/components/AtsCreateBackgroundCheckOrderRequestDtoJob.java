...
public class AtsCreateBackgroundCheckOrderRequestDtoJob {
     ...
     * Hiring team for the job.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoJob withHiringTeam(List<JobHiringTeam> hiringTeam) {
        Utils.checkNotNull(hiringTeam, "hiringTeam");
     ...
     * Hiring team for the job.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoJob withHiringTeam(JsonNullable<? extends List<JobHiringTeam>> hiringTeam) {
        Utils.checkNotNull(hiringTeam, "hiringTeam");
        this.hiringTeam = hiringTeam;
        return this;
    }
