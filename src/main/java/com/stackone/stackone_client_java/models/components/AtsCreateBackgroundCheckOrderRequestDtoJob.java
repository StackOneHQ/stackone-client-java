...
public class AtsCreateBackgroundCheckOrderRequestDtoJob {
     ...
     * Unique identifier
     */
    public AtsCreateBackgroundCheckOrderRequestDtoJob withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public AtsCreateBackgroundCheckOrderRequestDtoJob withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public AtsCreateBackgroundCheckOrderRequestDtoJob withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public AtsCreateBackgroundCheckOrderRequestDtoJob withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Title of the job
     */
    public AtsCreateBackgroundCheckOrderRequestDtoJob withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * Title of the job
     */
    public AtsCreateBackgroundCheckOrderRequestDtoJob withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * Hiring team for the job.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoJob withHiringTeam(List<AtsJobHiringTeam> hiringTeam) {
        Utils.checkNotNull(hiringTeam, "hiringTeam");
     ...
     * Hiring team for the job.
     */
    public AtsCreateBackgroundCheckOrderRequestDtoJob withHiringTeam(JsonNullable<? extends List<AtsJobHiringTeam>> hiringTeam) {
        Utils.checkNotNull(hiringTeam, "hiringTeam");
        this.hiringTeam = hiringTeam;
        return this;
    }
     ...
     * Value to pass through to the provider
     */
    public AtsCreateBackgroundCheckOrderRequestDtoJob withPassthrough(Map<String, Object> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
     ...
     * Value to pass through to the provider
     */
    public AtsCreateBackgroundCheckOrderRequestDtoJob withPassthrough(JsonNullable<? extends Map<String, Object>> passthrough) {
        Utils.checkNotNull(passthrough, "passthrough");
        this.passthrough = passthrough;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsCreateBackgroundCheckOrderRequestDtoJob other = (AtsCreateBackgroundCheckOrderRequestDtoJob) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsCreateBackgroundCheckOrderRequestDtoJob.class,
                "id", id,
                "remoteId", remoteId,
                "title", title,
