...
public class ScreeningPackagesPaginated {
    /**
     * 
    ...
    @JsonProperty("data")
    private List<ScreeningPackage> data;
    ...
    @JsonIgnore
    public List<ScreeningPackage> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public ScreeningPackagesPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public ScreeningPackagesPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public ScreeningPackagesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public ScreeningPackagesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public ScreeningPackagesPaginated withData(List<ScreeningPackage> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public ScreeningPackagesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public ScreeningPackagesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ScreeningPackagesPaginated other = (ScreeningPackagesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ScreeningPackagesPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<ScreeningPackage> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public ScreeningPackagesPaginated build() {

            return new ScreeningPackagesPaginated(
                nextPage, next, data,
                raw);
        }
