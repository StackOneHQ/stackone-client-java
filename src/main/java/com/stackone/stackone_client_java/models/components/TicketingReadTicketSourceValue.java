 ...
 */
@JsonDeserialize(using = TicketingReadTicketSourceValue._Deserializer.class)
public class TicketingReadTicketSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.TicketingReadTicketSourceValue4}</li>
    ...
    public static final class _Deserializer extends OneOfDeserializer<TicketingReadTicketSourceValue> {

        public _Deserializer() {
            super(TicketingReadTicketSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<TicketingReadTicketSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
