...
/**
 * InterviewSourceValue - The source value of the interview status.
 */

@JsonDeserialize(using = InterviewSourceValue._Deserializer.class)
public class InterviewSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.InterviewSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        InterviewSourceValue other = (InterviewSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<InterviewSourceValue> {

        public _Deserializer() {
            super(InterviewSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<InterviewSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(InterviewSourceValue.class,
                "value", value);
    }
