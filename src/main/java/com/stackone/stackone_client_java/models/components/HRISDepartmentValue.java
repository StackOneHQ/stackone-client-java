 ...
 *
 */
@JsonDeserialize(using = HRISDepartmentValue._Deserializer.class)
@JsonSerialize(using = HRISDepartmentValue._Serializer.class)
public class HRISDepartmentValue {
    ...
    public static final class _Serializer extends StdSerializer<HRISDepartmentValue> {

        protected _Serializer() {
            super(HRISDepartmentValue.class);
        }

        @Override
        public void serialize(HRISDepartmentValue value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<HRISDepartmentValue> {
        ...
        @Override
        public HRISDepartmentValue deserialize(JsonParser p, DeserializationContext ctxt)
                throws IOException, JacksonException {
            String v = p.readValueAs(new TypeReference<String>() {});
            // use the factory method to ensure we get singletons
            return HRISDepartmentValue.of(v);
        }
    }
