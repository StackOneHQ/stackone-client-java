...
/**
 * SmsMessagesSourceValue - The original value from the provider used to derive the unified message type.
 */

@JsonDeserialize(using = SmsMessagesSourceValue._Deserializer.class)
public class SmsMessagesSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.SmsMessagesSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SmsMessagesSourceValue other = (SmsMessagesSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<SmsMessagesSourceValue> {

        public _Deserializer() {
            super(SmsMessagesSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<SmsMessagesSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(SmsMessagesSourceValue.class,
                "value", value);
    }
