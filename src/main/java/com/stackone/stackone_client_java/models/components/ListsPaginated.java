...
public class ListsPaginated {
    ...
    @JsonProperty("data")
    private List<com.stackone.stackone_client_java.models.components.List> data;
    ...
    @JsonCreator
    public ListsPaginated(
            @JsonProperty("next_page") JsonNullable<String> nextPage,
            @JsonProperty("next") JsonNullable<String> next,
            @JsonProperty("data") List<com.stackone.stackone_client_java.models.components.List> data,
    ...
    public ListsPaginated(
            List<com.stackone.stackone_client_java.models.components.List> data) {
    ...
    @JsonIgnore
    public List<com.stackone.stackone_client_java.models.components.List> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public ListsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public ListsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public ListsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public ListsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public ListsPaginated withData(List<com.stackone.stackone_client_java.models.components.List> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public ListsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public ListsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListsPaginated other = (ListsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<com.stackone.stackone_client_java.models.components.List> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
