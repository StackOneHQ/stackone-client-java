 ...
 * format.
 */
@JsonDeserialize(using = CreateCategoriesApiModelSourceValue._Deserializer.class)
public class CreateCategoriesApiModelSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.CreateCategoriesApiModelSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCategoriesApiModelSourceValue other = (CreateCategoriesApiModelSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<CreateCategoriesApiModelSourceValue> {

        public _Deserializer() {
            super(CreateCategoriesApiModelSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<CreateCategoriesApiModelSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(CreateCategoriesApiModelSourceValue.class,
                "value", value);
    }
