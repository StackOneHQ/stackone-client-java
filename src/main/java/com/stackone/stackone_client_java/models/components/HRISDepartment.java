...
public class HRISDepartment {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    private JsonNullable<? extends HRISDepartmentType> type;

    @JsonCreator
    public HRISDepartment(
            ...
            @JsonProperty("type") JsonNullable<? extends HRISDepartmentType> type) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<HRISDepartmentType> type() {
        return (JsonNullable<HRISDepartmentType>) type;
    }
     ...
     * Unique identifier
     */
    public HRISDepartment withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier
     */
    public HRISDepartment withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Provider's unique identifier
     */
    public HRISDepartment withRemoteId(String remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
     ...
     * Provider's unique identifier
     */
    public HRISDepartment withRemoteId(JsonNullable<String> remoteId) {
        Utils.checkNotNull(remoteId, "remoteId");
        this.remoteId = remoteId;
        return this;
    }
     ...
     * Custom Unified Fields configured in your StackOne project
     */
    public HRISDepartment withUnifiedCustomFields(Map<String, Object> unifiedCustomFields) {
        Utils.checkNotNull(unifiedCustomFields, "unifiedCustomFields");
     ...
     * Custom Unified Fields configured in your StackOne project
     */
    public HRISDepartment withUnifiedCustomFields(JsonNullable<? extends Map<String, Object>> unifiedCustomFields) {
        Utils.checkNotNull(unifiedCustomFields, "unifiedCustomFields");
        this.unifiedCustomFields = unifiedCustomFields;
        return this;
    }
     ...
     * The name of the group
     */
    public HRISDepartment withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the group
     */
    public HRISDepartment withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The list of parent group ids of the given group
     */
    public HRISDepartment withParentIds(List<String> parentIds) {
        Utils.checkNotNull(parentIds, "parentIds");
     ...
     * The list of parent group ids of the given group
     */
    public HRISDepartment withParentIds(JsonNullable<? extends List<String>> parentIds) {
        Utils.checkNotNull(parentIds, "parentIds");
        this.parentIds = parentIds;
        return this;
    }
     ...
     * Provider's list of parent group remote ids of the given group
     */
    public HRISDepartment withRemoteParentIds(List<String> remoteParentIds) {
        Utils.checkNotNull(remoteParentIds, "remoteParentIds");
     ...
     * Provider's list of parent group remote ids of the given group
     */
    public HRISDepartment withRemoteParentIds(JsonNullable<? extends List<String>> remoteParentIds) {
        Utils.checkNotNull(remoteParentIds, "remoteParentIds");
        this.remoteParentIds = remoteParentIds;
        return this;
    }
     ...
     * The list of group owner ids of the given group
     */
    public HRISDepartment withOwnerIds(List<String> ownerIds) {
        Utils.checkNotNull(ownerIds, "ownerIds");
     ...
     * The list of group owner ids of the given group
     */
    public HRISDepartment withOwnerIds(JsonNullable<? extends List<String>> ownerIds) {
        Utils.checkNotNull(ownerIds, "ownerIds");
        this.ownerIds = ownerIds;
        return this;
    }
     ...
     * The list of remote group owner ids of the given group
     */
    public HRISDepartment withRemoteOwnerIds(List<String> remoteOwnerIds) {
        Utils.checkNotNull(remoteOwnerIds, "remoteOwnerIds");
     ...
     * The list of remote group owner ids of the given group
     */
    public HRISDepartment withRemoteOwnerIds(JsonNullable<? extends List<String>> remoteOwnerIds) {
        Utils.checkNotNull(remoteOwnerIds, "remoteOwnerIds");
        this.remoteOwnerIds = remoteOwnerIds;
        return this;
    }
     ...
     * The id of the company that the group belongs to
     */
    public HRISDepartment withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * The id of the company that the group belongs to
     */
    public HRISDepartment withCompanyId(JsonNullable<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Provider's id of the company that the group belongs to
     */
    public HRISDepartment withRemoteCompanyId(String remoteCompanyId) {
        Utils.checkNotNull(remoteCompanyId, "remoteCompanyId");
     ...
     * Provider's id of the company that the group belongs to
     */
    public HRISDepartment withRemoteCompanyId(JsonNullable<String> remoteCompanyId) {
        Utils.checkNotNull(remoteCompanyId, "remoteCompanyId");
        this.remoteCompanyId = remoteCompanyId;
        return this;
    }
     ...
     * The type of the department group
     */
    public HRISDepartment withType(HRISDepartmentType type) {
        Utils.checkNotNull(type, "type");
     ...
     * The type of the department group
     */
    public HRISDepartment withType(JsonNullable<? extends HRISDepartmentType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HRISDepartment other = (HRISDepartment) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HRISDepartment.class,
                "id", id,
                "remoteId", remoteId,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends HRISDepartmentType> type = JsonNullable.undefined();
         ...
         * The type of the department group
         */
        public Builder type(HRISDepartmentType type) {
            Utils.checkNotNull(type, "type");
            this.type = JsonNullable.of(type);
            return this;
        }
         ...
         * The type of the department group
         */
        public Builder type(JsonNullable<? extends HRISDepartmentType> type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }

        public HRISDepartment build() {

            return new HRISDepartment(
                id, remoteId, unifiedCustomFields,
                name, parentIds, remoteParentIds,
                ownerIds, remoteOwnerIds, companyId,
                remoteCompanyId, type);
