 ...
 * HasContent
 * 
 * <p>Whether the file has content
 */
@JsonDeserialize(using = HasContent._Deserializer.class)
public class HasContent {
     ...
     * <ul>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.HasContent2}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<HasContent> {
