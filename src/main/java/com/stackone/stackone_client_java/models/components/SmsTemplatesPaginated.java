...
public class SmsTemplatesPaginated {
     ...
     */
    @Deprecated
    public SmsTemplatesPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public SmsTemplatesPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public SmsTemplatesPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public SmsTemplatesPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public SmsTemplatesPaginated withData(List<SmsTemplate> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public SmsTemplatesPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public SmsTemplatesPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SmsTemplatesPaginated other = (SmsTemplatesPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SmsTemplatesPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<SmsTemplate> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public SmsTemplatesPaginated build() {
            return new SmsTemplatesPaginated(
                nextPage,
                next,
                data,
                raw);
