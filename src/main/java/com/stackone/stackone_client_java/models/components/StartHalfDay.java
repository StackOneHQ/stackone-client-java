...
/**
 * StartHalfDay - True if the start of the time off request begins half way through the day
 */

@JsonDeserialize(using = StartHalfDay._Deserializer.class)
public class StartHalfDay {
    ...
    public static final class _Deserializer extends OneOfDeserializer<StartHalfDay> {
