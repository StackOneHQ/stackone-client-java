...
public class TicketingTicketResultType {
     ...
     * The id of the ticket type.
     */
    public TicketingTicketResultType withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * The id of the ticket type.
     */
    public TicketingTicketResultType withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The name of the ticket type.
     */
    public TicketingTicketResultType withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the ticket type.
     */
    public TicketingTicketResultType withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The project the ticket type belongs to.
     */
    public TicketingTicketResultType withProjectId(String projectId) {
        Utils.checkNotNull(projectId, "projectId");
     ...
     * The project the ticket type belongs to.
     */
    public TicketingTicketResultType withProjectId(JsonNullable<String> projectId) {
        Utils.checkNotNull(projectId, "projectId");
        this.projectId = projectId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TicketingTicketResultType other = (TicketingTicketResultType) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TicketingTicketResultType.class,
                "id", id,
                "name", name,
                "projectId", projectId);
    }
    ...
    public final static class Builder {
        ...
        public TicketingTicketResultType build() {
            ...
            return new TicketingTicketResultType(
                id, name, projectId);
        }
