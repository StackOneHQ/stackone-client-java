...
@JsonDeserialize(using = IamUserAvatarFileFormatSourceValue._Deserializer.class)
public class IamUserAvatarFileFormatSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.IamUserSourceValueAvatarFileFormat4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IamUserAvatarFileFormatSourceValue other = (IamUserAvatarFileFormatSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<IamUserAvatarFileFormatSourceValue> {

        public _Deserializer() {
            super(IamUserAvatarFileFormatSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<IamUserSourceValueAvatarFileFormat4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(IamUserAvatarFileFormatSourceValue.class,
                "value", value);
    }
