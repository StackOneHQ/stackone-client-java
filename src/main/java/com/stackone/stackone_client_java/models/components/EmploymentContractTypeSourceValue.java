...
@JsonDeserialize(using = EmploymentContractTypeSourceValue._Deserializer.class)
public class EmploymentContractTypeSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.EmploymentSourceValueContractType4}</li>
    ...
    public static final class _Deserializer extends OneOfDeserializer<EmploymentContractTypeSourceValue> {

        public _Deserializer() {
            super(EmploymentContractTypeSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<EmploymentSourceValueContractType4>() {}, JsonShape.DEFAULT));
        }
    }
