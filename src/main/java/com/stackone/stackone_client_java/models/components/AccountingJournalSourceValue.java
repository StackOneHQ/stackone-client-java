...
@JsonDeserialize(using = AccountingJournalSourceValue._Deserializer.class)
public class AccountingJournalSourceValue {
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.AccountingJournalSourceValue4}</li>
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingJournalSourceValue other = (AccountingJournalSourceValue) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<AccountingJournalSourceValue> {

        public _Deserializer() {
            super(AccountingJournalSourceValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<List<Object>>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Boolean>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<Double>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<String>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<AccountingJournalSourceValue4>() {}, JsonShape.DEFAULT));
        }
    }
    
    @Override
    public String toString() {
        return Utils.toString(AccountingJournalSourceValue.class,
                "value", value);
    }
