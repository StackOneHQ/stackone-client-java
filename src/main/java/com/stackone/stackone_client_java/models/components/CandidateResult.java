...
public class CandidateResult {
    ...
    public CandidateResult(
            @JsonProperty("data") Candidate data,
    ...
    public CandidateResult withData(Candidate data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public CandidateResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public CandidateResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(CandidateResult.class,
                "data", data,
                "raw", raw);
    }
    ...
    public final static class Builder {
        ...
        public Builder data(Candidate data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
