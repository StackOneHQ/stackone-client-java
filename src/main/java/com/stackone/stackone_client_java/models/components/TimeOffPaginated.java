...
public class TimeOffPaginated {
     ...
     */
    @Deprecated
    public TimeOffPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public TimeOffPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public TimeOffPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public TimeOffPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public TimeOffPaginated withData(List<TimeOff> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public TimeOffPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public TimeOffPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TimeOffPaginated other = (TimeOffPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TimeOffPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<TimeOff> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public TimeOffPaginated build() {
            return new TimeOffPaginated(
                nextPage,
                next,
                data,
                raw);
