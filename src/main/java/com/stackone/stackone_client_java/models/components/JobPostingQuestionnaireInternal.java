...
@JsonDeserialize(using = JobPostingQuestionnaireInternal._Deserializer.class)
public class JobPostingQuestionnaireInternal {
     ...
     * <ul>
     * <li>{@code boolean}</li>
     * <li>{@code com.stackone.stackone_client_java.models.components.Internal2}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<JobPostingQuestionnaireInternal> {
