...
public class TemplateResult {
    ...
    public TemplateResult(
            @JsonProperty("data") Template data,
    ...
    public TemplateResult withData(Template data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public TemplateResult withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public TemplateResult withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TemplateResult other = (TemplateResult) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TemplateResult.class,
                "data", data,
                "raw", raw);
    }
