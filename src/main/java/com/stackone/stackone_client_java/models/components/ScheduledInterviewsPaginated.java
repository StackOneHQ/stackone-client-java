...
public class ScheduledInterviewsPaginated {
    ...
    @JsonProperty("data")
    private List<ScheduledInterview> data;
    ...
    @JsonIgnore
    public List<ScheduledInterview> data() {
        return data;
    }
     ...
     */
    @Deprecated
    public ScheduledInterviewsPaginated withNextPage(String nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
     ...
     */
    @Deprecated
    public ScheduledInterviewsPaginated withNextPage(JsonNullable<String> nextPage) {
        Utils.checkNotNull(nextPage, "nextPage");
        this.nextPage = nextPage;
        return this;
    }

    public ScheduledInterviewsPaginated withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = JsonNullable.of(next);
        return this;
    }

    public ScheduledInterviewsPaginated withNext(JsonNullable<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public ScheduledInterviewsPaginated withData(List<ScheduledInterview> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public ScheduledInterviewsPaginated withRaw(List<RawResponse> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = JsonNullable.of(raw);
        return this;
    }

    public ScheduledInterviewsPaginated withRaw(JsonNullable<? extends List<RawResponse>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ScheduledInterviewsPaginated other = (ScheduledInterviewsPaginated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ScheduledInterviewsPaginated.class,
                "nextPage", nextPage,
                "next", next,
                "data", data,
                "raw", raw);
    ...
    public final static class Builder {
        ...
        public Builder data(List<ScheduledInterview> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public ScheduledInterviewsPaginated build() {
            return new ScheduledInterviewsPaginated(
                nextPage,
                next,
                data,
                raw);
