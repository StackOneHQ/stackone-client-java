 ...
 *
 */
@JsonDeserialize(using = Internal._Deserializer.class)
@JsonSerialize(using = Internal._Serializer.class)
public class Internal {
    ...
    public static final class _Serializer extends StdSerializer<Internal> {
        ...
        @Override
        public void serialize(Internal value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<Internal> {
        ...
        @Override
        public Internal deserialize(JsonParser p, DeserializationContext ctxt)
                throws IOException, JacksonException {
            String v = p.readValueAs(new TypeReference<String>() {});
            // use the factory method to ensure we get singletons
            return Internal.of(v);
        }
    }
