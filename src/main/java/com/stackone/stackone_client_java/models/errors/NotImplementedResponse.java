...
public class NotImplementedResponse extends StackOneError {
    ...
    /**
    * Parse a response into an instance of NotImplementedResponse. If deserialization of the response body fails,
    * the resulting NotImplementedResponse instance will have a null data() value and a non-null deserializationException().
    */
    public static NotImplementedResponse from(HttpResponse<InputStream> response) {
        try {
            byte[] bytes = Utils.extractByteArrayFromBody(response);
            Data data = Utils.mapper().readValue(bytes, Data.class);
            return new NotImplementedResponse(response.statusCode(), bytes, response, data, null);
        } catch (Exception e) {
            return new NotImplementedResponse(response.statusCode(), null, response, null, e);
        }
    }

    /**
    * Parse a response into an instance of NotImplementedResponse asynchronously. If deserialization of the response body fails,
    * the resulting NotImplementedResponse instance will have a null data() value and a non-null deserializationException().
    */
    public static CompletableFuture<NotImplementedResponse> fromAsync(HttpResponse<Blob> response) {
