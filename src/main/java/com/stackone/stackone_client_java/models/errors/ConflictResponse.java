...
public class ConflictResponse extends RuntimeException {
     ...
     * HTTP status code
     */
    public ConflictResponse withStatusCode(double statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Error message
     */
    public ConflictResponse withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * Timestamp when the error occurred
     */
    public ConflictResponse withTimestamp(OffsetDateTime timestamp) {
        Utils.checkNotNull(timestamp, "timestamp");
        this.timestamp = timestamp;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ConflictResponse other = (ConflictResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ConflictResponse.class,
