...
public class RequestTimedOutResponse extends RuntimeException {
     ...
     * HTTP status code
     */
    public RequestTimedOutResponse withStatusCode(double statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Error message
     */
    public RequestTimedOutResponse withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * Timestamp when the error occurred
     */
    public RequestTimedOutResponse withTimestamp(OffsetDateTime timestamp) {
        Utils.checkNotNull(timestamp, "timestamp");
        this.timestamp = timestamp;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(RequestTimedOutResponse.class,
    ...
    public final static class Builder {
        ...
        public RequestTimedOutResponse build() {
