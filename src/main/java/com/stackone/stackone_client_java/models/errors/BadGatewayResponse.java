...
public class BadGatewayResponse extends StackOneError {
    ...
    /**
    * Parse a response into an instance of BadGatewayResponse. If deserialization of the response body fails,
    * the resulting BadGatewayResponse instance will have a null data() value and a non-null deserializationException().
    */
    public static BadGatewayResponse from(HttpResponse<InputStream> response) {
        try {
            byte[] bytes = Utils.extractByteArrayFromBody(response);
            Data data = Utils.mapper().readValue(bytes, Data.class);
            return new BadGatewayResponse(response.statusCode(), bytes, response, data, null);
        } catch (Exception e) {
            return new BadGatewayResponse(response.statusCode(), null, response, null, e);
        }
    }

    /**
    * Parse a response into an instance of BadGatewayResponse asynchronously. If deserialization of the response body fails,
    * the resulting BadGatewayResponse instance will have a null data() value and a non-null deserializationException().
    */
    public static CompletableFuture<BadGatewayResponse> fromAsync(HttpResponse<Blob> response) {
