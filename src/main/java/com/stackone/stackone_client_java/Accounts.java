...
public class Accounts implements
            MethodCallStackoneListLinkedAccounts,
            MethodCallStackoneGetAccount,
            MethodCallStackoneDeleteAccount,
            MethodCallStackoneUpdateAccount,
            MethodCallStackoneGetAccountMetaInfo {
    
    /**
     * STACKONE_LIST_LINKED_ACCOUNTS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] STACKONE_LIST_LINKED_ACCOUNTS_SERVERS = {
        "https://api.stackone.com",
    };
    
    /**
     * STACKONE_GET_ACCOUNT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] STACKONE_GET_ACCOUNT_SERVERS = {
        "https://api.stackone.com",
    };
    
    /**
     * STACKONE_DELETE_ACCOUNT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] STACKONE_DELETE_ACCOUNT_SERVERS = {
        "https://api.stackone.com",
    };
    
    /**
     * STACKONE_UPDATE_ACCOUNT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] STACKONE_UPDATE_ACCOUNT_SERVERS = {
        "https://api.stackone.com",
    };
    
    /**
     * STACKONE_GET_ACCOUNT_META_INFO_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] STACKONE_GET_ACCOUNT_META_INFO_SERVERS = {
        "https://api.stackone.com",
    };
    ...
    public StackoneListLinkedAccountsResponse listLinkedAccounts(
            StackoneListLinkedAccountsRequest request) throws Exception {
        return listLinkedAccounts(request, Optional.empty(), Optional.empty());
    }
    ...
    public StackoneListLinkedAccountsResponse listLinkedAccounts(
        ...
        String _baseUrl = Utils.templateUrl(STACKONE_LIST_LINKED_ACCOUNTS_SERVERS[0], new HashMap<String, String>());
        ...
        _req.addQueryParams(Utils.getQueryParams(
                StackoneListLinkedAccountsRequest.class,
                request, 
                null));
        ...
        StackoneListLinkedAccountsResponse.Builder _resBuilder = 
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                List<LinkedAccount> _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<List<LinkedAccount>>() {});
    ...
    public StackoneGetAccountResponse getAccount(
        ...
        return getAccount(id, Optional.empty(), Optional.empty());
    }
    ...
    public StackoneGetAccountResponse getAccount(
        ...
        String _baseUrl = Utils.templateUrl(STACKONE_GET_ACCOUNT_SERVERS[0], new HashMap<String, String>());
        if (serverURL.isPresent() && !serverURL.get().isBlank()) {
            _baseUrl = serverURL.get();
        }
        String _url = Utils.generateURL(
                StackoneGetAccountRequest.class,
                _baseUrl,
                "/accounts/{id}",
                request, null);
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        StackoneGetAccountResponse.Builder _resBuilder = 
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                LinkedAccount _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<LinkedAccount>() {});
    ...
    public StackoneDeleteAccountResponse deleteAccount(
            String id) throws Exception {
        return deleteAccount(id, Optional.empty(), Optional.empty());
    }
    ...
    public StackoneDeleteAccountResponse deleteAccount(
        ...
        String _baseUrl = Utils.templateUrl(STACKONE_DELETE_ACCOUNT_SERVERS[0], new HashMap<String, String>());
        if (serverURL.isPresent() && !serverURL.get().isBlank()) {
            _baseUrl = serverURL.get();
        }
        String _url = Utils.generateURL(
                StackoneDeleteAccountRequest.class,
                _baseUrl,
                "/accounts/{id}",
                request, null);
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        StackoneDeleteAccountResponse.Builder _resBuilder = 
    ...
    public StackoneUpdateAccountResponse updateAccount(
        ...
        return updateAccount(id, patchAccountExternalDto, Optional.empty(), Optional.empty());
    }
    ...
    public StackoneUpdateAccountResponse updateAccount(
        ...
        String _baseUrl = Utils.templateUrl(STACKONE_UPDATE_ACCOUNT_SERVERS[0], new HashMap<String, String>());
        if (serverURL.isPresent() && !serverURL.get().isBlank()) {
            _baseUrl = serverURL.get();
        }
        String _url = Utils.generateURL(
                StackoneUpdateAccountRequest.class,
                _baseUrl,
                "/accounts/{id}",
                request, null);
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        StackoneUpdateAccountResponse.Builder _resBuilder = 
    ...
    public StackoneGetAccountMetaInfoResponse getAccountMetaInfo(
            String id) throws Exception {
        return getAccountMetaInfo(id, Optional.empty(), Optional.empty());
    }
    ...
    public StackoneGetAccountMetaInfoResponse getAccountMetaInfo(
        ...
        String _baseUrl = Utils.templateUrl(STACKONE_GET_ACCOUNT_META_INFO_SERVERS[0], new HashMap<String, String>());
        if (serverURL.isPresent() && !serverURL.get().isBlank()) {
            _baseUrl = serverURL.get();
        }
        String _url = Utils.generateURL(
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        StackoneGetAccountMetaInfoResponse.Builder _resBuilder = 
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                LinkedAccountMeta _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<LinkedAccountMeta>() {});
