...
public class Proxy implements
    ...
    /**
     * STACKONE_PROXY_REQUEST_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] STACKONE_PROXY_REQUEST_SERVERS = {
    ...
    public StackoneProxyRequestResponse proxyRequest(
        ...
        return proxyRequest(xAccountId, proxyRequestBody, Optional.empty(), Optional.empty());
    }
    ...
    public StackoneProxyRequestResponse proxyRequest(
        ...
        String _baseUrl = Utils.templateUrl(STACKONE_PROXY_REQUEST_SERVERS[0], new HashMap<String, String>());
