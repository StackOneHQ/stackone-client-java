package com.stackone.stackone_client_java.hooks;
...
public final class SDKHooks {
    ...
    public static void initialize(com.stackone.stackone_client_java.utils.Hooks hooks) {
    ...
    public static void initialize(com.stackone.stackone_client_java.utils.AsyncHooks asyncHooks) {
        ...
        // asyncHooks.registerAfterError(com.stackone.stackone_client_java.utils.HookAdapters.adapt(mySyncHook));
