...
public class Lms {
    ...
    public LmsBatchUpsertCourseRequestBuilder batchUpsertCourse() {
        return new LmsBatchUpsertCourseRequestBuilder(sdkConfiguration);
    }
    ...
    public LmsUpsertCourseRequestBuilder upsertCourse() {
        return new LmsUpsertCourseRequestBuilder(sdkConfiguration);
    }
    ...
    public LmsCreateCollectionRequestBuilder createCollection() {
        return new LmsCreateCollectionRequestBuilder(sdkConfiguration);
    }
    ...
    public LmsUpdateCollectionRequestBuilder updateCollection() {
        return new LmsUpdateCollectionRequestBuilder(sdkConfiguration);
    }
