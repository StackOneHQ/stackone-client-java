...
CreateSkillsApiModelLanguageValue value = CreateSkillsApiModelLanguageValue.ARAR;

// Open enum: use .of() to create instances from custom string values
CreateSkillsApiModelLanguageValue custom = CreateSkillsApiModelLanguageValue.of("custom_value");
```
