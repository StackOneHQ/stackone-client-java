...
UnifiedUploadRequestDtoValue value = UnifiedUploadRequestDtoValue.UNMAPPED_VALUE;

// Open enum: use .of() to create instances from custom string values
UnifiedUploadRequestDtoValue custom = UnifiedUploadRequestDtoValue.of("custom_value");
```
