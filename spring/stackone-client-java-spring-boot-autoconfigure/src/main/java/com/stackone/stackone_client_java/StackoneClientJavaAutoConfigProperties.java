...
/**
 * Spring Boot Configuration Properties for stackone-client-java SDK
 */
@ConfigurationProperties(prefix = "stackoneclientjava")
public class StackoneClientJavaAutoConfigProperties {

    /**
     * Constructor.
     */
    public StackoneClientJavaAutoConfigProperties() {
    }
    ...
    public static class RetryConfig {
         ...
         */
        private com.stackone.stackone_client_java.utils.RetryConfig.Strategy strategy;
         ...
         */
        public com.stackone.stackone_client_java.utils.RetryConfig.Strategy getStrategy() {
            return strategy;
        }
         ...
         */
        public void setStrategy(com.stackone.stackone_client_java.utils.RetryConfig.Strategy strategy) {
